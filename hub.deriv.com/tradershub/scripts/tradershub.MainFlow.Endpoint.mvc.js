...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "MainFlow.Endpoint"; }
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Endpoint_mvc_controller_SaveOnClick_SaveWSURLJS, "SaveWSURL", "SaveOnClick", {
...
try {return controller.safeExecuteAsyncJSNode(tradershub_MainFlow_Endpoint_mvc_controller_OnReady_GetConfigJS, "GetConfig", "OnReady", {
...
get _resetOnClick$Action() {if(!(this.hasOwnProperty("__resetOnClick$Action"))) {
...
try {controller.ensureControllerAlive("ResetOnClick");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Endpoint_mvc_controller_ResetOnClick_ResetWSConfigJS, "ResetWSConfig", "ResetOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _resetOnClick$Action(value) {this.__resetOnClick$Action = value;
}

get _switchOnChange$Action() {if(!(this.hasOwnProperty("__switchOnChange$Action"))) {
...
try {controller.ensureControllerAlive("SwitchOnChange");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Endpoint_mvc_controller_SwitchOnChange_UpdateFeatureFlagByNameJS, "UpdateFeatureFlagByName", "SwitchOnChange", {
...
}set _switchOnChange$Action(value) {this.__switchOnChange$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._resetOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._switchOnChange$Action, callContext, flagNameIn);
} finally {
if(span) {
span.end();
}
...
const appIdValue = hostname === "hub.deriv.com" ? "61554"
              : hostname.includes("hub.deriv.me") ? "65205"
              : hostname.includes("hub.deriv.be") ? "65206"
