...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "WalletFlows.WalletsNoBalanceWithdrawal"; }
...
isDefault: false,
onClick: function () {
try {OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "wallets/withdrawal/no-balance", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Default), null, true);
} catch (ex) {
...
get _makeADepositOnClick$Action() {if(!(this.hasOwnProperty("__makeADepositOnClick$Action"))) {
...
try {controller.ensureControllerAlive("MakeADepositOnClick");
...
}set _makeADepositOnClick$Action(value) {this.__makeADepositOnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._makeADepositOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
