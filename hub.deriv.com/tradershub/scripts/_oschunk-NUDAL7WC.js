        ...
        get _onInitialize$Action() {
            return this.hasOwnProperty("__onInitialize$Action") || (this.__onInitialize$Action = function(t) {
                ...
                return i.Logger.startActiveSpan("OnInitialize", function(n) {
                    ...
                    try {
                        if (e.ensureControllerAlive("OnInitialize"), t = e.callContext(t), l.getAuthToken() === i.BuiltinFunctions.nullTextIdentifier()) return i.Navigation.navigateTo(i.Navigation.generateScreenURL("tradershub", "cfds/:ProductIdentifier?", {}), i.Transitions.createTransition(i.Transitions.TransitionAnimation.Default), t, !0)
                    } finally {
                        n && n.end()
                    }
                }, 1)
