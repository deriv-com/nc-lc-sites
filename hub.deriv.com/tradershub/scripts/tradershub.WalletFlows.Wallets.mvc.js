    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get getCurrenciesByCode$AggrRefresh() {
                if (!(this.hasOwnProperty("_getCurrenciesByCode$AggrRefresh"))) {
            ...
            set getCurrenciesByCode$AggrRefresh(value) {
                this._getCurrenciesByCode$AggrRefresh = value;
            }
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    ...
                                    return tradershubController.default.getWalletsList$Action(callContext).then(function(value) {
                                        ...
                                        getWalletIconJSResult.value = OS.Logger.startActiveSpan("GetWalletIcon", function(span) {
                                            ...
                                            try {
                                                return controller.safeExecuteJSNode(tradershub_WalletFlows_Wallets_mvc_controller_OnReady_GetWalletIconJS, "GetWalletIcon", "OnReady", {
                                        ...
                                        mapTransactionsJSResult.value = OS.Logger.startActiveSpan("MapTransactions", function(span) {
                                            ...
                                            try {
                                                return controller.safeExecuteJSNode(tradershub_WalletFlows_Wallets_mvc_controller_OnReady_MapTransactionsJS, "MapTransactions", "OnReady", {
