...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Signup.EmailSentScreen"; }
...
get _resendVerifyEmail$Action() {if(!(this.hasOwnProperty("__resendVerifyEmail$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_EmailSentScreen_mvc_controller_ResendVerifyEmail_VerifyEmailPayloadJS, "VerifyEmailPayload", "ResendVerifyEmail", {
...
}set _resendVerifyEmail$Action(value) {this.__resendVerifyEmail$Action = value;
}
