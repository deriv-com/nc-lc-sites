define("tradershub.FinancialAssessmentFlow.AccountTurnover.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.model$ST_0dd6e149ce474591a764bb53175023a1Structure"], function (OSRuntimeCore, tradershubModel) {
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "FinancialAssessmentFlow.AccountTurnover"; }
...
get _radioGroupOnClick$Action() {if(!(this.hasOwnProperty("__radioGroupOnClick$Action"))) {
...
try {controller.ensureControllerAlive("RadioGroupOnClick");
...
}set _radioGroupOnClick$Action(value) {this.__radioGroupOnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._radioGroupOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
