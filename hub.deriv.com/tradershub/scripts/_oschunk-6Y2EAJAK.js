                        ...
                        return e.Flow.executeAsyncFlow(function() {
                            return t.variables.isLoadingVar = !0, t.flush(), h.sendGetSetting$Action(r).then(function(n) {
                                ...
                                return e.Flow.executeSequence(function() {
                                    ...
                                    }, 1), t.flush(), h.derivApiSendMessage$Action(v.value.payloadOut, "new_account_real", !0, r).then(function(n) {
                                        i.value = n
                                    }).then(function() {
                                        return e.Flow.executeSequence(function() {
                                            if (i.value.isErrorOut) e.FeedbackMessageService.showFeedbackMessage(i.value.errorMessageOut, 3), t.variables.isLoadingVar = !1;
                                            else return p.value.dataOut = e.JSONUtils.deserializeFromJSON(i.value.responseOut, C, !1), w.setAuthToken(p.value.dataOut.new_account_realAttr.oauth_tokenAttr), e.Logger.startActiveSpan("UpdateAccountList", function(n) {
                                                ...
                                                try {
                                                    return a.safeExecuteJSNode(D, "UpdateAccountList", "AddNewAccountAction", {
                                                        Token: e.DataConversion.JSNodeParamConverter.to(p.value.dataOut.new_account_realAttr.oauth_tokenAttr, e.DataTypes.DataTypes.Text),
                                                        LoginId: e.DataConversion.JSNodeParamConverter.to(p.value.dataOut.new_account_realAttr.client_idAttr, e.DataTypes.DataTypes.Text)
                                                    }, function(g) {}, {}, {})
                                                } finally {
                                                    n && n.end()
                                                }
                                                ...
                                                }, 1), F.value.dataOut = e.JSONUtils.deserializeFromJSON(l.value.responseOut, S, !1), w.setActiveLoginId(u.value.responseOut.authorizeAttr.loginidAttr), t.variables.isLoadingVar = !1, t.variables.availableAccountsVar = F.value.dataOut, e.FeedbackMessageService.showFeedbackMessage(u.value.responseOut.authorizeAttr.currencyAttr + e.Injector.resolve(e.ServiceNames.TranslationsService).getMessage("hNv6JEs2FECYWJoo0eZIXA#Message.-1310993086.1", " options trading account added."), 1)
                                            }).then(function() {
