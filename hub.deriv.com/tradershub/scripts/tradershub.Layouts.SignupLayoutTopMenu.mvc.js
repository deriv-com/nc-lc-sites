...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Layouts.SignupLayoutTopMenu"; }
...
get getEUCountries$AggrRefresh() {if(!(this.hasOwnProperty("_getEUCountries$AggrRefresh"))) {
...
}set getEUCountries$AggrRefresh(value) {this._getEUCountries$AggrRefresh = value;
}
...
get _toggleTopDisclaimerOnClick$Action() {if(!(this.hasOwnProperty("__toggleTopDisclaimerOnClick$Action"))) {
...
try {controller.ensureControllerAlive("ToggleTopDisclaimerOnClick");
callContext = controller.callContext(callContext);
...
}set _toggleTopDisclaimerOnClick$Action(value) {this.__toggleTopDisclaimerOnClick$Action = value;
}

get _onLogoClick$Action() {if(!(this.hasOwnProperty("__onLogoClick$Action"))) {
...
try {controller.ensureControllerAlive("OnLogoClick");
callContext = controller.callContext(callContext);
...
}set _onLogoClick$Action(value) {this.__onLogoClick$Action = value;
}

get _onClickPolicy$Action() {if(!(this.hasOwnProperty("__onClickPolicy$Action"))) {
...
try {controller.ensureControllerAlive("OnClickPolicy");
callContext = controller.callContext(callContext);
...
}set _onClickPolicy$Action(value) {this.__onClickPolicy$Action = value;
}
...
get _getEUCountriesOnAfterFetch$Action() {if(!(this.hasOwnProperty("__getEUCountriesOnAfterFetch$Action"))) {
...
try {controller.ensureControllerAlive("GetEUCountriesOnAfterFetch");
callContext = controller.callContext(callContext);
...
}set _getEUCountriesOnAfterFetch$Action(value) {this.__getEUCountriesOnAfterFetch$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._toggleTopDisclaimerOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onLogoClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickPolicy$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._buttonOnClick$Action, callContext, agreeIn);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._getEUCountriesOnAfterFetch$Action, callContext);
} finally {
if(span) {
span.end();
}
