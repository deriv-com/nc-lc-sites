import {
    a as Z
} from "./_oschunk-QFK67O6B.js";
import {
    a as ee
} from "./_oschunk-SJ32ZBMY.js";
import {
    a as T
...
var c = K,
    ...
    b = class b extends A.BaseWebScreen {
        static get displayName() {
            return "BFFPocFlow.LegacyCFDs"
        }
        static getAttributes() {
            return {
                codeFunction: "LegacyCFDs",
                functionKey: "eb4a765c-0971-456d-b2ba-ce89a02d8ea3",
        ...
        static getCssDependencies() {
            return ["css/OutSystemsReactWidgets.css", "css/OutSystemsUI.OutSystemsUI.css", "css/tradershub.AccountCreation.css", "css/tradershub.BFFPocFlow.LegacyCFDs.css", "css/tradershub.AccountCreation.extra.css"]
        }
        static getJsDependencies() {
            return ["scripts/tradershub.UserScripts.JSCookie.js"]
        }
        static getBlocks() {
            return [W, k, D, T, L, U, B, $, H, N, z, G, Q, j, Y, M, F, I]
        }
        get modelFactory() {
            return Z
        }
        ...
        get title() {
            return A.BaseWebScreen.getTranslation("XHZK63EJbUWyus6JoC2Oow#Title", "LegacyCFDs")
        }
        internalRender() {
            let n = this.model,
                a = this.controller,
                    ...
                    content: new y(function() {
                        return [t.createElement(k, {
                            ...
                            visible: n.getCachedValue(e.getId("LoggedInBlocks.Visible"), function() {
                                return g.getAuthToken() !== c.BuiltinFunctions.nullTextIdentifier()
                            }, function() {
                            ...
                            inputs: {
                                ...
                                IsPasswordSet: n.getCachedValue(e.getId("mbQlEitjJkiLfFvq8sbppg.IsPasswordSet"), function() {
                            ...
                            inputs: {
                                IsVisible: n.getCachedValue(e.getId("X_GYEOSyMUay4u1s6WGb3g.IsVisible"), function() {
                                    return g.getTradingPlatformDxtradePasswordReset() !== c.BuiltinFunctions.nullTextIdentifier() || g.getTradingPlatformMt5PasswordReset() !== c.BuiltinFunctions.nullTextIdentifier() || n.variables.showModalVar === "ShowResetPasswordModal"
                                }, function() {
                                ...
                                Platform: n.getCachedValue(e.getId("X_GYEOSyMUay4u1s6WGb3g.Platform"), function() {
                                    return g.getTradingPlatformDxtradePasswordReset() !== c.BuiltinFunctions.nullTextIdentifier() ? "dxtrade" : g.getTradingPlatformMt5PasswordReset() !== c.BuiltinFunctions.nullTextIdentifier() ? "mt5" : ""
                                }, function() {
                                    return g.getTradingPlatformDxtradePasswordReset()
                                }, function() {
                                    return g.getTradingPlatformMt5PasswordReset()
                            ...
                            text: [f(_("6AdkVibp+ES_E_iaRpoqaw#Value", "Account details"))],
                            _idProps: {
                                service: e,
                                uuid: "10"
                            },
                            ...
                            style: "",
                            text: [f(_("07ZKvFKM4kmpiHfYS0fJmQ#Value", "Transfer"))],
                            _idProps: {
                                service: e,
                                uuid: "24"
                            },
                            ...
                            return [t.createElement(s, {
                                ...
                                text: [f(_("8WVQQFSNVUiDJCJeTcvvOw#Value", "Get another cTrader account"))],
                                _idProps: {
                                    service: e,
                                    uuid: "36"
                                },
                            ...
                            inputs: {
                                InfoMessage: c.Injector.resolve(c.ServiceNames.TranslationsService).getMessage("PF1mryViFkqkwUwN65Tiuw#Value.1054975282.1", "Scheduled downtime: Monthly on the first Saturday, 07:00-10:00 GMT. Service may be affected."),
                            ...
                            text: [f(_("637Adx5IzEGhmAbzuLIh3Q#Value", "cTrader web terminal"))],
                            _idProps: {
                                service: e,
                                uuid: "42"
                            },
                            ...
                            text: [f(_("YyR8L5wQCkaRrbpknQ6h8w#Value", "Also available on "))],
                            _idProps: {
                                service: e,
                                uuid: "47"
                            },
                            ...
                            text: [f(_("uY1yEqpdjEGfbS8oA_cpBg#Value", "Scan to download the mobile app."))],
                            _idProps: {
                                service: e,
                                uuid: "53"
                            },
                            ...
                            text: [f(_("m_QY7g92kkWkNvAJpkwM6Q#Value", "cTrader app"))],
                            _idProps: {
                                service: e,
                                uuid: "57"
                            },
                            ...
                            text: [f(_("cMijjdgLQUuEv1Qu7WfWhA#Value", "Complete profile setup"))],
                            _idProps: {
                                service: e,
                                uuid: "62"
                            },
                            ...
                            value: c.Injector.resolve(c.ServiceNames.TranslationsService).getMessage("PySxxf8tzkye1m7mqtmTgg#ValueExpression.-513209657.1", "To enable your MT5 ") + n.variables.selectedAccountVar.labelAttr + c.Injector.resolve(c.ServiceNames.TranslationsService).getMessage("PySxxf8tzkye1m7mqtmTgg#ValueExpression.489677834.1", " account, complete these steps."),
                            _idProps: {
                                service: e,
                                uuid: "65"
                            },
                            ...
                            inputs: {
                                status: n.getCachedValue(e.getId("d81xpw4GY0Kz5cf43vR1qg.status"), function() {
                            ...
                            _widgetRecordProvider: r
                        }), "Pound Sterling (GBP)"))), t.createElement(Y, {
                            getOwnerSpan: o(function() {
                                return l.getChildSpan("render")
                            }, "getOwnerSpan"),
                            getOwnerDisposeSpan: o(function() {
                            ...
                            visible: n.getCachedValue(e.getId("MyAccountsContainer.Visible"), function() {
                                return g.getAuthToken() !== c.BuiltinFunctions.nullTextIdentifier() && !n.variables.dataLoadingVar && !n.variables.createdCFDAccountsVar.isEmpty
                            }, function() {
                                return g.getAuthToken()
                            }, function() {
                            ...
                            text: [f(_("_Urr8jb+DUiXUDMCVaYe6Q#Value", "My accounts"))],
                            _idProps: {
                                service: e,
                                uuid: "96"
                            },
                                    ...
                                    content: new E(function(i, u) {
                                        return [t.createElement(M, {
                                            ...
                                            inputs: {
                                                ...
                                                Balance: n.getCachedValue(i.getId("2xQ2ohDzkkmtBmUF1Ppr6g.Balance"), function() {
                            ...
                            return [t.createElement(s, {
                                ...
                                text: [f(_("oGaNHmQZ4Uiz_OyJMumr1A#Value", "Available accounts"))],
                                _idProps: {
                                    service: e,
                                    uuid: "110"
                                },
                                ...
                                text: [f(_("2x3v_cA8DE2gfwYkzyQNcQ#Value", "View specifications"))],
                                _idProps: {
                                    service: e,
                                    uuid: "112"
                                },
