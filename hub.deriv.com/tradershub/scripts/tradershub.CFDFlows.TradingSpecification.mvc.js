define("tradershub.CFDFlows.TradingSpecification.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "OutSystemsUI.model", "tradershub.Layouts.MainLayout.mvc$model", "OutSystemsUI.Interaction.Carousel.mvc$model", "CustomComponentsOfficial.ButtonVariants.PrimaryButton.mvc$model", "tradershub.model$EN_8212284ed6913c62a123b32716b72fbaEntityRecord", "tradershub.model$RL_9eb97ad6cb81943972e368260e0cb936", "OutSystemsUI.model$ST_660adb7a9db48bff1b12c6e03515b415Structure", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "OutSystemsUI.model$ST_7d99fd1de65649f174aff6854b052539Structure", "tradershub.model$RC_07be8d7193ba16b1cc9d953b8fa48e9d", "tradershub.model$RL_ee1664da44e6893a731536d754684359"], function(OSRuntimeCore, tradershubModel, OutSystemsUIModel, tradershub_Layouts_MainLayout_mvcModel, OutSystemsUI_Interaction_Carousel_mvcModel, CustomComponentsOfficial_ButtonVariants_PrimaryButton_mvcModel) {
        ...
        OS.DataTypes.GenericRecord {
            static attributesToDeclare() {
                return [
                    ...
                    this.attr("CombinedCFDAccounts", "combinedCFDAccountsVar", "CombinedCFDAccounts", true, false, OS.DataTypes.DataTypes.RecordList, function() {
                    ...
                    this.attr("CreatedCFDAccounts", "createdCFDAccountsIn", "CreatedCFDAccounts", true, false, OS.DataTypes.DataTypes.Text, function() {
                        return "";
                    }, false),
                    this.attr("_createdCFDAccountsInDataFetchStatus", "_createdCFDAccountsInDataFetchStatus", "_createdCFDAccountsInDataFetchStatus", true, false, OS.DataTypes.DataTypes.Integer, function() {
                        return /*Fetched*/ 1;
                    }, false),
                    this.attr("AvailableCFDAccounts", "availableCFDAccountsIn", "AvailableCFDAccounts", true, false, OS.DataTypes.DataTypes.Text, function() {
                        return "";
                    }, false),
                    this.attr("_availableCFDAccountsInDataFetchStatus", "_availableCFDAccountsInDataFetchStatus", "_availableCFDAccountsInDataFetchStatus", true, false, OS.DataTypes.DataTypes.Integer, function() {
                        return /*Fetched*/ 1;
                    }, false),
    ...
    OS.Model.BaseViewModel {
        ...
        setInputs(inputs) {
            if ("CreatedCFDAccounts" in inputs) {
                this.variables.createdCFDAccountsIn = OS.DataConversion.ServerDataConverter.from(inputs.CreatedCFDAccounts, OS.DataTypes.DataTypes.Text);
            }

            if ("AvailableCFDAccounts" in inputs) {
                this.variables.availableCFDAccountsIn = OS.DataConversion.ServerDataConverter.from(inputs.AvailableCFDAccounts, OS.DataTypes.DataTypes.Text);
            }
                ...
                placeholders: {
                    content: new PlaceholderContent(function() {
                        return [React.createElement(OSWidgets.Container, {
                            ...
                            placeholders: {
                                carouselItems: new PlaceholderContent(function() {
                                    return [React.createElement(OSWidgets.List, {
                                        ...
                                        mode: /*Default*/ 0,
                                        source: model.variables.combinedCFDAccountsVar,
                                        ...
                                        placeholders: {
                                            content: new IteratorPlaceholderContent(function(idService, callContext) {
                                                return [React.createElement(OSWidgets.Container, {
                                                    ...
                                                    _widgetRecordProvider: widgetsRecordProvider,
                                                    _dependencies: [asPrimitiveValue(tradershubClientVariables.getAuthToken()), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).assetsClassesAttr), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).minimumDepositAttr), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).commissionAttr), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).spreadsAttr), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).descriptionAttr), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).titleAttr), asPrimitiveValue(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).iconAttr)]
                                                    ...
                                                    style: "display-flex ",
                                                    type: /*External*/ 1,
                                                    url: model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).iconAttr,
                                                    _idProps: {
                                                        service: idService,
                                                        name: "Icon"
                                                    },
                                                    ...
                                                    value: model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).titleAttr,
                                                    _idProps: {
                                                        service: idService,
                                                        name: "Product"
                                                    },
                                                    ...
                                                    value: model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).descriptionAttr,
                                                    _idProps: {
                                                        service: idService,
                                                        name: "Description"
                                                    },
                                                    ...
                                                    value: model.getCachedValue(idService.getId("DynamicSpreads.Value"), function() {
                                                        return ((((!(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).spreadsAttr.equals(OS.BuiltinFunctions.integerToDecimal(0)))) ? ("From ") : ("")) + OS.BuiltinFunctions.decimalToText(model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).spreadsAttr)) + " pips");
                                                    }, function() {
                                                        return model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).spreadsAttr;
                                                    }),
                                                    _idProps: {
                                                        service: idService,
                                                        name: "DynamicSpreads"
                                                    ...
                                                    value: model.getCachedValue(idService.getId("DynamicCommission.Value"), function() {
                                                        return ((model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).commissionAttr) ? ("Yes") : ("No"));
                                                    }, function() {
                                                        return model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).commissionAttr;
                                                    }),
                                                    _idProps: {
                                                        service: idService,
                                                    ...
                                                    value: model.getCachedValue(idService.getId("MinimumDeposit.Value"), function() {
                                                        return ((model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).minimumDepositAttr) ? ("Yes") : ("No"));
                                                    }, function() {
                                                        return model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).minimumDepositAttr;
                                                    }),
                                                    _idProps: {
                                                        service: idService,
                                                        name: "MinimumDeposit"
                                                    ...
                                                    value: model.variables.combinedCFDAccountsVar.getCurrent(callContext.iterationContext).assetsClassesAttr,
                                                    _idProps: {
                                                        service: idService,
                                                        name: "AssetClasses"
                                                    },
                            ...
                            _dependencies: [asPrimitiveValue(tradershubClientVariables.getAuthToken()), asPrimitiveValue(model.variables.combinedCFDAccountsVar)]
                        })];
                    })
                },
                _dependencies: [asPrimitiveValue(tradershubClientVariables.getAuthToken()), asPrimitiveValue(model.variables.combinedCFDAccountsVar)]
...
define("tradershub.CFDFlows.TradingSpecification.mvc$controller", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.model", "tradershub.languageResources", "tradershub.clientVariables", "tradershub.CFDFlows.TradingSpecification.mvc$translationsResources", "tradershub.CFDFlows.controller", "tradershub.CFDFlows.TradingSpecification.mvc$controller.OnReady.JavaScript1JS", "tradershub.model$EN_8212284ed6913c62a123b32716b72fbaEntityRecord", "tradershub.model$RL_9eb97ad6cb81943972e368260e0cb936", "OutSystemsUI.model$ST_660adb7a9db48bff1b12c6e03515b415Structure", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "OutSystemsUI.model$ST_7d99fd1de65649f174aff6854b052539Structure", "tradershub.model$RC_07be8d7193ba16b1cc9d953b8fa48e9d", "tradershub.model$RL_ee1664da44e6893a731536d754684359"], function(OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIModel, tradershubLanguageResources, tradershubClientVariables, tradershub_CFDFlows_TradingSpecification_mvc_TranslationsResources, tradershub_CFDFlowsController, tradershub_CFDFlows_TradingSpecification_mvc_controller_OnReady_JavaScript1JS) {
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
                ...
                if (!(this.hasOwnProperty("_getCfdProductConfigs$AggrRefresh"))) {
                    this._getCfdProductConfigs$AggrRefresh = function() {
                        var innerBody = function(maxRecords, startIndex, callContext) {
                            ...
                            return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetCfdProductConfigs", "screenservices/tradershub/CFDFlows/TradingSpecification/ScreenDataSetGetCfdProductConfigs", "bDB0nbNBDtJBnQRqX4xwyQ", maxRecords, startIndex, function(b) {
                                ...
                                controller._onReady$Action(controller.callContext(callContext));
                            });
                        }.bind(this);
                    ...
                    this.__onReady$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "e6501e0b-e00f-4c8b-b0ab-24d1f212c9ff");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                            ...
                            try {
                                ...
                                javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    if (span) {
                                        ...
                                        span.setAttribute("outsystems.function.key", "022f1e2d-c7bc-4afd-aa7f-74b6f6776618");
                                        span.setAttribute("outsystems.function.owner.name", "tradershub");
                                        span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_CFDFlows_TradingSpecification_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
                                            AvailableAccounts: OS.DataConversion.JSNodeParamConverter.to(model.variables.availableCFDAccountsIn, OS.DataTypes.DataTypes.Text),
                                            CfdConfig: OS.DataConversion.JSNodeParamConverter.to(jSONSerializeCfdConfigVar.value.jSONOut, OS.DataTypes.DataTypes.Text),
                                            CreatedAccounts: OS.DataConversion.JSNodeParamConverter.to(model.variables.createdCFDAccountsIn, OS.DataTypes.DataTypes.Text),
                                            Out1: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
                                        }, function($parameters) {
                                            var jsNodeResult = new(controller.constructor.getVariableGroupType("tradershub.CFDFlows.TradingSpecification.OnReady$javaScript1JSResult"))();
                                ...
                                jSONDeserializeCfdProductConfigListVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(javaScript1JSResult.value.out1Out, tradershubModel.RL_9eb97ad6cb81943972e368260e0cb936, false);
                                // CombinedCFDAccounts = JSONDeserializeCfdProductConfigList.Data
                                model.variables.combinedCFDAccountsVar = jSONDeserializeCfdProductConfigListVar.value.dataOut;
                                // isLoading = False
            ...
            get _cTAOnClick$Action() {
                if (!(this.hasOwnProperty("__cTAOnClick$Action"))) {
                    this.__cTAOnClick$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("CTAOnClick", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("CTAOnClick");
                                callContext = controller.callContext(callContext);
                                // Destination: /tradershub/CFDs
                                return OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "CFDs", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Default), callContext, true);
                            } finally {
            ...
            set _cTAOnClick$Action(value) {
                this.__cTAOnClick$Action = value;
            }
            ...
            cTAOnClick$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("CTAOnClick__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._cTAOnClick$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
        ...
        Controller.registerVariableGroupType("tradershub.CFDFlows.TradingSpecification.OnReady$javaScript1JSResult", [{
            name: "Out1",
            attrName: "out1Out",
            mandatory: true,
...
define("tradershub.CFDFlows.TradingSpecification.mvc$controller.OnReady.JavaScript1JS", [], function() {
    return function($parameters, $actions, $roles, $public) {
        ...
        const modifiedCfdConfig = cfdConfig.map(item => {
            const product = item.CfdProductConfig;

            // Check if the product is in availableAccounts or createdAccounts
            const isInAvailable = availableAccounts.some(account => account.ProductIdentifier === product.ProductIdentifier);
            const isInCreated = createdAccounts.some(account => account.ProductIdentifier === product.ProductIdentifier);

            let isAdded = null;
            if (isInAvailable) {
                isAdded = false; // If in availableAccounts, set is_added to false
            } else if (isInCreated) {
                isAdded = true; // If in createdAccounts, set is_added to true
            }

            // Return a new object with the CfdProductConfig and is_added property
            return {
                ...product, // Keep all existing properties
                isAdded: isAdded // Add the is_added flag

            };
        });

        $parameters.Out1 = JSON.stringify(modifiedCfdConfig)
    };
});
