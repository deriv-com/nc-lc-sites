...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.PersonalDetailsAdditional"; }
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_PersonalDetailsAdditional_mvc_controller_SaveOnClick_ValidateJS, "Validate", "SaveOnClick", {
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_PersonalDetailsAdditional_mvc_controller_SaveOnClick_RudderStackJS, "RudderStack", "SaveOnClick", null, function ($parameters) {
}, {
...
get _placeofBirthSelectorOnClickCountry$Action() {if(!(this.hasOwnProperty("__placeofBirthSelectorOnClickCountry$Action"))) {
...
try {controller.ensureControllerAlive("PlaceofBirthSelectorOnClickCountry");
callContext = controller.callContext(callContext);
...
}set _placeofBirthSelectorOnClickCountry$Action(value) {this.__placeofBirthSelectorOnClickCountry$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._placeofBirthSelectorOnClickCountry$Action, callContext, placeValueIn, labelIn);
} finally {
if(span) {
span.end();
}
...
const { errors, validFields } = validate($parameters.IsDesktop ? mergeSchema(validationSchema, validationSchemaAccountOpeningReason) : validationSchema, payload)
