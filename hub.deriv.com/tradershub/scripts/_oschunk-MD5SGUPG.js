            ...
            return this.hasOwnProperty("__onReady$Action") || (this.__onReady$Action = function(e) {
                ...
                return p.Logger.startActiveSpan("OnReady", function(n) {
                    ...
                    try {
                        ...
                        l.value = C.scrollToElement$Action(d.getId("HeaderContainer"), !0, 0, r.variables.titleIn, 0, e), p.Logger.startActiveSpan("Flatpickr", function(v) {
                            ...
                            try {
                                return t.safeExecuteJSNode(Q, "Flatpickr", "OnReady", null, function(h) {}, {}, {})
                            } finally {
                                v && v.end()
                            }
                        }, 1)
                    ...
                    return n && (n.setAttribute("code.function", "GoToDemoOnClick"), n.setAttribute("outsystems.function.key", "90bca2f7-c283-42a3-bc22-e018b7b45819"), n.setAttribute("outsystems.function.owner.name", "tradershub"), n.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc"), n.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION")), p.Flow.tryFinally(function() {
                        return t.ensureControllerAlive("GoToDemoOnClick"), e = t.callContext(e), p.Flow.executeAsyncFlow(function() {
                            return p.Logger.startActiveSpan("RudderStack", function(l) {
                                ...
                                if (o.getIsWallet()) return p.Flow.returnAsync(p.Navigation.navigateTo(p.Navigation.generateScreenURL("tradershub", "cfds/:ProductIdentifier?", {}), p.Transitions.createTransition(p.Transitions.TransitionAnimation.Default), e, !0));
                                M.syncAccountInfo$Action(e)
                            })
                        })
                    }, function() {
                        n && n.end()
        ...
        get _onInitialize$Action() {
            return this.hasOwnProperty("__onInitialize$Action") || (this.__onInitialize$Action = function(e) {
                ...
                return p.Logger.startActiveSpan("OnInitialize", function(n) {
                    ...
                    try {
                        if (t.ensureControllerAlive("OnInitialize"), e = t.callContext(e), r.variables.isLoadingVar = !0, o.getAuthToken() === p.BuiltinFunctions.nullTextIdentifier() || o.getActiveLoginId() === p.BuiltinFunctions.nullIdentifier().toString()) return p.Navigation.navigateTo(p.Navigation.generateScreenURL("https://app.deriv.com", {}), p.Transitions.createTransition(p.Transitions.TransitionAnimation.Default), e, !0);
                        (o.getIsWallet() ? p.BuiltinFunctions.index(o.getActiveWalletLoginId(), "VR", 0, !1, !0) === -1 || !o.getInitializeRealSignup() : p.BuiltinFunctions.index(o.getActiveLoginId(), "VR", 0, !1, !0) === -1 || !o.getInitializeRealSignup()) ? M.syncAccountInfo$Action(e): r.variables.isLoadingVar = !1
                    } finally {
                        n && n.end()
                    }
                }, 1)
...
var _e, he = new p.Controller.ControllerFactory(_e, de);
var X = L(F());
var Se = {};
var be = R; {
    let a = class a extends be.Controller.BaseViewController {
        constructor(e, r, t) {
            super(e, r, t, Se);
            var d = this.controller;
            this.clientActionProxies = {}, this.dataFetchDependenciesOriginal = {}, this.dataFetchDependentsGraph = {}, this.shouldSendClientVarsToDataSources = !1
...
var Ce, Ae = new be.Controller.ControllerFactory(Ce, W);
var He = R,
        ...
        constructor(e, r, t) {
            ...
            this.clientActionProxies = {
                triggerClick$Action: s(function() {
                    return d.executeActionInsideJSNode(d._triggerClick$Action.bind(d), d.callContext(), function(n) {
                        return {}
                        ...
                        t.ensureControllerAlive("OnReady"), e = t.callContext(e), E.Logger.startActiveSpan("SetAriaLabel", function(l) {
                            ...
                            try {
                                return t.safeExecuteJSNode(ie, "SetAriaLabel", "OnReady", {
                                    WidgetId: E.DataConversion.JSNodeParamConverter.to(d.getId("WizardWrapperItem"), E.DataTypes.DataTypes.Text)
                                }, function(v) {}, {}, {})
                            } finally {
                                l && l.end()
                            }
...
var Re, Ee = new E.Controller.ControllerFactory(Re, W);
var Oe = R,
                ...
                extendedEvents: {
                    onClick: s(function() {
                        return Promise.resolve().then(function() {
                            var c = d.clone();
                            return u.triggerClick$Action(u.callContext(c))
                        })
                    }, "onClick"),
                    onKeyPress: s(function() {
                        var c = d.clone();
                        u.wizardItemOnKeypress$Action(u.callContext(c))
                    }, "onKeyPress")
                },
                extendedProperties: {
                    role: "tab",
...
var _ = R; {
    let a = class a extends _.Controller.BaseViewController {
        constructor(e, r, t) {
            ...
            this.clientActionProxies = {
                initializedHandler$Action: s(function(n) {
                    return n = n === void 0 ? "" : n, d.executeActionInsideJSNode(d._initializedHandler$Action.bind(d, _.DataConversion.JSNodeParamConverter.from(n, _.DataTypes.DataTypes.Text)), d.callContext(), function(l) {
                        return {}
        ...
        get _initializedHandler$Action() {
            return this.hasOwnProperty("__initializedHandler$Action") || (this.__initializedHandler$Action = function(e, r) {
                var t = this.model,
                    d = this.controller,
                    n = this.idService;
                return _.Logger.startActiveSpan("InitializedHandler", function(l) {
                    return l && (l.setAttribute("code.function", "InitializedHandler"), l.setAttribute("outsystems.function.key", "4e9a6be6-5cee-4691-b501-6be035f94ad7"), l.setAttribute("outsystems.function.owner.name", "OutSystemsUI"), l.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271"), l.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION")), _.Flow.tryFinally(function() {
                        d.ensureControllerAlive("InitializedHandler"), r = d.callContext(r);
                        var v = new _.DataTypes.VariableHolder(new(d.constructor.getVariableGroupType("OutSystemsUI.Numbers.ProgressBar.InitializedHandler$vars")));
                        return v.value.progressBarIdInLocal = e, _.Flow.executeAsyncFlow(function() {
                            return d.initialized$Action(v.value.progressBarIdInLocal, r)
                        })
                    }, function() {
                        l && l.end()
                    })
            ...
            return this.hasOwnProperty("__registerCallbacks$Action") || (this.__registerCallbacks$Action = function(e) {
                ...
                return _.Logger.startActiveSpan("RegisterCallbacks", function(n) {
                    ...
                    try {
                        ...
                        var l = new _.DataTypes.VariableHolder;
                        l.value = _.Logger.startActiveSpan("GetCallbackHandlers", function(v) {
        ...
        initializedHandler$Action(e, r) {
            ...
            return _.Logger.startActiveSpan("InitializedHandler__proxy", function(d) {
    ...
    s(a, "ControllerInner");
    let S = a;
    B = S, B.registerVariableGroupType("OutSystemsUI.Numbers.ProgressBar.InitializedHandler$vars", [{
        name: "ProgressBarId",
...
var B, xe = new _.Controller.ControllerFactory(B, W);
    ...
    z = class z extends T.BaseWebBlock {
        ...
        internalRender() {
            ...
            return i.createElement("div", this.getRootNodeProperties(), i.createElement(m, {
                ...
                text: [l(h("00Hg9JXhFU+VYKs5xFdaZg#Value", "Add a real account"))],
                _idProps: {
                    service: e,
                    uuid: "3"
                },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("P0Xu+1Tig0m4OLvgURtYdw#Value", "Account currency"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "10"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("+BvKEOcms0KfYyA9fStPYw#Value", "Personal details"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "14"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("xZYEMoT7J0i13z2jBWtiXg#Value", "Identity verification"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "18"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("nPjWA3lug0mp2hTL7VWp8A#Value", "Employment details"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "22"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("o7a21oFyYkWHxN_tdG5Aug#Value", "Address details"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "26"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("7rOieFFmR0aKtMmCQNa7wQ#Value", "Terms of use"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "30"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("+ebJ3an1yESSA8b3MxMCtQ#Value", "Account currency"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "35"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("sOFFOZ5eSkKZAQpkfvxx5Q#Value", "Personal details"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "39"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("YA2CWMcV2E66elYYLwz5Ew#Value", "Employment details"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "43"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("97ai+Wm57kq0+TK67W4fyw#Value", "Address details"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "47"
                                            },
                                ...
                                placeholders: {
                                    ...
                                    label: new y(function() {
                                        return [i.createElement(m, {
                                            ...
                                            text: [l(h("yq52o9hmMUuVUf7G4tnWiQ#Value", "Terms of use"))],
                                            _idProps: {
                                                service: e,
                                                uuid: "51"
                                            },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("G2BcsZjRdkiwgC9dchNrvQ#Value", "Account currency"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "56"
                                        },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("uifKUurnwke7CIJg4vYqrg#Value", "Personal details"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "60"
                                        },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("Pa2O+RxuT0qU3KJjYgRjsw#Value", "Employment details"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "64"
                                        },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("rTJyiiw0_EW+g2SNDlVWHA#Value", "Address details"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "68"
                                        },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("dp6GYwWpyku50q1bnrTUng#Value", "Trading assessment"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "72"
                                        },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("lPkQVd47ME2wNfaiy8oIvw#Value", "Financial assessment"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "76"
                                        },
                            ...
                            placeholders: {
                                ...
                                label: new y(function() {
                                    return [i.createElement(m, {
                                        ...
                                        text: [l(h("YU9cCtAP3EyaCllIHVGvDQ#Value", "Terms of use"))],
                                        _idProps: {
                                            service: e,
                                            uuid: "80"
                                        },
                ...
                return [i.createElement(U, {
                    ...
                    onClick: s(function() {
                        var c = d.clone();
                        u.previousScreen$Action(u.callContext(c))
                    }, "onClick"),
                    style: "display-flex",
                    visible: !0,
                    _idProps: {
                ...
                extendedEvents: {
                    onClick: s(function() {
                        var c = d.clone();
                        u.onOpenModal$Action(u.callContext(c))
                    }, "onClick")
                },
                visible: !0,
                _idProps: {
                ...
                text: [l(h("wFdeBW5220eorYzALA2eOA#Value", "Exit profile setup"))],
                _idProps: {
                    service: e,
                    uuid: "112"
                },
                ...
                extendedEvents: {
                    onClick: s(function() {
                        var c = d.clone();
                        u.onCloseModal$Action(u.callContext(c))
                    }, "onClick")
                },
                gridProperties: {
                    classes: "ThemeGrid_MarginGutter"
                ...
                text: [l(h("NPlnceVpDk+tMW25I6omMA#Value", "You will lose your progress."))],
                _idProps: {
                    service: e,
                    uuid: "115"
                },
                ...
                text: [l(h("dfo3eZPJdEadIldymCRAug#Value", "Continue setup"))],
                _idProps: {
                    service: e,
                    uuid: "117"
                },
                ...
                onClick: s(function() {
                    return Promise.resolve().then(function() {
                        var c = d.clone();
                        return u.goToDemoOnClick$Action(u.callContext(c))
                    })
                }, "onClick"),
                style: "btn",
                visible: !0,
                ...
                text: [l(h("TGotkGwAd0mP+Rfg+z+ejQ#Value", "Go to demo"))],
                _idProps: {
                    service: e,
                    uuid: "119"
                },
