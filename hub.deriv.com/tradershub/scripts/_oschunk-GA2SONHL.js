import {
    a as O
} from "./_oschunk-XBVQ5FI3.js";
import {
    a as R
} from "./_oschunk-2FL724PB.js";
import {
    a as T
} from "./_oschunk-Y6NOXVJO.js";
import {
    a as y
    ...
    m = class m extends V.BaseWebScreen {
        ...
        get title() {
            let i = this.model,
                ...
                h = m.getTranslation,
                v = this;
            return p.Injector.resolve(p.ServiceNames.TranslationsService).getMessage("TNAEDlc4s0i1nQQFHUByLA#TitleExpression.-787762664.1", "Set a new password")
        }
        internalRender() {
            let i = this.model,
                o = this.controller,
                ...
                placeholders: {
                    content: new u(function() {
                        return [t.createElement(c, {
                            ...
                            image: p.Navigation.VersionedURL.getVersionedUrl("img/tradershub.Logo.png"),
                            type: 0,
                            _idProps: {
                                service: e,
                                uuid: "5"
                            ...
                            _widgetRecordProvider: r
                        }, v(g("RyWkZ2V37k6kDAl2adJqXw#Value", "Reset password"))), t.createElement(c, {
                            align: 0,
                            animate: !1,
                            style: "margin-top-s",
                            visible: !0,
                            ...
                            _widgetRecordProvider: r
                        }, v(g("k4KVmCe6QEaS0B56phl+9g#Value", `If the entered email is correct, we'll send a verification code to that email.
...
`))))), t.createElement(c, {
                            ...
                            placeholders: {
                                label: new u(function() {
                                    return [t.createElement(b, {
                                        ...
                                        _widgetRecordProvider: r
                                    }, v(g("QL1mqWwGjE2zCHgcaf2iCA#Value", "Email")))]
                                }),
                                input: new u(function() {
                                    return [t.createElement(f, {
                                        ...
                                        style: "form-control",
                                        variable: i.createVariable(p.DataTypes.DataTypes.Email, i.variables.emailIn, function(n) {
                            ...
                            placeholders: {
                                label: new u(function() {
                                    return [t.createElement(b, {
                                        ...
                                        _widgetRecordProvider: r
                                    }, v(g("fyHM5Gx3wkWMLqJccQoLnw#Value", "Verification code")))]
                                }),
                                input: new u(function() {
                                    return [t.createElement(f, {
                                        _validationProps: {
                                        ...
                                        style: "form-control",
                                        variable: i.createVariable(p.DataTypes.DataTypes.Text, i.variables.verificationCodeIn, function(n) {
                            ...
                            placeholders: {
                                label: new u(function() {
                                    return [t.createElement(b, {
                                        ...
                                        _widgetRecordProvider: r
                                    }, v(g("WrZQ2WIh0UejDSX42KwiwA#Value", "New password")))]
                                }),
                                input: new u(function() {
                                        ...
                                        placeholders: {
                                            ...
                                            input: new u(function() {
                                                return [t.createElement(f, {
                                                    ...
                                                    variable: i.createVariable(p.DataTypes.DataTypes.Text, i.variables.newPasswordVar, function(n) {
                            ...
                            events: {
                                ...
                                compliant$Action: a(function(n) {
                                    var U = P.clone();
                                    o.passwordPolicyCompliant$Action(n, o.callContext(U))
                                }, "compliant$Action")
                            },
                            _validationProps: {
                                validationService: l,
                            ...
                            placeholders: {
                                label: new u(function() {
                                    return [t.createElement(b, {
                                        ...
                                        _widgetRecordProvider: r
                                    }, v(g("D8SnzXdRCEuo2QnLs_vGRw#Value", "Confirm password")))]
                                }),
                                input: new u(function() {
                                    return [t.createElement(R, {
                                        getOwnerSpan: a(function() {
                                        ...
                                        placeholders: {
                                            ...
                                            input: new u(function() {
                                                return [t.createElement(f, {
                                                    ...
                                                    style: "form-control login-password",
                                                    variable: i.createVariable(p.DataTypes.DataTypes.Text, i.variables.confirmPasswordVar, function(n) {
                            ...
                            placeholders: {
                                button: new u(function() {
                                    return [t.createElement(D, {
                                        ...
                                        _widgetRecordProvider: r
                                    }), v(g("lDd0coklNEO+7t7X5YyfQA#Value", "Save password")))]
                                })
                            },
                            ...
                            _widgetRecordProvider: r
                        }, v(g("U+g_NOruNkeUZxEnphvXbQ#Value", "Not in the right place?")), t.createElement(S, {
                            enabled: !0,
                            extendedProperties: {
                                tabIndex: "5",
                            ...
                            url: p.Navigation.generateScreenURL("tradershub", "CommonLogin", {}),
                            visible: !0,
                            _idProps: {
                                service: e,
                                uuid: "40"
                            ...
                            _widgetRecordProvider: r
                        }, v(g("4LDnfyb9g0GaneMelrpuhg#Value", "Go to login."))))))]
                    })
                },
