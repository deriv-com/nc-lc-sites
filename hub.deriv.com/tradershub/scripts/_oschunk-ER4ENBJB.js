import {
    a as E
} from "./_oschunk-TZL5IHNU.js";
import {
    a as W
} from "./_oschunk-5HGQNCO3.js";
import {
    a as _
...
var t = k(A());
var s = O,
    V = y.PlaceholderContent,
    M = y.IteratorPlaceholderContent,
            ...
            return t.createElement("div", this.getRootNodeProperties(), t.createElement(R, {
                ...
                inputs: {
                    HideTitle: c.getCachedValue(e.getId("9sqRcQOtBUiPn6y2wXzSnQ.HideTitle"), function() {
                        return S.isPhone$Action(p).isPhoneOut
                    }),
                    ...
                    content: new V(function() {
                        return [t.createElement(d, {
                            ...
                            style: c.getCachedValue(e.getId("ZdNsv1ZO6kWI1OhbDzX6rw.Style"), function() {
                                return "display-flex flex-direction-column " + (S.isPhone$Action(p).isPhoneOut ? "gap-base" : "gap-m")
                            }),
                            visible: !0,
                            _idProps: {
                                service: e,
                            ...
                            mandatory: !1,
                            style: "radio-group",
                            variable: c.createVariable(s.DataTypes.DataTypes.Text, f.getTradingAssessmentHighRiskStopLoss(), function(n) {
                                f.setTradingAssessmentHighRiskStopLoss(n)
                            }),
                            _idProps: {
                                service: e,
                                name: "RadioGroup"
                ...
                _dependencies: [w(f.getTradingAssessmentHighRiskStopLoss()), w(c.variables.isRequiredVar)]
            }))
        }
    };
i(l, "View");
