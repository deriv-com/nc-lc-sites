...
try {controller.ensureControllerAlive("AddAccountOnClick");
...
try {controller.ensureControllerAlive("SetPasswordOnClick");
callContext = controller.callContext(callContext);
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteClientAction(controller._addAccountOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._setPasswordOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
