                        ...
                        return OS.Logger.startActiveSpan("OnParametersChanged", function(span) {
                            ...
                            try {
                                ...
                                formaDynamicLoginJSResult.value = OS.Logger.startActiveSpan("FormaDynamicLogin", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_CFDBlocks_DerivXTradeModal_mvc_controller_OnParametersChanged_FormaDynamicLoginJS, "FormaDynamicLogin", "OnParametersChanged", {
                        ...
                        return OS.Logger.startActiveSpan("CopyToClipboard", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_CFDBlocks_DerivXTradeModal_mvc_controller_CopyToClipboard_JavaScript1JS, "JavaScript1", "CopyToClipboard", {
