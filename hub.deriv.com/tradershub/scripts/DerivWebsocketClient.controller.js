...
try {return controller.safeExecuteAsyncJSNode(DerivWebsocketClient_controller_DerivApiClientSendMessage_SendAPIRequestJS, "SendAPIRequest", "DerivApiClientSendMessage", {
...
try {return controller.safeExecuteJSNode(DerivWebsocketClient_controller_MountDerivAPIClient_JavaScript1JS, "JavaScript1", "MountDerivAPIClient", {
...
class DerivAPIClient {
    ...
    async subscribe({ name, value, payload, onData, onError }) {
        var _a;
        const subscriptionPayload = { [name]: value ?? 1, ...(payload ?? {}), subscribe: 1 };
