...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.TermsOfUse"; }
...
isDefault: false,
onClick: function () {
try {OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "personal-details", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Fade), null, true);
} catch (ex) {
...
get _closeDuplicateAccountPopup$Action() {if(!(this.hasOwnProperty("__closeDuplicateAccountPopup$Action"))) {
...
try {controller.ensureControllerAlive("CloseDuplicateAccountPopup");
callContext = controller.callContext(callContext);
...
}set _closeDuplicateAccountPopup$Action(value) {this.__closeDuplicateAccountPopup$Action = value;
}
...
try {return controller.safeExecuteAsyncJSNode(tradershub_RealAccountCreation_TermsOfUse_mvc_controller_ButtonOnClick_ValidateJS, "Validate", "ButtonOnClick", {
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_TermsOfUse_mvc_controller_ButtonOnClick_RudderStackSuccessJS, "RudderStackSuccess", "ButtonOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_TermsOfUse_mvc_controller_ButtonOnClick_RudderStackFailureJS, "RudderStackFailure", "ButtonOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
get _liveChatOnClick$Action() {if(!(this.hasOwnProperty("__liveChatOnClick$Action"))) {
...
try {controller.ensureControllerAlive("LiveChatOnClick");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_TermsOfUse_mvc_controller_LiveChatOnClick_SyncLocalStorageJS, "SyncLocalStorage", "LiveChatOnClick", {
...
}set _liveChatOnClick$Action(value) {this.__liveChatOnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._closeDuplicateAccountPopup$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._liveChatOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
const {validFields} = validate(validationSchema, payload)
