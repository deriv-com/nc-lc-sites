import {
    a as R,
    b as y
} from "./_oschunk-EJBERAB4.js";
import {
    a as D
} from "./_oschunk-M6256IHZ.js";
import "./_oschunk-AMH7FBEG.js";
import {
    a as L
} from "./_oschunk-NNT6ZMUD.js";
    ...
    m = class m extends I.BaseWebScreen {
        ...
        get title() {
            let e = this.model,
                ...
                b = m.getTranslation,
                p = this;
            return d.Injector.resolve(d.ServiceNames.TranslationsService).getMessage("Jff0FqU4F0eDmVVEQUDdIw#TitleExpression.-1003058815.1", "Country of residence | Deriv")
        }
        internalRender() {
            let e = this.model,
                s = this.controller,
                            ...
                            return [r.createElement(o, {
                                ...
                                inputs: {
                                    OptionalConfigs: e.getCachedValue(t.getId("ti5l9nPyNkG05hKkI9Fl+g.OptionalConfigs"), function() {
                                        return function() {
                                            var n = new E;
                                            return n.allowMultipleSelectionAttr = !1, n.isDisabledAttr = !1, n.noResultsTextAttr = d.Injector.resolve(d.ServiceNames.TranslationsService).getMessage("PwA5m7KEv0+nTrl+mxRorw#Value.-517233753.1", "No result was found"), n.noOptionsTextAttr = "There are no options to show", n
                                        }()
                                    }),
                                    ...
                                    Prompt: d.Injector.resolve(d.ServiceNames.TranslationsService).getMessage("nLtVd0C+0U6Ot+cJMU65hg#Value.830386192.1", "Select your country of residence"),
                                    StartingSelection: e.getCachedValue(t.getId("ti5l9nPyNkG05hKkI9Fl+g.StartingSelection"), function() {
                                        return function() {
                                            var n = new h;
                                            return n.pushAll([function() {
                                                var c = new A;
                                                return c.valueAttr = e.variables.selectedResidenceVar !== "" ? e.variables.selectedResidenceVar : e.variables.websiteStatusClientCountryVar.getCurrent(l.iterationContext).valueAttr, c.labelAttr = e.variables.selectedResidenceVar !== "" ? e.variables.selectedResidenceVar : e.variables.websiteStatusClientCountryVar.getCurrent(l.iterationContext).labelAttr, c
                                            }()]), n
                                        }()
                                    }, function() {
                                    ...
                                    OptionsList: e.getCachedValue(t.getId("ti5l9nPyNkG05hKkI9Fl+g.OptionsList"), function() {
                                        return d.DataConversion.JSConversions.typeConvertRecordList(e.variables.residenceListResponseVar.residence_listAttr, new h, function(n, c) {
                                            return c.valueAttr = n.valueAttr, c.labelAttr = n.textAttr, c.descriptionAttr = n.disabledAttr === "DISABLED" ? "Services not available" : "", c
                                        })
                                    }, function() {
                                ...
                                events: {
                                    ...
                                    onChanged$Action: a(function(n, c) {
                                        var M = l.clone();
                                        s.dropdownSearchOnChanged$Action(c, c.getCurrent(l.iterationContext).valueAttr, s.callContext(M))
                                    }, "onChanged$Action")
                                },
                                _validationProps: {
                                    validationService: S
...
Confirmation is required.`))],
                                ...
                                onClick: a(function() {
                                    try {
                                        d.Navigation.navigateTo(d.Navigation.generateScreenURL("tradershub", "signup/citizenship", {}), d.Transitions.createTransition(d.Transitions.TransitionAnimation.Fade), null, !0)
                                    } catch (n) {
                                ...
                                inputs: {
                                    HasCloseIcon: !1,
                                    Title: d.Injector.resolve(d.ServiceNames.TranslationsService).getMessage("DbsG4eAw00iUDHHl7ueYvg#Value.-925459353.1", "Country of residence"),
                                    HasBackButton: !1
                                },
                                events: {
                                    _handleError: a(function(n) {
                                        ...
                                        return [r.createElement(o, {
                                            ...
                                            events: {
                                                ...
                                                onClickCountry$Action: a(function(n) {
                                                    var c = l.clone();
                                                    s.onClickCountry$Action(n, s.callContext(c))
