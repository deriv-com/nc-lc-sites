                        ...
                        return OS.Logger.startActiveSpan("SkipOnClick", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("RudderStack", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_RealAccountCreationMobile_EmploymentDetailsForm_mvc_controller_SkipOnClick_RudderStackJS, "RudderStack", "SkipOnClick", null, function($parameters) {}, {}, {});
                                    } finally {
                                        if (span) {
                                            span.end();
                                        }
