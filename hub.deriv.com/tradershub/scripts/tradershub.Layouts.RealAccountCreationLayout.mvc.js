...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Layouts.RealAccountCreationLayout"; }
...
define("tradershub.Layouts.RealAccountCreationLayout.mvc$controller", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.model", "OutSystemsUI.controller", "tradershub.languageResources", "tradershub.clientVariables", "tradershub.Layouts.RealAccountCreationLayout.mvc$controller.OnReady.FlatpickrJS", "tradershub.Layouts.RealAccountCreationLayout.mvc$controller.GoToDemoOnClick.RudderStackJS", "tradershub.Layouts.RealAccountCreationLayout.mvc$controller.OnOpenModal.RudderStackJS", "tradershub.Layouts.RealAccountCreationLayout.mvc$controller.PreviousScreen.RudderStackJS", "tradershub.model$ST_0dd6e149ce474591a764bb53175023a1Structure", "OutSystemsUI.model$ST_8391f9d0c6b78f74493c47987669deecStructure", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "OutSystemsUI.model$ST_b7d405ca4407e572da091e54d07e3bd1Structure", "OutSystemsUI.controller$ScrollToElement", "tradershub.model$ST_2b68b61da9b8f6db8463a60cc48350faStructure", "tradershub.controller$SendAuthorize", "tradershub.controller$SyncAccountInfo", "OutSystemsUI.controller$AddFavicon"], function (OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIModel, OutSystemsUIController, tradershubLanguageResources, tradershubClientVariables, tradershub_Layouts_RealAccountCreationLayout_mvc_controller_OnReady_FlatpickrJS, tradershub_Layouts_RealAccountCreationLayout_mvc_controller_GoToDemoOnClick_RudderStackJS, tradershub_Layouts_RealAccountCreationLayout_mvc_controller_OnOpenModal_RudderStackJS, tradershub_Layouts_RealAccountCreationLayout_mvc_controller_PreviousScreen_RudderStackJS) {
var OS = OSRuntimeCore;
...
get _onCloseModal$Action() {if(!(this.hasOwnProperty("__onCloseModal$Action"))) {
...
try {controller.ensureControllerAlive("OnCloseModal");
...
}set _onCloseModal$Action(value) {this.__onCloseModal$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_Layouts_RealAccountCreationLayout_mvc_controller_OnReady_FlatpickrJS, "Flatpickr", "OnReady", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
get _goToDemoOnClick$Action() {if(!(this.hasOwnProperty("__goToDemoOnClick$Action"))) {
...
try {return controller.safeExecuteAsyncJSNode(tradershub_Layouts_RealAccountCreationLayout_mvc_controller_GoToDemoOnClick_RudderStackJS, "RudderStack", "GoToDemoOnClick", {
...
}set _goToDemoOnClick$Action(value) {this.__goToDemoOnClick$Action = value;
}
...
get _onOpenModal$Action() {if(!(this.hasOwnProperty("__onOpenModal$Action"))) {
...
try {controller.ensureControllerAlive("OnOpenModal");
callContext = controller.callContext(callContext);
// ShowCloseModal = True
...
try {return controller.safeExecuteJSNode(tradershub_Layouts_RealAccountCreationLayout_mvc_controller_OnOpenModal_RudderStackJS, "RudderStack", "OnOpenModal", {
...
}set _onOpenModal$Action(value) {this.__onOpenModal$Action = value;
}

get _previousScreen$Action() {if(!(this.hasOwnProperty("__previousScreen$Action"))) {
...
try {controller.ensureControllerAlive("PreviousScreen");
callContext = controller.callContext(callContext);
OS.Logger.startActiveSpan("RudderStack", function (span) {
if(span) {
span.setAttribute("code.function", "RudderStack");
...
try {return controller.safeExecuteJSNode(tradershub_Layouts_RealAccountCreationLayout_mvc_controller_PreviousScreen_RudderStackJS, "RudderStack", "PreviousScreen", {
step: OS.DataConversion.JSNodeParamConverter.to((tradershubClientVariables.getRealSignupCurrentStep() - 1), OS.DataTypes.DataTypes.Integer)
}, function ($parameters) {
}, {}, {});
} finally {
...
}set _previousScreen$Action(value) {this.__previousScreen$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onCloseModal$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onOpenModal$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._previousScreen$Action, callContext);
} finally {
if(span) {
span.end();
}
