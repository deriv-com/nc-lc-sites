...
require(["@outsystems/runtime-core-js", "DerivWebsocketClient.appDefinition", "@outsystems/runtime-core-js/debugger"], function (OSRuntimeCore, DerivWebsocketClientAppDefinition, NullDebugger) {
var OS = OSRuntimeCore;
if(OS.Navigation.ensureRequestSecurity()) {
return;
}

Promise.all([OS.Application.default.initialize(DerivWebsocketClientAppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
if(success) {
