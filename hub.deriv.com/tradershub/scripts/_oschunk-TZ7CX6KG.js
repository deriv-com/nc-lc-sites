import {
    ...
    c as de,
    d as ce
} from "./_oschunk-3S5PH6XM.js";
import {
    a as ue
} from "./_oschunk-VDT5ZEPM.js";
        ...
        get _onDestroy$Action() {
            return this.hasOwnProperty("__onDestroy$Action") || (this.__onDestroy$Action = function(e) {
                ...
                return M.Logger.startActiveSpan("OnDestroy", function(i) {
                    ...
                    try {
                        t.ensureControllerAlive("OnDestroy"), e = t.callContext(e), R.setIsAuthorized(!1)
                    } finally {
                        i && i.end()
                    }
                }, 1)
...
var ve, ge = new M.Controller.ControllerFactory(ve, L);
var u = A,
    ze = C.PlaceholderContent,
    ...
    D = class D extends I.BaseWebBlock {
        ...
        internalRender() {
            ...
            return v.createElement("div", this.getRootNodeProperties(), v.createElement(l, {
                ...
                _widgetRecordProvider: t
            }))), i(R.getAuthToken() !== u.BuiltinFunctions.nullTextIdentifier(), !1, this, function() {
                ...
                return [v.createElement(l, {
                    ...
                    onClick: s(function() {
                        try {
                            u.Navigation.navigateTo(u.Navigation.generateScreenURL("https://" + R.getURL() + "/oauth2/authorize?app_id=" + R.getAppId() + "&l=" + R.getLang() + "&brand=deriv", {}), u.Transitions.createTransition(u.Transitions.TransitionAnimation.Default), null, !0)
                        } catch (d) {
...
var n = A; {
        ...
        get _onReady$Action() {
            return this.hasOwnProperty("__onReady$Action") || (this.__onReady$Action = function(e) {
                ...
                return n.Logger.startActiveSpan("OnReady", function(i) {
                    ...
                    try {
                        t.ensureControllerAlive("OnReady"), e = t.callContext(e), m.carouselInitialize$Action(r.variables.internalConfigsVar.uniqueIdAttr, e), m.logEvent$Action($.logType.general, "Carousel created", e)
                    } finally {
                        i && i.end()
                    }
                }, 1)
            ...
            return this.hasOwnProperty("__registerCallbacks$Action") || (this.__registerCallbacks$Action = function(e) {
                ...
                return n.Logger.startActiveSpan("RegisterCallbacks", function(i) {
                    ...
                    try {
                        ...
                        }, 1), m.carouselRegisterCallback$Action(r.variables.internalConfigsVar.uniqueIdAttr, $.registeredCallbackEvents.carousel_OnSlideMoved, c.value.onSlideMovedObjOut, e), m.carouselRegisterCallback$Action(r.variables.internalConfigsVar.uniqueIdAttr, $.registeredCallbackEvents.initialized, c.value.onCarouselInitializedObjOut, e)
                    } finally {
                        i && i.end()
                    }
                }, 1)
    ...
    s(o, "ControllerInner");
    let S = o;
    k = S, k.registerVariableGroupType("OutSystemsUI.Interaction.Carousel.InitializeHandler$vars", [{
        name: "CarouselId",
    ...
    }]), k.registerVariableGroupType("OutSystemsUI.Interaction.Carousel.OnSlideMovedHandler$vars", [{
        name: "CarouselId",
        attrName: "carouselIdInLocal",
        mandatory: !0,
        dataType: n.DataTypes.DataTypes.Text,
    ...
    }]), k.registerVariableGroupType("OutSystemsUI.Interaction.Carousel.RegisterCallbacks$getCallbackHandlersJSResult", [{
...
var k, be = new n.Controller.ControllerFactory(k, oe);
var nt = C.PlaceholderContent,
    ...
    V = class V extends I.BaseWebBlock {
        ...
        internalRender() {
            ...
            return g.createElement("div", this.getRootNodeProperties(), g.createElement(l, {
                ...
                _widgetRecordProvider: t
            }, i(R.getAuthToken() !== "", !1, this, function() {
...
var Ie = A,
    ...
    we = C.IteratorPlaceholderContent,
