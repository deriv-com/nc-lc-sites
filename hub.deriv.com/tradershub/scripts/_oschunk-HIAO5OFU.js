        ...
        get _onInitialize$Action() {
            return this.hasOwnProperty("__onInitialize$Action") || (this.__onInitialize$Action = function(e) {
                ...
                return n.Logger.startActiveSpan("OnInitialize", function(a) {
                    ...
                    try {
                        if (t.ensureControllerAlive("OnInitialize"), e = t.callContext(e), h.getAuthToken() === n.BuiltinFunctions.nullTextIdentifier()) return n.Navigation.navigateTo(n.Navigation.generateScreenURL("tradershub", "cfds", {}), n.Transitions.createTransition(n.Transitions.TransitionAnimation.Default), e, !0)
                    } finally {
                        a && a.end()
                    }
                }, 1)
