    ...
    c = class c extends p.BaseWebScreen {
        ...
        internalRender() {
            ...
            return r.createElement("div", this.getRootNodeProperties(), r.createElement(P, {
                ...
                placeholders: {
                    content: new y(function() {
                        return [r.createElement(b, {
                            ...
                            _widgetRecordProvider: s
                        }, a(i("PKUyJe5Uh0i4qWlcQ+Wyqw#Value", "Students")))), r.createElement(E, {
                            align: 0,
                            animate: !1,
                            style: "btn-container",
                            visible: !0,
                ...
                _dependencies: [R(v.getFinancialAssessmentOccupation()), R(g.variables.isRequiredVar)]
            }))
        }
    };
o(c, "View");
