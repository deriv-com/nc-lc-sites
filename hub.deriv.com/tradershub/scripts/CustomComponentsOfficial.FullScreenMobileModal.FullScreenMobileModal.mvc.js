define("CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModal.mvc$model", ["@outsystems/runtime-core-js", "CustomComponentsOfficial.model", "CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModalHeader.mvc$model"], function (OSRuntimeCore, CustomComponentsOfficialModel, CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModalHeader_mvcModel) {
...
Model._hasValidationWidgetsValue = CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModalHeader_mvcModel.hasValidationWidgets;
}
...
define("CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModal.mvc$view", ["@outsystems/runtime-core-js", "CustomComponentsOfficial.model", "CustomComponentsOfficial.controller", "react", "@outsystems/runtime-view-js", "CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModal.mvc$model", "CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModal.mvc$controller", "@outsystems/runtime-widgets-js", "CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModalHeader.mvc$view"], function (OSRuntimeCore, CustomComponentsOfficialModel, CustomComponentsOfficialController, React, OSView, CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModal_mvc_model, CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModal_mvc_controller, OSWidgets, CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModalHeader_mvc_view) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "FullScreenMobileModal.FullScreenMobileModal"; }
...
screen: ""
        ...
        static getBlocks() {
            return [CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModalHeader_mvc_view];
        }

        get modelFactory() {
            return CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModal_mvc_model;
        }

        get controllerFactory() {
            return CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModal_mvc_controller;
        }
...
return [React.createElement(CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModalHeader_mvc_view, {
...
define("CustomComponentsOfficial.FullScreenMobileModal.FullScreenMobileModal.mvc$controller", ["@outsystems/runtime-core-js", "CustomComponentsOfficial.model", "CustomComponentsOfficial.controller", "CustomComponentsOfficial.languageResources"], function (OSRuntimeCore, CustomComponentsOfficialModel, CustomComponentsOfficialController, CustomComponentsOfficialLanguageResources) {
var OS = OSRuntimeCore;
...
get onBack$Action() {if(!(this.hasOwnProperty("_onBack$Action"))) {
...
}set onBack$Action(value) {this._onBack$Action = value;
}
