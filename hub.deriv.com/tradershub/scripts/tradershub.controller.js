...
try {return controller.safeExecuteJSNode(tradershub_controller_CheckEUTrackingCookies_CheckCookiesJS, "CheckCookies", "CheckEUTrackingCookies", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_CombineAvailableAccounts_CombineListJS, "CombineList", "CombineAvailableAccounts", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_CombineCreatedAccounts_CombineListJS, "CombineList", "CombineCreatedAccounts", {
CTraderAccounts: OS.DataConversion.JSNodeParamConverter.to(jSONSerializeCTraderVar.value.jSONOut, OS.DataTypes.DataTypes.Text),
MT5Accounts: OS.DataConversion.JSNodeParamConverter.to(jSONSerializeMT5Var.value.jSONOut, OS.DataTypes.DataTypes.Text),
DXTradeAccounts: OS.DataConversion.JSNodeParamConverter.to(jSONSerializeDXTradeVar.value.jSONOut, OS.DataTypes.DataTypes.Text),
CombinedList: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
...
try {return controller.safeExecuteJSNode(tradershub_controller_CreatedCTraderAccounts_GenerateTotalBalanceJS, "GenerateTotalBalance", "CreatedCTraderAccounts", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_CreatedMT5Accounts_ModifyDataJS, "ModifyData", "CreatedMT5Accounts", {
...
const demoAccounts = filteredAccounts.filter(({ account_type }) => account_type === 'demo');
const realAccounts = filteredAccounts.filter(({ account_type }) => account_type === 'real');
...
try {return controller.safeExecuteJSNode(tradershub_controller_CryptoEstimations_PayloadJS, "Payload", "CryptoEstimations", {
...
try {return controller.safeExecuteAsyncJSNode(tradershub_controller_DerivApiSendMessage_SendApiCallJS, "SendApiCall", "DerivApiSendMessage", {
...
if (DerivAPI) {
    if ($parameters.Authorize && $parameters.Token) {
        DerivAPI.send({ authorize: $parameters.Token }).then(() => sendRequest())
    } else {
        sendRequest();
    }
...
try {return controller.safeExecuteJSNode(tradershub_controller_ExchangeRates_PayloadJS, "Payload", "ExchangeRates", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_FeatureFlagValueByName_GetFeatureFlagValueByNameJS, "GetFeatureFlagValueByName", "FeatureFlagValueByName", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_FilterAvailableAccounts_FilterDataJS, "FilterData", "FilterAvailableAccounts", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GBFeatureFlagValue_GetFeatureFlagValueJS, "GetFeatureFlagValue", "GBFeatureFlagValue", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GenerateAvailableAccountsPayload_CreatePayloadJS, "CreatePayload", "GenerateAvailableAccountsPayload", {
...
if ($parameters.HasToken) {
    payload = { "platform": $parameters.Platform };
} else {
    payload = {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetAccountByLoginId_GetAccountJS, "GetAccount", "GetAccountByLoginId", {
LoginId: OS.DataConversion.JSNodeParamConverter.to(vars.value.loginIdInLocal, OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetAllAccountsBalance_PayloadJS, "Payload", "GetAllAccountsBalance", {
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetAvailableAccounts_AvailableAccountsPayloadJS, "AvailableAccountsPayload", "GetAvailableAccounts", {
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetAvailableWallets_PayloadJS, "Payload", "GetAvailableWallets", {
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetBackOfficeLocks_JavaScript1JS, "JavaScript1", "GetBackOfficeLocks", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetCurrencyIcon_FilterCurrenciesListJS, "FilterCurrenciesList", "GetCurrencyIcon", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetSocialLoginRedirectURL_AffiliateUTMJS, "AffiliateUTM", "GetSocialLoginRedirectURL", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetWalletsList_GetFirstWalletIndexJS, "GetFirstWalletIndex", "GetWalletsList", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_GetWalletsList_WalletListsJS, "WalletLists", "GetWalletsList", {
...
try {return controller.safeExecuteAsyncJSNode(tradershub_controller_InitGrowthbookAndRudderStack_InitAnalyticsJS, "InitAnalytics", "InitGrowthbookAndRudderStack", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_InitizalizeDerivApi_InitializeDerivApiJS, "InitializeDerivApi", "InitizalizeDerivApi", {
...
(function initializeDerivAPIBasic() {
    if (!window.DerivAPI) {
        ...
        window.DerivAPI = new DerivAPIBasic({ connection: socket });
        socket.readyState === 1 && DerivAPI.send({ ping: 1 });
...
try {return controller.safeExecuteJSNode(tradershub_controller_LoadScriptsAsync_LoadScriptsAsyncJS, "LoadScriptsAsync", "LoadScriptsAsync", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_MT5NewAccount_PayloadJS, "Payload", "MT5NewAccount", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountReal_NewAccountRealPayloadJS, "NewAccountRealPayload", "NewAccountReal", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountReal_RudderStackSuccessJS, "RudderStackSuccess", "NewAccountReal", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountReal_AuthorizePayloadJS, "AuthorizePayload", "NewAccountReal", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountReal_SyncLocalStorageJS, "SyncLocalStorage", "NewAccountReal", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountRealEU_NewAccountRealEUPayloadJS, "NewAccountRealEUPayload", "NewAccountRealEU", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountRealEU_RudderStackSuccessJS, "RudderStackSuccess", "NewAccountRealEU", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountRealEU_AuthorizePayloadJS, "AuthorizePayload", "NewAccountRealEU", {
AuthToken: OS.DataConversion.JSNodeParamConverter.to(jSONDeserializeNewAccountRealResponseVar.value.dataOut.new_account_realAttr.oauth_tokenAttr, OS.DataTypes.DataTypes.Text),
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_NewAccountRealEU_SyncLocalStorageJS, "SyncLocalStorage", "NewAccountRealEU", {
Token: OS.DataConversion.JSNodeParamConverter.to(jSONDeserializeNewAccountRealResponseVar.value.dataOut.new_account_realAttr.oauth_tokenAttr, OS.DataTypes.DataTypes.Text),
Response: OS.DataConversion.JSNodeParamConverter.to(derivApiSendAuthorizeVar.value.responseOut, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
...
try {return controller.safeExecuteAsyncJSNode(tradershub_controller_OnApplicationReady_GetConfigJS, "GetConfig", "On Application Ready", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostCashierCryptoDeposit_PayloadJS, "Payload", "PostCashierCryptoDeposit", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostCashierCryptoDeposit_ModifyDataJS, "ModifyData", "PostCashierCryptoDeposit", {
Data: OS.DataConversion.JSNodeParamConverter.to(derivApiSendMessageVar.value.responseOut, OS.DataTypes.DataTypes.Text),
Response: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostCashierCryptoWithdraw_PayloadJS, "Payload", "PostCashierCryptoWithdraw", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostCashierCryptoWithdraw_ModifyDataJS, "ModifyData", "PostCashierCryptoWithdraw", {
Data: OS.DataConversion.JSNodeParamConverter.to(derivApiSendMessageVar.value.responseOut, OS.DataTypes.DataTypes.Text),
Response: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostCashierFiat_PayloadJS, "Payload", "PostCashierFiat", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostSignupActions_AuthorizePayloadJS, "AuthorizePayload", "PostSignupActions", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostSignupActions_CheckLandingCompanyJS, "CheckLandingCompany", "PostSignupActions", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostSignupActions_SetAccountSettingsPayloadJS, "SetAccountSettingsPayload", "PostSignupActions", {
Citizen: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getSelectedCitizenship(), OS.DataTypes.DataTypes.Text),
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostSignupActions_GetIDVCountryJS, "GetIDVCountry", "PostSignupActions", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_PostSignupActions_SyncLocalStorageJS, "SyncLocalStorage", "PostSignupActions", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_RedirectToExternalURL_RedirectJS, "Redirect", "RedirectToExternalURL", {
URL: OS.DataConversion.JSNodeParamConverter.to(vars.value.uRLInLocal, OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(tradershub_controller_RudderstackIdentifyEvent_JavaScript1JS, "JavaScript1", "RudderstackIdentifyEvent", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_SendAuthorize_AuthorizePayloadJS, "AuthorizePayload", "SendAuthorize", {
AuthToken: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getAuthToken(), OS.DataTypes.DataTypes.Text),
Payload: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_SendAuthorize_SeAccountsListJS, "SeAccountsList", "SendAuthorize", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_SendIDVDocumentDetails_IDVPayloadJS, "IDVPayload", "SendIDVDocumentDetails", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_ServiceToken_PayloadJS, "Payload", "ServiceToken", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_ServiceToken_ModifyDataJS, "ModifyData", "ServiceToken", {
Data: OS.DataConversion.JSNodeParamConverter.to(derivApiSendMessageVar.value.responseOut, OS.DataTypes.DataTypes.Text),
Response: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_SetEUTrackingCookies_SetCookieJS, "SetCookie", "SetEUTrackingCookies", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_Statement_PayloadJS, "Payload", "Statement", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_SyncAccountInfo_SyncLocalStorageJS, "SyncLocalStorage", "SyncAccountInfo", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_TINValidations_PayloadJS, "Payload", "TINValidations", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_TradingPlatformAccounts_ModifyDataJS, "ModifyData", "TradingPlatformAccounts", {
Data: OS.DataConversion.JSNodeParamConverter.to(derivApiSendMessageVar.value.responseOut, OS.DataTypes.DataTypes.Text),
CFDAccounts: OS.DataConversion.JSNodeParamConverter.to(jSONSerializeCFDAccountsVar.value.jSONOut, OS.DataTypes.DataTypes.Text),
Platform: OS.DataConversion.JSNodeParamConverter.to(vars.value.platformInLocal, OS.DataTypes.DataTypes.Text),
DemoAccounts: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(tradershub_controller_TradingPlatformAvailableAccounts2_ModifyDataJS, "ModifyData", "TradingPlatformAvailableAccounts2", {
Data: OS.DataConversion.JSNodeParamConverter.to(derivApiSendMessageVar.value.responseOut, OS.DataTypes.DataTypes.Text),
CFDAccounts: OS.DataConversion.JSNodeParamConverter.to(jSONSerializeCFDAccountsVar.value.jSONOut, OS.DataTypes.DataTypes.Text),
Response: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_TradingPlatformNewAccount_PayloadJS, "Payload", "TradingPlatformNewAccount", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_TradingPlatformPasswordChange_PayloadJS, "Payload", "TradingPlatformPasswordChange", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_TradingPlatformProductListing_TradingPlatformPayloadJS, "TradingPlatformPayload", "TradingPlatformProductListing", {
...
try {return controller.safeExecuteJSNode(tradershub_controller_TradingPlatformProductListing_ModifyDataJS, "ModifyData", "TradingPlatformProductListing", {
Data: OS.DataConversion.JSNodeParamConverter.to(derivApiSendMessageVar.value.responseOut, OS.DataTypes.DataTypes.Text),
Response: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(tradershub_controller_VerifyEmail_VerifyEmailPayloadJS, "VerifyEmailPayload", "VerifyEmail", {
