    ...
    class View extends OSView.BaseView.BaseWebScreen {
        ...
        static getAttributes() {
            return {
                ...
                functionKey: "08c67be9-5df5-4c6b-89ea-9e0cfd2b933e",
                ...
                placeholders: {
                    mainContent: new PlaceholderContent(function() {
                        return [React.createElement(OSWidgets.Container, {
                            ...
                            animate: false,
                            extendedProperties: {
                                style: "background-color: white; border-radius: 8px; display: flex; flex-direction: column; gap: 16px; height: auto; padding: 24px;"
                            },
                            gridProperties: {
                                classes: "OSInline",
                                width: "400px"
                            ...
                            animate: false,
                            extendedProperties: {
                                style: "align-items: center; display: flex; gap: 8px; height: auto; margin-bottom: 0px; padding: 0px;"
                            },
                            visible: true,
                            _idProps: {
                                service: idService,
                            ...
                            inputs: {
                                ExtendedClass: model.getCachedValue(idService.getId("b3xhY4A8eEWh49X5Pi2afw.ExtendedClass"), function() {
                                ...
                                OptionalConfigs: model.getCachedValue(idService.getId("b3xhY4A8eEWh49X5Pi2afw.OptionalConfigs"), function() {
                                    return function() {
                                ...
                                StartingSelection: model.getCachedValue(idService.getId("b3xhY4A8eEWh49X5Pi2afw.StartingSelection"), function() {
                                    return function() {
                                ...
                                OptionsList: model.getCachedValue(idService.getId("b3xhY4A8eEWh49X5Pi2afw.OptionsList"), function() {
                            ...
                            onClick: function() {
                                try {
                                    OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "citizenship", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Fade), null, true);
                                } catch (ex) {
                    ...
                    this.__onReady$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "2237662f-82f3-4a3e-91c2-0404c8f30d41");
                    ...
                    this.__onInitialize$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnInitialize", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "3a1cd2c3-107f-426f-b9bc-54a34be6b3d9");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                    ...
                    this.__dropdownSearchOnChanged$Action = function(selectedOptionListIn, selectedCountryIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("DropdownSearchOnChanged", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "457c388f-c748-4e75-950c-79315a6e6680");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                            ...
                            try {
                                ...
                                javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    if (span) {
                                        ...
                                        span.setAttribute("outsystems.function.key", "b49b018f-8172-461b-a867-780b0368a580");
                                        span.setAttribute("outsystems.function.owner.name", "tradershub");
                                        span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                        span.setAttribute("outsystems.function.type", "JAVASCRIPT");
                                    }
                    ...
                    this.__onRender$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnRender", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "4ba8cbf9-931f-4e26-a172-10d58bf00e40");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                    ...
                    this.__onCancelClick$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnCancelClick", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "584f0223-220a-4323-8c0f-cff6c7299432");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                    ...
                    this.__onNextButtonClick$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnNextButtonClick", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "8b38f898-c9d7-4e49-9df5-2c16548d172e");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                    ...
                    this.__onClickCountry$Action = function(mobileSelectedResidenceIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OnClickCountry", function(span) {
                            if (span) {
                                ...
                                span.setAttribute("outsystems.function.key", "cb2b9c9b-0b73-442d-8370-de3bee4bd43a");
                                span.setAttribute("outsystems.function.owner.name", "tradershub");
                                span.setAttribute("outsystems.function.owner.key", "2ad446d5-32d7-4fbf-959d-82d8325bcfbc");
                                span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
                            }
                            ...
                            try {
                                ...
                                if (((model.variables.isBrazilVar === true))) {
                                    ...
                                    // Destination: /tradershub/Citizenship
                                    return OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "citizenship", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Default), callContext, true);
                                }
