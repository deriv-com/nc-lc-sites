                        ...
                        return OS.Logger.startActiveSpan("OnCancelClick", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("RudderStack", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_Signup_CountryOfResidence_mvc_controller_OnCancelClick_RudderStackJS, "RudderStack", "OnCancelClick", null, function($parameters) {}, {}, {});
                                    } finally {
                                        if (span) {
                                            span.end();
                                        }
                        ...
                        return OS.Logger.startActiveSpan("DropdownSearchOnChanged", function(span) {
                            ...
                            try {
                                ...
                                javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_Signup_CountryOfResidence_mvc_controller_DropdownSearchOnChanged_JavaScript1JS, "JavaScript1", "DropdownSearchOnChanged", {
