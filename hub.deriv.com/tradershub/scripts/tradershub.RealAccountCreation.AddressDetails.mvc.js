...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.AddressDetails"; }
...
Analytics: model.getCachedValue(idService.getId("5_eT_ufK30yOnDIHcx9M5g.Analytics"), function () {
return function () {
var rec = new tradershubModel.ST_0dd6e149ce474591a764bb53175023a1Structure();
rec.stepCodenameAttr = "address_details";
rec.stepNumberAttr = "3";
return rec;
}();
})
},
...
get _stateSelectorOnClickCountry$Action() {if(!(this.hasOwnProperty("__stateSelectorOnClickCountry$Action"))) {
...
try {controller.ensureControllerAlive("StateSelectorOnClickCountry");
...
}set _stateSelectorOnClickCountry$Action(value) {this.__stateSelectorOnClickCountry$Action = value;
}

get _stateOnClickMobile$Action() {if(!(this.hasOwnProperty("__stateOnClickMobile$Action"))) {
...
try {controller.ensureControllerAlive("StateOnClickMobile");
callContext = controller.callContext(callContext);
...
}set _stateOnClickMobile$Action(value) {this.__stateOnClickMobile$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_AddressDetails_mvc_controller_SaveOnClick_ValidateJS, "Validate", "SaveOnClick", {
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_AddressDetails_mvc_controller_SaveOnClick_RudderStackJS, "RudderStack", "SaveOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_AddressDetails_mvc_controller_OnReady_GenerateStatesListPayloadJS, "GenerateStatesListPayload", "OnReady", {
...
try {return controller.safeExecuteClientAction(controller._stateSelectorOnClickCountry$Action, callContext, stateIn, labelIn);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._stateOnClickMobile$Action, callContext);
} finally {
if(span) {
span.end();
}
