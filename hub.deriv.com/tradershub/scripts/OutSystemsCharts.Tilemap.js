...
function(e) {
    ...
    function a(t, a, i, s) {
        t.hasOwnProperty(a) || (t[a] = s.apply(null, i), "function" == typeof CustomEvent && e.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: a,
                module: t[a]
            }
            ...
            hexagon: {
                ...
                translate: function() {
                    ...
                    for (let t of (this.generatePoints(), this.points)) {
                        let o = r(Math.floor(a.len - a.translate(t.x - 2 * n, 0, 1, 0, 1)), -a.len, 2 * a.len),
                            p = r(Math.floor(a.len - a.translate(t.x - n, 0, 1, 0, 1)), -a.len, 2 * a.len),
                            h = r(Math.floor(a.len - a.translate(t.x + n, 0, 1, 0, 1)), -a.len, 2 * a.len),
                            d = r(Math.floor(a.len - a.translate(t.x + 2 * n, 0, 1, 0, 1)), -a.len, 2 * a.len),
                            u = r(Math.floor(i.translate(t.y - l, 0, 1, 0, 1)), -i.len, 2 * i.len),
                            g = r(Math.floor(i.translate(t.y, 0, 1, 0, 1)), -i.len, 2 * i.len),
                            c = r(Math.floor(i.translate(t.y + l, 0, 1, 0, 1)), -i.len, 2 * i.len),
                            y = t.pointPadding ?? s,
                            x = y * Math.abs(p - o) / Math.abs(c - g),
                            f = a.reversed ? -x : x,
                            m = a.reversed ? -y : y,
                            P = i.reversed ? -y : y;
                        t.x % 2 && (e = e || Math.round(Math.abs(c - u) / 2) * (i.reversed ? -1 : 1), u += e, g += e, c += e), t.plotX = t.clientX = (p + h) / 2, t.plotY = g, o += f + m, p += m, h -= m, d -= f + m, u -= P, c += P, t.tileEdges = {
                            x1: o,
                            x2: p,
                            x3: h,
                            x4: d,
                ...
                translate: function() {
                    ...
                    for (let e of (this.generatePoints(), this.points)) {
                        let u = r(Math.round(t.len - t.translate(e.x, 0, 1, 0, 0)), -t.len, 2 * t.len),
                            g = i,
                            c = !1,
                            y = r(Math.round(a.translate(e.y, 0, 1, 0, 0)), -a.len, 2 * a.len);
                        void 0 !== e.pointPadding && (g = e.pointPadding, c = !0, d = !0), (!h || d) && (p = Math.floor(Math.sqrt((l = Math.abs(r(Math.floor(t.len - t.translate(e.x + n, 0, 1, 0, 0)), -t.len, 2 * t.len) - u)) * l + (o = Math.abs(r(Math.floor(a.translate(e.y + s, 0, 1, 0, 0)), -a.len, 2 * a.len) - y)) * o) / 2), h = Math.min(l, p, o) - g, d && !c && (d = !1)), e.x % 2 && (y += o * (a.reversed ? -1 : 1)), e.plotX = e.clientX = u, e.plotY = y, e.radius = h, e.shapeType = "circle", e.shapeArgs = {
                            x: u,
                            y: y,
                            r: h
                        }
