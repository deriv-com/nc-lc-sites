...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "RESTAPIWebsocketOfficial.model", "SharedUtilities.controller", "react", "@outsystems/runtime-view-js", "tradershub.CFDBlocks.CFDTradeModal.mvc$model", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller", "tradershub.clientVariables", "@outsystems/runtime-widgets-js", "OutSystemsUI.controller$IsPhone", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "OutSystemsUI.controller$IsDesktop", "RESTAPIWebsocketOfficial.model$ST_2f457e0a5b13526850516eea23ae0e9aStructure", "tradershub.referencesHealth$RESTAPIWebsocketOfficial", "RESTAPIWebsocketOfficial.model$ST_75725e65d106c1568a850780233a08baStructure", "SharedUtilities.controller$FormatMoney", "tradershub.referencesHealth$SharedUtilities", "OutSystemsUI.controller$GetOS", "tradershub.model$RC_07be8d7193ba16b1cc9d953b8fa48e9d", "tradershub.model$RL_ee1664da44e6893a731536d754684359", "tradershub.model$RC_d63c71568ad59ee17d766d503a162ca6", "tradershub.model$RL_030016655dc986d68e79b8c56a17e0d5"], function(OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, RESTAPIWebsocketOfficialModel, SharedUtilitiesController, React, OSView, tradershub_CFDBlocks_CFDTradeModal_mvc_model, tradershub_CFDBlocks_CFDTradeModal_mvc_controller, tradershubClientVariables, OSWidgets) {
    var OS = OSRuntimeCore;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() {
            return "CFDBlocks.CFDTradeModal";
        }

        static getAttributes() {
            return {
                codeFunction: "CFDTradeModal",
        ...
        static getCssDependencies() {
            return ["css/OutSystemsReactWidgets.css", "css/tradershub.CFDBlocks.CFDTradeModal.css"];
        }
        ...
        get modelFactory() {
            return tradershub_CFDBlocks_CFDTradeModal_mvc_model;
        }

        get controllerFactory() {
            return tradershub_CFDBlocks_CFDTradeModal_mvc_controller;
        }
        ...
        internalRender() {
            ...
            return React.createElement("div", this.getRootNodeProperties(), React.createElement(OSWidgets.Popup, {
                ...
                text: [$text(getTranslation("4XAj5bchLESQ+mQpXFd3RA#Value", "2. You can have up to 5 Deriv cTrader accounts.4. If your strategy remains inactive for 30 days, it will be deleted automatically. You can create a new strategy on the same account afterwards."))],
                _idProps: {
                    service: idService,
                    uuid: "56"
                },
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "RESTAPIWebsocketOfficial.model", "SharedUtilities.controller", "tradershub.languageResources", "tradershub.clientVariables", "tradershub.CFDBlocks.CFDTradeModal.mvc$translationsResources", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.CopyToClipboard.JavaScript1JS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.CtraderPropsJS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.GetSelectedProductConfigJS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.DxtradePropsJS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.Mt5PropsJS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnClickWebterminal.RedirectDemoJS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnClickWebterminal.RedirectLiveJS", "tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnClickWebterminal.RedirectWebTerminalJS", "OutSystemsUI.controller$IsPhone", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "OutSystemsUI.controller$IsDesktop", "RESTAPIWebsocketOfficial.model$ST_2f457e0a5b13526850516eea23ae0e9aStructure", "tradershub.referencesHealth$RESTAPIWebsocketOfficial", "RESTAPIWebsocketOfficial.model$ST_75725e65d106c1568a850780233a08baStructure", "SharedUtilities.controller$FormatMoney", "tradershub.referencesHealth$SharedUtilities", "OutSystemsUI.controller$GetOS", "tradershub.model$RC_07be8d7193ba16b1cc9d953b8fa48e9d", "tradershub.model$RL_ee1664da44e6893a731536d754684359", "tradershub.model$RC_d63c71568ad59ee17d766d503a162ca6", "tradershub.model$RL_030016655dc986d68e79b8c56a17e0d5"], function(OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, RESTAPIWebsocketOfficialModel, SharedUtilitiesController, tradershubLanguageResources, tradershubClientVariables, tradershub_CFDBlocks_CFDTradeModal_mvc_TranslationsResources, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_CopyToClipboard_JavaScript1JS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_CtraderPropsJS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_GetSelectedProductConfigJS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_DxtradePropsJS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_Mt5PropsJS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnClickWebterminal_RedirectDemoJS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnClickWebterminal_RedirectLiveJS, tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnClickWebterminal_RedirectWebTerminalJS) {
    var OS = OSRuntimeCore; {
        class ControllerInner extends
        OS.Controller.BaseViewController {
            constructor(model, messagesProvider, idService) {
                super(model, messagesProvider, idService, tradershub_CFDBlocks_CFDTradeModal_mvc_TranslationsResources);
                var controller = this.controller;
            ...
            get getProductByProductIdentifier$AggrRefresh() {
                if (!(this.hasOwnProperty("_getProductByProductIdentifier$AggrRefresh"))) {
                    this._getProductByProductIdentifier$AggrRefresh = function() {
                        var innerBody = function(maxRecords, startIndex, callContext) {
                            var model = this.model;
                            var controller = this.controller;
                            var callContext = controller.callContext(callContext);
                            return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetProductByProductIdentifier", "screenservices/tradershub/CFDBlocks/CFDTradeModal/ScreenDataSetGetProductByProductIdentifier", "9ZfBFMGWC_Uitc+NemguFg", maxRecords, startIndex, function(b) {
            ...
            set getProductByProductIdentifier$AggrRefresh(value) {
                this._getProductByProductIdentifier$AggrRefresh = value;
            }

            get getLinksByPlatform$AggrRefresh() {
                if (!(this.hasOwnProperty("_getLinksByPlatform$AggrRefresh"))) {
                    this._getLinksByPlatform$AggrRefresh = function() {
                        var innerBody = function(maxRecords, startIndex, callContext) {
                            var model = this.model;
                            var controller = this.controller;
                            var callContext = controller.callContext(callContext);
                            return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetLinksByPlatform", "screenservices/tradershub/CFDBlocks/CFDTradeModal/ScreenDataSetGetLinksByPlatform", "ERChAMPp4mcU0_YuaxNNXg", maxRecords, startIndex, function(b) {
            ...
            set getLinksByPlatform$AggrRefresh(value) {
                this._getLinksByPlatform$AggrRefresh = value;
            }
                    ...
                    this.__copyToClipboard$Action = function(textToCopyIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("CopyToClipboard", function(span) {
                            ...
                            try {
                                ...
                                var vars = new OS.DataTypes.VariableHolder(new(controller.constructor.getVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.CopyToClipboard$vars"))());
                                ...
                                OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_CopyToClipboard_JavaScript1JS, "JavaScript1", "CopyToClipboard", {
            ...
            get _ctImportantNotesOnClick$Action() {
                if (!(this.hasOwnProperty("__ctImportantNotesOnClick$Action"))) {
                    this.__ctImportantNotesOnClick$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("CtImportantNotesOnClick", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("CtImportantNotesOnClick");
                                callContext = controller.callContext(callContext);
            ...
            set _ctImportantNotesOnClick$Action(value) {
                this.__ctImportantNotesOnClick$Action = value;
            }
                                        ...
                                        if (((model.variables.isVisibleIn === true))) {
                                            ...
                                            return result.then(function() {
                                                getSelectedProductConfigJSResult.value = OS.Logger.startActiveSpan("GetSelectedProductConfig", function(span) {
                                                    ...
                                                    try {
                                                        return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_GetSelectedProductConfigJS, "GetSelectedProductConfig", "OnParametersChanged", {
                                                            ...
                                                            var jsNodeResult = new(controller.constructor.getVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$getSelectedProductConfigJSResult"))();
                                                ...
                                                if (((model.variables.platformVar === "mt5"))) {
                                                    ...
                                                    mt5PropsJSResult.value = OS.Logger.startActiveSpan("Mt5Props", function(span) {
                                                        ...
                                                        try {
                                                            return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_Mt5PropsJS, "Mt5Props", "OnParametersChanged", {
                                                                SelectedProduct: OS.DataConversion.JSNodeParamConverter.to(model.variables.selectedProductArgIn, OS.DataTypes.DataTypes.Text),
                                                                ...
                                                                var jsNodeResult = new(controller.constructor.getVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$mt5PropsJSResult"))();
                                                    ...
                                                    if (((model.variables.platformVar === "dxtrade"))) {
                                                        ...
                                                        dxtradePropsJSResult.value = OS.Logger.startActiveSpan("DxtradeProps", function(span) {
                                                            ...
                                                            try {
                                                                return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_DxtradePropsJS, "DxtradeProps", "OnParametersChanged", {
                                                                    ...
                                                                    var jsNodeResult = new(controller.constructor.getVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$dxtradePropsJSResult"))();
                                                                    jsNodeResult.balanceOut = OS.DataConversion.JSNodeParamConverter.from($parameters.Balance, OS.DataTypes.DataTypes.Text);
                                                                    jsNodeResult.currencyOut = OS.DataConversion.JSNodeParamConverter.from($parameters.Currency, OS.DataTypes.DataTypes.Text);
                                                                    jsNodeResult.loginOut = OS.DataConversion.JSNodeParamConverter.from($parameters.Login, OS.DataTypes.DataTypes.Text);
                                                                    return jsNodeResult;
                                                        ...
                                                        ctraderPropsJSResult.value = OS.Logger.startActiveSpan("CtraderProps", function(span) {
                                                            ...
                                                            try {
                                                                return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnParametersChanged_CtraderPropsJS, "CtraderProps", "OnParametersChanged", {
                                                                    SelectedProduct: OS.DataConversion.JSNodeParamConverter.to(model.variables.selectedProductArgIn, OS.DataTypes.DataTypes.Text),
                                                                    AccountType: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getAccountType(), OS.DataTypes.DataTypes.Text),
                                                                    ...
                                                                    var jsNodeResult = new(controller.constructor.getVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$ctraderPropsJSResult"))();
                                                                    jsNodeResult.loginOut = OS.DataConversion.JSNodeParamConverter.from($parameters.Login, OS.DataTypes.DataTypes.Text);
                                                                    jsNodeResult.balanceOut = OS.DataConversion.JSNodeParamConverter.from($parameters.Balance, OS.DataTypes.DataTypes.Text);
                                                                    jsNodeResult.currencyOut = OS.DataConversion.JSNodeParamConverter.from($parameters.Currency, OS.DataTypes.DataTypes.Text);
            ...
            get _onClickWebterminal$Action() {
                if (!(this.hasOwnProperty("__onClickWebterminal$Action"))) {
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    if (((model.variables.platformVar === "mt5"))) {
                                        redirectWebTerminalJSResult.value = OS.Logger.startActiveSpan("RedirectWebTerminal", function(span) {
                                            ...
                                            try {
                                                return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnClickWebterminal_RedirectWebTerminalJS, "RedirectWebTerminal", "OnClickWebterminal", {
                                                    AccountType: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getAccountType(), OS.DataTypes.DataTypes.Text),
                                                    ...
                                                    var jsNodeResult = new(controller.constructor.getVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnClickWebterminal$redirectWebTerminalJSResult"))();
                                        ...
                                        if (((tradershubClientVariables.getAccountType() === "real"))) {
                                            OS.Logger.startActiveSpan("RedirectLive", function(span) {
                                                ...
                                                try {
                                                    return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnClickWebterminal_RedirectLiveJS, "RedirectLive", "OnClickWebterminal", {
                                            ...
                                            OS.Logger.startActiveSpan("RedirectDemo", function(span) {
                                                ...
                                                try {
                                                    return controller.safeExecuteJSNode(tradershub_CFDBlocks_CFDTradeModal_mvc_controller_OnClickWebterminal_RedirectDemoJS, "RedirectDemo", "OnClickWebterminal", {
            ...
            set _onClickWebterminal$Action(value) {
                this.__onClickWebterminal$Action = value;
            }
            ...
            ctImportantNotesOnClick$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("CtImportantNotesOnClick__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._ctImportantNotesOnClick$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
        ...
        Controller.registerVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.CopyToClipboard$vars", [{
            name: "TextToCopy",
        ...
        Controller.registerVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$ctraderPropsJSResult", [{
            name: "Login",
            attrName: "loginOut",
            mandatory: true,
            dataType: OS.DataTypes.DataTypes.Text,
        ...
        Controller.registerVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$getSelectedProductConfigJSResult", [{
            name: "Platform",
        ...
        Controller.registerVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$dxtradePropsJSResult", [{
            name: "Balance",
            attrName: "balanceOut",
            mandatory: true,
            dataType: OS.DataTypes.DataTypes.Text,
        ...
        Controller.registerVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnParametersChanged$mt5PropsJSResult", [{
            name: "Broker",
            attrName: "brokerOut",
            mandatory: true,
            dataType: OS.DataTypes.DataTypes.Text,
        ...
        Controller.registerVariableGroupType("tradershub.CFDBlocks.CFDTradeModal.OnClickWebterminal$redirectWebTerminalJSResult", [{
            name: "userAgent",
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.CopyToClipboard.JavaScript1JS", [], function() {
    return function($parameters, $actions, $roles, $public) {
        navigator.clipboard.writeText($parameters.TextToCopy);
    };
});

define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.CtraderPropsJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.GetSelectedProductConfigJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.DxtradePropsJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnParametersChanged.Mt5PropsJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnClickWebterminal.RedirectDemoJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
        window.open($parameters.Link, '_blank')
    };
});

define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnClickWebterminal.RedirectLiveJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
        window.open($parameters.Link, '_blank')
    };
});

define("tradershub.CFDBlocks.CFDTradeModal.mvc$controller.OnClickWebterminal.RedirectWebTerminalJS", [], function() {
    return function($parameters, $actions, $roles, $public) {
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$translationsResources.fr-FR", [], function() {
    return {
...
define("tradershub.CFDBlocks.CFDTradeModal.mvc$translationsResources", ["exports", "tradershub.CFDBlocks.CFDTradeModal.mvc$translationsResources.fr-FR"], function(exports, tradershub_CFDBlocks_CFDTradeModal_mvc_translationsResources_frFR) {
    return {
        "fr-FR": {
            "translations": tradershub_CFDBlocks_CFDTradeModal_mvc_translationsResources_frFR,
            "isRTL": false
        }
    };
});