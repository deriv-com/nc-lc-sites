...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "MainFlowBlocks.EmptyPlatformModal"; }
...
get _derivComRedirection$Action() {if(!(this.hasOwnProperty("__derivComRedirection$Action"))) {
...
try {controller.ensureControllerAlive("DerivComRedirection");
callContext = controller.callContext(callContext);
...
}set _derivComRedirection$Action(value) {this.__derivComRedirection$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._derivComRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
