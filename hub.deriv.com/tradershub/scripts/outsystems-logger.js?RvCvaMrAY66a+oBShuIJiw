(function (global, factory) {
  ...
  function ke(t) {
    ...
    for (var r in Se) {
      var n = r;
      if ("OTEL_LOG_LEVEL" === n) Ie(n, e, t);else if (ve(n)) Oe(n, e, t);else if (ye(n)) we(n, e, t);else if (me(n)) Le(n, e, t);else {
        var i = t[n];
        null != i && (e[n] = String(i));
      }
    }
  ...
  function Sr(t, e, r, n) {
    ...
    if (void 0 === r && (r = 0), !(r > br)) {
      if (r++, Ir(t) || Ir(e) || Lr(e)) i = Er(e);else if (wr(t)) {
        if (i = t.slice(), wr(e)) for (var o = 0, s = e.length; o < s; o++) i.push(Er(e[o]));else if (Ar(e)) for (o = 0, s = (a = Object.keys(e)).length; o < s; o++) {
          i[u = a[o]] = Er(e[u]);
        }
      } else if (Ar(t)) if (Ar(e)) {
        if (!function (t, e) {
        ...
        for (o = 0, s = (a = Object.keys(e)).length; o < s; o++) {
          var u,
            c = e[u = a[o]];
          if (Ir(c)) void 0 === c ? delete i[u] : i[u] = c;else {
            var l = i[u],
              f = c;
            if (Or(t, u, n) || Or(e, u, n)) delete i[u];else {
              if (Ar(l) && Ar(f)) {
                var h = n.get(l) || [],
                  p = n.get(f) || [];
                h.push({
  ...
  class sn {
    ...
    waitForUnlock() {
      ...
      return this._couldLockImmediately(t, e) ? Promise.resolve() : new Promise(r => {
        this._weightedWaiters[t - 1] || (this._weightedWaiters[t - 1] = []), function (t, e) {
    ...
    _drainUnlockWaiters() {
      if (0 === this._queue.length) for (let t = this._value; t > 0; t--) {
  ...
  class di {
    ...
    aggregate(t, e) {
      return i(this, void 0, void 0, function* () {
        ...
        if (s) {
          if (o(this, ni, "f").isOutlier(n, s)) yield o(this, ri, "f").insertSpans([o(this, ei, "m", ui).call(this, n)], e);else {
  ...
  class Ni {
    ...
    processLog(t) {
      return i(this, void 0, void 0, function* () {
        ...
        for (const r of e) if (r.hasWriteBuffer()) yield this.offlineManager.writeLog(t, r);else {
    ...
    processSpan(t) {
      return i(this, void 0, void 0, function* () {
        ...
        for (const r of e) if (r.hasWriteBuffer()) yield this.offlineManager.writeSpan(t, r);else {
          const e = r.getTransportId();
  ...
  var Is = function (t, e) {
    ...
    ks = Is;
  var Rs = function (t, e) {
      for (var r = t.length; r--;) if (ks(t[r][0], e)) return r;
      return -1;
    },
    Ps = Rs,
  ...
  function Wf(t, e, r) {
    if (e) for (let n = 0; n < e.length; n++) Uf(t, "on" + e[n], r);else {
      const e = [];
    ...
    function v(e, r) {
      ...
      const P = function (e, i, o, s) {
        ...
        return function () {
          ...
          if (k) for (let t = 0; t < k.length; t++) if (l === k[t]) return g ? e.call(c, l, f, v) : e.apply(this, arguments);
          ...
          let w,
            ...
            A = !1;
          if (L) {
            if (A = !0, p) for (let t = 0; t < L.length; t++) if (I(L[t], f)) return;
          } else L = c[O] = [];
  ...
  function sh(t, e) {
    if (!e) {
      ...
      for (let n in t) {
        ...
        if (o && (!e || o === e)) {
          const e = t[n];
          if (e) for (let t = 0; t < e.length; t++) r.push(e[t]);
        }
      }
      return r;
    }
  ...
  function lh(t, e, r, n) {
    ...
    i = Zf(t, e += n, r => function (i, o) {
      if (Kf(o[0])) {
        ...
        if (c) s[c] = i;else if (l && (l[ch] = i, f && !h)) {
          const t = l.refresh;
          l.refresh = function () {
            const {
              zone: e,
    ...
    t.__load_patch("ZoneAwarePromise", (t, e, r) => {
      ...
      function R(t, n, o) {
        ...
        if (t[v] === E) {
          ...
          if (n !== O && o instanceof M && o.hasOwnProperty(v) && o.hasOwnProperty(_) && o[v] !== E) C(o), R(t, o[v], o[_]);else if (n !== O && "function" == typeof c) try {
      ...
      class n {
        ...
        runTask(t, e, r) {
          ...
          try {
            ...
            const e = t.state;
            if (e !== _ && e !== E) if (i == w || o || s && e === y) a && n._transitionTo(T, m, y);else {
    ...
    t.__load_patch("legacy", e => {
      ...
      !function (t) {
        ...
        function d(t) {
          ...
          const c = s[i] = () => {
            if (s.readyState === s.DONE) if (!n.aborted && s[o] && t.state === p) {
  ...
  var gp,
    ...
    yp = function () {
      ...
      }, t._registeredPropagators = new Map([["tracecontext", function () {
        return new cr();
      }], ["baggage", function () {
        return new ie();
    ...
    Wp = function (t) {
      ...
      return Bp(e, t), e.prototype.init = function () {}, e.prototype._addChildSpan = function (t, e) {
        ...
        if (void 0 === e && (e = {}), !function (t, e) {
          ...
          if (!e) return !1;
          try {
            for (var i = kr(e), o = i.next(); !o.done; o = i.next()) if (Rr(t, o.value)) return !0;
          } catch (t) {
            r = {
              error: t
            };
