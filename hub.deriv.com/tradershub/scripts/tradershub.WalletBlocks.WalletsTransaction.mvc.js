                ...
                placeholders: {
                    content: new IteratorPlaceholderContent(function(idService, callContext) {
                        return [React.createElement(OSWidgets.Container, {
                            ...
                            visible: ((model.variables.transactionsListIn.getCurrentRowNumber(callContext.iterationContext)) !== ((model.variables.transactionsListIn.length - 1))),
                            _idProps: {
                                service: idService,
                                uuid: "12"
                            },
    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            ...
                            try {
                                ...
                                modifiedTransactionsListJSResult.value = OS.Logger.startActiveSpan("ModifiedTransactionsList", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletBlocks_WalletsTransaction_mvc_controller_OnReady_ModifiedTransactionsListJS, "ModifiedTransactionsList", "OnReady", {
            ...
            get _tooltipInitialized$Action() {
                if (!(this.hasOwnProperty("__tooltipInitialized$Action"))) {
                    this.__tooltipInitialized$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("TooltipInitialized", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("TooltipInitialized");
                                callContext = controller.callContext(callContext);
                                OS.Logger.startActiveSpan("ClipboardAction", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletBlocks_WalletsTransaction_mvc_controller_TooltipInitialized_ClipboardActionJS, "ClipboardAction", "TooltipInitialized", {
            ...
            set _tooltipInitialized$Action(value) {
                this.__tooltipInitialized$Action = value;
            }
            ...
            tooltipInitialized$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("TooltipInitialized__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._tooltipInitialized$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
