...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Signup.SocialLogin"; }
...
get _appleAction$Action() {if(!(this.hasOwnProperty("__appleAction$Action"))) {
...
try {controller.ensureControllerAlive("AppleAction");
...
try {return controller.safeExecuteJSNode(tradershub_Signup_SocialLogin_mvc_controller_AppleAction_RudderStackJS, "RudderStack", "AppleAction", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _appleAction$Action(value) {this.__appleAction$Action = value;
}

get _googleAction$Action() {if(!(this.hasOwnProperty("__googleAction$Action"))) {
...
try {controller.ensureControllerAlive("GoogleAction");
callContext = controller.callContext(callContext);
var getSocialLoginRedirectURLVar = new OS.DataTypes.VariableHolder();
OS.Logger.startActiveSpan("RudderStack", function (span) {
if(span) {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_SocialLogin_mvc_controller_GoogleAction_RudderStackJS, "RudderStack", "GoogleAction", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _googleAction$Action(value) {this.__googleAction$Action = value;
}

get _facebookAction$Action() {if(!(this.hasOwnProperty("__facebookAction$Action"))) {
...
try {controller.ensureControllerAlive("FacebookAction");
callContext = controller.callContext(callContext);
var getSocialLoginRedirectURLVar = new OS.DataTypes.VariableHolder();
OS.Logger.startActiveSpan("RudderStack", function (span) {
if(span) {
...
try {return controller.safeExecuteJSNode(tradershub_Signup_SocialLogin_mvc_controller_FacebookAction_RudderStackJS, "RudderStack", "FacebookAction", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _facebookAction$Action(value) {this.__facebookAction$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._appleAction$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._googleAction$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._facebookAction$Action, callContext);
} finally {
if(span) {
span.end();
}
