import {
    a as L
} from "./_oschunk-XOCTKP7L.js";
import {
    a as U
} from "./_oschunk-AC5OOGJQ.js";
    ...
    u = class u extends E.BaseWebScreen {
        ...
        get title() {
            let m = this.model,
                ...
                A = u.getTranslation,
                a = this;
            return c.Injector.resolve(c.ServiceNames.TranslationsService).getMessage("gTuQ9I_ohEiA0LIcjyWQXg#TitleExpression.2133226043.1", "Easy And Free Sign Up | Online Trading | Hub.Deriv.com")
        }
        internalRender() {
            let m = this.model,
                o = this.controller,
...
`))],
                            ...
                            mandatory: !0,
                            maxLength: 0,
                            prompt: c.Injector.resolve(c.ServiceNames.TranslationsService).getMessage("53iIrc8ky0epygNbeCYIXw#ValueExpression.-374653993.1", "Enter your email"),
                            style: "form-control",
