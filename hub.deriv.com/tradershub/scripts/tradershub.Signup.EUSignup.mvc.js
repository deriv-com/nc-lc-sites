                        ...
                        return OS.Logger.startActiveSpan("Validate", function(span) {
                            ...
                            try {
                                ...
                                validateEmailJSResult.value = OS.Logger.startActiveSpan("ValidateEmail", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_Validate_ValidateEmailJS, "ValidateEmail", "Validate", {
                            ...
                            return OS.Flow.tryFinally(function() {
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    verifyEmailPayloadJSResult.value = OS.Logger.startActiveSpan("VerifyEmailPayload", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_SendVerifyEmail_VerifyEmailPayloadJS, "VerifyEmailPayload", "SendVerifyEmail", {
                                    ...
                                    return tradershubController.default.derivApiSendMessage$Action(verifyEmailPayloadJSResult.value.payloadOut, "", false, callContext).then(function(value) {
                                        ...
                                        if ((derivApiSendMessageVar.value.isErrorOut)) {
                                            ...
                                            OS.Logger.startActiveSpan("RudderStackError", function(span) {
                                                ...
                                                try {
                                                    return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_SendVerifyEmail_RudderStackErrorJS, "RudderStackError", "SendVerifyEmail", null, function($parameters) {}, {}, {});
                                                } finally {
                                                    if (span) {
                                                        span.end();
                                                    }
                                            ...
                                            OS.Logger.startActiveSpan("RudderStack", function(span) {
                                                ...
                                                try {
                                                    return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_SendVerifyEmail_RudderStackJS, "RudderStack", "SendVerifyEmail", null, function($parameters) {}, {}, {});
                                                } finally {
                                                    if (span) {
                                                        span.end();
                                                    }
                                    ...
                                    return OS.Flow.executeSequence(function() {
                                        if ((model.widgets.get(idService.getId("Form")).validAttr)) {
                                            ...
                                            OS.Logger.startActiveSpan("RudderStack", function(span) {
                                                ...
                                                try {
                                                    return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_SubmitOnClick_RudderStackJS, "RudderStack", "SubmitOnClick", null, function($parameters) {}, {}, {});
                                                } finally {
                                                    if (span) {
                                                        span.end();
                                                    }
                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            ...
                            try {
                                ...
                                checkAuthURLParamJSResult.value = OS.Logger.startActiveSpan("CheckAuthURLParam", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_OnReady_CheckAuthURLParamJS, "CheckAuthURLParam", "OnReady", {
                                ...
                                if ((((checkAuthURLParamJSResult.value.authTokenOut) !== (OS.BuiltinFunctions.nullTextIdentifier())))) {
                                    ...
                                    OS.Logger.startActiveSpan("RudderStack", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteJSNode(tradershub_Signup_EUSignup_mvc_controller_OnReady_RudderStackJS, "RudderStack", "OnReady", null, function($parameters) {}, {}, {});
                                        } finally {
                                            if (span) {
                                                span.end();
                                            }
