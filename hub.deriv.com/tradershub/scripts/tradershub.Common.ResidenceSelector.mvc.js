                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            ...
                            try {
                                ...
                                javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_Common_ResidenceSelector_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
                            ...
                            try {
                                ...
                                if (((OS.BuiltinFunctions.length(vars.value.searchedItemArgInLocal) > 0))) {
                                    ...
                                    searchCountryJSResult.value = OS.Logger.startActiveSpan("SearchCountry", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteJSNode(tradershub_Common_ResidenceSelector_mvc_controller_OnSearch_SearchCountryJS, "SearchCountry", "OnSearch", {
