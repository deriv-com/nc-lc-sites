...
define("tradershub.WalletFlows.WalletEmailFailedVerificationWithdrawal.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "RESTAPIWebsocketOfficial.model", "react", "@outsystems/runtime-view-js", "tradershub.WalletFlows.WalletEmailFailedVerificationWithdrawal.mvc$model", "tradershub.WalletFlows.WalletEmailFailedVerificationWithdrawal.mvc$controller", "tradershub.clientVariables", "tradershub.Layouts.MainLayout.mvc$view", "@outsystems/runtime-widgets-js", "tradershub.WalletBlocks.WalletOverlayPage.mvc$view", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "RESTAPIWebsocketOfficial.model$ST_b5532fbd5672db40752d556a46e96eaeStructure", "tradershub.referencesHealth$RESTAPIWebsocketOfficial", "tradershub.controller$VerifyEmail"], function(OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, RESTAPIWebsocketOfficialModel, React, OSView, tradershub_WalletFlows_WalletEmailFailedVerificationWithdrawal_mvc_model, tradershub_WalletFlows_WalletEmailFailedVerificationWithdrawal_mvc_controller, tradershubClientVariables, tradershub_Layouts_MainLayout_mvc_view, OSWidgets, tradershub_WalletBlocks_WalletOverlayPage_mvc_view) {
    var OS = OSRuntimeCore;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() {
            return "WalletFlows.WalletEmailFailedVerificationWithdrawal";
        }

        static getAttributes() {
            return {
                codeFunction: "WalletEmailFailedVerificationWithdrawal",
        ...
        get modelFactory() {
            return tradershub_WalletFlows_WalletEmailFailedVerificationWithdrawal_mvc_model;
        }

        get controllerFactory() {
            return tradershub_WalletFlows_WalletEmailFailedVerificationWithdrawal_mvc_controller;
        }

        get title() {


            return "WalletEmailFailedVerificationWithdrawal";
        }
                            ...
                            placeholders: {
                                walletOverlayPageContent: new PlaceholderContent(function() {
                                    return [React.createElement(OSWidgets.Container, {
                                        ...
                                        _widgetRecordProvider: widgetsRecordProvider
                                    }), "The verification link you used is invalid or expired. Please request for a new one."), React.createElement(OSWidgets.Container, {
                                        align: /*Default*/ 0,
                                        animate: false,
                                        style: model.getCachedValue(idService.getId("FlWDzbeg00uk59SIhWYPyQ.Style"), function() {
