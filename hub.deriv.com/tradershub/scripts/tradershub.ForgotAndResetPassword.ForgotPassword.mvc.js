...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "ForgotAndResetPassword.ForgotPassword"; }
...
get _reset$Action() {if(!(this.hasOwnProperty("__reset$Action"))) {
...
try {controller.ensureControllerAlive("Reset");
...
}set _reset$Action(value) {this.__reset$Action = value;
}

get _clickOnClose$Action() {if(!(this.hasOwnProperty("__clickOnClose$Action"))) {
...
try {controller.ensureControllerAlive("ClickOnClose");
callContext = controller.callContext(callContext);
...
}set _clickOnClose$Action(value) {this.__clickOnClose$Action = value;
}

get _sendEmailOnClick$Action() {if(!(this.hasOwnProperty("__sendEmailOnClick$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_ForgotAndResetPassword_ForgotPassword_mvc_controller_SendEmailOnClick_ValidateEmailJS, "ValidateEmail", "SendEmailOnClick", {
...
}set _sendEmailOnClick$Action(value) {this.__sendEmailOnClick$Action = value;
}
...
get _sendResetPasswordEmail$Action() {if(!(this.hasOwnProperty("__sendResetPasswordEmail$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_ForgotAndResetPassword_ForgotPassword_mvc_controller_SendResetPasswordEmail_verify_email_payloadJS, "verify_email_payload", "SendResetPasswordEmail", {
...
}set _sendResetPasswordEmail$Action(value) {this.__sendResetPasswordEmail$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._reset$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._clickOnClose$Action, callContext);
} finally {
if(span) {
span.end();
}
