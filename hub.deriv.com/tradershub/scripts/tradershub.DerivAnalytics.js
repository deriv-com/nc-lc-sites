    ...
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.Analytics = t() : e.Analytics = t()
                ...
                var e = {
                        ...
                        707: (e, t, r) => {
                            ...
                            function S(e) {
                                if ("idle" !== e.state && (e.errors++, e.errors > 3 || e.src && 2 === e.src.readyState)) {
                                    ...
                                    w(e), setTimeout((() => {
                                        ["idle", "active"].includes(e.state) || E(e)
                                    }), Math.min(t, 3e5))
                                }
                            }
                        ...
                        182: (e, t, r) => {
                                ...
                                function Ce(e) {
                                    Ae.call(this, void 0), this.x = e, this.s = void 0, this.g = we - 1, this.f = 4
                                }
                                ...
                                const je = {
                                    ...
                                    Ue = new class {
                                        ...
                                        setMinLogLevel(e) {
                                            this.minLogLevel = je[e], w(this.minLogLevel) && (this.minLogLevel = je[Le])
                                        }
                                        formatLogData(e) {
                                    ...
                                    Tt = new class {
                                        ...
                                        attachEffect() {
                                            if (!0 === Et.reporting.isErrorReportingPluginLoaded.value)
                                        ...
                                        init(e) {
                                            if (this.pluginEngine) try {
                                                const t = "errorReporting.init",
                                                    r = this.pluginEngine.invokeSingle(t, Et, this.pluginEngine, e, this.logger);
                                        ...
                                        onError(e, t = "", r = "", n = !1, i = "handled") {
                                            ...
                                            Et.reporting.isErrorReportingEnabled.value && Et.reporting.isErrorReportingPluginLoaded.value
                                        }
                                        leaveBreadcrumb(e) {
                                            if (this.pluginEngine) try {
                                        ...
                                        notifyError(e) {
                                            if (this.errReportingClient && (e => !e.message || !xt.some((t => e.message.includes(t))))(e)) try {
                                                this.pluginEngine?.invokeSingle("errorReporting.notify", this.pluginEngine, this.errReportingClient, e, Et, this.logger)
                                            } catch (e) {
                                ...
                                class Ut {
                                    ...
                                    init() {
                                        Et.lifecycle.status.value = "pluginsLoading", ae("pluginsCDNPath", Et.lifecycle.pluginsCDNPath.value), this.setActivePlugins(), this.registerLocalPlugins(), this.registerRemotePlugins(), this.attachEffects()
                                    }
                                    attachEffects() {
                                        $e((() => {
                                            (0 === Et.plugins.activePlugins.value.length || Et.plugins.loadedPlugins.value.length + Et.plugins.failedPlugins.value.length === Et.plugins.totalPluginsToLoad.value) && me((() => {
                                                Et.plugins.ready.value = !0, Et.lifecycle.status.value = "pluginsReady"
                                            }))
                                        }))
                                    }
                                    getPluginsToLoadBasedOnConfig() {
                                        let e = Et.plugins.pluginsToLoadFromConfig.value;
                                        if (!e) return [];
                                        return [{
                                            configurationStatus: () => A(Et.dataPlaneEvents.eventsQueuePluginName.value),
                                            configurationStatusStr: "Data plane events delivery is enabled",
                                            activePluginName: Et.dataPlaneEvents.eventsQueuePluginName.value,
                                            supportedPlugins: Object.values(ot),
                                            shouldAddMissingPlugins: !0
                                        }, {
                                            configurationStatus: () => A(Et.reporting.errorReportingProviderPluginName.value),
                                            configurationStatusStr: "Error reporting is enabled",
                                            activePluginName: Et.reporting.errorReportingProviderPluginName.value,
                                            basePlugins: ["ErrorReporting"],
                                            supportedPlugins: Object.values(it)
                                        }, {
                                            configurationStatus: () => Ct(Et.nativeDestinations.configuredDestinations.value).length > 0,
                                            ...
                                            configurationStatus: () => Ct(Et.nativeDestinations.configuredDestinations.value).some((e => e.shouldApplyDeviceModeTransformation)),
                                            ...
                                            configurationStatus: () => A(Et.consents.activeConsentManagerPluginName.value),
                                            configurationStatusStr: "Consent management is enabled",
                                            activePluginName: Et.consents.activeConsentManagerPluginName.value,
                                            supportedPlugins: Object.values(nt)
                                        }, {
                                            configurationStatus: () => A(Et.storage.encryptionPluginName.value),
                                            configurationStatusStr: "Storage encryption is enabled",
                                            activePluginName: Et.storage.encryptionPluginName.value,
                                            supportedPlugins: Object.values(st)
                                        }, {
                                            configurationStatus: () => Et.storage.migrate.value,
                                    ...
                                    setActivePlugins() {
                                        ...
                                        })), n.length > 0 && this.onError(new Error(`Ignoring loading of unknown plugins: ${n.join(",")}. Mandatory plugins: ${Object.keys({}).join(",")}. Load option plugins: ${Et.plugins.pluginsToLoadFromConfig.value.join(",")}`)), me((() => {
                                            Et.plugins.totalPluginsToLoad.value = e.length, Et.plugins.activePlugins.value = r, Et.plugins.failedPlugins.value = n
                                        }))
                                    }
                                    registerLocalPlugins() {
                                        Object.values(Lt).forEach((e => {
                                            k(e) && Et.plugins.activePlugins.value.includes(e().name) && this.register([e()])
                                        }))
                                    }
                                    registerRemotePlugins() {
                                        const e = (t = Et.plugins.activePlugins.value, {
                                            ...jt(t)
                                        });
                                        var t;
                                        Promise.all(Object.keys(e).map((async t => {
                                            await e[t]().then((e => this.register([e.default()]))).catch((e => {
                                                Et.plugins.failedPlugins.value = [...Et.plugins.failedPlugins.value, t], this.onError(e, t)
                                            }))
                                        }))).catch((e => {
                                            this.onError(e)
                                        }))
                                    ...
                                    register(e) {
                                        e.forEach((e => {
                                            try {
                                                this.engine.register(e, Et)
                                            } catch (t) {
                                                Et.plugins.failedPlugins.value = [...Et.plugins.failedPlugins.value, e.name], this.onError(t)
                                            }
                                        }))
                                    }
                                ...
                                const Gt = new Kt(Tt, Ue),
                                    ...
                                    ar = () => !E(globalThis.navigator.userAgentData),
                                    lr = {
                                ...
                                class _r {
                                    ...
                                    decrypt(e) {
                                        return E(e) ? null : this.crypto(e, "decrypt")
                                    }
                                    encrypt(e) {
                                ...
                                class Sr {
                                    ...
                                    init() {
                                        ...
                                        })(M(R(t.cookieStorageOptions ?? {}, Et.storage.cookie?.value ?? {})), M(t.localStorageOptions), M(t.inMemoryStorageOptions), M(t.sessionStorageOptions)), this.initClientDataStores(), this.isInitialized = !0
                                    }
                                    ...
                                    initializeStorageState() {
                                        let e = Et.storage.type.value,
                                            t = Et.loadOptions.value.storage?.entries;
                                        const r = Et.consents.postConsent.value.storage;
                                        ...
                                        tr.forEach((r => {
                                            ...
                                            Et.storage.type.value = e, Et.storage.entries.value = i, Et.storage.trulyAnonymousTracking.value = n
                                        }))
                                    }
                                ...
                                const wr = e => {
                                    ...
                                    Er = e => e?.endsWith("/") ? Er(e.substring(0, e.length - 1)) : e,
                                    Ar = e => {
                                        try {
                                    ...
                                    Br = e => {
                                        ...
                                        const o = s && st[s];
                                        var a, l;
                                        !w(s) && w(o) ? (e?.warn((a = st, l = tt, `${H}${ce}The storage encryption version "${s}" is not supported. Please choose one of the following supported versions: "${Object.keys(a)}". The default version "${l}" will be used instead.`)), s = tt) : w(s) && (s = tt);
                                        const u = n?.migrate,
                                            c = u && s === tt;
                                        !0 === u && c !== u && e?.warn(((e, t, r) => `${e}${ce}The storage data migration has been disabled because the configured storage encryption version (${t}) is not the latest (${r}). To enable storage data migration, please update the storage encryption version to the latest version.`)(H, s, tt)), me((() => {
                                                        Et.storage.type.value = i;
                                                        let e = n?.cookie ?? {};
                                                        if (t) {
                                                            Et.serverCookies.isEnabledServerSideCookies.value = t;
                                                            const n = (o = r ?? "rsaRequest", `${(e=>{const t=new URL(e),{host:r,protocol:n}=t,i=r.split(".");let s;return s=i.length>2?`
                                                                    ...
                                                                    $ {
                                                                        n
                                                                    } //${s}`})(window.location.href)}/${o.startsWith("/")?o.substring(1):o}`);wr(n)?(Et.serverCookies.dataServiceUrl.value=Er(n),Ar(window.location.href)!==Ar(n)&&(e={...e,samesite:"None",secure:!0})):Et.serverCookies.isEnabledServerSideCookies.value=!1}var o;Et.storage.cookie.value=e,Et.storage.encryptionPluginName.value=st[s],Et.storage.migrate.value=c}))},Mr=(e,t,r,n,i,s)=>{let o="";if(s){if(!wr(s))throw new Error(`Failed to load the SDK as the base URL for ${e} is not valid.`);return Er(s)}const a=(()=>{const e=document.getElementsByTagName("script"),t=/(?:^|\/)rsa(\.min)?\.js$/;for(const r of e){const e=r.getAttribute("src");if(e&&t.test(e))return e}})();return o=a?a.split("/").slice(0,-1).concat(t).join("/"):r,i&&(o=o.replace(`/${We}/${qe}/${t}`,`/${n}/${qe}/${t}`)),o};class $r{hasErrorHandler=!1;constructor(e,t,r){this.errorHandler=t,this.logger=r,this.httpClient=e,this.hasErrorHandler=Boolean(this.errorHandler),this.onError=this.onError.bind(this),this.processConfig=this.processConfig.bind(this)}attachEffects(){$e((()=>{this.logger?.setMinLogLevel(Et.lifecycle.logLevel.value)}))}init(){var e,t;this.attachEffects(),e=Et.lifecycle.writeKey.value,t=Et.lifecycle.dataPlaneUrl.value,(e=>{if(!_(e)||0===e.trim().length)throw new Error((e=>`The write key "${e}" is invalid. It must be a non-empty string. Please check that the write key is correct and try again.`)(e))})(e),(e=>{if(!wr(e))throw new Error((e=>`The data plane URL "${e}" is invalid. It must be a valid URL string. Please check that the data plane URL is correct and try again.`)(e))})(t);const{logLevel:r,configUrl:n,lockIntegrationsVersion:i,lockPluginsVersion:s,destSDKBaseURL:o,pluginsSDKBaseURL:a}=Et.loadOptions.value;Et.lifecycle.activeDataplaneUrl.value=Er(Et.lifecycle.dataPlaneUrl.value);const l=((e,t,r)=>Mr("integrations",Ge,Xe,e,t,r))(Y,i,o),u=((e,t,r)=>Mr("plugins",Qe,Ze,e,t,r))(Y,s,a);Br(this.logger),(e=>{const{provider:t,consentManagerPluginName:r,initialized:n,enabled:i,consentsData:s}=Rr(Et.loadOptions.value.consentManagement,e),o=Et.loadOptions.value.preConsent;let a=o?.storage?.strategy??Tr;var l,u;A(a)&&!["none","session","anonymousId"].includes(a)&&(a=Tr,e?.warn((l=H,u=o?.storage?.strategy,`${l}${ce}The pre-consent storage strategy "${u}" is not supported. Please choose one of the following supported strategies: "none, session, anonymousId". The default strategy "${Tr}" will be used instead.`)));let c=o?.events?.delivery??Pr;A(c)&&!["immediate","buffer"].includes(c)&&(c=Pr,e?.warn(((e,t,r)=>`${e}${ce}The pre-consent events delivery type "${t}" is not supported. Please choose one of the following supported types: "immediate, buffer". The default type "${r}" will be used instead.`)(H,o?.events?.delivery,Pr))),me((()=>{Et.consents.activeConsentManagerPluginName.value=r,Et.consents.initialized.value=n,Et.consents.enabled.value=i,Et.consents.data.value=s,Et.consents.provider.value=t,Et.consents.preConsent.value={enabled:!0===Et.loadOptions.value.preConsent?.enabled&&!1===n&&!0===i,storage:{strategy:a},events:{delivery:c}}}))})(this.logger),(e=>{if(Et.dataPlaneEvents.deliveryEnabled.value){const t="XhrQueue";let r=t;Et.loadOptions.value.useBeacon&&(Et.capabilities.isBeaconAvailable.value?r="BeaconQueue":(r=t,e?.warn(`${H}${ce}The Beacon API is not supported by your browser. The events will be sent using XHR instead.`))),me((()=>{Et.dataPlaneEvents.eventsQueuePluginName.value=r}))}})(this.logger),me((()=>{Et.lifecycle.integrationsCDNPath.value=l,Et.lifecycle.pluginsCDNPath.value=u,r&&(Et.lifecycle.logLevel.value=r),Et.lifecycle.sourceConfigUrl.value=((e,t,r,n,i)=>{const s=new URLSearchParams({p:"npm",v:Y,build:qe,writeKey:t,lockIntegrationsVersion:r.toString(),lockPluginsVersion:n.toString()});let o=Ye,a=s,l="/sourceConfig/",u="";if(wr(e)){const t=new URL(e);Er(t.pathname).endsWith("/sourceConfig")||(t.pathname=`${Er(t.pathname)}/sourceConfig/`),t.pathname=t.pathname.replace(/\/{2,}/g,"/"),s.forEach(((e,r)=>{null===t.searchParams.get(r)&&t.searchParams.set(r,e)})),o=t.origin,l=t.pathname,a=t.searchParams,u=t.hash}else i?.warn(((e,t)=>`${e}${ce}The provided source config URL "${t}" is invalid. Using the default source config URL instead.`)(H,e));return`${o}${l}?${a}${u}`})(n,Et.lifecycle.writeKey.value,i,s,this.logger)})),this.getConfig()}onError(e,t,r){if(!this.hasErrorHandler)throw e;this.errorHandler?.onError(e,H,t,r)}processConfig(e,t){if(!e)return void this.onError((r=t?.error,`Failed to fetch the source config. Reason: ${r}`));var r;let n;try{n=_(e)?JSON.parse(e):e}catch(e){return void this.onError(e,Ve,!0)}if(!(e=>C(e)&&C(e.source)&&!E(e.source.id)&&C(e.source.config)&&Array.isArray(e.source.destinations))(n))return void this.onError(new Error(Ve),void 0,!0);if(!1===n.source.enabled)return void this.logger?.error("The source is disabled. Please enable the source in the dashboard to send events.");((e,t)=>{var r,n,i;if(Et.reporting.isErrorReportingEnabled.value=(r=e.source.config,!(!0!==r?.statsCollection?.errors?.enabled||window.chrome&&window.chrome.runtime&&window.chrome.runtime.id)),Et.reporting.isMetricsReportingEnabled.value=(e=>!0===e?.statsCollection?.metrics?.enabled)(e.source.config),Et.reporting.isErrorReportingEnabled.value){const r=(e=>e?.statsCollection?.errors?.provider)(e.source.config),s=r?it[r]:void 0;w(r)||s||t?.warn((n=it,i=et,`${H}${ce}The error reporting provider "${r}" is not supported. Please choose one of the following supported providers: "${Object.keys(n)}". The default provider "${i}" will be used instead.`)),Et.reporting.errorReportingProviderPluginName.value=s??it[et]}})(n,this.logger);const i=n.source.destinations.length>0?(e=>{const t=[];return e.forEach((e=>{e.enabled&&!e.deleted&&t.push({id:e.id,displayName:e.destinationDefinition.displayName,config:e.config,shouldApplyDeviceModeTransformation:e.shouldApplyDeviceModeTransformation||!1,propagateEventsUntransformedOnError:e.propagateEventsUntransformedOnError||!1,userFriendlyId:`${e.destinationDefinition.displayName.replaceAll(" ","-")}___${e.id}`})})),t})(n.source.destinations):[];me((()=>{Et.source.value={config:n.source.config,id:n.source.id,workspaceId:n.source.workspaceId},Et.nativeDestinations.configuredDestinations.value=i,Et.plugins.pluginsToLoadFromConfig.value=Et.loadOptions.value.plugins??[],(e=>{let t,r=Et.consents.resolutionStrategy.value;C(e.consentManagementMetadata)&&(Et.consents.provider.value&&(r=e.consentManagementMetadata.providers.find((e=>e.provider===Et.consents.provider.value))?.resolutionStrategy??Et.consents.resolutionStrategy.value),t=e.consentManagementMetadata),"custom"===Et.consents.provider.value&&(r=void 0),me((()=>{Et.consents.metadata.value=g(t),Et.consents.resolutionStrategy.value=r}))})(n),Et.lifecycle.status.value="configured"}))}getConfig(){const e=Et.loadOptions.value.getSourceConfig;if(e){if(!k(e))throw new Error('"getSourceConfig" must be a function. Please make sure that it is defined and returns a valid source configuration object.');const t=e();t instanceof Promise?t.then((e=>this.processConfig(e))).catch((e=>{this.onError(e,"SourceConfig")})):this.processConfig(t)}else this.httpClient.getAsyncData({url:Et.lifecycle.sourceConfigUrl.value,options:{headers:{"Content-Type":void 0}},callback:this.processConfig})}}const Dr=()=>document?.referrer||"$direct",jr=()=>{const e=(()=>{const e=document.getElementsByTagName("link");let t="";for(let r=0;e[r];r+=1){const n=e[r];if("canonical"===n.getAttribute("rel")&&!t){t=n.getAttribute("href")??"";break}}return t})();let t=globalThis.location.pathname;const{href:r}=globalThis.location;let n=r;const{search:i}=globalThis.location;if(e)try{const r=new URL(e);n=""===r.search?e+i:e,t=r.pathname}catch(e){}const s=(e=>{let t=e;try{const r=new URL(e);t=r.origin+r.pathname+r.search}catch(e){}return t})(n),{title:o}=document,a=Dr();return{path:t,referrer:a,referring_domain:Ir(a),search:i,title:o,url:s,tab_url:r}},Lr=`https://polyfill-fastly.io/v3/polyfill.min.js?version=3.111.0&features=${Object.keys(lr).join("%2C")}`,Ur="rudderstackPolyfill";class Nr{constructor(e,t){this.logger=t,this.errorHandler=e,this.externalSrcLoader=new pe(this.errorHandler,this.logger),this.onError=this.onError.bind(this),this.onReady=this.onReady.bind(this)}init(){try{this.prepareBrowserCapabilities(),this.attachWindowListeners()}catch(e){this.onError(e)}}detectBrowserCapabilities(){me((()=>{Et.capabilities.storage.isCookieStorageAvailable.value=dr(Qt,kr(Qt),this.logger),Et.capabilities.storage.isLocalStorageAvailable.value=dr(zt,void 0,this.logger),Et.capabilities.storage.isSessionStorageAvailable.value=dr(qt,void 0,this.logger),Et.capabilities.isBeaconAvailable.value=!E(globalThis.navigator.sendBeacon)&&k(globalThis.navigator.sendBeacon),Et.capabilities.isUaCHAvailable.value=ar(),Et.capabilities.isCryptoAvailable.value=!E(globalThis.crypto)&&k(globalThis.crypto.getRandomValues),Et.capabilities.isIE11.value=Boolean(globalThis.navigator.userAgent.match(/Trident.*rv:11\./)),Et.capabilities.isOnline.value=globalThis.navigator.onLine,Et.context.userAgent.value=(()=>{if(w(globalThis.navigator))return null;let{userAgent:e}=globalThis.navigator;const{brave:t}=globalThis.navigator;if(t&&Object.getPrototypeOf(t).isBrave){const t=e.match(/(chrome)\/([\w.]+)/i);t&&(e=`${e} Brave/${t[2]}`)}return e})(),Et.context.locale.value=w(globalThis.navigator)?null:globalThis.navigator.language??globalThis.navigator.browserLanguage,Et.context.screen.value=ur(),Et.context.timezone.value=(()=>{const e=(new Date).toString().match(/([A-Z]+[+-]\d+)/);return e&&e[1]?e[1]:"NA"})(),ar()&&((e,t="none")=>{"none"===t&&e(void 0),"default"===t&&e(navigator.userAgentData),"full"===t&&navigator.userAgentData?.getHighEntropyValues(["architecture","bitness","brands","mobile","model","platform","platformVersion","uaFullVersion","fullVersionList","wow64"]).then((t=>{e(t)})).catch((()=>{e()}))})((e=>{Et.context["ua-ch"].value=e}),Et.loadOptions.value.uaChTrackLevel)})),$e((()=>{!0===Et.loadOptions.value.sendAdblockPage&&void 0!==Et.lifecycle.sourceConfigUrl.value&&((e,t)=>{const r=new URL(Et.lifecycle.sourceConfigUrl.value),n=`${r.origin}${r.pathname}?view=ad`,i=new Kt(e,t);i.setAuthHeader(Et.lifecycle.writeKey.value),i.getAsyncData({url:n,options:{method:"HEAD",headers:{"Content-Type":void 0}},isRawResponse:!0,callback:(e,t)=>{Et.capabilities.isAdBlocked.value=void 0!==t?.error||t?.xhr?.responseURL!==n}})})(this.errorHandler,this.logger)}))}prepareBrowserCapabilities(){Et.capabilities.isLegacyDOM.value=(()=>{const e=Object.keys(lr);let t=!1;for(let r=0;r<e.length;r++){const n=lr[e[r]];if(k(n)&&n()){t=!0;break}}return t})();const e=Et.loadOptions.value.polyfillURL;let t=Lr;if(I(e)&&(wr(e)?t=e:this.logger?.warn(((e,t)=>`${e}${ce}The provided polyfill URL "${t}" is invalid. The default polyfill URL will be used instead.`)(V,e))),Et.loadOptions.value.polyfillIfRequired&&Et.capabilities.isLegacyDOM.value&&wr(t)){const e=t!==Et.loadOptions.value.polyfillURL;if(e){const e=`RS_polyfillCallback_${Et.lifecycle.writeKey.value}`,r=()=>{this.onReady(),delete globalThis[e]};globalThis[e]=r,t=`${t}&callback=${e}`}this.externalSrcLoader.loadJSFile({url:t,id:Ur,async:!0,timeout:1e4,callback:r=>{r?e||this.onReady():this.onError(new Error(((e,t)=>`Failed to load the polyfill script with ID "${e}" from URL ${t}.`)(Ur,t)))}})}else this.onReady()}attachWindowListeners(){globalThis.addEventListener("offline",(()=>{Et.capabilities.isOnline.value=!1})),globalThis.addEventListener("online",(()=>{Et.capabilities.isOnline.value=!0})),globalThis.addEventListener("resize",function(e,t,r=250){let n;return(...i)=>{globalThis.clearTimeout(n),n=globalThis.setTimeout((()=>{e.apply(t,i)}),r)}}((()=>{Et.context.screen.value=ur()}),this))}onReady(){this.detectBrowserCapabilities(),Et.lifecycle.status.value="browserCapabilitiesReady"}onError(e){if(!this.errorHandler)throw e;this.errorHandler.onError(e,V)}}for(var Fr,Vr=[],Hr=0;Hr<256;Hr++)Vr[Hr]=(Hr+256).toString(16).substring(1);for(var Kr,Gr=256,Qr=[];Gr--;)Qr[Gr]=(Gr+256).toString(16).substring(1);const zr=()=>!E(globalThis.crypto)&&k(globalThis.crypto.getRandomValues)?function(){(!Fr||Hr+16>4096)&&(Fr=crypto.getRandomValues(new Uint8Array(4096)),Hr=0);for(var e,t=0,r="";t<16;t++)e=Fr[Hr+t],r+=6==t?Vr[15&e|64]:8==t?Vr[63&e|128]:Vr[e],1&t&&t>1&&t<11&&(r+="-");return Hr+=16,r}():function(){var e,t=0,r="";if(!Kr||Gr+16>256){for(Kr=Array(t=256);t--;)Kr[t]=256*Math.random()|0;t=Gr=0}for(;t<16;t++)e=Kr[Gr+t],r+=6==t?Qr[15&e|64]:8==t?Qr[63&e|128]:Qr[e],1&t&&t>1&&t<11&&(r+="-");return Gr++,r}(),qr=["integrations","anonymousId","originalTimestamp"],Jr=["library","consentManagement","userAgent","ua-ch","screen"],Wr=["id","anonymous_id","user_id","sent_at","timestamp","received_at","original_timestamp","event","event_text","channel","context_ip","context_request_ip","context_passed_ip","group_id","previous_id"],Xr=e=>"number"==typeof e&&!Number.isNaN(e),Zr=e=>Xr(e)&&e>=0&&Number.isInteger(e),Yr=e=>{const t=Date.now();return Boolean(!e||t>e)},en=(e,t)=>{return!!(e&&Zr(e)&&(r=e,r.toString().length>=10))||(t?.warn(((e,t,r)=>`${e}${ce}The provided session ID (${t}) is either invalid, not a positive integer, or not at least "10" digits long. A new session ID will be auto-generated instead.`)(Q,e)),!1);var r},tn=e=>Boolean(e===Qt||e===zt||e===qt||e===Jt),rn=()=>zr(),nn=e=>{const t=jr(),r={};return Object.keys(t).forEach((n=>{r[n]=e?.[n]||t[n]})),r.initial_referrer=e?.initial_referrer||Et.session.initialReferrer.value,r.initial_referring_domain=e?.initial_referring_domain||Et.session.initialReferringDomain.value,r},sn=(e,t,r)=>{C(e)&&Object.keys(e).forEach((e=>{(Wr.includes(e)||Wr.includes(e.toLowerCase()))&&r?.warn(((e,t,r,n)=>`${e}${ce}The "${t}" property defined under "${r}" is a reserved keyword. Please choose a different property name to avoid conflicts with reserved keywords (${n}).`)(K,e,t,Wr))}))},on=(e,t,r,n)=>{const i={channel:"web",context:{traits:g(Et.session.userTraits.value),sessionId:Et.session.sessionInfo.value.id||void 0,sessionStart:Et.session.sessionInfo.value.sessionStart||void 0,...Et.consents.enabled.value&&{consentManagement:{deniedConsentIds:g(Et.consents.data.value.deniedConsentIds),allowedConsentIds:g(Et.consents.data.value.allowedConsentIds),provider:Et.consents.provider.value,resolutionStrategy:Et.consents.resolutionStrategy.value}},"ua-ch":Et.context["ua-ch"].value,app:Et.context.app.value,library:Et.context.library.value,userAgent:Et.context.userAgent.value,os:Et.context.os.value,locale:Et.context.locale.value,screen:Et.context.screen.value,campaign:xr(globalThis.location.href),page:nn(r),timezone:Et.context.timezone.value},originalTimestamp:(new Date).toISOString(),integrations:Cr,messageId:zr(),userId:e.userId||Et.session.userId.value};tn(Et.storage.entries.value.anonymousId?.type)?i.anonymousId=Et.session.anonymousId.value:i.anonymousId=rn(),Et.storage.trulyAnonymousTracking.value&&(i.context.trulyAnonymousTracking=!0),"identify"===e.type&&(i.context.traits=Et.storage.entries.value.userTraits?.type!==Wt?g(Et.session.userTraits.value):e.context.traits),"group"===e.type&&((e.groupId||Et.session.groupId.value)&&(i.groupId=e.groupId||Et.session.groupId.value),(e.traits||Et.session.groupTraits.value)&&(i.traits=Et.storage.entries.value.groupTraits?.type!==Wt?g(Et.session.groupTraits.value):e.traits));const s=R(e,i);return void 0===s.event&&(s.event=null),void 0===s.properties&&(s.properties=null),((e,t)=>{C(t)&&(((e,t)=>{t.anonymousId&&_(t.anonymousId)&&(e.anonymousId=t.anonymousId),C(t.integrations)&&(e.integrations=t.integrations),t.originalTimestamp&&_(t.originalTimestamp)&&(e.originalTimestamp=t.originalTimestamp)})(e,t),e.context=((e,t,r)=>{let n=e;return Object.keys(t).forEach((e=>{if(!qr.includes(e)&&!Jr.includes(e))if("context"!==e)n=R(n,{[e]:t[e]});else if(!w(t[e])&&C(t[e])){const r={};Object.keys(t[e]).forEach((n=>{Jr.includes(n)||(r[n]=t[e][n])})),n=R(n,{...r})}})),n})(e.context,t))})(s,t),((e,t)=>{const{properties:r,traits:n,context:i}=e,{traits:s}=i;sn(r,"properties",t),sn(n,"traits",t),sn(s,"context.traits",t)})(s,n),s.integrations=(e=>{let t;return t=Et.loadOptions.value.useGlobalIntegrationsConfigInEvents&&(C(Et.consents.postConsent.value?.integrations)||C(Et.nativeDestinations.loadOnlyIntegrations.value))?g(Et.consents.postConsent.value?.integrations??Et.nativeDestinations.loadOnlyIntegrations.value):C(e)?e:Cr,t})(s.integrations),s};class an{constructor(e){this.logger=e}generatePageEvent(e,t,r,n){let i=r??{};return i.name=t,i.category=e,i=((e,t)=>{const r=t?.page||{},n=e,i=jr();return Object.keys(i).forEach((e=>{w(n[e])&&(n[e]=r[e]||i[e])})),w(n.initial_referrer)&&(n.initial_referrer=r.initial_referrer||Et.session.initialReferrer.value),w(n.initial_referring_domain)&&(n.initial_referring_domain=r.initial_referring_domain||Et.session.initialReferringDomain.value),n})(i,n),on({properties:i,name:t,category:e,type:"page"},n,i,this.logger)}generateTrackEvent(e,t,r){return on({properties:t,event:e,type:"track"},r,void 0,this.logger)}generateIdentifyEvent(e,t,r){return on({userId:e,type:"identify",context:{traits:t}},r,void 0,this.logger)}generateAliasEvent(e,t,r){const n=on({previousId:t,type:"alias"},r,void 0,this.logger);return n.userId=e??n.userId,n}generateGroupEvent(e,t,r){const n={type:"group"};return e&&(n.groupId=e),t&&(n.traits=t),on(n,r,void 0,this.logger)}create(e){let t;switch(e.type){case"page":t=this.generatePageEvent(e.category,e.name,e.properties,e.options);break;case"track":t=this.generateTrackEvent(e.name,e.properties,e.options);break;case"identify":t=this.generateIdentifyEvent(e.userId,e.traits,e.options);break;case"alias":t=this.generateAliasEvent(e.to,e.from,e.options);break;case"group":t=this.generateGroupEvent(e.groupId,e.traits,e.options)}return t}}class ln{constructor(e,t,r,n){this.eventRepository=e,this.userSessionManager=t,this.errorHandler=r,this.logger=n,this.eventFactory=new an(this.logger),this.onError=this.onError.bind(this)}init(){this.eventRepository.init()}resume(){this.eventRepository.resume()}addEvent(e){this.userSessionManager.refreshSession();const t=this.eventFactory.create(e);t?this.eventRepository.enqueue(t,e.callback):this.onError(new Error("Failed to generate the event object."))}onError(e,t,r){if(!this.errorHandler)throw e;this.errorHandler.onError(e,K,t,r)}}class un{constructor(e,t,r,n,i){this.storeManager=n,this.pluginsManager=r,this.logger=t,this.errorHandler=e,this.httpClient=i,this.onError=this.onError.bind(this),this.serverSideCookieDebounceFuncs={}}init(){this.syncStorageDataToState(),this.registerEffects()}syncStorageDataToState(){this.migrateStorageIfNeeded(),this.migrateDataFromPreviousStorage(),this.setUserId(this.getUserId()),this.setUserTraits(this.getUserTraits()),this.setGroupId(this.getGroupId()),this.setGroupTraits(this.getGroupTraits());const{externalAnonymousIdCookieName:e,anonymousIdOptions:t}=Et.loadOptions.value;let r;I(e)&&"string"==typeof e&&(r=this.getExternalAnonymousIdByCookieName(e)),this.setAnonymousId(r??this.getAnonymousId(t)),this.setAuthToken(this.getAuthToken()),this.setInitialReferrerInfo(),this.configureSessionTracking()}configureSessionTracking(){let e=this.getSessionInfo();if(this.isPersistenceEnabledForStorageEntry("sessionInfo")){const t=this.getConfiguredSessionTrackingInfo(),r=e??ut;e={...r,...t,autoTrack:t.autoTrack&&!0!==r.manualTrack}}Et.session.sessionInfo.value=this.isPersistenceEnabledForStorageEntry("sessionInfo")?e:lt.sessionInfo,Et.session.sessionInfo.value.autoTrack&&this.startOrRenewAutoTracking(Et.session.sessionInfo.value)}setInitialReferrerInfo(){const e=this.getInitialReferrer(),t=this.getInitialReferringDomain();if(e&&t)this.setInitialReferrer(e),this.setInitialReferringDomain(t);else{const t=e||Dr();this.setInitialReferrer(t),this.setInitialReferringDomain(Ir(t))}}isPersistenceEnabledForStorageEntry(e){return tn(Et.storage.entries.value[e]?.type)}migrateDataFromPreviousStorage(){const e=Et.storage.entries.value,t=[Qt,zt,qt];Object.keys(e).forEach((r=>{const n=r,i=e[n]?.type,s=this.storeManager?.getStore(rr[i]);s&&t.forEach((e=>{const t=this.storeManager?.getStore(rr[e]);if(t&&e!==i){const e=t.get(Xt[n]);(e=>I(e)&&""!==e)(e)&&s.set(Xt[n],e),t.remove(Xt[n])}}))}))}migrateStorageIfNeeded(){if(!Et.storage.migrate.value)return;const e=[];[Zt,Yt,er].forEach((t=>{const r=this.storeManager?.getStore(t);r&&e.push(r)})),Object.keys(Xt).forEach((t=>{const r=Xt[t];e.forEach((e=>{const t=this.pluginsManager?.invokeSingle("storage.migrate",r,e.engine,this.errorHandler,this.logger);E(t)||e.set(r,t)}))}))}getConfiguredSessionTrackingInfo(){let e,t=!1!==Et.loadOptions.value.sessions?.autoTrack;if(!t)return{autoTrack:t};const r=Et.loadOptions.value.sessions?.timeout;return Zr(r)?e=r:(this.logger?.warn(((e,t,r)=>`${e}${ce}The session timeout value "${t}" is not a number. The default timeout of 1800000 ms will be used instead.`)(Q,r)),e=se),0===e&&(this.logger?.warn(`${Q}${ce}The session timeout value is 0, which disables the automatic session tracking feature. If you want to enable session tracking, please provide a positive integer value for the timeout.`),t=!1),e>0&&e<1e4&&this.logger?.warn(((e,t,r)=>`${e}${ce}The session timeout value ${t} ms is less than the recommended minimum of 10000 ms. Please consider increasing the timeout value to ensure optimal performance and reliability.`)(Q,e)),{timeout:e,autoTrack:t}}onError(e,t){if(!this.errorHandler)throw e;this.errorHandler.onError(e,Q,t)}getEncryptedCookieData(e,t){const r=[];return e.forEach((e=>{const n=t?.encrypt(ge(e.value,!1,[],this.logger));I(n)&&r.push({name:e.name,value:n})})),r}makeRequestToSetCookie(e,t){this.httpClient?.getAsyncData({url:Et.serverCookies.dataServiceUrl.value,options:{method:"POST",data:ge({reqType:"setCookies",workspaceId:Et.source.value?.workspaceId,data:{options:{maxAge:Et.storage.cookie.value?.maxage,path:Et.storage.cookie.value?.path,domain:Et.storage.cookie.value?.domain,sameSite:Et.storage.cookie.value?.samesite,secure:Et.storage.cookie.value?.secure,expires:Et.storage.cookie.value?.expires},cookies:e}}),sendRawData:!0,withCredentials:!0},isRawResponse:!0,callback:t})}setServerSideCookies(e,t,r){try{const n=this.getEncryptedCookieData(e,r);n.length>0&&this.makeRequestToSetCookie(n,((n,i)=>{var s;200===i?.xhr?.status?e.forEach((e=>{const n=r?.get(e.name),i=ge(e.value,!1,[]);ge(n,!1,[])!==i&&(this.logger?.error(`The server failed to set the ${e.name} cookie. As a fallback, the cookies will be set client side.`),t&&t(e.name,e.value))})):(this.logger?.error((s=i?.xhr?.status,`The server responded with status ${s} while setting the cookies. As a fallback, the cookies will be set client side.`)),e.forEach((e=>{t&&t(e.name,e.value)})))}))}catch(r){this.onError(r,"Failed to set/remove cookies via server. As a fallback, the cookies will be managed client side."),e.forEach((e=>{t&&t(e.name,e.value)}))}}syncValueToStorage(e,t){const r=Et.storage.entries.value,n=r[e]?.type;if(tn(n)){const i=this.storeManager?.getStore(rr[n]),s=r[e]?.key;t&&(_(t)||B(t))?Et.serverCookies.isEnabledServerSideCookies.value&&n===Qt?(this.serverSideCookieDebounceFuncs[e]&&globalThis.clearTimeout(this.serverSideCookieDebounceFuncs[e]),this.serverSideCookieDebounceFuncs[e]=globalThis.setTimeout((()=>{this.setServerSideCookies([{name:s,value:t}],((e,t)=>{i?.set(e,t)}),i)}),10)):i?.set(s,t):i?.remove(s)}}registerEffects(){tr.forEach((e=>{$e((()=>{this.syncValueToStorage(e,Et.session[e].value)}))}))}setAnonymousId(e,t){let r=e;if(this.isPersistenceEnabledForStorageEntry("anonymousId")){if(!r&&t){const e=this.pluginsManager?.invokeSingle("userSession.anonymousIdGoogleLinker",t);r=e}r=r||rn()}else r=lt.anonymousId;Et.session.anonymousId.value=r}getAnonymousId(e){const t=Et.storage.entries.value.anonymousId?.type;if(tn(t)){let t=this.getEntryValue("anonymousId");if(!t&&e){const r=this.pluginsManager?.invokeSingle("storage.getAnonymousId",kr,e);t=r}Et.session.anonymousId.value=t||rn()}return Et.session.anonymousId.value}getEntryValue(e){const t=Et.storage.entries.value,r=t[e]?.type;if(tn(r)){const n=this.storeManager?.getStore(rr[r]),i=t[e]?.key;return n?.get(i)??null}return null}getExternalAnonymousIdByCookieName(e){const t=kr(Qt);return t?.isEnabled?t.getItem(e)??null:null}getUserId(){return this.getEntryValue("userId")}getUserTraits(){return this.getEntryValue("userTraits")}getGroupId(){return this.getEntryValue("groupId")}getGroupTraits(){return this.getEntryValue("groupTraits")}getInitialReferrer(){return this.getEntryValue("initialReferrer")}getInitialReferringDomain(){return this.getEntryValue("initialReferringDomain")}getSessionInfo(){return this.getEntryValue("sessionInfo")}getAuthToken(){return this.getEntryValue("authToken")}getSessionId(){const e=this.getSessionInfo()??lt.sessionInfo;return e.autoTrack&&!Yr(e.expiresAt)||e.manualTrack?e.id??null:null}refreshSession(){let e=this.getSessionInfo()??lt.sessionInfo;(e.autoTrack||e.manualTrack)&&(e.autoTrack&&(this.startOrRenewAutoTracking(e),e=Et.session.sessionInfo.value),void 0===e.sessionStart?e={...e,sessionStart:!0}:e.sessionStart&&(e={...e,sessionStart:!1})),Et.session.sessionInfo.value=e,"readyExecuted"!==Et.lifecycle.status.value&&this.syncValueToStorage("sessionInfo",e)}reset(e,t){const{session:r}=Et,{manualTrack:n,autoTrack:i}=r.sessionInfo.value;me((()=>{r.userId.value=lt.userId,r.userTraits.value=lt.userTraits,r.groupId.value=lt.groupId,r.groupTraits.value=lt.groupTraits,r.authToken.value=lt.authToken,e&&this.setAnonymousId(),t||(i?(r.sessionInfo.value=lt.sessionInfo,this.startOrRenewAutoTracking(r.sessionInfo.value)):n&&this.startManualTrackingInternal())}))}setUserId(e){Et.session.userId.value=this.isPersistenceEnabledForStorageEntry("userId")&&e?e:lt.userId}setUserTraits(e){Et.session.userTraits.value=this.isPersistenceEnabledForStorageEntry("userTraits")&&e?R(Et.session.userTraits.value??lt.userTraits,e):lt.userTraits}setGroupId(e){Et.session.groupId.value=this.isPersistenceEnabledForStorageEntry("groupId")&&e?e:lt.groupId}setGroupTraits(e){Et.session.groupTraits.value=this.isPersistenceEnabledForStorageEntry("groupTraits")&&e?R(Et.session.groupTraits.value??lt.groupTraits,e):lt.groupTraits}setInitialReferrer(e){Et.session.initialReferrer.value=this.isPersistenceEnabledForStorageEntry("initialReferrer")&&e?e:lt.initialReferrer}setInitialReferringDomain(e){Et.session.initialReferringDomain.value=this.isPersistenceEnabledForStorageEntry("initialReferringDomain")&&e?e:lt.initialReferringDomain}startOrRenewAutoTracking(e){if(Yr(e.expiresAt))Et.session.sessionInfo.value=(e=>{const t=Date.now(),r=e||se;return{id:t,expiresAt:t+r,timeout:r,sessionStart:void 0,autoTrack:!0}})(e.timeout);else{const t=Date.now(),r=e.timeout;Et.session.sessionInfo.value=R(e,{expiresAt:t+r})}}start(e){Et.session.sessionInfo.value=((e,t)=>({id:en(e,t)?e:Date.now(),sessionStart:void 0,manualTrack:!0}))(e,this.logger)}startManualTrackingInternal(){this.start(Date.now())}end(){Et.session.sessionInfo.value=lt.sessionInfo}setAuthToken(e){Et.session.authToken.value=this.isPersistenceEnabledForStorageEntry("authToken")&&e?e:lt.authToken}}const cn=["BeaconQueue","Bugsnag","CustomConsentManager","DeviceModeDestinations","DeviceModeTransformation","ErrorReporting","ExternalAnonymousId","GoogleLinker","KetchConsentManager","NativeDestinationQueue","OneTrustConsentManager","StorageEncryption","StorageEncryptionLegacy","StorageMigrator","XhrQueue"],dn="dataplaneEventsQueue",hn="destinationsEventsQueue";class gn{constructor(e,t,r,n){this.pluginsManager=e,this.errorHandler=r,this.logger=n,this.httpClient=new Kt(r,n),this.storeManager=t,this.onError=this.onError.bind(this)}init(){try{this.dataplaneEventsQueue=this.pluginsManager.invokeSingle(`${dn}.init`,Et,this.httpClient,this.storeManager,this.errorHandler,this.logger)}catch(e){this.onError(e,"XhrQueuePlugin initialization failed")}try{this.dmtEventsQueue=this.pluginsManager.invokeSingle("transformEvent.init",Et,this.pluginsManager,this.httpClient,this.storeManager,this.errorHandler,this.logger)}catch(e){this.onError(e,"DeviceModeTransformationPlugin initialization failed")}try{this.destinationsEventsQueue=this.pluginsManager.invokeSingle(`${hn}.init`,Et,this.pluginsManager,this.storeManager,this.dmtEventsQueue,this.errorHandler,this.logger)}catch(e){this.onError(e,"NativeDestinationQueuePlugin initialization failed")}$e((()=>{!0===Et.nativeDestinations.clientDestinationsReady.value&&(this.destinationsEventsQueue?.start(),this.dmtEventsQueue?.start())}));const e=(e=>e.consents.preConsent.value.enabled&&"buffer"===e.consents.preConsent.value.events?.delivery&&("session"===e.consents.preConsent.value.storage?.strategy||"none"===e.consents.preConsent.value.storage?.strategy))(Et);let t;$e((()=>{const r=!0===Et.loadOptions.value.bufferDataPlaneEventsUntilReady&&!1===Et.nativeDestinations.clientDestinationsReady.value;!1!==Et.nativeDestinations.activeDestinations.value.some((e=>{return t=e,Boolean("hybrid"===t.config.connectionMode||!0===t.config.useNativeSDKToSend);var t}))&&!1!==r||e||!0===this.dataplaneEventsQueue?.scheduleTimeoutActive||(globalThis.clearTimeout(t),this.dataplaneEventsQueue?.start())})),!0===Et.loadOptions.value.bufferDataPlaneEventsUntilReady&&(t=globalThis.setTimeout((()=>{!0!==this.dataplaneEventsQueue?.scheduleTimeoutActive&&this.dataplaneEventsQueue?.start()}),Et.loadOptions.value.dataPlaneEventsBufferTimeout))}resume(){!0!==this.dataplaneEventsQueue?.scheduleTimeoutActive&&(Et.consents.postConsent.value.discardPreConsentEvents&&(this.dataplaneEventsQueue?.clear(),this.destinationsEventsQueue?.clear()),this.dataplaneEventsQueue?.start())}enqueue(e,t){let r;try{r=((e,t)=>{const r=g(e),n=e.integrations??Cr,i=t.nativeDestinations.integrationsConfig.value,s=((e,t)=>Object.keys(e).filter((r=>!0!==e[r]||!t[r])).reduce(((t,r)=>{const n=g(t);return n[r]=e[r],n}),{}))(n,i);return r.integrations=R(i,s),r})(e,Et),this.pluginsManager.invokeSingle(`${dn}.enqueue`,Et,this.dataplaneEventsQueue,r,this.errorHandler,this.logger)}catch(e){this.onError(e,"XhrQueuePlugin event enqueue failed")}try{const t=g(e);this.pluginsManager.invokeSingle(`${hn}.enqueue`,Et,this.destinationsEventsQueue,t,this.errorHandler,this.logger)}catch(e){this.onError(e,"NativeDestinationQueuePlugin event enqueue failed")}try{t?.(r)}catch(e){this.onError(e,"API Callback Invocation Failed")}}onError(e,t,r){if(!this.errorHandler)throw e;this.errorHandler.onError(e,"EventRepository",t,r)}}const fn=e=>{const t=new CustomEvent(e,{detail:{analyticsInstance:globalThis.rudderanalytics},bubbles:!0,cancelable:!0,composed:!0});globalThis.document.dispatchEvent(t)};class pn{constructor(){this.preloadBuffer=new De,this.initialized=!1,this.errorHandler=Tt,this.logger=Ue,this.externalSrcLoader=new pe(this.errorHandler,this.logger),this.capabilitiesManager=new Nr(this.errorHandler,this.logger),this.httpClient=Gt}load(e,t,r={}){if(Et.lifecycle.status.value)return;let n=g(t),i=g(r);P(t)&&(i=t,n=void 0),me((()=>{Et.lifecycle.writeKey.value=e,Et.lifecycle.dataPlaneUrl.value=n,Et.loadOptions.value=((e,t)=>{const r=g(t);return _(r.setCookieDomain)||delete r.setCookieDomain,["Strict","Lax","None"].includes(r.sameSiteCookie)||delete r.sameSiteCookie,r.secureCookie=!0===r.secureCookie,["none","default","full"].includes(r.uaChTrackLevel)||delete r.uaChTrackLevel,C(r.integrations)||delete r.integrations,r.plugins=r.plugins??cn,r.useGlobalIntegrationsConfigInEvents=!0===r.useGlobalIntegrationsConfigInEvents,r.bufferDataPlaneEventsUntilReady=!0===r.bufferDataPlaneEventsUntilReady,r.sendAdblockPage=!0===r.sendAdblockPage,r.useServerSideCookies=!0===r.useServerSideCookies,r.dataServiceEndpoint&&"string"!=typeof r.dataServiceEndpoint&&delete r.dataServiceEndpoint,C(r.sendAdblockPageOptions)||delete r.sendAdblockPageOptions,A(r.loadIntegration)?r.loadIntegration=!0===r.loadIntegration:delete r.loadIntegration,C(r.storage)?(r.storage=$(r.storage),r.storage.migrate=!0===r.storage?.migrate):delete r.storage,C(r.beaconQueueOptions)?r.beaconQueueOptions=$(r.beaconQueueOptions):delete r.beaconQueueOptions,C(r.destinationsQueueOptions)?r.destinationsQueueOptions=$(r.destinationsQueueOptions):delete r.destinationsQueueOptions,C(r.queueOptions)?r.queueOptions=$(r.queueOptions):delete r.queueOptions,r.lockIntegrationsVersion=!0===r.lockIntegrationsVersion,r.lockPluginsVersion=!0===r.lockPluginsVersion,Xr(r.dataPlaneEventsBufferTimeout)||delete r.dataPlaneEventsBufferTimeout,C(r.storage?.cookie)?r.storage.cookie=$(r.storage?.cookie):delete r.storage?.cookie,C(r.preConsent)?r.preConsent=$(r.preConsent):delete r.preConsent,R(e,r)})(Et.loadOptions.value,i),Et.lifecycle.status.value="mounted"})),Et.loadOptions.value.logLevel&&this.logger?.setMinLogLevel(Et.loadOptions.value.logLevel),ae("state",Et,e),this.startLifecycle()}startLifecycle(){$e((()=>{try{switch(Et.lifecycle.status.value){case"mounted":this.onMounted();break;case"browserCapabilitiesReady":this.onBrowserCapabilitiesReady();break;case"configured":this.onConfigured();break;case"pluginsLoading":case"destinationsLoading":case"readyExecuted":default:break;case"pluginsReady":this.onPluginsReady();break;case"initialized":this.onInitialized();break;case"loaded":this.onLoaded();break;case"destinationsReady":this.onDestinationsReady();break;case"ready":this.onReady()}}catch(e){const t="Failed to load the SDK";this.errorHandler.onError(fe(e,t),X)}}))}onBrowserCapabilitiesReady(){(e=>{const t=((e,t="app")=>(oe(t),globalThis.RudderStackGlobals[t][e]))(te)||[];((e=[])=>{const t=new URLSearchParams(globalThis.location.search);t.get(ie)&&e.unshift(["track",t.get(ie),le(t,"ajs_prop_")]),t.get(ne)&&e.unshift(["identify",t.get(ne),le(t,"ajs_trait_")]),t.get(re)&&e.unshift(["setAnonymousId",t.get(re)])})(t),t.length>0&&(e.enqueuePreloadBufferEvents(t),ae(te,[]))})(this),this.prepareInternalServices(),this.loadConfig()}onLoaded(){this.processBufferedEvents(),!0===Et.consents.preConsent.value.enabled?Et.lifecycle.status.value="ready":this.loadDestinations()}onMounted(){this.capabilitiesManager.init()}enqueuePreloadBufferEvents(e){Array.isArray(e)&&e.forEach((e=>this.preloadBuffer.enqueue(g(e))))}processDataInPreloadBuffer(){for(;this.preloadBuffer.size()>0;){const e=this.preloadBuffer.dequeue();e&&ue([...e],this)}}prepareInternalServices(){this.pluginsManager=new Ut(At,this.errorHandler,this.logger),this.storeManager=new Sr(this.pluginsManager,this.errorHandler,this.logger),this.configManager=new $r(this.httpClient,this.errorHandler,this.logger),this.userSessionManager=new un(this.errorHandler,this.logger,this.pluginsManager,this.storeManager,this.httpClient),this.eventRepository=new gn(this.pluginsManager,this.storeManager,this.errorHandler,this.logger),this.eventManager=new ln(this.eventRepository,this.userSessionManager,this.errorHandler,this.logger)}loadConfig(){Et.lifecycle.writeKey.value&&this.httpClient.setAuthHeader(Et.lifecycle.writeKey.value),this.configManager?.init()}onPluginsReady(){this.errorHandler.init(this.externalSrcLoader),this.storeManager?.init(),this.userSessionManager?.init(),Et.consents.enabled.value&&!Et.consents.initialized.value&&(this.pluginsManager?.invokeSingle("consentManager.init",Et,this.logger),!1===Et.consents.preConsent.value.enabled&&this.pluginsManager?.invokeSingle("consentManager.updateConsentsInfo",Et,this.storeManager,this.logger)),this.eventManager?.init(),Et.lifecycle.status.value="initialized"}onConfigured(){this.pluginsManager?.init()}onInitialized(){this.processDataInPreloadBuffer(),k(Et.loadOptions.value.onLoaded)&&Et.loadOptions.value.onLoaded(globalThis.rudderanalytics),me((()=>{Et.lifecycle.loaded.value=!0,Et.lifecycle.status.value="loaded"})),this.initialized=!0,fn("RSA_Initialised")}onReady(){Et.lifecycle.status.value="readyExecuted",Et.eventBuffer.readyCallbacksArray.value.forEach((e=>{try{e()}catch(e){this.errorHandler.onError(e,X,Ke)}})),fn("RSA_Ready")}processBufferedEvents(){let e=Et.eventBuffer.toBeProcessedArray.value;for(;e.length>0;){const t=e.shift();if(Et.eventBuffer.toBeProcessedArray.value=e,t){const e=t[0];k(this[e])&&this[e](...t.slice(1),!0)}e=Et.eventBuffer.toBeProcessedArray.value}}loadDestinations(){if(Et.nativeDestinations.clientDestinationsReady.value)return;this.pluginsManager?.invokeSingle("nativeDestinations.setActiveDestinations",Et,this.pluginsManager,this.errorHandler,this.logger);const e=Et.nativeDestinations.activeDestinations.value.length;0!==e?(Et.lifecycle.status.value="destinationsLoading",this.pluginsManager?.invokeSingle("nativeDestinations.load",Et,this.externalSrcLoader,this.errorHandler,this.logger),$e((()=>{(0===e||Et.nativeDestinations.initializedDestinations.value.length+Et.nativeDestinations.failedDestinations.value.length===e)&&me((()=>{Et.lifecycle.status.value="destinationsReady",Et.nativeDestinations.clientDestinationsReady.value=!0}))}))):Et.lifecycle.status.value="destinationsReady"}onDestinationsReady(){"ready"!==Et.lifecycle.status.value&&(Et.lifecycle.status.value="ready")}ready(e,t=!1){const r="ready";if(Et.lifecycle.loaded.value)if(this.errorHandler.leaveBreadcrumb(`New ${r} invocation`),k(e))if("readyExecuted"===Et.lifecycle.status.value)try{e()}catch(e){this.errorHandler.onError(e,X,Ke)}else Et.eventBuffer.readyCallbacksArray.value=[...Et.eventBuffer.readyCallbacksArray.value,e];else this.logger.error(`readyApi${ce}The callback is not a function.`);else Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}page(e,t=!1){const r="page";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${r} event`),Et.metrics.triggered.value+=1,this.eventManager?.addEvent({type:"page",category:e.category,name:e.name,properties:e.properties,options:e.options,callback:e.callback}),!0===Et.capabilities.isAdBlocked.value&&e.category!==ee&&this.page(j(ee,"ad-block page request",{path:"/ad-blocked"},Et.loadOptions.value.sendAdblockPageOptions))):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}track(e,t=!1){const r="track";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${r} event`),Et.metrics.triggered.value+=1,this.eventManager?.addEvent({type:r,name:e.name||void 0,properties:e.properties,options:e.options,callback:e.callback})):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}identify(e,t=!1){const r="identify";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${r} event`),Et.metrics.triggered.value+=1,Boolean(e.userId&&Et.session.userId.value&&e.userId!==Et.session.userId.value)&&this.reset(),S(e.userId)||this.userSessionManager?.setUserId(e.userId),this.userSessionManager?.setUserTraits(e.traits),this.eventManager?.addEvent({type:r,userId:e.userId,traits:e.traits,options:e.options,callback:e.callback})):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}alias(e,t=!1){const r="alias";if(!Et.lifecycle.loaded.value)return void(Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]);this.errorHandler.leaveBreadcrumb(`New ${r} event`),Et.metrics.triggered.value+=1;const n=e.from??this.userSessionManager?.getUserId()??this.userSessionManager?.getAnonymousId();this.eventManager?.addEvent({type:r,to:e.to,from:n,options:e.options,callback:e.callback})}group(e,t=!1){const r="group";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${r} event`),Et.metrics.triggered.value+=1,S(e.groupId)||this.userSessionManager?.setGroupId(e.groupId),this.userSessionManager?.setGroupTraits(e.traits),this.eventManager?.addEvent({type:r,groupId:e.groupId,traits:e.traits,options:e.options,callback:e.callback})):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}reset(e,t=!1){const r="reset";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${r} invocation, resetAnonymousId: ${e}`),this.userSessionManager?.reset(e)):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}getAnonymousId(e){return this.userSessionManager?.getAnonymousId(e)}setAnonymousId(e,t,r=!1){const n="setAnonymousId";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${n} invocation`),this.userSessionManager?.setAnonymousId(e,t)):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[n,e,t]]}getUserId(){return Et.session.userId.value}getUserTraits(){return Et.session.userTraits.value}getGroupId(){return Et.session.groupId.value}getGroupTraits(){return Et.session.groupTraits.value}startSession(e,t=!1){const r="startSession";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${r} invocation`),this.userSessionManager?.start(e)):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[r,e]]}endSession(e=!1){const t="endSession";Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb(`New ${t} invocation`),this.userSessionManager?.end()):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,[t]]}getSessionId(){const e=this.userSessionManager?.getSessionId();return e??null}consent(e,t=!1){Et.lifecycle.loaded.value?(this.errorHandler.leaveBreadcrumb("New consent invocation"),me((()=>{Et.consents.preConsent.value={...Et.consents.preConsent.value,enabled:!1},Et.consents.postConsent.value=(e=>{const t={sendPageEvent:!1,trackConsent:!1,discardPreConsentEvents:!1};if(C(e)){const r=g(e);t.storage=r.storage,A(r.integrations)&&(t.integrations=C(r.integrations)?r.integrations:Cr),t.discardPreConsentEvents=!0===r.discardPreConsentEvents,t.sendPageEvent=!0===r.sendPageEvent,t.trackConsent=!0===r.trackConsent,B(r.consentManagement)&&(t.consentManagement=R(r.consentManagement,{enabled:Et.consents.enabled.value}))}return t})(e);const{initialized:t,consentsData:r}=Rr(Et.consents.postConsent.value.consentManagement,this.logger);Et.consents.initialized.value=t||Et.consents.initialized.value,Et.consents.data.value=r})),Et.consents.enabled.value&&!Et.consents.initialized.value&&this.pluginsManager?.invokeSingle("consentManager.updateConsentsInfo",Et,this.storeManager,this.logger),this.storeManager?.initializeStorageState(),this.userSessionManager?.syncStorageDataToState(),this.eventManager?.resume(),this.loadDestinations(),this.sendTrackingEvents(t)):Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,["consent",e]]}sendTrackingEvents(e){if(Et.consents.postConsent.value.trackConsent){const t=L("Consent Management Interaction");e?Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,["track",t]]:this.track(t)}if(Et.consents.postConsent.value.sendPageEvent){const t=j();e?Et.eventBuffer.toBeProcessedArray.value=[...Et.eventBuffer.toBeProcessedArray.value,["page",t]]:this.page(t)}}setAuthToken(e){this.userSessionManager?.setAuthToken(e)}}class vn{static globalSingleton=null;analyticsInstances={};defaultAnalyticsKey="";logger=Ue;constructor(){if(vn.globalSingleton)return vn.globalSingleton;Tt.attachErrorListeners(),this.setDefaultInstanceKey=this.setDefaultInstanceKey.bind(this),this.getAnalyticsInstance=this.getAnalyticsInstance.bind(this),this.load=this.load.bind(this),this.ready=this.ready.bind(this),this.triggerBufferedLoadEvent=this.triggerBufferedLoadEvent.bind(this),this.page=this.page.bind(this),this.track=this.track.bind(this),this.identify=this.identify.bind(this),this.alias=this.alias.bind(this),this.group=this.group.bind(this),this.reset=this.reset.bind(this),this.getAnonymousId=this.getAnonymousId.bind(this),this.setAnonymousId=this.setAnonymousId.bind(this),this.getUserId=this.getUserId.bind(this),this.getUserTraits=this.getUserTraits.bind(this),this.getGroupId=this.getGroupId.bind(this),this.getGroupTraits=this.getGroupTraits.bind(this),this.startSession=this.startSession.bind(this),this.endSession=this.endSession.bind(this),this.getSessionId=this.getSessionId.bind(this),this.setAuthToken=this.setAuthToken.bind(this),this.consent=this.consent.bind(this),vn.globalSingleton=this,this.triggerBufferedLoadEvent(),globalThis.rudderanalytics=this}setDefaultInstanceKey(e){e&&(this.defaultAnalyticsKey=e)}getAnalyticsInstance(e){const t=e??this.defaultAnalyticsKey;return Boolean(this.analyticsInstances[t])||(this.analyticsInstances[t]=new pn),this.analyticsInstances[t]}load(e,t,r){_(e)?this.analyticsInstances[e]||(this.setDefaultInstanceKey(e),this.analyticsInstances[e]=new pn,this.getAnalyticsInstance(e).load(e,t,r)):this.logger.error(((e,t)=>`${e}${ce}The write key "${t}" is not a string. Please check that the write key is correct and try again.`)(W,e))}triggerBufferedLoadEvent(){const e=Array.isArray(globalThis.rudderanalytics)?globalThis.rudderanalytics:[];(e=>{const t="consent",r=e.filter((e=>e[0]===t)),n=e.filter((e=>e[0]!==t));e.splice(0,e.length,...r,...n)})(e);const t=(e=>{let t=[],r=0;for(;r<e.length;){if(e[r]&&"load"===e[r][0]){t=g(e[r]),e.splice(r,1);break}r+=1}return t})(e);ae(te,g(e)),t.length>0&&(t.shift(),this.load.apply(null,t))}ready(e){this.getAnalyticsInstance().ready(e)}page(e,t,r,n,i){this.getAnalyticsInstance().page(j(e,t,r,n,i))}track(e,t,r,n){this.getAnalyticsInstance().track(L(e,t,r,n))}identify(e,t,r,n){this.getAnalyticsInstance().identify(U(e,t,r,n))}alias(e,t,r,n){this.getAnalyticsInstance().alias(N(e,t,r,n))}group(e,t,r,n){0!==arguments.length?this.getAnalyticsInstance().group(F(e,t,r,n)):this.logger.error(`${W}${ce}The group() method must be called with at least one argument.`)}reset(e){this.getAnalyticsInstance().reset(e)}getAnonymousId(e){return this.getAnalyticsInstance().getAnonymousId(e)}setAnonymousId(e,t){this.getAnalyticsInstance().setAnonymousId(e,t)}getUserId(){return this.getAnalyticsInstance().getUserId()}getUserTraits(){return this.getAnalyticsInstance().getUserTraits()}getGroupId(){return this.getAnalyticsInstance().getGroupId()}getGroupTraits(){return this.getAnalyticsInstance().getGroupTraits()}startSession(e){return this.getAnalyticsInstance().startSession(e)}endSession(){return this.getAnalyticsInstance().endSession()}getSessionId(){return this.getAnalyticsInstance().getSessionId()}setAuthToken(e){return this.getAnalyticsInstance().setAuthToken(e)}consent(e){return this.getAnalyticsInstance().consent(e)}}t.RudderAnalytics=vn},591:(e,t,r)=>{"use strict";r.r(t),r.d(t,{connectGlobalObserver:()=>M,default:()=>N,disconnectGlobalObserver:()=>B,validAttributeName:()=>n});var n=/^[a-zA-Z:_][a-zA-Z0-9:_.-]*$/,i={revert:function(){}},s=new Map,o=new Set;function a(e){var t=s.get(e);return t||(t={element:e,attributes:{}},s.set(e,t)),t}function l(e,t,r,n,i){var s=r(e),o={isDirty:!1,originalValue:s,virtualValue:s,mutations:[],el:e,_positionTimeout:null,observer:new MutationObserver((function(){if("position"!==t||!o._positionTimeout){"position"===t&&(o._positionTimeout=setTimeout((function(){o._positionTimeout=null}),1e3));var n=r(e);"position"===t&&n.parentNode===o.virtualValue.parentNode&&n.insertBeforeNode===o.virtualValue.insertBeforeNode||n!==o.virtualValue&&(o.originalValue=n,i(o))}})),mutationRunner:i,setValue:n,getCurrentValue:r};return"position"===t&&e.parentNode?o.observer.observe(e.parentNode,{childList:!0,subtree:!0,attributes:!1,characterData:!1}):o.observer.observe(e,function(e){return"html"===e?{childList:!0,subtree:!0,attributes:!0,characterData:!0}:{childList:!1,subtree:!1,attributes:!0,attributeFilter:[e]}}(t)),o}function u(e,t){var r=t.getCurrentValue(t.el);t.virtualValue=e,e&&"string"!=typeof e?r&&e.parentNode===r.parentNode&&e.insertBeforeNode===r.insertBeforeNode||(t.isDirty=!0,C()):e!==r&&(t.isDirty=!0,C())}function c(e){var t=e.originalValue;e.mutations.forEach((function(e){return t=e.mutate(t)})),u(function(e){return w||(w=document.createElement("div")),w.innerHTML=e,w.innerHTML}(t),e)}function d(e){var t=new Set(e.originalValue.split(/\s+/).filter(Boolean));e.mutations.forEach((function(e){return e.mutate(t)})),u(Array.from(t).filter(Boolean).join(" "),e)}function h(e){var t=e.originalValue;e.mutations.forEach((function(e){return t=e.mutate(t)})),u(t,e)}function g(e){var t=e.originalValue;e.mutations.forEach((function(e){var r=function(e){var t=e.parentSelector,r=e.insertBeforeSelector,n=document.querySelector(t);if(!n)return null;var i=r?document.querySelector(r):null;return r&&!i?null:{parentNode:n,insertBeforeNode:i}}(e.mutate());t=r||t})),u(t,e)}var f=function(e){return e.innerHTML},p=function(e,t){return e.innerHTML=t};function v(e){var t=a(e);return t.html||(t.html=l(e,"html",f,p,c)),t.html}var y=function(e){return{parentNode:e.parentElement,insertBeforeNode:e.nextElementSibling}},m=function(e,t){t.insertBeforeNode&&!t.parentNode.contains(t.insertBeforeNode)||t.parentNode.insertBefore(e,t.insertBeforeNode)};function b(e){var t=a(e);return t.position||(t.position=l(e,"position",y,m,g)),t.position}var k=function(e,t){return t?e.className=t:e.removeAttribute("class")},_=function(e){return e.className};function S(e){var t=a(e);return t.classes||(t.classes=l(e,"class",_,k,d)),t.classes}var w,E,A=function(e){return function(t){var r;return null!=(r=t.getAttribute(e))?r:null}},I=function(e){return function(t,r){return null!==r?t.setAttribute(e,r):t.removeAttribute(e)}};function x(e,t){var r=a(e);return r.attributes[t]||(r.attributes[t]=l(e,t,A(t),I(t),h)),r.attributes[t]}function T(e,t,r){if(r.isDirty){r.isDirty=!1;var n=r.virtualValue;r.mutations.length||function(e,t){var r,n,i=s.get(e);if(i)if("html"===t)null==(r=i.html)||null==(n=r.observer)||n.disconnect(),delete i.html;else if("class"===t){var o,a;null==(o=i.classes)||null==(a=o.observer)||a.disconnect(),delete i.classes}else if("position"===t){var l,u;null==(l=i.position)||null==(u=l.observer)||u.disconnect(),delete i.position}else{var c,d,h;null==(c=i.attributes)||null==(d=c[t])||null==(h=d.observer)||h.disconnect(),delete i.attributes[t]}}(e,t),r.setValue(e,n)}}function P(e,t){e.html&&T(t,"html",e.html),e.classes&&T(t,"class",e.classes),e.position&&T(t,"position",e.position),Object.keys(e.attributes).forEach((function(r){T(t,r,e.attributes[r])}))}function C(){s.forEach(P)}function O(e){if("position"!==e.kind||1!==e.elements.size){var t=new Set(e.elements);document.querySelectorAll(e.selector).forEach((function(r){t.has(r)||(e.elements.add(r),function(e,t){var r=null;"html"===e.kind?r=v(t):"class"===e.kind?r=S(t):"attribute"===e.kind?r=x(t,e.attribute):"position"===e.kind&&(r=b(t)),r&&(r.mutations.push(e),r.mutationRunner(r))}(e,r))}))}}function R(){o.forEach(O)}function B(){E&&E.disconnect()}function M(){"undefined"!=typeof document&&(E||(E=new MutationObserver((function(){R()}))),R(),E.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!1,characterData:!1}))}function $(e){return"undefined"==typeof document?i:(o.add(e),O(e),{revert:function(){var t;(t=e).elements.forEach((function(e){return function(e,t){var r=null;if("html"===e.kind?r=v(t):"class"===e.kind?r=S(t):"attribute"===e.kind?r=x(t,e.attribute):"position"===e.kind&&(r=b(t)),r){var n=r.mutations.indexOf(e);-1!==n&&r.mutations.splice(n,1),r.mutationRunner(r)}}(t,e)})),t.elements.clear(),o.delete(t)}})}function D(e,t){return $({kind:"html",elements:new Set,mutate:t,selector:e})}function j(e,t){return $({kind:"position",elements:new Set,mutate:t,selector:e})}function L(e,t){return $({kind:"class",elements:new Set,mutate:t,selector:e})}function U(e,t,r){return n.test(t)?"class"===t||"className"===t?L(e,(function(e){var t=r(Array.from(e).join(" "));e.clear(),t&&t.split(/\s+/g).filter(Boolean).forEach((function(t){return e.add(t)}))})):$({kind:"attribute",attribute:t,elements:new Set,mutate:r,selector:e}):i}M();const N={html:D,classes:L,attribute:U,position:j,declarative:function(e){var t=e.selector,r=e.action,n=e.value,s=e.attribute,o=e.parentSelector,a=e.insertBeforeSelector;if("html"===s){if("append"===r)return D(t,(function(e){return e+(null!=n?n:"")}));if("set"===r)return D(t,(function(){return null!=n?n:""}))}else if("class"===s){if("append"===r)return L(t,(function(e){n&&e.add(n)}));if("remove"===r)return L(t,(function(e){n&&e.delete(n)}));if("set"===r)return L(t,(function(e){e.clear(),n&&e.add(n)}))}else if("position"===s){if("set"===r&&o)return j(t,(function(){return{insertBeforeSelector:a,parentSelector:o}}))}else{if("append"===r)return U(t,s,(function(e){return null!==e?e+(null!=n?n:""):null!=n?n:""}));if("set"===r)return U(t,s,(function(){return null!=n?n:""}));if("remove"===r)return U(t,s,(function(){return null}))}return i}}},733:function(e){e.exports=function(){"use strict";function e(e){for(var t=1;t<arguments.length;t++){var r=arguments[t];for(var n in r)e[n]=r[n]}return e}return function t(r,n){function i(t,i,s){if("undefined"!=typeof document){"number"==typeof(s=e({},n,s)).expires&&(s.expires=new Date(Date.now()+864e5*s.expires)),s.expires&&(s.expires=s.expires.toUTCString()),t=encodeURIComponent(t).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape);var o="";for(var a in s)s[a]&&(o+="; "+a,!0!==s[a]&&(o+="="+s[a].split(";")[0]));return document.cookie=t+"="+r.write(i,t)+o}}return Object.create({set:i,get:function(e){if("undefined"!=typeof document&&(!arguments.length||e)){for(var t=document.cookie?document.cookie.split("; "):[],n={},i=0;i<t.length;i++){var s=t[i].split("="),o=s.slice(1).join("=");try{var a=decodeURIComponent(s[0]);if(n[a]=r.read(o,a),e===a)break}catch(e){}}return e?n[e]:n}},remove:function(t,r){i(t,"",e({},r,{expires:-1}))},withAttributes:function(r){return t(this.converter,e({},this.attributes,r))},withConverter:function(r){return t(e({},this.converter,r),this.attributes)}},{attributes:{value:Object.freeze(n)},converter:{value:Object.freeze(r)}})}({read:function(e){return'"'===e[0]&&(e=e.slice(1,-1)),e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent)},write:function(e){return encodeURIComponent(e).replace(/%(2[346BF]|3[AC-F]|40|5[BDE]|60|7[BCD])/g,decodeURIComponent)}},{path:"/"})}()},396:function(e,t,r){"use strict";var n=this&&this.__assign||function(){return n=Object.assign||function(e){for(var t,r=1,n=arguments.length;r<n;r++)for(var i in t=arguments[r])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},n.apply(this,arguments)},i=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))((function(i,s){function o(e){try{l(n.next(e))}catch(e){s(e)}}function a(e){try{l(n.throw(e))}catch(e){s(e)}}function l(e){var t;e.done?i(e.value):(t=e.value,t instanceof r?t:new r((function(e){e(t)}))).then(o,a)}l((n=n.apply(e,t||[])).next())}))},s=this&&this.__generator||function(e,t){var r,n,i,s,o={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return s={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(s[Symbol.iterator]=function(){return this}),s;function a(a){return function(l){return function(a){if(r)throw new TypeError("Generator is already executing.");for(;s&&(s=0,a[0]&&(o=0)),o;)try{if(r=1,n&&(i=2&a[0]?n.return:a[0]?n.throw||((i=n.return)&&i.call(n),0):n.next)&&!(i=i.call(n,a[1])).done)return i;switch(n=0,i&&(a=[2&a[0],i.value]),a[0]){case 0:case 1:i=a;break;case 4:return o.label++,{value:a[1],done:!1};case 5:o.label++,n=a[1],a=[0];continue;case 7:a=o.ops.pop(),o.trys.pop();continue;default:if(!((i=(i=o.trys).length>0&&i[i.length-1])||6!==a[0]&&2!==a[0])){o=0;continue}if(3===a[0]&&(!i||a[1]>i[0]&&a[1]<i[3])){o.label=a[1];break}if(6===a[0]&&o.label<i[1]){o.label=i[1],i=a;break}if(i&&o.label<i[2]){o.label=i[2],o.ops.push(a);break}i[2]&&o.ops.pop(),o.trys.pop();continue}a=t.call(e,o)}catch(e){a=[6,e],n=0}finally{r=i=0}if(5&a[0])throw a[1];return{value:a[0]?a[1]:void 0,done:!0}}([a,l])}}},o=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.Analytics=t.createAnalyticsInstance=void 0;var a=r(316),l=r(706),u=o(r(733));function c(e){var t,r,o=this,c={},d={},h=[],g=function(e,r){return null==t?void 0:t.getFeatureValue(e,r)},f=function(){return(null==r?void 0:r.getUserId())||""},p={initialise:function(e){var h=e.growthbookKey,f=e.growthbookDecryptionKey,p=e.rudderstackKey,v=e.growthbookOptions,y=e.disableRudderstackAMD,m=void 0!==y&&y;return i(o,void 0,void 0,(function(){var e,i,o,y,b,k,_,S,w,E,A,I,x,T,P,C,O,R,B,M,$,D,j,L,U,N,F;return s(this,(function(s){switch(s.label){case 0:e="",s.label=1;case 1:return s.trys.push([1,5,,6]),[4,fetch("https://www.cloudflare.com/cdn-cgi/trace")];case 2:return(i=s.sent()).ok?[4,null==i?void 0:i.text()]:[3,4];case 3:o=s.sent(),(y=Object.fromEntries(o.split("\n").map((function(e){return e.split("=",2)})))).loc?e=y.loc.toLowerCase():console.warn("Location not found in the response."),s.label=4;case 4:return[3,6];case 5:return b=s.sent(),console.warn("Cannot get the Cloudflare location:",b),[3,6];case 6:if(k=u.default.get("website_status"))try{_=JSON.parse(k)}catch(e){console.error("Failed to parse cookie: ",e)}try{S=u.default.get("clients_country")||(null==_?void 0:_.clients_country)||e,r=l.RudderStack.getRudderStackInstance(p,m),(null==v?void 0:v.attributes)&&Object.keys(v.attributes).length>0&&(c=n(n(n(n(n(n(n(n(n(n(n(n(n({},c),(null===(E=null==v?void 0:v.attributes)||void 0===E?void 0:E.country)&&{country:S}),(null===(A=null==v?void 0:v.attributes)||void 0===A?void 0:A.user_language)&&{user_language:null==v?void 0:v.attributes.user_language}),(null===(I=null==v?void 0:v.attributes)||void 0===I?void 0:I.account_type)&&{account_type:null==v?void 0:v.attributes.account_type}),(null===(x=null==v?void 0:v.attributes)||void 0===x?void 0:x.app_id)&&{app_id:null==v?void 0:v.attributes.app_id}),(null===(T=null==v?void 0:v.attributes)||void 0===T?void 0:T.residence_country)&&{residence_country:null===(P=null==v?void 0:v.attributes)||void 0===P?void 0:P.residence_country}),(null===(C=null==v?void 0:v.attributes)||void 0===C?void 0:C.device_type)&&{device_type:null==v?void 0:v.attributes.device_type}),(null===(O=null==v?void 0:v.attributes)||void 0===O?void 0:O.url)&&{url:null==v?void 0:v.attributes.url}),(null==v?void 0:v.attributes)&&{loggedIn:!!(null===(R=null==v?void 0:v.attributes)||void 0===R?void 0:R.loggedIn)}),(null===(B=null==v?void 0:v.attributes)||void 0===B?void 0:B.email_hash)&&{email_hash:null==v?void 0:v.attributes.email_hash}),(null===(M=null==v?void 0:v.attributes)||void 0===M?void 0:M.network_type)&&{network_type:null==v?void 0:v.attributes.network_type}),(null===($=null==v?void 0:v.attributes)||void 0===$?void 0:$.network_rtt)&&{network_rtt:null==v?void 0:v.attributes.network_rtt}),(null===(D=null==v?void 0:v.attributes)||void 0===D?void 0:D.network_downlink)&&{network_downlink:null==v?void 0:v.attributes.network_downlink})),null!=v||(v={}),null!==(j=v.attributes)&&void 0!==j||(v.attributes={}),null!==(L=(N=v.attributes).id)&&void 0!==L||(N.id=r.getAnonymousId()),null!==(U=(F=v.attributes).country)&&void 0!==U||(F.country=S),h&&(t=a.Growthbook.getGrowthBookInstance(h,f,v),w=setInterval((function(){Object.keys(d).length>0?clearInterval(w):d=g("tracking-buttons-config",{})}),1e3))}catch(e){console.log("Error in initializing analytics",e)}return[2]}}))}))},setAttributes:function(e){var i=e.country,s=e.user_language,o=e.device_language,a=e.device_type,l=e.account_type,u=e.user_id,d=e.app_id,h=e.utm_source,g=e.utm_medium,p=e.utm_campaign,v=e.is_authorised,y=e.residence_country,m=e.url,b=e.domain,k=e.geo_location,_=e.loggedIn,S=e.network_downlink,w=e.network_rtt,E=e.network_type;if(t||r){var A=null!=u?u:f();if(t){var I={country:i,residence_country:y,user_language:s,device_language:o,device_type:a,utm_source:h,utm_medium:g,utm_campaign:p,is_authorised:v,url:m,domain:b,loggedIn:_};A&&(I.id=A),t.setAttributes(I)}c=n(n(n(n(n(n(n(n(n(n(n(n(n({},c),i&&{country:i}),k&&{geo_location:k}),s&&{user_language:s}),l&&{account_type:l}),d&&{app_id:d}),y&&{residence_country:y}),a&&{device_type:a}),m&&{url:m}),_&&{loggedIn:_}),S&&{network_downlink:S}),w&&{network_rtt:w}),E&&{network_type:E})}},identifyEvent:function(e){var t=e||f();r&&(null==r||r.identifyEvent(t,{language:(null==c?void 0:c.user_language)||"en"}))},getFeatureState:function(e){var r,n;return null===(n=null===(r=null==t?void 0:t.getFeatureState(e))||void 0===r?void 0:r.experimentResult)||void 0===n?void 0:n.name},getFeatureValue:g,getGrowthbookStatus:function(){return i(o,void 0,void 0,(function(){return s(this,(function(e){switch(e.label){case 0:return[4,null==t?void 0:t.getStatus()];case 1:return[2,e.sent()]}}))}))},isFeatureOn:function(e){return null==t?void 0:t.isOn(e)},setUrl:function(e){return null==t?void 0:t.setUrl(e)},getId:f,trackEvent:function(e,t){navigator.onLine&&r?(h.length>0&&h.forEach((function(e,t){r.track(e.event,e.payload),delete h[t]})),e in d?d[e]&&(null==r||r.track(e,n(n({},c),t))):null==r||r.track(e,n(n({},c),t))):h.push({event:e,payload:n(n({},c),t)})},getInstances:function(){return{ab:t,tracking:r}},pageView:function(e,t,n){void 0===t&&(t="Deriv App"),r&&(null==r||r.pageView(e,t,f(),n))},reset:function(){r&&(null==r||r.reset())}};return"undefined"!=typeof window&&(window.AnalyticsInstance=p),p}t.createAnalyticsInstance=c,t.Analytics=c()},316:function(e,t,r){"use strict";var n=this&&this.__assign||function(){return n=Object.assign||function(e){for(var t,r=1,n=arguments.length;r<n;r++)for(var i in t=arguments[r])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},n.apply(this,arguments)},i=this&&this.__awaiter||function(e,t,r,n){return new(r||(r=Promise))((function(i,s){function o(e){try{l(n.next(e))}catch(e){s(e)}}function a(e){try{l(n.throw(e))}catch(e){s(e)}}function l(e){var t;e.done?i(e.value):(t=e.value,t instanceof r?t:new r((function(e){e(t)}))).then(o,a)}l((n=n.apply(e,t||[])).next())}))},s=this&&this.__generator||function(e,t){var r,n,i,s,o={label:0,sent:function(){if(1&i[0])throw i[1];return i[1]},trys:[],ops:[]};return s={next:a(0),throw:a(1),return:a(2)},"function"==typeof Symbol&&(s[Symbol.iterator]=function(){return this}),s;function a(a){return function(l){return function(a){if(r)throw new TypeError("Generator is already executing.");for(;s&&(s=0,a[0]&&(o=0)),o;)try{if(r=1,n&&(i=2&a[0]?n.return:a[0]?n.throw||((i=n.return)&&i.call(n),0):n.next)&&!(i=i.call(n,a[1])).done)return i;switch(n=0,i&&(a=[2&a[0],i.value]),a[0]){case 0:case 1:i=a;break;case 4:return o.label++,{value:a[1],done:!1};case 5:o.label++,n=a[1],a=[0];continue;case 7:a=o.ops.pop(),o.trys.pop();continue;default:if(!((i=(i=o.trys).length>0&&i[i.length-1])||6!==a[0]&&2!==a[0])){o=0;continue}if(3===a[0]&&(!i||a[1]>i[0]&&a[1]<i[3])){o.label=a[1];break}if(6===a[0]&&o.label<i[1]){o.label=i[1],i=a;break}if(i&&o.label<i[2]){o.label=i[2],o.ops.push(a);break}i[2]&&o.ops.pop(),o.trys.pop();continue}a=t.call(e,o)}catch(e){a=[6,e],n=0}finally{r=i=0}if(5&a[0])throw a[1];return{value:a[0]?a[1]:void 0,done:!0}}([a,l])}}};Object.defineProperty(t,"__esModule",{value:!0}),t.Growthbook=void 0;var o=r(200),a=r(182),l=function(){function e(e,t,r){void 0===r&&(r={});var l=this;this.analytics=new a.RudderAnalytics,this.isLoaded=!1,this.status=void 0,this.setAttributes=function(e){var t=e.id,r=e.country,i=e.user_language,s=e.device_language,o=e.device_type,a=e.utm_source,u=e.utm_medium,c=e.utm_campaign,d=e.is_authorised,h=e.url,g=e.domain,f=e.utm_content,p=e.residence_country,v=e.loggedIn,y=l.GrowthBook.getAttributes();l.GrowthBook.setAttributes(n(n(n(n(n(n(n(n(n(n(n(n(n(n(n({},y),{id:t}),r&&{country:r}),p&&{residence_country:p}),i&&{user_language:i}),s&&{device_language:s}),o&&{device_type:o}),a&&{utm_source:a}),u&&{utm_medium:u}),c&&{utm_campaign:c}),d&&{is_authorised:d}),h&&{url:h}),g&&{domain:g}),f&&{utm_content:f}),v&&{loggedIn:v}))},this.getFeatureValue=function(e,t){return l.GrowthBook.getFeatureValue(e,t)},this.getStatus=function(){return i(l,void 0,void 0,(function(){return s(this,(function(e){switch(e.label){case 0:return[4,this.waitForIsLoaded()];case 1:return e.sent(),[2,{isLoaded:this.isLoaded,status:this.status}]}}))}))},this.getFeatureState=function(e){return l.GrowthBook.evalFeature(e)},this.setUrl=function(e){return l.GrowthBook.setURL(e)},this.isOn=function(e){return l.GrowthBook.isOn(e)},this.init=function(){return i(l,void 0,void 0,(function(){var e;return s(this,(function(t){switch(t.label){case 0:return[4,this.GrowthBook.init({timeout:2e3,streaming:!0}).catch((function(e){console.error(e)}))];case 1:return e=t.sent(),this.status=e,this.isLoaded=!0,[2]}}))}))},this.GrowthBook=new o.GrowthBook(n({apiHost:"https://cdn.growthbook.io",clientKey:e,decryptionKey:t,antiFlicker:!1,navigateDelay:0,antiFlickerTimeout:3500,subscribeToChanges:!0,enableDevMode:null===window||void 0===window?void 0:window.location.hostname.includes("localhost"),trackingCallback:function(e,t){window.dataLayer&&window.dataLayer.push({event:"experiment_viewed",event_category:"experiment",rudder_anonymous_id:l.analytics.getAnonymousId(),experiment_id:e.key,variation_id:t.variationId}),l.analytics.track("experiment_viewed",{experimentId:e.key,variationId:t.variationId})}},r)),this.init()}return e.prototype.waitForIsLoaded=function(){var e=this;return new Promise((function(t){var r=setInterval((function(){e.isLoaded&&(clearInterval(r),t())}),100)}))},e.getGrowthBookInstance=function(t,r,n){return e._instance||(e._instance=new e(t,null!=r?r:"",n)),e._instance},e}();t.Growthbook=l},706:function(e,t,r){"use strict";var n=this&&this.__importDefault||function(e){return e&&e.__esModule?e:{default:e}};Object.defineProperty(t,"__esModule",{value:!0}),t.RudderStack=void 0;var i=r(182),s=r(831),o=n(r(733)),a=function(){function e(e,t){void 0===t&&(t=!1);var r=this;this.analytics=new i.RudderAnalytics,this.has_identified=!1,this.has_initialized=!1,this.current_page="",this.rudderstack_anonymous_cookie_key="rudder_anonymous_id",this.getAnonymousId=function(){var e;return null===(e=document.cookie.match("(^|;)\\s*"+r.rudderstack_anonymous_cookie_key+"\\s*=\\s*([^;]+)"))||void 0===e?void 0:e.pop()},this.setCookieIfNotExists=function(){if(!r.getAnonymousId()){var e=window.location.hostname.split(".").slice(-2).join(".");document.cookie="".concat(r.rudderstack_anonymous_cookie_key,"=").concat((0,s.v6)(),"; path=/; Domain=").concat(e)}},this.getUserId=function(){return r.analytics.getUserId()},this.handleCachedEvents=function(){var e=o.default.get("cached_analytics_events"),t=o.default.get("cached_analytics_page_views");try{if(e){var n=JSON.parse(e);Array.isArray(n)&&n.length>0&&(n.forEach((function(e){r.analytics.track(e.name,e.properties)})),o.default.remove("cached_analytics_events",{domain:".deriv.com"}))}if(t){var i=JSON.parse(t);Array.isArray(i)&&i.length>0&&(i.forEach((function(e){r.analytics.page(null==e?void 0:e.name,null==e?void 0:e.properties)})),o.default.remove("cached_analytics_page_views",{domain:".deriv.com"}))}}catch(e){console.log(e)}},this.init=function(e,t){var n;void 0===t&&(t=!1),e&&(t&&(n=window.define,window.define=void 0),r.setCookieIfNotExists(),r.analytics.load(e,"https://deriv-dataplane.rudderstack.com",{externalAnonymousIdCookieName:r.rudderstack_anonymous_cookie_key}),r.analytics.ready((function(){t&&(window.define=n),r.has_initialized=!0,r.has_identified=!(!r.getUserId()&&!r.getAnonymousId()),r.handleCachedEvents()})))},this.identifyEvent=function(e,t){r.analytics.identify(e,t),r.has_identified=!0},this.pageView=function(e,t,n,i){void 0===t&&(t="Deriv App"),r.has_initialized&&r.has_identified&&e!==r.current_page&&(r.analytics.page(t,e,{user_id:n},i),r.current_page=e)},this.reset=function(){r.has_initialized&&(r.analytics.reset(),r.has_identified=!1)},this.track=function(e,t){var n=Object.fromEntries(Object.entries(t).filter((function(e){return e[0],void 0!==e[1]})));if(r.has_initialized&&r.has_identified)try{r.analytics.track(e,n)}catch(e){console.error(e)}},this.init(e,t)}return e.getRudderStackInstance=function(t,r){return void 0===r&&(r=!1),e._instance||(e._instance=new e(t,r)),e._instance},e}();t.RudderStack=a},831:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"MAX",{enumerable:!0,get:function(){return n.default}}),Object.defineProperty(t,"NIL",{enumerable:!0,get:function(){return i.default}}),Object.defineProperty(t,"parse",{enumerable:!0,get:function(){return s.default}}),Object.defineProperty(t,"stringify",{enumerable:!0,get:function(){return o.default}}),Object.defineProperty(t,"v1",{enumerable:!0,get:function(){return a.default}}),Object.defineProperty(t,"v1ToV6",{enumerable:!0,get:function(){return l.default}}),Object.defineProperty(t,"v3",{enumerable:!0,get:function(){return u.default}}),Object.defineProperty(t,"v4",{enumerable:!0,get:function(){return c.default}}),Object.defineProperty(t,"v5",{enumerable:!0,get:function(){return d.default}}),Object.defineProperty(t,"v6",{enumerable:!0,get:function(){return h.default}}),Object.defineProperty(t,"v6ToV1",{enumerable:!0,get:function(){return g.default}}),Object.defineProperty(t,"v7",{enumerable:!0,get:function(){return f.default}}),Object.defineProperty(t,"validate",{enumerable:!0,get:function(){return p.default}}),Object.defineProperty(t,"version",{enumerable:!0,get:function(){return v.default}});var n=y(r(213)),i=y(r(808)),s=y(r(792)),o=y(r(910)),a=y(r(518)),l=y(r(343)),u=y(r(948)),c=y(r(73)),d=y(r(186)),h=y(r(671)),g=y(r(507)),f=y(r(744)),p=y(r(37)),v=y(r(775));function y(e){return e&&e.__esModule?e:{default:e}}},213:(e,t)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0,t.default="ffffffff-ffff-ffff-ffff-ffffffffffff"},311:(e,t)=>{"use strict";function r(e){return 14+(e+64>>>9<<4)+1}function n(e,t){var r=(65535&e)+(65535&t);return(e>>16)+(t>>16)+(r>>16)<<16|65535&r}function i(e,t,r,i,s,o){return n((a=n(n(t,e),n(i,o)))<<(l=s)|a>>>32-l,r);var a,l}function s(e,t,r,n,s,o,a){return i(t&r|~t&n,e,t,s,o,a)}function o(e,t,r,n,s,o,a){return i(t&n|r&~n,e,t,s,o,a)}function a(e,t,r,n,s,o,a){return i(t^r^n,e,t,s,o,a)}function l(e,t,r,n,s,o,a){return i(r^(t|~n),e,t,s,o,a)}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0,t.default=function(e){if("string"==typeof e){var t=unescape(encodeURIComponent(e));e=new Uint8Array(t.length);for(var i=0;i<t.length;++i)e[i]=t.charCodeAt(i)}return function(e){for(var t=[],r=32*e.length,n="0123456789abcdef",i=0;i<r;i+=8){var s=e[i>>5]>>>i%32&255,o=parseInt(n.charAt(s>>>4&15)+n.charAt(15&s),16);t.push(o)}return t}(function(e,t){e[t>>5]|=128<<t%32,e[r(t)-1]=t;for(var i=1732584193,u=-271733879,c=-1732584194,d=271733878,h=0;h<e.length;h+=16){var g=i,f=u,p=c,v=d;i=s(i,u,c,d,e[h],7,-680876936),d=s(d,i,u,c,e[h+1],12,-389564586),c=s(c,d,i,u,e[h+2],17,606105819),u=s(u,c,d,i,e[h+3],22,-1044525330),i=s(i,u,c,d,e[h+4],7,-176418897),d=s(d,i,u,c,e[h+5],12,1200080426),c=s(c,d,i,u,e[h+6],17,-1473231341),u=s(u,c,d,i,e[h+7],22,-45705983),i=s(i,u,c,d,e[h+8],7,1770035416),d=s(d,i,u,c,e[h+9],12,-1958414417),c=s(c,d,i,u,e[h+10],17,-42063),u=s(u,c,d,i,e[h+11],22,-1990404162),i=s(i,u,c,d,e[h+12],7,1804603682),d=s(d,i,u,c,e[h+13],12,-40341101),c=s(c,d,i,u,e[h+14],17,-1502002290),i=o(i,u=s(u,c,d,i,e[h+15],22,1236535329),c,d,e[h+1],5,-165796510),d=o(d,i,u,c,e[h+6],9,-1069501632),c=o(c,d,i,u,e[h+11],14,643717713),u=o(u,c,d,i,e[h],20,-373897302),i=o(i,u,c,d,e[h+5],5,-701558691),d=o(d,i,u,c,e[h+10],9,38016083),c=o(c,d,i,u,e[h+15],14,-660478335),u=o(u,c,d,i,e[h+4],20,-405537848),i=o(i,u,c,d,e[h+9],5,568446438),d=o(d,i,u,c,e[h+14],9,-1019803690),c=o(c,d,i,u,e[h+3],14,-187363961),u=o(u,c,d,i,e[h+8],20,1163531501),i=o(i,u,c,d,e[h+13],5,-1444681467),d=o(d,i,u,c,e[h+2],9,-51403784),c=o(c,d,i,u,e[h+7],14,1735328473),i=a(i,u=o(u,c,d,i,e[h+12],20,-1926607734),c,d,e[h+5],4,-378558),d=a(d,i,u,c,e[h+8],11,-2022574463),c=a(c,d,i,u,e[h+11],16,1839030562),u=a(u,c,d,i,e[h+14],23,-35309556),i=a(i,u,c,d,e[h+1],4,-1530992060),d=a(d,i,u,c,e[h+4],11,1272893353),c=a(c,d,i,u,e[h+7],16,-155497632),u=a(u,c,d,i,e[h+10],23,-1094730640),i=a(i,u,c,d,e[h+13],4,681279174),d=a(d,i,u,c,e[h],11,-358537222),c=a(c,d,i,u,e[h+3],16,-722521979),u=a(u,c,d,i,e[h+6],23,76029189),i=a(i,u,c,d,e[h+9],4,-640364487),d=a(d,i,u,c,e[h+12],11,-421815835),c=a(c,d,i,u,e[h+15],16,530742520),i=l(i,u=a(u,c,d,i,e[h+2],23,-995338651),c,d,e[h],6,-198630844),d=l(d,i,u,c,e[h+7],10,1126891415),c=l(c,d,i,u,e[h+14],15,-1416354905),u=l(u,c,d,i,e[h+5],21,-57434055),i=l(i,u,c,d,e[h+12],6,1700485571),d=l(d,i,u,c,e[h+3],10,-1894986606),c=l(c,d,i,u,e[h+10],15,-1051523),u=l(u,c,d,i,e[h+1],21,-2054922799),i=l(i,u,c,d,e[h+8],6,1873313359),d=l(d,i,u,c,e[h+15],10,-30611744),c=l(c,d,i,u,e[h+6],15,-1560198380),u=l(u,c,d,i,e[h+13],21,1309151649),i=l(i,u,c,d,e[h+4],6,-145523070),d=l(d,i,u,c,e[h+11],10,-1120210379),c=l(c,d,i,u,e[h+2],15,718787259),u=l(u,c,d,i,e[h+9],21,-343485551),i=n(i,g),u=n(u,f),c=n(c,p),d=n(d,v)}return[i,u,c,d]}(function(e){if(0===e.length)return[];for(var t=8*e.length,n=new Uint32Array(r(t)),i=0;i<t;i+=8)n[i>>5]|=(255&e[i/8])<<i%32;return n}(e),8*e.length))}},140:(e,t)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var r="undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto);t.default={randomUUID:r}},808:(e,t)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0,t.default="00000000-0000-0000-0000-000000000000"},792:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,i=(n=r(37))&&n.__esModule?n:{default:n};t.default=function(e){if(!(0,i.default)(e))throw TypeError("Invalid UUID");var t,r=new Uint8Array(16);return r[0]=(t=parseInt(e.slice(0,8),16))>>>24,r[1]=t>>>16&255,r[2]=t>>>8&255,r[3]=255&t,r[4]=(t=parseInt(e.slice(9,13),16))>>>8,r[5]=255&t,r[6]=(t=parseInt(e.slice(14,18),16))>>>8,r[7]=255&t,r[8]=(t=parseInt(e.slice(19,23),16))>>>8,r[9]=255&t,r[10]=(t=parseInt(e.slice(24,36),16))/1099511627776&255,r[11]=t/4294967296&255,r[12]=t>>>24&255,r[13]=t>>>16&255,r[14]=t>>>8&255,r[15]=255&t,r}},656:(e,t)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0,t.default=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i},858:(e,t)=>{"use strict";var r;Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(){if(!r&&!(r="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return r(n)};var n=new Uint8Array(16)},42:(e,t)=>{"use strict";function r(e,t,r,n){switch(e){case 0:return t&r^~t&n;case 1:case 3:return t^r^n;case 2:return t&r^t&n^r&n}}function n(e,t){return e<<t|e>>>32-t}Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0,t.default=function(e){var t=[1518500249,1859775393,2400959708,3395469782],i=[1732584193,4023233417,2562383102,271733878,3285377520];if("string"==typeof e){var s=unescape(encodeURIComponent(e));e=[];for(var o=0;o<s.length;++o)e.push(s.charCodeAt(o))}else Array.isArray(e)||(e=Array.prototype.slice.call(e));e.push(128);for(var a=e.length/4+2,l=Math.ceil(a/16),u=new Array(l),c=0;c<l;++c){for(var d=new Uint32Array(16),h=0;h<16;++h)d[h]=e[64*c+4*h]<<24|e[64*c+4*h+1]<<16|e[64*c+4*h+2]<<8|e[64*c+4*h+3];u[c]=d}u[l-1][14]=8*(e.length-1)/Math.pow(2,32),u[l-1][14]=Math.floor(u[l-1][14]),u[l-1][15]=8*(e.length-1)&4294967295;for(var g=0;g<l;++g){for(var f=new Uint32Array(80),p=0;p<16;++p)f[p]=u[g][p];for(var v=16;v<80;++v)f[v]=n(f[v-3]^f[v-8]^f[v-14]^f[v-16],1);for(var y=i[0],m=i[1],b=i[2],k=i[3],_=i[4],S=0;S<80;++S){var w=Math.floor(S/20),E=n(y,5)+r(w,m,b,k)+_+t[w]+f[S]>>>0;_=k,k=b,b=n(m,30)>>>0,m=y,y=E}i[0]=i[0]+y>>>0,i[1]=i[1]+m>>>0,i[2]=i[2]+b>>>0,i[3]=i[3]+k>>>0,i[4]=i[4]+_>>>0}return[i[0]>>24&255,i[0]>>16&255,i[0]>>8&255,255&i[0],i[1]>>24&255,i[1]>>16&255,i[1]>>8&255,255&i[1],i[2]>>24&255,i[2]>>16&255,i[2]>>8&255,255&i[2],i[3]>>24&255,i[3]>>16&255,i[3]>>8&255,255&i[3],i[4]>>24&255,i[4]>>16&255,i[4]>>8&255,255&i[4]]}},910:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0,t.unsafeStringify=a;for(var n,i=(n=r(37))&&n.__esModule?n:{default:n},s=[],o=0;o<256;++o)s.push((o+256).toString(16).slice(1));function a(e,t=0){return(s[e[t+0]]+s[e[t+1]]+s[e[t+2]]+s[e[t+3]]+"-"+s[e[t+4]]+s[e[t+5]]+"-"+s[e[t+6]]+s[e[t+7]]+"-"+s[e[t+8]]+s[e[t+9]]+"-"+s[e[t+10]]+s[e[t+11]]+s[e[t+12]]+s[e[t+13]]+s[e[t+14]]+s[e[t+15]]).toLowerCase()}t.default=function(e,t=0){var r=a(e,t);if(!(0,i.default)(r))throw TypeError("Stringified UUID is invalid");return r}},518:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,i,s,o=(n=r(858))&&n.__esModule?n:{default:n},a=r(910),l=0,u=0;t.default=function(e,t,r){var n=t&&r||0,c=t||new Array(16),d=(e=e||{}).node,h=e.clockseq;if(e._v6||(d||(d=i),null==h&&(h=s)),null==d||null==h){var g=e.random||(e.rng||o.default)();null==d&&(d=[g[0],g[1],g[2],g[3],g[4],g[5]],i||e._v6||(d[0]|=1,i=d)),null==h&&(h=16383&(g[6]<<8|g[7]),void 0!==s||e._v6||(s=h))}var f=void 0!==e.msecs?e.msecs:Date.now(),p=void 0!==e.nsecs?e.nsecs:u+1,v=f-l+(p-u)/1e4;if(v<0&&void 0===e.clockseq&&(h=h+1&16383),(v<0||f>l)&&void 0===e.nsecs&&(p=0),p>=1e4)throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");l=f,u=p,s=h;var y=(1e4*(268435455&(f+=122192928e5))+p)%4294967296;c[n++]=y>>>24&255,c[n++]=y>>>16&255,c[n++]=y>>>8&255,c[n++]=255&y;var m=f/4294967296*1e4&268435455;c[n++]=m>>>8&255,c[n++]=255&m,c[n++]=m>>>24&15|16,c[n++]=m>>>16&255,c[n++]=h>>>8|128,c[n++]=255&h;for(var b=0;b<6;++b)c[n+b]=d[b];return t||(0,a.unsafeStringify)(c)}},343:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(e){var t,r=(t="string"==typeof e?(0,i.default)(e):e,Uint8Array.of((15&t[6])<<4|t[7]>>4&15,(15&t[7])<<4|(240&t[4])>>4,(15&t[4])<<4|(240&t[5])>>4,(15&t[5])<<4|(240&t[0])>>4,(15&t[0])<<4|(240&t[1])>>4,(15&t[1])<<4|(240&t[2])>>4,96|15&t[2],t[3],t[8],t[9],t[10],t[11],t[12],t[13],t[14],t[15]));return"string"==typeof e?(0,s.unsafeStringify)(r):r};var n,i=(n=r(792))&&n.__esModule?n:{default:n},s=r(910)},948:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=s(r(25)),i=s(r(311));function s(e){return e&&e.__esModule?e:{default:e}}var o=(0,n.default)("v3",48,i.default);t.default=o},25:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.URL=t.DNS=void 0,t.default=function(e,t,r){function n(e,n,o,a){var l;if("string"==typeof e&&(e=function(e){e=unescape(encodeURIComponent(e));for(var t=[],r=0;r<e.length;++r)t.push(e.charCodeAt(r));return t}(e)),"string"==typeof n&&(n=(0,s.default)(n)),16!==(null===(l=n)||void 0===l?void 0:l.length))throw TypeError("Namespace must be array-like (16 iterable integer values, 0-255)");var u=new Uint8Array(16+e.length);if(u.set(n),u.set(e,n.length),(u=r(u))[6]=15&u[6]|t,u[8]=63&u[8]|128,o){a=a||0;for(var c=0;c<16;++c)o[a+c]=u[c];return o}return(0,i.unsafeStringify)(u)}try{n.name=e}catch(e){}return n.DNS=o,n.URL=a,n};var n,i=r(910),s=(n=r(792))&&n.__esModule?n:{default:n},o=t.DNS="6ba7b810-9dad-11d1-80b4-00c04fd430c8",a=t.URL="6ba7b811-9dad-11d1-80b4-00c04fd430c8"},73:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=o(r(140)),i=o(r(858)),s=r(910);function o(e){return e&&e.__esModule?e:{default:e}}t.default=function(e,t,r){if(n.default.randomUUID&&!t&&!e)return n.default.randomUUID();var o=(e=e||{}).random||(e.rng||i.default)();if(o[6]=15&o[6]|64,o[8]=63&o[8]|128,t){r=r||0;for(var a=0;a<16;++a)t[r+a]=o[a];return t}return(0,s.unsafeStringify)(o)}},186:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=s(r(25)),i=s(r(42));function s(e){return e&&e.__esModule?e:{default:e}}var o=(0,n.default)("v5",80,i.default);t.default=o},671:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(e={},t,r=0){var o=(0,i.default)(l(l({},e),{},{_v6:!0}),new Uint8Array(16));if(o=(0,s.default)(o),t){for(var a=0;a<16;a++)t[r+a]=o[a];return t}return(0,n.unsafeStringify)(o)};var n=r(910),i=o(r(518)),s=o(r(343));function o(e){return e&&e.__esModule?e:{default:e}}function a(e,t){var r=Object.keys(e);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(e);t&&(n=n.filter((function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable}))),r.push.apply(r,n)}return r}function l(e){for(var t=1;t<arguments.length;t++){var r=null!=arguments[t]?arguments[t]:{};t%2?a(Object(r),!0).forEach((function(t){u(e,t,r[t])})):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(r)):a(Object(r)).forEach((function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(r,t))}))}return e}function u(e,t,r){return(t=function(e){var t=function(e,t){if("object"!=typeof e||!e)return e;var r=e[Symbol.toPrimitive];if(void 0!==r){var n=r.call(e,"string");if("object"!=typeof n)return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(e);return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}):e[t]=r,e}},507:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(e){var t,r=(t="string"==typeof e?(0,i.default)(e):e,Uint8Array.of((15&t[3])<<4|t[4]>>4&15,(15&t[4])<<4|(240&t[5])>>4,(15&t[5])<<4|15&t[6],t[7],(15&t[1])<<4|(240&t[2])>>4,(15&t[2])<<4|(240&t[3])>>4,16|(240&t[0])>>4,(15&t[0])<<4|(240&t[1])>>4,t[8],t[9],t[10],t[11],t[12],t[13],t[14],t[15]));return"string"==typeof e?(0,s.unsafeStringify)(r):r};var n,i=(n=r(792))&&n.__esModule?n:{default:n},s=r(910)},744:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,i=(n=r(858))&&n.__esModule?n:{default:n},s=r(910),o=null,a=null,l=0;t.default=function(e,t,r){e=e||{};var n=t&&r||0,u=t||new Uint8Array(16),c=e.random||(e.rng||i.default)(),d=void 0!==e.msecs?e.msecs:Date.now(),h=void 0!==e.seq?e.seq:null,g=a,f=o;return d>l&&void 0===e.msecs&&(l=d,null!==h&&(g=null,f=null)),null!==h&&(h>2147483647&&(h=2147483647),g=h>>>19&4095,f=524287&h),null!==g&&null!==f||(g=(g=127&c[6])<<8|c[7],f=(f=(f=63&c[8])<<8|c[9])<<5|c[10]>>>3),d+1e4>l&&null===h?++f>524287&&(f=0,++g>4095&&(g=0,l++)):l=d,a=g,o=f,u[n++]=l/1099511627776&255,u[n++]=l/4294967296&255,u[n++]=l/16777216&255,u[n++]=l/65536&255,u[n++]=l/256&255,u[n++]=255&l,u[n++]=g>>>4&15|112,u[n++]=255&g,u[n++]=f>>>13&63|128,u[n++]=f>>>5&255,u[n++]=f<<3&255|7&c[10],u[n++]=c[11],u[n++]=c[12],u[n++]=c[13],u[n++]=c[14],u[n++]=c[15],t||(0,s.unsafeStringify)(u)}},37:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,i=(n=r(656))&&n.__esModule?n:{default:n};t.default=function(e){return"string"==typeof e&&i.default.test(e)}},775:(e,t,r)=>{"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,i=(n=r(37))&&n.__esModule?n:{default:n};t.default=function(e){if(!(0,i.default)(e))throw TypeError("Invalid UUID");return parseInt(e.slice(14,15),16)}}},t={};function r(n){var i=t[n];if(void 0!==i)return i.exports;var s=t[n]={exports:{}};return e[n].call(s.exports,s,s.exports,r),s.exports}r.d=(e,t)=>{for(var n in t)r.o(t,n)&&!r.o(e,n)&&Object.defineProperty(e,n,{enumerable:!0,get:t[n]})},r.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"==typeof window)return window}}(),r.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),r.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})};var n={};return(()=>{"use strict";var e=n;Object.defineProperty(e,"__esModule",{value:!0}),e.Analytics=void 0;var t=r(396);Object.defineProperty(e,"Analytics",{enumerable:!0,get:function(){return t.Analytics}})})(),n})()));