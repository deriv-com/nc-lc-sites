    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get _clientLogout$Action() {
                if (!(this.hasOwnProperty("__clientLogout$Action"))) {
            ...
            set _clientLogout$Action(value) {
                this.__clientLogout$Action = value;
            }
            ...
            get _getUsernameAndPhoto$Action() {
                if (!(this.hasOwnProperty("__getUsernameAndPhoto$Action"))) {
            ...
            set _getUsernameAndPhoto$Action(value) {
                this.__getUsernameAndPhoto$Action = value;
            }
