...
var c = Y,
    ...
    w = class w extends W.BaseWebScreen {
        ...
        static getBlocks() {
            return [D, F, I, k, M, U, V, L, $, B, H, N, z, G, j, K, q, J, Q]
        }
        get modelFactory() {
            return te
        }
        ...
        internalRender() {
            let n = this.model,
                ...
                C = w.getTranslation,
                l = this;
            return t.createElement("div", this.getRootNodeProperties(), t.createElement(D, {
                        ...
                        return [t.createElement(F, {
                            ...
                            events: {
                                ...
                                onClick$Action: a(function() {
                                    var i = d.clone();
                                    o.onClickClearCache$Action(o.callContext(i))
                                }, "onClick$Action")
                            },
                            _validationProps: {
                                validationService: g
                            ...
                            inputs: {
                                Position: n.getCachedValue(e.getId("8_1zqidlwk6PYDDh14q1hw.Position"), function() {
                                    return Z.isDesktop$Action(d).isDesktopOut ? y.position.right : y.position.bottom
                                })
                            },
                            events: {
                                _handleError: a(function(i) {
                            ...
                            events: {
                                ...
                                demoClickEvent$Action: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.setDemoValue$Action(o.callContext(i))
                                    })
                                }, "demoClickEvent$Action"),
                                realClickEvent$Action: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.setRealValue$Action(o.callContext(i))
                                    })
                                        ...
                                        return [t.createElement(U, {
                                            ...
                                            events: {
                                                ...
                                                onClickEvent$Action: a(function() {
                                                    var f = u.clone();
                                                    o.createdAccountOnClick$Action(o.callContext(f))
                                                }, "onClickEvent$Action")
                                            },
                                            _validationProps: {
                                                validationService: g
                            ...
                            extendedEvents: {
                                onClick: a(function() {
                                    var i = d.clone();
                                    o.goToAccountSpecification$Action(o.callContext(i))
                                }, "onClick")
                            },
                            visible: !n.variables.dataLoadingVar,
                            _idProps: {
                                        ...
                                        return [t.createElement(V, {
                                            ...
                                            events: {
                                                ...
                                                onClickEvent$Action: a(function() {
                                                    return Promise.resolve().then(function() {
                                                        var f = u.clone();
                                                        return o.availableAccountOnClick$Action(o.callContext(f))
                                                    })
                                                }, "onClickEvent$Action")
                                            },
                                            _validationProps: {
                            ...
                            events: {
                                ...
                                onCloseClick$Action: a(function() {
                                    var i = d.clone();
                                    o.closeModal$Action(o.callContext(i))
                                }, "onCloseClick$Action")
                            },
                            _validationProps: {
                                validationService: g
                            ...
                            events: {
                                ...
                                refetchDxtradeEvent$Action: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.onAccountCreated$Action("dxtrade", o.callContext(i))
                                    })
                                }, "refetchDxtradeEvent$Action"),
                                refetchMT5Event$Action: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.onAccountCreated$Action("mt5", o.callContext(i))
                                    })
                                }, "refetchMT5Event$Action"),
                                needsKYCEvent$Action: a(function() {
                                    var i = d.clone();
                                    o.onNeedKYC$Action(o.callContext(i))
                                }, "needsKYCEvent$Action"),
                                forgotPasswordEvent$Action: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.handleForgotPassword$Action(o.callContext(i))
                                    })
                            ...
                            return [t.createElement(s, {
                                ...
                                extendedEvents: {
                                    onClick: a(function() {
                                        return Promise.resolve().then(function() {
                                            var i = d.clone();
                                            return o.cTraderAccountCreation$Action(n.variables.selectedAccountVar.market_typeAttr, "svg", o.callContext(i))
                                        })
                                    }, "onClick")
                                },
                            ...
                            onClick: a(function() {
                                return Promise.resolve().then(function() {
                                    var i = d.clone();
                                    return o.ctraderWebTerminalOnClick$Action(o.callContext(i))
                                })
                            }, "onClick"),
                            ...
                            onClick: a(function() {
                                var i = d.clone();
                                o.ctraderAppOnClick$Action(o.callContext(i))
                            }, "onClick"),
                            style: "display-flex align-items-center justify-content-center",
                            visible: !0,
                            _idProps: {
                                    ...
                                    return [t.createElement(K, {
                                        ...
                                        events: {
                                            ...
                                            redirectToEvent$Action: a(function() {
                                                return Promise.resolve().then(function() {
                                                    var f = u.clone();
                                                    return o.redirectToKYC$Action(n.variables.profileSetupVar.getCurrent(u.iterationContext).identifierAttr === "poi" ? "proof-of-identity" : n.variables.profileSetupVar.getCurrent(u.iterationContext).identifierAttr === "poa" ? "proof-of-address" : "personal-details", o.callContext(f))
                                                })
                            ...
                            events: {
                                ...
                                updateProfile$Action: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.redirectToKYC$Action("account/personal-details", o.callContext(i))
                                    })
                            ...
                            extendedEvents: {
                                onClick: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.addNewWalletOnClick$Action("USD", o.callContext(i))
                                    })
                                }, "onClick")
                            },
                            extendedProperties: {
                            ...
                            extendedEvents: {
                                onClick: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.addNewWalletOnClick$Action("EUR", o.callContext(i))
                                    })
                                }, "onClick")
                            },
                            extendedProperties: {
                            ...
                            extendedEvents: {
                                onClick: a(function() {
                                    return Promise.resolve().then(function() {
                                        var i = d.clone();
                                        return o.addNewWalletOnClick$Action("GBP", o.callContext(i))
                                    })
                                }, "onClick")
                            },
                            extendedProperties: {
                                ...
                                topBar: new R(function() {
                                    return [t.createElement(s, {
                                        ...
                                        extendedEvents: {
                                            onClick: a(function() {
                                                var i = d.clone();
                                                o.closeBottomSheet$Action(o.callContext(i))
                                            }, "onClick")
                                        },
                                        extendedProperties: {
                ...
                _dependencies: [v(n.variables.profileSetupVar), v(n.variables.selectedAccountVar), v(n.variables.isDowntimeVar), v(n.variables.cTraderAvailableAccountsCountVar), v(p.getAccountType()), v(n.variables.createdCtraderAccountsVar), v(n.variables.accountCreationLoadingVar), v(p.getTradingPlatformMt5PasswordReset()), v(p.getTradingPlatformDxtradePasswordReset()), v(n.variables.isDxtradePasswordSetVar), v(n.variables.isMt5PasswordSetVar), v(n.variables.selectedAvailableAccountVar), v(n.variables.showModalVar), v(n.variables.availableCFDAccountsVar), v(n.variables.isEmptyVar), v(p.getTotalCTraderBalance()), v(n.variables.createdCFDAccountsVar), v(p.getAuthToken()), v(n.variables.dataLoadingVar), v(n.variables.hasRealAccountVar)]
            }))
        }
    };
a(w, "View");
