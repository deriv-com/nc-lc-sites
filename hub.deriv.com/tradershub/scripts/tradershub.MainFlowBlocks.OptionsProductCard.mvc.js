...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "MainFlowBlocks.OptionsProductCard"; }
...
get redirectionLink$Action() {if(!(this.hasOwnProperty("_redirectionLink$Action"))) {
...
}set redirectionLink$Action(value) {this._redirectionLink$Action = value;
}
