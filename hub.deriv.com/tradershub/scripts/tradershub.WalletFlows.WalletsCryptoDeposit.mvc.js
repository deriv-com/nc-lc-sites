                        ...
                        return OS.Logger.startActiveSpan("ClipboardAction", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("ClipboardAction", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller_ClipboardAction_ClipboardActionJS, "ClipboardAction", "ClipboardAction", {
                        ...
                        return OS.Logger.startActiveSpan("OnRender", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("InitQR", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller_OnRender_InitQRJS, "InitQR", "OnRender", {
