...
define("tradershub.WalletFlows.WalletsCryptoDeposit.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "RESTAPIWebsocketOfficial.model", "react", "@outsystems/runtime-view-js", "tradershub.WalletFlows.WalletsCryptoDeposit.mvc$model", "tradershub.WalletFlows.WalletsCryptoDeposit.mvc$controller", "tradershub.clientVariables", "tradershub.Layouts.MainLayout.mvc$view", "@outsystems/runtime-widgets-js", "tradershub.WalletBlocks.WalletsOverlayPage.mvc$view", "OutSystemsUI.Content.Tooltip.mvc$view", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "tradershub.model$EN_bf87ce2ee46f8f5bc73889fe14426739EntityRecord", "RESTAPIWebsocketOfficial.model$ST_2f46c6fecf81fe9d91763f789141eec9Structure", "tradershub.referencesHealth$RESTAPIWebsocketOfficial", "tradershub.controller$PostCashierCryptoDeposit", "tradershub.model$ST_2b68b61da9b8f6db8463a60cc48350faStructure", "tradershub.controller$SendAuthorize", "tradershub.model$RC_6a44851bc01e80a885c4aa0ae740b8fc", "tradershub.model$RL_5ee36d8deb03b51810340e621ea66d4b"], function (OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, RESTAPIWebsocketOfficialModel, React, OSView, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_model, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller, tradershubClientVariables, tradershub_Layouts_MainLayout_mvc_view, OSWidgets, tradershub_WalletBlocks_WalletsOverlayPage_mvc_view, OutSystemsUI_Content_Tooltip_mvc_view) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "WalletFlows.WalletsCryptoDeposit"; }
...
screen: ""
        ...
        get modelFactory() {
            return tradershub_WalletFlows_WalletsCryptoDeposit_mvc_model;
        }

        get controllerFactory() {
            return tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller;
        }

        get title() {
            

            return OSView.BaseView.BaseWebScreen.getTranslation("dnNrjala10i1RPYw1QSXkQ#Title", "WalletsCryptoDeposit");
        }
...
define("tradershub.WalletFlows.WalletsCryptoDeposit.mvc$controller", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "RESTAPIWebsocketOfficial.model", "tradershub.languageResources", "tradershub.clientVariables", "tradershub.WalletFlows.WalletsCryptoDeposit.mvc$translationsResources", "tradershub.WalletFlows.controller", "tradershub.WalletFlows.WalletsCryptoDeposit.mvc$controller.ClipboardAction.ClipboardActionJS", "tradershub.WalletFlows.WalletsCryptoDeposit.mvc$controller.OnRender.InitQRJS", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "tradershub.model$EN_bf87ce2ee46f8f5bc73889fe14426739EntityRecord", "RESTAPIWebsocketOfficial.model$ST_2f46c6fecf81fe9d91763f789141eec9Structure", "tradershub.referencesHealth$RESTAPIWebsocketOfficial", "tradershub.controller$PostCashierCryptoDeposit", "tradershub.model$ST_2b68b61da9b8f6db8463a60cc48350faStructure", "tradershub.controller$SendAuthorize", "tradershub.model$RC_6a44851bc01e80a885c4aa0ae740b8fc", "tradershub.model$RL_5ee36d8deb03b51810340e621ea66d4b"], function (OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, RESTAPIWebsocketOfficialModel, tradershubLanguageResources, tradershubClientVariables, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_TranslationsResources, tradershub_WalletFlowsController, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller_ClipboardAction_ClipboardActionJS, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller_OnRender_InitQRJS) {
var OS = OSRuntimeCore;
{class ControllerInner extends 
OS.Controller.BaseViewController {
constructor(model, messagesProvider, idService) {
super(model, messagesProvider, idService, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_TranslationsResources);
var controller = this.controller;
...
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetCurrencies", "screenservices/tradershub/WalletFlows/WalletsCryptoDeposit/ScreenDataSetGetCurrencies", "npjMYW44GFvhkxw14gO3vA", maxRecords, startIndex, function (b) {
...
get _getCurrenciesOnAfterFetch$Action() {if(!(this.hasOwnProperty("__getCurrenciesOnAfterFetch$Action"))) {
...
}set _getCurrenciesOnAfterFetch$Action(value) {this.__getCurrenciesOnAfterFetch$Action = value;
}

get _clipboardAction$Action() {if(!(this.hasOwnProperty("__clipboardAction$Action"))) {
...
try {controller.ensureControllerAlive("ClipboardAction");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller_ClipboardAction_ClipboardActionJS, "ClipboardAction", "ClipboardAction", {
...
}set _clipboardAction$Action(value) {this.__clipboardAction$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsCryptoDeposit_mvc_controller_OnRender_InitQRJS, "InitQR", "OnRender", {
...
try {return controller.safeExecuteClientAction(controller._clipboardAction$Action, callContext);
} finally {
if(span) {
span.end();
}
...
define("tradershub.WalletFlows.WalletsCryptoDeposit.mvc$controller.ClipboardAction.ClipboardActionJS", [], function () {
...
define("tradershub.WalletFlows.WalletsCryptoDeposit.mvc$controller.OnRender.InitQRJS", [], function () {
return function ($parameters, $actions, $roles, $public) {
...
define("tradershub.WalletFlows.WalletsCryptoDeposit.mvc$translationsResources.fr-FR", [], function () {
return {
...
define("tradershub.WalletFlows.WalletsCryptoDeposit.mvc$translationsResources", ["exports", "tradershub.WalletFlows.WalletsCryptoDeposit.mvc$translationsResources.fr-FR"], function (exports, tradershub_WalletFlows_WalletsCryptoDeposit_mvc_translationsResources_frFR) {
return {
"fr-FR": {
"translations": tradershub_WalletFlows_WalletsCryptoDeposit_mvc_translationsResources_frFR,
"isRTL": false
}
};
});
