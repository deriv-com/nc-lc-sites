define("tradershub.WalletBlocks.WalletsOverlayPage.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "OutSystemsUI.controller", "OutSystemsUI.Utilities.Separator.mvc$model", "tradershub.WalletBlocks.WalletsCashierHeader.mvc$model", "tradershub.Common.LoaderBlock.mvc$model", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI"], function(OSRuntimeCore, tradershubModel, OutSystemsUIController, OutSystemsUI_Utilities_Separator_mvcModel, tradershub_WalletBlocks_WalletsCashierHeader_mvcModel, tradershub_Common_LoaderBlock_mvcModel) {
...
define("tradershub.WalletBlocks.WalletsOverlayPage.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "react", "@outsystems/runtime-view-js", "tradershub.WalletBlocks.WalletsOverlayPage.mvc$model", "tradershub.WalletBlocks.WalletsOverlayPage.mvc$controller", "tradershub.clientVariables", "@outsystems/runtime-widgets-js", "OutSystemsUI.Utilities.Separator.mvc$view", "tradershub.WalletBlocks.WalletsCashierHeader.mvc$view", "tradershub.Common.LoaderBlock.mvc$view", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI"], function(OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, React, OSView, tradershub_WalletBlocks_WalletsOverlayPage_mvc_model, tradershub_WalletBlocks_WalletsOverlayPage_mvc_controller, tradershubClientVariables, OSWidgets, OutSystemsUI_Utilities_Separator_mvc_view, tradershub_WalletBlocks_WalletsCashierHeader_mvc_view, tradershub_Common_LoaderBlock_mvc_view) {
    var OS = OSRuntimeCore;
                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletBlocks_WalletsOverlayPage_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
