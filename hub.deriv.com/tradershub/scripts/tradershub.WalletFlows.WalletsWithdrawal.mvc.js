    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get _convertFiatToCrypto$Action() {
                if (!(this.hasOwnProperty("__convertFiatToCrypto$Action"))) {
                    this.__convertFiatToCrypto$Action = function(latestRateIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("ConvertFiatToCrypto", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("ConvertFiatToCrypto");
                                callContext = controller.callContext(callContext);
                                ...
                                OS.Logger.startActiveSpan("ConvertCryptoToFiat", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_ConvertFiatToCrypto_ConvertCryptoToFiatJS, "ConvertCryptoToFiat", "ConvertFiatToCrypto", {
            ...
            set _convertFiatToCrypto$Action(value) {
                this.__convertFiatToCrypto$Action = value;
            }
                        ...
                        return OS.Logger.startActiveSpan("OnChangeAmountInput", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("TriggerExchangeRate", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_OnChangeAmountInput_TriggerExchangeRateJS, "TriggerExchangeRate", "OnChangeAmountInput", {
            ...
            get _assignPriorityWithdrawalInfoCountdownTimer$Action() {
                if (!(this.hasOwnProperty("__assignPriorityWithdrawalInfoCountdownTimer$Action"))) {
                    this.__assignPriorityWithdrawalInfoCountdownTimer$Action = function(countdownTimerIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("AssignPriorityWithdrawalInfoCountdownTimer", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("AssignPriorityWithdrawalInfoCountdownTimer");
                                callContext = controller.callContext(callContext);
            ...
            set _assignPriorityWithdrawalInfoCountdownTimer$Action(value) {
                this.__assignPriorityWithdrawalInfoCountdownTimer$Action = value;
            }

            get _assignWithdrawalAmountInCrypto$Action() {
                if (!(this.hasOwnProperty("__assignWithdrawalAmountInCrypto$Action"))) {
                    this.__assignWithdrawalAmountInCrypto$Action = function(assignWithdrawalAmountInCryptoIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("AssignWithdrawalAmountInCrypto", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("AssignWithdrawalAmountInCrypto");
                                callContext = controller.callContext(callContext);
            ...
            set _assignWithdrawalAmountInCrypto$Action(value) {
                this.__assignWithdrawalAmountInCrypto$Action = value;
            }

            get _getExchangeRate$Action() {
                if (!(this.hasOwnProperty("__getExchangeRate$Action"))) {
                            ...
                            return OS.Flow.tryFinally(function() {
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    return OS.Logger.startActiveSpan("InitExchangeRate", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteAsyncJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_GetExchangeRate_InitExchangeRateJS, "InitExchangeRate", "GetExchangeRate", {
            ...
            set _getExchangeRate$Action(value) {
                this.__getExchangeRate$Action = value;
            }
                        ...
                        return OS.Logger.startActiveSpan("OnDestroy", function(span) {
                            ...
                            try {
                                ...
                                OS.Logger.startActiveSpan("JSDisposeTimerExchangeRate", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_OnDestroy_JSDisposeTimerExchangeRateJS, "JSDisposeTimerExchangeRate", "OnDestroy", null, function($parameters) {}, {}, {});
                                    } finally {
                                        if (span) {
                                            span.end();
                                        }
                                        ...
                                        if ((model.variables.cryptoPriorityWithdrawalVar)) {
                                            ...
                                            return controller._getPriorityWithdrawalInfo$Action(callContext).then(function() {
                                                ...
                                                calculateFinalCryptoAmountJSResult.value = OS.Logger.startActiveSpan("CalculateFinalCryptoAmount", function(span) {
                                                    ...
                                                    try {
                                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_OnPriorityCheck_CalculateFinalCryptoAmountJS, "CalculateFinalCryptoAmount", "OnPriorityCheck", {
                                                ...
                                                convertCryptoToFiatJSResult.value = OS.Logger.startActiveSpan("ConvertCryptoToFiat", function(span) {
                                                    ...
                                                    try {
                                                        return controller.safeExecuteJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_OnPriorityCheck_ConvertCryptoToFiatJS, "ConvertCryptoToFiat", "OnPriorityCheck", {
            ...
            get _assignExchangeRate$Action() {
                if (!(this.hasOwnProperty("__assignExchangeRate$Action"))) {
                    this.__assignExchangeRate$Action = function(ratefromAPIIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("AssignExchangeRate", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("AssignExchangeRate");
                                callContext = controller.callContext(callContext);
            ...
            set _assignExchangeRate$Action(value) {
                this.__assignExchangeRate$Action = value;
            }

            get _assignWithdrawalAmountInFiat$Action() {
                if (!(this.hasOwnProperty("__assignWithdrawalAmountInFiat$Action"))) {
                    this.__assignWithdrawalAmountInFiat$Action = function(assignWithdrawalAmountInFiatIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("AssignWithdrawalAmountInFiat", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("AssignWithdrawalAmountInFiat");
                                callContext = controller.callContext(callContext);
            ...
            set _assignWithdrawalAmountInFiat$Action(value) {
                this.__assignWithdrawalAmountInFiat$Action = value;
            }

            get _assignPriorityWithdrawalInfo$Action() {
                if (!(this.hasOwnProperty("__assignPriorityWithdrawalInfo$Action"))) {
                    this.__assignPriorityWithdrawalInfo$Action = function(priorityWithdrawalInfoObjIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("AssignPriorityWithdrawalInfo", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("AssignPriorityWithdrawalInfo");
                                callContext = controller.callContext(callContext);
            ...
            set _assignPriorityWithdrawalInfo$Action(value) {
                this.__assignPriorityWithdrawalInfo$Action = value;
            }

            get _getPriorityWithdrawalInfo$Action() {
                if (!(this.hasOwnProperty("__getPriorityWithdrawalInfo$Action"))) {
                            ...
                            return OS.Flow.tryFinally(function() {
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    return OS.Logger.startActiveSpan("InitPriorityWithdrawalInfo", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteAsyncJSNode(tradershub_WalletFlows_WalletsWithdrawal_mvc_controller_GetPriorityWithdrawalInfo_InitPriorityWithdrawalInfoJS, "InitPriorityWithdrawalInfo", "GetPriorityWithdrawalInfo", {
                                                Currency: OS.DataConversion.JSNodeParamConverter.to(model.variables.activeWalletVar.currencyAttr, OS.DataTypes.DataTypes.Text)
                                            }, function($parameters) {}, {
            ...
            set _getPriorityWithdrawalInfo$Action(value) {
                this.__getPriorityWithdrawalInfo$Action = value;
            }
            ...
            get _assignExchangeRateCountdownTimer$Action() {
                if (!(this.hasOwnProperty("__assignExchangeRateCountdownTimer$Action"))) {
                    this.__assignExchangeRateCountdownTimer$Action = function(countdownTimerIn, callContext) {
                        ...
                        return OS.Logger.startActiveSpan("AssignExchangeRateCountdownTimer", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("AssignExchangeRateCountdownTimer");
                                callContext = controller.callContext(callContext);
            ...
            set _assignExchangeRateCountdownTimer$Action(value) {
                this.__assignExchangeRateCountdownTimer$Action = value;
            }
            ...
            convertFiatToCrypto$Action(latestRateIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("ConvertFiatToCrypto__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._convertFiatToCrypto$Action, callContext, latestRateIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            assignPriorityWithdrawalInfoCountdownTimer$Action(countdownTimerIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("AssignPriorityWithdrawalInfoCountdownTimer__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._assignPriorityWithdrawalInfoCountdownTimer$Action, callContext, countdownTimerIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            assignWithdrawalAmountInCrypto$Action(assignWithdrawalAmountInCryptoIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("AssignWithdrawalAmountInCrypto__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._assignWithdrawalAmountInCrypto$Action, callContext, assignWithdrawalAmountInCryptoIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            assignExchangeRate$Action(ratefromAPIIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("AssignExchangeRate__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._assignExchangeRate$Action, callContext, ratefromAPIIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            assignWithdrawalAmountInFiat$Action(assignWithdrawalAmountInFiatIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("AssignWithdrawalAmountInFiat__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._assignWithdrawalAmountInFiat$Action, callContext, assignWithdrawalAmountInFiatIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            assignPriorityWithdrawalInfo$Action(priorityWithdrawalInfoObjIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("AssignPriorityWithdrawalInfo__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._assignPriorityWithdrawalInfo$Action, callContext, priorityWithdrawalInfoObjIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            convertCryptoToFiat$Action(latestRateIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("ConvertCryptoToFiat__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._convertCryptoToFiat$Action, callContext, latestRateIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            assignExchangeRateCountdownTimer$Action(countdownTimerIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("AssignExchangeRateCountdownTimer__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._assignExchangeRateCountdownTimer$Action, callContext, countdownTimerIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
