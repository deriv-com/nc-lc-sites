define("tradershub.WalletBlocks.WalletsOverlayPageWithPopup.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "OutSystemsUI.controller", "OutSystemsUI.Utilities.Separator.mvc$model", "tradershub.WalletBlocks.WalletsCashierHeader.mvc$model", "tradershub.Common.LoaderBlock.mvc$model", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "tradershub.model$ST_3425849bb816196585dd6f07dbf2721dStructure"], function(OSRuntimeCore, tradershubModel, OutSystemsUIController, OutSystemsUI_Utilities_Separator_mvcModel, tradershub_WalletBlocks_WalletsCashierHeader_mvcModel, tradershub_Common_LoaderBlock_mvcModel) {
    ...
    OS.Model.BaseViewModel {
        ...
        static get hasValidationWidgets() {
            if ((Model._hasValidationWidgetsValue === undefined)) {
                Model._hasValidationWidgetsValue = ((OutSystemsUI_Utilities_Separator_mvcModel.hasValidationWidgets || tradershub_WalletBlocks_WalletsCashierHeader_mvcModel.hasValidationWidgets) || tradershub_Common_LoaderBlock_mvcModel.hasValidationWidgets);
            }
...
define("tradershub.WalletBlocks.WalletsOverlayPageWithPopup.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "react", "@outsystems/runtime-view-js", "tradershub.WalletBlocks.WalletsOverlayPageWithPopup.mvc$model", "tradershub.WalletBlocks.WalletsOverlayPageWithPopup.mvc$controller", "tradershub.clientVariables", "@outsystems/runtime-widgets-js", "OutSystemsUI.Utilities.Separator.mvc$view", "tradershub.WalletBlocks.WalletsCashierHeader.mvc$view", "tradershub.Common.LoaderBlock.mvc$view", "OutSystemsUI.controller$IsDesktop", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "tradershub.model$ST_3425849bb816196585dd6f07dbf2721dStructure"], function(OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, React, OSView, tradershub_WalletBlocks_WalletsOverlayPageWithPopup_mvc_model, tradershub_WalletBlocks_WalletsOverlayPageWithPopup_mvc_controller, tradershubClientVariables, OSWidgets, OutSystemsUI_Utilities_Separator_mvc_view, tradershub_WalletBlocks_WalletsCashierHeader_mvc_view, tradershub_Common_LoaderBlock_mvc_view) {
    var OS = OSRuntimeCore;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        ...
        static getBlocks() {
            return [OutSystemsUI_Utilities_Separator_mvc_view, tradershub_WalletBlocks_WalletsCashierHeader_mvc_view, tradershub_Common_LoaderBlock_mvc_view];
        }
    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get _closePopup$Action() {
                if (!(this.hasOwnProperty("__closePopup$Action"))) {
                    this.__closePopup$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("ClosePopup", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("ClosePopup");
                                callContext = controller.callContext(callContext);
                                // ShowPopup = False
            ...
            set _closePopup$Action(value) {
                this.__closePopup$Action = value;
            }

            get _showPopup$Action() {
                if (!(this.hasOwnProperty("__showPopup$Action"))) {
                    this.__showPopup$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("ShowPopup", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("ShowPopup");
                                callContext = controller.callContext(callContext);
                                // ShowPopup = True
            ...
            set _showPopup$Action(value) {
                this.__showPopup$Action = value;
            }

            get _exitOnClick$Action() {
                if (!(this.hasOwnProperty("__exitOnClick$Action"))) {
                    this.__exitOnClick$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("ExitOnClick", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("ExitOnClick");
                                callContext = controller.callContext(callContext);
            ...
            set _exitOnClick$Action(value) {
                this.__exitOnClick$Action = value;
            }
            ...
            closePopup$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("ClosePopup__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._closePopup$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            showPopup$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("ShowPopup__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._showPopup$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            exitOnClick$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("ExitOnClick__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._exitOnClick$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
