define("tradershub.RealAccountCreation.TradingAssessment.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "OutSystemsUI.controller", "OutSystemsUI.controller$IsPhone", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI", "tradershub.model$ST_0dd6e149ce474591a764bb53175023a1Structure"], function (OSRuntimeCore, tradershubModel, OutSystemsUIController) {
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.TradingAssessment"; }
...
get _whyDoWeCollectThis_OnClick$Action() {if(!(this.hasOwnProperty("__whyDoWeCollectThis_OnClick$Action"))) {
...
try {controller.ensureControllerAlive("WhyDoWeCollectThis_OnClick");
...
}set _whyDoWeCollectThis_OnClick$Action(value) {this.__whyDoWeCollectThis_OnClick$Action = value;
}

get _okOnClick$Action() {if(!(this.hasOwnProperty("__okOnClick$Action"))) {
...
try {controller.ensureControllerAlive("OkOnClick");
callContext = controller.callContext(callContext);
...
}set _okOnClick$Action(value) {this.__okOnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._whyDoWeCollectThis_OnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._okOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
