    ...
    u = class u extends C.BaseWebScreen {
        ...
        get title() {
            let m = this.model,
                ...
                D = u.getTranslation,
                a = this;
            return l.Injector.resolve(l.ServiceNames.TranslationsService).getMessage("FkAFqM0xE065+QFlMmJYcg#TitleExpression.2133226043.1", "Easy And Free Sign Up | Online Trading | Hub.Deriv.com")
        }
        internalRender() {
            let m = this.model,
                o = this.controller,
...
`))],
                            ...
                            mandatory: !0,
                            maxLength: 0,
                            prompt: l.Injector.resolve(l.ServiceNames.TranslationsService).getMessage("yF8cEKbcxUaOlH9ylne2QQ#ValueExpression.-374653993.1", "Enter your email"),
                            style: "form-control",
                            ...
                            style: "text-neutral-9",
                            value: l.Injector.resolve(l.ServiceNames.TranslationsService).getMessage("xR3DXkGU+0Cebvp7vB1vPg#ValueExpression.1739998963.1", "Security and privacy policy"),
                            _idProps: {
                                service: e,
                                uuid: "28"
                            },
...
By signing up, you agree to our `))],
                            ...
                            transition: l.Transitions.createTransition(l.Transitions.TransitionAnimation.Default),
                            url: l.Navigation.generateScreenURL("https://oauth.deriv.com/oauth2/authorize?app_id=16929&l=en&brand=deriv&platform=", {}),
                            visible: !0,
                            _idProps: {
                                service: e,
                                name: "LoginLink"
