...
try {return controller.safeExecuteJSNode(tradershub_Common_controller_OnException_ReloadWindowJS, "ReloadWindow", "OnException", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {OS.FeedbackMessageService.showFeedbackMessage("There was a problem with the database request. Please try reloading the page.", /*Error*/ 3);
return ;
...
try {OS.FeedbackMessageService.showFeedbackMessage("There was a problem communicating with the server. Please try reloading the page.", /*Error*/ 3);
return ;
...
try {OS.FeedbackMessageService.showFeedbackMessage("There was a problem. Please try reloading the page.", /*Error*/ 3);
return ;
