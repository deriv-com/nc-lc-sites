...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "CFDBlocks.AvailableAccountCard"; }
...
get _onClickAction$Action() {if(!(this.hasOwnProperty("__onClickAction$Action"))) {
...
}set _onClickAction$Action(value) {this.__onClickAction$Action = value;
}
