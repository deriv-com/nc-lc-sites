    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get _noTaxIDNumberAvailableOnChange$Action() {
                if (!(this.hasOwnProperty("__noTaxIDNumberAvailableOnChange$Action"))) {
                    this.__noTaxIDNumberAvailableOnChange$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("NoTaxIDNumberAvailableOnChange", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("NoTaxIDNumberAvailableOnChange");
                                callContext = controller.callContext(callContext);
            ...
            set _noTaxIDNumberAvailableOnChange$Action(value) {
                this.__noTaxIDNumberAvailableOnChange$Action = value;
            }
            ...
            get _input_TIDNumberOnChange$Action() {
                if (!(this.hasOwnProperty("__input_TIDNumberOnChange$Action"))) {
                    this.__input_TIDNumberOnChange$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("Input_TIDNumberOnChange", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("Input_TIDNumberOnChange");
                                callContext = controller.callContext(callContext);
            ...
            set _input_TIDNumberOnChange$Action(value) {
                this.__input_TIDNumberOnChange$Action = value;
            }
            ...
            noTaxIDNumberAvailableOnChange$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("NoTaxIDNumberAvailableOnChange__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._noTaxIDNumberAvailableOnChange$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            employementStatusDropdownOnChange$Action(onReadyIn, callContext) {
                ...
                return OS.Logger.startActiveSpan("EmployementStatusDropdownOnChange__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._employementStatusDropdownOnChange$Action, callContext, onReadyIn);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            input_TIDNumberOnChange$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("Input_TIDNumberOnChange__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._input_TIDNumberOnChange$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
