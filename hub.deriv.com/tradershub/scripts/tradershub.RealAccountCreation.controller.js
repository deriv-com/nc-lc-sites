                ...
                this._handleError = function(ex, callContext) {
                    ...
                    return OS.Logger.startActiveSpan("OnException", function(span) {
                        ...
                        try {
                            ...
                            try {
                                OS.Logger.debug("RealAccountCreation.OnException", OS.Exceptions.getMessage(ex));
                                    ...
                                    return OS.Logger.startActiveSpan("CommunicationException", function(span) {
                                        ...
                                        try {
                                            OS.Logger.startActiveSpan("ReloadWindow", function(span) {
                                                ...
                                                try {
                                                    return controller.safeExecuteJSNode(tradershub_RealAccountCreation_controller_OnException_ReloadWindowJS, "ReloadWindow", "OnException", null, function($parameters) {}, {}, {});
                                                } finally {
                                                    if (span) {
                                                        span.end();
                                                    }
