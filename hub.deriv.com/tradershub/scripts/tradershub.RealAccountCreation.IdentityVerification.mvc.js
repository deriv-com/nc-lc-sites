...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.IdentityVerification"; }
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_IdentityVerification_mvc_controller_OnReady_GetIDVCountryJS, "GetIDVCountry", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_IdentityVerification_mvc_controller_OnReady_GetIDVCountry2JS, "GetIDVCountry2", "OnReady", {
Residence: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getSelectedResidence(), OS.DataTypes.DataTypes.Text),
...
get _input_DocumentTypeOnChange$Action() {if(!(this.hasOwnProperty("__input_DocumentTypeOnChange$Action"))) {
...
try {return controller.safeExecuteAsyncJSNode(tradershub_RealAccountCreation_IdentityVerification_mvc_controller_Input_DocumentTypeOnChange_JavaScript1JS, "JavaScript1", "Input_DocumentTypeOnChange", {
SelectedDocument: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getRealSignupIDVDocumentName(), OS.DataTypes.DataTypes.Text),
...
}set _input_DocumentTypeOnChange$Action(value) {this.__input_DocumentTypeOnChange$Action = value;
}
...
try {return controller.safeExecuteAsyncJSNode(tradershub_RealAccountCreation_IdentityVerification_mvc_controller_NextOnClick_ValidateIDVJS, "ValidateIDV", "NextOnClick", {
SelectedDocument: OS.DataConversion.JSNodeParamConverter.to(tradershubClientVariables.getRealSignupIDVDocumentName(), OS.DataTypes.DataTypes.Text),
