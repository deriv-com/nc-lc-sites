...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_AddMoreAccount_mvc_controller_OnAfterFetch_ModifyDataJS, "ModifyData", "OnAfterFetch", {
...
get _addNewAccountAction$Action() {if(!(this.hasOwnProperty("__addNewAccountAction$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_AddMoreAccount_mvc_controller_AddNewAccountAction_NewAccountRealPayloadJS, "NewAccountRealPayload", "AddNewAccountAction", {
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_AddMoreAccount_mvc_controller_AddNewAccountAction_UpdateAccountListJS, "UpdateAccountList", "AddNewAccountAction", {
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_AddMoreAccount_mvc_controller_AddNewAccountAction_RemoveSelectedAccountJS, "RemoveSelectedAccount", "AddNewAccountAction", {
SelectedCurrency: OS.DataConversion.JSNodeParamConverter.to(model.variables.availableAccountsVar.getCurrent(callContext.iterationContext).codeAttr, OS.DataTypes.DataTypes.Text),
...
}set _addNewAccountAction$Action(value) {this.__addNewAccountAction$Action = value;
}
...
accountsList[$parameters.LoginId] = { token: $parameters.Token };
