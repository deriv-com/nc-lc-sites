...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.PersonalDetails"; }
...
get _iconOnClick$Action() {if(!(this.hasOwnProperty("__iconOnClick$Action"))) {
...
try {controller.ensureControllerAlive("IconOnClick");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_PersonalDetails_mvc_controller_IconOnClick_OpenDatePickerJS, "OpenDatePicker", "IconOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _iconOnClick$Action(value) {this.__iconOnClick$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_PersonalDetails_mvc_controller_OnReady_InitializeFlatpickrJS, "InitializeFlatpickr", "OnReady", {
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_PersonalDetails_mvc_controller_SaveOnClick_ValidateJS, "Validate", "SaveOnClick", {
...
try {return controller.safeExecuteJSNode(tradershub_RealAccountCreation_PersonalDetails_mvc_controller_SaveOnClick_RudderStackJS, "RudderStack", "SaveOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteClientAction(controller._iconOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
