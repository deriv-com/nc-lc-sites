define("tradershub.FinancialAssessmentFlow.EducationLevel.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.model$ST_0dd6e149ce474591a764bb53175023a1Structure"], function (OSRuntimeCore, tradershubModel) {
...
define("tradershub.FinancialAssessmentFlow.EducationLevel.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "react", "@outsystems/runtime-view-js", "tradershub.FinancialAssessmentFlow.EducationLevel.mvc$model", "tradershub.FinancialAssessmentFlow.EducationLevel.mvc$controller", "tradershub.clientVariables", "tradershub.Layouts.RealAccountCreationLayout.mvc$view", "@outsystems/runtime-widgets-js", "tradershub.FinancialAssessmentFlow.AssessmentBlock.mvc$view", "tradershub.model$ST_0dd6e149ce474591a764bb53175023a1Structure"], function (OSRuntimeCore, tradershubModel, tradershubController, React, OSView, tradershub_FinancialAssessmentFlow_EducationLevel_mvc_model, tradershub_FinancialAssessmentFlow_EducationLevel_mvc_controller, tradershubClientVariables, tradershub_Layouts_RealAccountCreationLayout_mvc_view, OSWidgets, tradershub_FinancialAssessmentFlow_AssessmentBlock_mvc_view) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "FinancialAssessmentFlow.EducationLevel"; }
...
screen: ""
        ...
        get modelFactory() {
            return tradershub_FinancialAssessmentFlow_EducationLevel_mvc_model;
        }

        get controllerFactory() {
            return tradershub_FinancialAssessmentFlow_EducationLevel_mvc_controller;
        }
...
mandatory: false,
style: "radio-group",
variable: model.createVariable(OS.DataTypes.DataTypes.Text, tradershubClientVariables.getFinancialAssessmentEducationLevel(), function (value) {
tradershubClientVariables.setFinancialAssessmentEducationLevel(value);
}),
_idProps: {
service: idService,
name: "RadioGroup"
...
_dependencies: [asPrimitiveValue(tradershubClientVariables.getFinancialAssessmentEducationLevel()), asPrimitiveValue(model.variables.isRequiredVar)]
}));
        }
    }
...
span.setAttribute("outsystems.function.key", "7a614509-8bcd-429c-a5f8-b563900eb818");
...
if(((tradershubClientVariables.getFinancialAssessmentEducationLevel() === OS.BuiltinFunctions.nullTextIdentifier()))) {
// IsRequired = True
model.variables.isRequiredVar = true;
} else {
// Destination: /tradershub/NetAnnualIncome
return OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "financial-assessment/net-annual-income", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Default), callContext, true);
}
