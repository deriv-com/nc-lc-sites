...
function(t) {
    ...
    function s(i, s, e, o) {
        i.hasOwnProperty(s) || (i[s] = o.apply(null, e), "function" == typeof CustomEvent && t.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: s,
                module: i[s]
            }
    ...
    s(i, "Extensions/Annotations/AnnotationChart.js", [i["Core/Utilities.js"]], function(t) {
        ...
        return class {
            ...
            onMouseDown(t) {
                ...
                i.cancelClick = !1, i.chart.hasDraggedAnnotation = !0, i.removeDrag = o(s, e || l ? "touchmove" : "mousemove", function(t) {
                    ...
                    t && (t.cancelClick = i.hasDragged), i.cancelClick = i.hasDragged, i.chart.hasDraggedAnnotation = !1, i.hasDragged && n(r(t, i), "afterUpdate"), i.hasDragged = !1, i.onMouseUp()
                }, e || l ? {
                    passive: !1
                } : void 0)
            }
        ...
        class f extends t {
            ...
            render(t) {
                ...
                this.graphic = this.annotation.chart.renderer.path([
                    ["M", 0, 0]
                ]).attr(s).add(t), this.tracker = this.annotation.chart.renderer.path([
                    ["M", 0, 0]
            ...
            setMarkers(t) {
                ...
                ["markerStart", "markerEnd"].forEach(function(o) {
                    ...
                    if (d) {
                        for (c in e)
                            if ((d === ((a = e[c]).attributes && a.attributes.id) || d === a.id) && "marker" === a.tagName) {
                                r = a;
                                break
                            } r && (p = t[o] = s.renderer.addMarker((i.id || h()) + "-" + d, l(r, {
                            color: n
                        })), t.attr(o, p.getAttribute("id")))
                    }
                })
            }
        }
        ...
        class n extends t {
            ...
            getAttrs(t, i) {
                let s = t.x,
                    ...
                    n = i.y,
                    a = (s + o) / 2,
                    r = Math.sqrt((s - o) * (s - o) / 4 + (e - n) * (e - n) / 4),
                    l = 180 * Math.atan((n - e) / (o - s)) / Math.PI;
                return a < s && (l += 180), {
                    cx: a,
                    cy: (e + n) / 2,
                    rx: r,
        ...
        class h extends t {
            ...
            position(t) {
                let i = this.graphic,
                    ...
                    d, u, g, m, f = a.series.visible && s.prototype.isInsidePlot.call(a);
                if (i && f) {
                    let {
                        width: t = 0,
                        height: s = 0
                    ...
                    l.distance && o ? d = o.getPosition.call({
                        ...
                        width: t,
                        height: s
                    }), u), "justify" === this.options.overflow && (d = h.alignedPosition(h.justifiedOptions(e, i, l, d), u))), l.crop && (g = d.x - e.plotLeft, m = d.y - e.plotTop, f = e.isInsidePlot(g, m) && e.isInsidePlot(g + t, m + s))
                }
                return f ? d : null
            }
        }
        ...
        function c(t, i, l, p, d, u) {
            ...
            let f = this.addInput,
                x = this.lang;
            r(p, (s, e) => {
                g = "" !== l ? l + "." + e : e, a(s) && (!n(s) || n(s) && a(s[0]) ? ((m = x[e] || e).match(/\d/g) || d.push([!0, m, t]), c.call(this, t, i, g, s, d, !1)) : d.push([this, g, "annotation", t, s]))
        ...
        function b(i, s, e, o) {
            function n(t, s) {
                ...
                x.call(a, i, t, s, y), e && (e.style.display = "block"), u && t.options && h("input", {
                    type: "hidden",
        ...
        return {
            addForm: function(t, i, s) {
                ...
                f(n[0]), y.call(this, t, n[0]), b.call(this, t, n[0], "add"), e = n[0].querySelectorAll(".highcharts-popup-rhs-col")[0], this.addButton(e, o.addButton || "add", "add", e, s), f(n[1]), b.call(this, t, n[1], "edit"), e = n[1].querySelectorAll(".highcharts-popup-rhs-col")[0], this.addButton(e, o.saveButton || "save", "edit", e, s), this.addButton(e, o.removeButton || "remove", "remove", e, s)
            },
            getAmount: function() {
                let t = 0;
        ...
        class E extends p {
            ...
            destroy() {
                ...
                this.labels.forEach(i), this.shapes.forEach(i), this.clipXAxis = null, this.clipYAxis = null, x(t.labelCollectors, this.labelCollector), super.destroy(), this.destroyControlTarget(), f(this, t)
            }
            destroyItem(t) {
        ...
        function T(t) {
            ...
            function o(t) {
                ...
                e && e.call(i, t), o !== i ? (s.deselectAnnotation(), s.activeAnnotation = i, i.setControlPointsVisibility(!0), x(s, "showPopup", {
                    annotation: i,
                ...
                })) : x(s, "closePopup"), t.activeAnnotation = !0
            }
        ...
        class D {
            ...
            bindingsButtonClick(t, i, s) {
                let e = this.chart,
                    ...
                    n = !0;
                this.selectedButtonElement && (this.selectedButtonElement.classList === t.classList && (n = !1), x(this, "deselectButton", {
                    button: this.selectedButtonElement
                }), this.nextEvent && (this.currentUserDetails && "annotations" === this.currentUserDetails.coll && e.removeAnnotation(this.currentUserDetails), this.mouseMoveEvent = this.nextEvent = !1)), n ? (this.selectedButton = i, this.selectedButtonElement = t, x(this, "selectButton", {
                    button: t
                }), i.init && i.init.call(this, t, s), (i.start || i.steps) && e.renderer.boxWrapper.addClass("highcharts-draw-mode")) : (e.stockTools && t.classList.remove("highcharts-active"), o.removeClass("highcharts-draw-mode"), this.nextEvent = !1, this.mouseMoveEvent = !1, this.selectedButton = null)
            }
            bindingsChartClick(t, i) {
                ...
                s && (s.cancelClick || i.activeAnnotation || !i.target.parentNode || function(t, i) {
                    ...
                    s.cancelClick = !1
                }, 0) : x(this, "closePopup")), e && e.start && (this.nextEvent ? (this.nextEvent(i, this.currentUserDetails), this.steps && (this.stepIndex++, e.steps[this.stepIndex] ? this.mouseMoveEvent = this.nextEvent = e.steps[this.stepIndex] : (x(this, "deselectButton", {
                    button: this.selectedButtonElement
                }), o.removeClass("highcharts-draw-mode"), e.end && e.end.call(this, i, this.currentUserDetails), this.nextEvent = !1, this.mouseMoveEvent = !1, this.selectedButton = null))) : (this.currentUserDetails = e.start.call(this, i), this.currentUserDetails && e.steps ? (this.stepIndex = 0, this.steps = !0, this.mouseMoveEvent = this.nextEvent = e.steps[this.stepIndex]) : (x(this, "deselectButton", {
                    button: this.selectedButtonElement
            ...
            annotationToFields(t) {
                ...
                function r(i, s, o, a, h) {
                    let c;
                    o && f(i) && -1 === n.indexOf(s) && ((o.indexOf && o.indexOf(s)) >= 0 || o[s] || !0 === o) && (b(i) ? (a[s] = [], i.forEach((t, i) => {
                        A(t) ? (a[s][i] = {}, E(t, (t, o) => {
                            r(t, o, e[s], a[s][i], s)
                        })) : r(t, 0, e[s], a[s], s)
