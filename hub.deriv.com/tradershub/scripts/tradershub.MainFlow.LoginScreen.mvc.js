...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "MainFlow.LoginScreen"; }
...
get _onClickLogin$Action() {if(!(this.hasOwnProperty("__onClickLogin$Action"))) {
...
try {controller.ensureControllerAlive("OnClickLogin");
...
}set _onClickLogin$Action(value) {this.__onClickLogin$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onClickLogin$Action, callContext);
} finally {
if(span) {
span.end();
}
