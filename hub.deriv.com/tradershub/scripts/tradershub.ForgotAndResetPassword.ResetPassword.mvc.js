...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "ForgotAndResetPassword.ResetPassword"; }
...
get _sendNewPassword$Action() {if(!(this.hasOwnProperty("__sendNewPassword$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_ForgotAndResetPassword_ResetPassword_mvc_controller_SendNewPassword_reset_password_payloadJS, "reset_password_payload", "SendNewPassword", {
...
}set _sendNewPassword$Action(value) {this.__sendNewPassword$Action = value;
}

get _resetMyPasswordOnClick$Action() {if(!(this.hasOwnProperty("__resetMyPasswordOnClick$Action"))) {
...
}set _resetMyPasswordOnClick$Action(value) {this.__resetMyPasswordOnClick$Action = value;
}
