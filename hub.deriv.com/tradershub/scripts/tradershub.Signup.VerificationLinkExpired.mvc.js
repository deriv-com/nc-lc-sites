define("tradershub.Signup.VerificationLinkExpired.mvc$model", ["@outsystems/runtime-core-js", "tradershub.model", "OutSystemsUI.controller", "tradershub.Layouts.SignupLayoutTopMenu.mvc$model", "OutSystemsUI.controller$IsPhone", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI"], function (OSRuntimeCore, tradershubModel, OutSystemsUIController, tradershub_Layouts_SignupLayoutTopMenu_mvcModel) {
...
define("tradershub.Signup.VerificationLinkExpired.mvc$view", ["@outsystems/runtime-core-js", "tradershub.model", "tradershub.controller", "OutSystemsUI.controller", "react", "@outsystems/runtime-view-js", "tradershub.Signup.VerificationLinkExpired.mvc$model", "tradershub.Signup.VerificationLinkExpired.mvc$controller", "tradershub.clientVariables", "tradershub.Layouts.SignupLayoutTopMenu.mvc$view", "@outsystems/runtime-widgets-js", "OutSystemsUI.controller$IsPhone", "tradershub.referencesHealth", "tradershub.referencesHealth$OutSystemsUI"], function (OSRuntimeCore, tradershubModel, tradershubController, OutSystemsUIController, React, OSView, tradershub_Signup_VerificationLinkExpired_mvc_model, tradershub_Signup_VerificationLinkExpired_mvc_controller, tradershubClientVariables, tradershub_Layouts_SignupLayoutTopMenu_mvc_view, OSWidgets) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Signup.VerificationLinkExpired"; }
...
screen: ""
        ...
        get modelFactory() {
            return tradershub_Signup_VerificationLinkExpired_mvc_model;
        }

        get controllerFactory() {
            return tradershub_Signup_VerificationLinkExpired_mvc_controller;
        }
...
image: OS.Navigation.VersionedURL.getVersionedUrl("img/tradershub.warning.svg"),
type: /*Static*/ 0,
_idProps: {
service: idService,
uuid: "3"
