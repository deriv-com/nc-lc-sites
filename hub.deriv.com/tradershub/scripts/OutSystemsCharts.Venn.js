...
function(e) {
    ...
    function r(t, r, n, i) {
        t.hasOwnProperty(r) || (t[r] = i.apply(null, n), "function" == typeof CustomEvent && e.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: r,
                module: t[r]
            }
    ...
    r(t, "Core/Geometry/CircleUtilities.js", [t["Core/Geometry/GeometryUtilities.js"]], function(e) {
                        ...
                        a = t.reduce(function(t, s) {
                            let {
                                ...
                                let a = e[n],
                                    u = r(a, s),
                                    c = r(a, o),
                                    f = c - u + (c < u ? 2 * Math.PI : 0),
                                    h = c - f / 2,
                                    p = i(l, {
                                        x: a.x + a.r * Math.sin(h),
                                        y: a.y + a.r * Math.cos(h)
                                    }),
                                    {
                                        r: d
                                    } = a;
                                return p > 2 * d && (p = 2 * d), (!t || t.width > p) && (t = {
                                    r: d,
                                    largeArc: p > d ? 1 : 0,
                                    width: p,
                                    x: s.x,
        ...
        function g(e, t, r, n, i) {
            ...
            if (0 === s) c = t;
                ...
                for (; h++ <= l && 0 !== f && u > a;) u = (r - t) / 2, s * (f = e(c = t + u)) > 0 ? t = c : r = c;
            return c
        }
        ...
        class O extends m {
            ...
            static getLabelValues(e, t) {
                ...
                let i = O.getLabelPosition(n.internal, n.external),
            ...
            static layout(e) {
                ...
                if (e.length > 0) {
                    ...
                    for (let s of e) {
                        ...
                        l && (t[o] = l, r[o] = O.getLabelValues(s, i))
                    }
                }
                return {
                    mapOfIdToShape: t,
            ...
            static updateFieldBoundaries(e, t) {
                let r = t.x - t.r,
                    ...
                    i = t.y + t.r,
                    s = t.y - t.r;
                return (!A(e.left) || e.left > r) && (e.left = r), (!A(e.right) || e.right < n) && (e.right = n), (!A(e.top) || e.top > s) && (e.top = s), (!A(e.bottom) || e.bottom < i) && (e.bottom = i), e
            }
            animate(e) {
                if (!e) {
            ...
            translate() {
                ...
                let t = a.processVennData(this.options.data, O.splitter),
                    {
                        mapOfIdToShape: r,
                    ...
                    i = Object.keys(r).filter(e => {
                        let t = r[e];
                        return t && A(t.r)
                    }).reduce((e, t) => O.updateFieldBoundaries(e, r[t]), {
                        top: 0,
                        bottom: 0,
                        left: 0,
                        right: 0
                    }),
                    s = O.getScale(e.plotWidth, e.plotHeight, i),
                    o = s.scale,
                    l = s.centerX,
                    u = s.centerY;
                for (let e of this.points) {
                    let t = C(e.sets) ? e.sets : [],
                        ...
                        s = r[i],
                        a = n[i] || {},
                        c = e.options && e.options.dataLabels,
                        f, h = a.width,
                        p = a.position;
                    if (s) {
                        if (s.r) f = {
                        ...
                        p ? (p.x = l + p.x * o, p.y = u + p.y * o) : p = {}, A(h) && (h = Math.round(h * o))
                    }
                    e.shapeArgs = f, p && f && (e.plotX = p.x, e.plotY = p.y), h && f && (e.dlOptions = j(!0, {
                        style: {
                            width: h
                        }
                    }, M(c, !0) ? c : void 0)), e.name = e.options.name || t.join("∩")
                }
            }
        }
        return O.splitter = "highcharts-split", O.defaultOptions = j(m.defaultOptions, l), v(O.prototype, {
            axisTypes: [],
            directTouch: !0,
            isCartesian: !1,
            pointArrayMap: ["value"],
            pointClass: o,
            utils: a
        }), b(O, "afterSetOptions", function(e) {
