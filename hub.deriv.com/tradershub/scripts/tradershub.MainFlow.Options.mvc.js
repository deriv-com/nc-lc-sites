...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "MainFlow.Options"; }
...
isDefault: false,
onClick: function () {
try {OS.Navigation.navigateTo(OS.Navigation.generateScreenURL("tradershub", "wallets", {}), OS.Transitions.createTransition(OS.Transitions.TransitionAnimation.Default), null, true);
} catch (ex) {
...
get _botRedirection$Action() {if(!(this.hasOwnProperty("__botRedirection$Action"))) {
...
try {controller.ensureControllerAlive("BotRedirection");
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_BotRedirection_GenerateRedirectURLJS, "GenerateRedirectURL", "BotRedirection", {
...
}set _botRedirection$Action(value) {this.__botRedirection$Action = value;
}

get _checkShowAddMoreAccount$Action() {if(!(this.hasOwnProperty("__checkShowAddMoreAccount$Action"))) {
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_CheckShowAddMoreAccount_CheckShowAddMoreAccountJS, "CheckShowAddMoreAccount", "CheckShowAddMoreAccount", {
...
}set _checkShowAddMoreAccount$Action(value) {this.__checkShowAddMoreAccount$Action = value;
}

get _closeDerivGoModal$Action() {if(!(this.hasOwnProperty("__closeDerivGoModal$Action"))) {
...
try {controller.ensureControllerAlive("CloseDerivGoModal");
callContext = controller.callContext(callContext);
...
}set _closeDerivGoModal$Action(value) {this.__closeDerivGoModal$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_SetDemoValue_GenerateDemoAccountTokenJS, "GenerateDemoAccountToken", "SetDemoValue", {
...
get _titleContainerMobileOnClick$Action() {if(!(this.hasOwnProperty("__titleContainerMobileOnClick$Action"))) {
...
try {controller.ensureControllerAlive("TitleContainerMobileOnClick");
callContext = controller.callContext(callContext);
...
}set _titleContainerMobileOnClick$Action(value) {this.__titleContainerMobileOnClick$Action = value;
}
...
get _toggleDerivGoModal$Action() {if(!(this.hasOwnProperty("__toggleDerivGoModal$Action"))) {
...
try {controller.ensureControllerAlive("ToggleDerivGoModal");
callContext = controller.callContext(callContext);
...
}set _toggleDerivGoModal$Action(value) {this.__toggleDerivGoModal$Action = value;
}

get _smarttraderRedirection$Action() {if(!(this.hasOwnProperty("__smarttraderRedirection$Action"))) {
...
try {controller.ensureControllerAlive("SmarttraderRedirection");
callContext = controller.callContext(callContext);
var getURLVar = new OS.DataTypes.VariableHolder();
var getPlatformFromURLVar = new OS.DataTypes.VariableHolder();
var generateRedirectURLJSResult = new OS.DataTypes.VariableHolder();
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_SmarttraderRedirection_GenerateRedirectURLJS, "GenerateRedirectURL", "SmarttraderRedirection", {
IsStaging: OS.DataConversion.JSNodeParamConverter.to(getPlatformFromURLVar.value.isStagingOut, OS.DataTypes.DataTypes.Boolean),
...
}set _smarttraderRedirection$Action(value) {this.__smarttraderRedirection$Action = value;
}

get _dTraderRedirection$Action() {if(!(this.hasOwnProperty("__dTraderRedirection$Action"))) {
...
try {controller.ensureControllerAlive("DTraderRedirection");
callContext = controller.callContext(callContext);
var getURLVar = new OS.DataTypes.VariableHolder();
var getPlatformFromURLVar = new OS.DataTypes.VariableHolder();
var generateRedirectURLJSResult = new OS.DataTypes.VariableHolder();
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_DTraderRedirection_GenerateRedirectURLJS, "GenerateRedirectURL", "DTraderRedirection", {
IsStaging: OS.DataConversion.JSNodeParamConverter.to(getPlatformFromURLVar.value.isStagingOut, OS.DataTypes.DataTypes.Boolean),
...
}set _dTraderRedirection$Action(value) {this.__dTraderRedirection$Action = value;
}
...
try {return controller.safeExecuteJSNode(tradershub_MainFlow_Options_mvc_controller_OnAfterFetch_FilterAccountListJS, "FilterAccountList", "OnAfterFetch", {
...
get _mobileAccountSwitcherOnClick$Action() {if(!(this.hasOwnProperty("__mobileAccountSwitcherOnClick$Action"))) {
...
try {controller.ensureControllerAlive("MobileAccountSwitcherOnClick");
callContext = controller.callContext(callContext);
...
}set _mobileAccountSwitcherOnClick$Action(value) {this.__mobileAccountSwitcherOnClick$Action = value;
}

get _accountListItemOnClick$Action() {if(!(this.hasOwnProperty("__accountListItemOnClick$Action"))) {
...
}set _accountListItemOnClick$Action(value) {this.__accountListItemOnClick$Action = value;
}

get _openAccountSwitcherOnClick$Action() {if(!(this.hasOwnProperty("__openAccountSwitcherOnClick$Action"))) {
...
try {controller.ensureControllerAlive("OpenAccountSwitcherOnClick");
callContext = controller.callContext(callContext);
...
}set _openAccountSwitcherOnClick$Action(value) {this.__openAccountSwitcherOnClick$Action = value;
}

get _getBOLocks$Action() {if(!(this.hasOwnProperty("__getBOLocks$Action"))) {
...
}set _getBOLocks$Action(value) {this.__getBOLocks$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._botRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._closeDerivGoModal$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._titleContainerMobileOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._toggleDerivGoModal$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._smarttraderRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._dTraderRedirection$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._mobileAccountSwitcherOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._openAccountSwitcherOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
