...
function(t) {
    ...
    s(e, "Core/Axis/Color/ColorAxisComposition.js", [e["Core/Color/Color.js"], e["Core/Utilities.js"]], function(t, e) {
        ...
        return function(t) {
            ...
            function g() {
                let t = this,
                    e = this.data.length ? this.data : this.points,
        ...
        class y extends t {
            ...
            getOffset() {
                ...
                if (t) {
                    ...
                    }), s.render(), this.chart.getMargins(!0), this.added || (this.added = !0, this.labelLeft = 0, this.labelRight = this.width), this.chart.axisOffset[this.side] = e
                }
            }
            setLegendColor() {
                let t = this.horiz,
            ...
            getSize() {
                ...
                return {
                    width: f(d(o) ? x(o, t.chartWidth) : void 0, s?.symbolWidth, e ? y.defaultLegendLength : 12),
                    height: f(d(i) ? x(i, t.chartHeight) : void 0, s?.symbolHeight, e ? 12 : y.defaultLegendLength)
                }
            }
        }
    ...
    }), s(e, "Series/ColorMapComposition.js", [e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function(t, e) {
        var s;
        let {
            column: {
                prototype: i
        ...
        return function(t) {
            ...
            t.pointMembers = {
                ...
                colorAttribs: function(t) {
                    let e = {};
                    return r(t.color) && (!t.state || "normal" === t.state) && (e[this.colorProp || "fill"] = t.color), e
                },
                pointAttribs: i.pointAttribs
            }, t.compose = function(t) {
                return o(t.prototype.pointClass, "afterSetState", e), t
            }
        }(s || (s = {})), s
                    ...
                    if (!e || t.isDirtyData || t.isDirtyCanvas) {
                        ...
                        if (n && l && m) {
                            let {
                                ...
                                [v, v / C, r, "ceil"],
                                [A, A / b, !a, "floor"]
                            ].map(([t, e, s, i]) => s ? s => Math[i](t - e * s) : t => Math[i](e * t)), L = n.width = v + 1, I = L * (n.height = A + 1), S = (u - 1) / I, k = new Uint8ClampedArray(4 * I), j = (t, e) => 4 * Math.ceil(L * w(e - f) + M(t - m));
                            t.buildKDTree();
                            for (let t = 0; t < I; t++) {
                                ...
                                k.set(y(e.value, e), j(s, i))
                            }
                            l.putImageData(new ImageData(k, L), 0, 0), e ? e.attr({
                                ...h,
