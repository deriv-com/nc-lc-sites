...
function(t) {
    ...
    function i(t, e, i, n) {
        t.hasOwnProperty(e) || (t[e] = n.apply(null, i), "function" == typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: e,
                module: t[e]
            }
    ...
    i(e, "Series/Organization/OrganizationPoint.js", [e["Core/Series/SeriesRegistry.js"], e["Core/Utilities.js"]], function(t, e) {
    ...
    }), i(e, "Series/Organization/OrganizationSeries.js", [e["Series/Organization/OrganizationPoint.js"], e["Series/Organization/OrganizationSeriesDefaults.js"], e["Core/Series/SeriesRegistry.js"], e["Series/PathUtilities.js"], e["Core/Utilities.js"]], function(t, e, i, n, s) {
        let {
            sankey: o
        } = i.seriesTypes, {
            css: r,
        ...
        class p extends o {
            ...
            pointAttribs(t, e) {
                let i = o.prototype.pointAttribs.call(this, t, e),
                    n = t.isNode ? t.level : t.fromNode.level,
                    s = this.mapOptionsToLevel[n || 0] || {},
                    r = t.options,
                    a = s.states && s.states[e] || {},
                    l = d(a.borderRadius, r.borderRadius, s.borderRadius, this.options.borderRadius),
                    p = d(a.linkColor, r.linkColor, s.linkColor, this.options.linkColor, a.link && a.link.color, r.link && r.link.color, s.link && s.link.color, this.options.link && this.options.link.color),
                    g = d(a.linkLineWidth, r.linkLineWidth, s.linkLineWidth, this.options.linkLineWidth, a.link && a.link.lineWidth, r.link && r.link.lineWidth, s.link && s.link.lineWidth, this.options.link && this.options.link.lineWidth),
                    u = d(a.linkOpacity, r.linkOpacity, s.linkOpacity, this.options.linkOpacity, a.link && a.link.linkOpacity, r.link && r.link.linkOpacity, s.link && s.link.linkOpacity, this.options.link && this.options.link.linkOpacity);
                return t.isNode ? h(l) && (i.r = l) : (i.stroke = p, i["stroke-width"] = g, i.opacity = u, delete i.fill), i
            }
            translateLink(t) {
                let e = this.chart,
                    i = this.options,
                    s = t.fromNode,
                    o = t.toNode,
                    r = d(i.linkLineWidth, i.link.lineWidth),
                    a = Math.round(r) % 2 / 2,
                    h = d(i.link.offset, .5),
                    l = d(t.options.link && t.options.link.type, i.link.type);
                if (s.shapeArgs && o.shapeArgs) {
                    let p = i.hangingIndent,
                        g = "right" === i.hangingSide,
                        u = o.options.offset,
                        f = /%$/.test(u) && parseInt(u, 10),
                        c = e.inverted,
                        k = Math.floor((s.shapeArgs.x || 0) + (s.shapeArgs.width || 0)) + a,
                        m = Math.floor((s.shapeArgs.y || 0) + (s.shapeArgs.height || 0) / 2) + a,
                        y = Math.floor(o.shapeArgs.x || 0) + a,
                        L = Math.floor((o.shapeArgs.y || 0) + (o.shapeArgs.height || 0) / 2) + a,
                        b;
                    if (c && (k -= s.shapeArgs.width || 0, y += o.shapeArgs.width || 0), b = this.colDistance ? Math.floor(y + (c ? 1 : -1) * (this.colDistance - this.nodeWidth) / 2) + a : Math.floor((y + k) / 2) + a, f && (f >= 50 || f <= -50) && (b = y = Math.floor(y + (c ? -.5 : .5) * (o.shapeArgs.width || 0)) + a, L = o.shapeArgs.y || 0, f > 0 && (L += o.shapeArgs.height || 0)), o.hangsFrom === s && (e.inverted ? (m = g ? Math.floor((s.shapeArgs.y || 0) + p / 2) + a : Math.floor((s.shapeArgs.y || 0) + (s.shapeArgs.height || 0) - p / 2) + a, L = g ? (o.shapeArgs.y || 0) + p / 2 : (o.shapeArgs.y || 0) + (o.shapeArgs.height || 0)) : m = Math.floor((s.shapeArgs.y || 0) + p / 2) + a, b = y = Math.floor((o.shapeArgs.x || 0) + (o.shapeArgs.width || 0) / 2) + a), t.plotX = b, t.plotY = (m + L) / 2, t.shapeType = "path", "straight" === l) t.shapeArgs = {
                        d: [
                            ["M", k, m],
                            ["L", y, L]
                        ]
            ...
            translateNode(t, e) {
                ...
                if (u) {
                    if ("cumulative" === a)
                        for (p.height -= r, i.inverted && !o && (p.y -= g * r); u;) p.y += (o ? 1 : g) * r, u = u.hangsFrom;
                    else if ("shrink" === a)
                        for (; u && p.height > r + h;) p.height -= r, (!i.inverted || o) && (p.y += r), u = u.hangsFrom;
                    else p.height -= r, (!i.inverted || o) && (p.y += r)
                }
                t.nodeHeight = i.inverted ? p.width : p.height, t.shapeArgs && !t.hangsFrom && (t.shapeArgs = l(t.shapeArgs, {
                    x: (t.shapeArgs.x || 0) + d / 2 - (t.shapeArgs.width || 0) / 2,
            ...
            drawDataLabels() {
                ...
                if (t.linkTextPath && t.linkTextPath.enabled)
                    for (let t of this.points) t.options.dataLabels = l(t.options.dataLabels, {
                        useHTML: !1
                    });
                super.drawDataLabels()
            }
        }
        return p.defaultOptions = l(o.defaultOptions, e), a(p.prototype, {
            pointClass: t
        }), i.registerSeriesType("organization", p), p
