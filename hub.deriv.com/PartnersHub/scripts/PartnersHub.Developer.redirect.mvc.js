...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Developer.redirect"; }
...
get _redirectCheck$Action() {if(!(this.hasOwnProperty("__redirectCheck$Action"))) {
...
try {controller.ensureControllerAlive("RedirectCheck");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Developer_redirect_mvc_controller_RedirectCheck_CheckRedirectTypeJS, "CheckRedirectType", "RedirectCheck", {
...
}set _redirectCheck$Action(value) {this.__redirectCheck$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._redirectCheck$Action, callContext);
} finally {
if(span) {
span.end();
}
