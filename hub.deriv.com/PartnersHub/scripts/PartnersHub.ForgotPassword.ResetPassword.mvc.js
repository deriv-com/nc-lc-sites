...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "ForgotPassword.ResetPassword"; }
...
screen: ""
        ...
        static getBlocks() {
            return [PartnersHub_Layouts_LayoutSignup_mvc_view, PartnersHub_Layouts_DeviceLayout_mvc_view, PartnersHub_Common_AlertBlock_mvc_view, PartnersHub_ForgotPassword_ResetPasswordBlock_mvc_view, CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModal_mvc_view];
        }
...
get _onResetPassword$Action() {if(!(this.hasOwnProperty("__onResetPassword$Action"))) {
...
try {controller.ensureControllerAlive("OnResetPassword");
...
}set _onResetPassword$Action(value) {this.__onResetPassword$Action = value;
}

get _redirect$Action() {if(!(this.hasOwnProperty("__redirect$Action"))) {
...
try {controller.ensureControllerAlive("redirect");
callContext = controller.callContext(callContext);
...
}set _redirect$Action(value) {this.__redirect$Action = value;
}

get _goToLogin$Action() {if(!(this.hasOwnProperty("__goToLogin$Action"))) {
...
try {controller.ensureControllerAlive("GoToLogin");
callContext = controller.callContext(callContext);
// Execute Action: RedirectToOauth
PartnersHubController.default.redirectToOauth$Action(callContext);
} finally {
...
}set _goToLogin$Action(value) {this.__goToLogin$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onResetPassword$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._redirect$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._goToLogin$Action, callContext);
} finally {
if(span) {
span.end();
}
