...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Home.WhatsAppBanner"; }
...
get _onClickJoinNow$Action() {if(!(this.hasOwnProperty("__onClickJoinNow$Action"))) {
...
try {controller.ensureControllerAlive("OnClickJoinNow");
...
}set _onClickJoinNow$Action(value) {this.__onClickJoinNow$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onClickJoinNow$Action, callContext);
} finally {
if(span) {
span.end();
}
