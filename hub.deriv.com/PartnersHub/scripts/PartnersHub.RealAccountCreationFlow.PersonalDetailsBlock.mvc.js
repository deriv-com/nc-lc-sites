...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.PersonalDetailsBlock"; }
...
text: [$text(getTranslation("0T3Wi9jMUEaxXFsiJf7cxQ#Value", "First (and middle) name"))],
_idProps: {
service: idService,
uuid: "4"
},
...
mandatory: true,
maxLength: 50,
prompt: OS.Injector.resolve(OS.ServiceNames.TranslationsService).getMessage("hBJlxfgynUmzZ9AhSwOZXw#ValueExpression.1768419283.1", "Enter your first (and middle) name"),
style: "form-control",
...
prompt: "YYYY-MM-DD",
style: "form-control",
variable: model.createVariable(OS.DataTypes.DataTypes.Text, PartnersHubClientVariables.getRealSignupDateofBirth(), function (value) {
...
get _datePickerOnSelected$Action() {if(!(this.hasOwnProperty("__datePickerOnSelected$Action"))) {
...
PartnersHubClientVariables.setRealSignupDateofBirth(OS.BuiltinFunctions.dateTimeToText(vars.value.selectedDateTimeInLocal));
} finally {
if(span) {
span.end();
}
...
}set _datePickerOnSelected$Action(value) {this.__datePickerOnSelected$Action = value;
}

get _openDateOfBirthContainer$Action() {if(!(this.hasOwnProperty("__openDateOfBirthContainer$Action"))) {
...
try {controller.ensureControllerAlive("OpenDateOfBirthContainer");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_PersonalDetailsBlock_mvc_controller_OpenDateOfBirthContainer_ValidateFirstandLastNameJS, "ValidateFirstandLastName", "OpenDateOfBirthContainer", {
...
}set _openDateOfBirthContainer$Action(value) {this.__openDateOfBirthContainer$Action = value;
}
...
span.setAttribute("outsystems.function.key", "c0ed8f82-ec54-405b-a4cf-a8ec806b737d");
span.setAttribute("outsystems.function.owner.name", "PartnersHub");
span.setAttribute("outsystems.function.owner.key", "9587f849-ee05-428a-81d2-3be0a1b1dccc");
span.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION");
}
...
get _buttonOnClick$Action() {if(!(this.hasOwnProperty("__buttonOnClick$Action"))) {
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_PersonalDetailsBlock_mvc_controller_ButtonOnClick_ValidateJS, "Validate", "ButtonOnClick", {
DateOfBirth: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupDateofBirth(), OS.DataTypes.DataTypes.Text),
FirstName: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupFirstName(), OS.DataTypes.DataTypes.Text),
LastName: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupLastName(), OS.DataTypes.DataTypes.Text),
ValidationErrors: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text),
ValidFields: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
...
}set _buttonOnClick$Action(value) {this.__buttonOnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._openDateOfBirthContainer$Action, callContext);
} finally {
if(span) {
span.end();
}
...
get onClickNextStep$Action() {if(!(this.hasOwnProperty("_onClickNextStep$Action"))) {
...
}set onClickNextStep$Action(value) {this._onClickNextStep$Action = value;
}
...
return function ($parameters, $actions, $roles, $public) {
function stripTimestamp(dateString) {
    return dateString.split(' ')[0]; // Take the date portion before the space
}


const payload = {
    // DateOfBirth: convertToDateOfBirthFormat($parameters.DateOfBirth),
    DateOfBirth: stripTimestamp($parameters.DateOfBirth),
    FirstName: $parameters.FirstName,
    LastName: $parameters.LastName,
}
...
const validationSchema = yup.object().shape({
    ...
    .trim()
    .matches(
        /^(?:(?:19|20)\d{2})-(?:(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1\d|2[0-8])|(?:0[1-9]|1[0-2])-(29|30)|(?:0[1-9]|1[0-2])-31|(?:0[1-9]|1[0-2])-29(?=-?(?:19|20)([02468]|[13579][26])$)))$/,
...
"hBJlxfgynUmzZ9AhSwOZXw#ValueExpression.1768419283.1": "Prénom (et deuxième prénom)",
...
"8wPzweYOjEW2uxdLwdFzSA#ValueExpression.1197690936.1": "Nome próprio (e segundo nome)",
"2mZm2HFVgEyXiVPF5ncAMA#Value": "Nome próprio (e segundo nome)",
...
"0T3Wi9jMUEaxXFsiJf7cxQ#Value": "Nome próprio (e segundo nome)"
};
});
