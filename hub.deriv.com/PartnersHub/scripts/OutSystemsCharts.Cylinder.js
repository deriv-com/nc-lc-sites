...
function(e) {
    ...
    function r(t, r, s, i) {
        t.hasOwnProperty(r) || (t[r] = i.apply(null, s), "function" == typeof CustomEvent && e.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: r,
                module: t[r]
            }
    ...
    r(t, "Series/Cylinder/SVGElement3DCylinder.js", [t["Core/Color/Color.js"], t["Core/Renderer/RendererRegistry.js"]], function(e, t) {
        ...
        function C(e, t, r) {
            ...
            let {
                ...
                height: y = 0,
                alphaCorrection: d = 0
            } = t, h = u(t.depth, l, 0), p = Math.min(l, h) / 2, c = n * (e.options.chart.options3d.beta - 90 + d), C = (t.y || 0) + (r ? y : 0), a = .5519 * p, f = l / 2 + (t.x || 0), g = h / 2 + (t.z || 0), m = [{
                x: 0,
                y: C,
                z: p
            }, {
