...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreation.AccountPurposeBlock"; }
...
get _listItem2OnClick$Action() {if(!(this.hasOwnProperty("__listItem2OnClick$Action"))) {
...
try {controller.ensureControllerAlive("ListItem2OnClick");
...
}set _listItem2OnClick$Action(value) {this.__listItem2OnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._listItem2OnClick$Action, callContext, purposeIn);
} finally {
if(span) {
span.end();
}
