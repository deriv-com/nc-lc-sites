...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Events.SpeakersBlock"; }
...
text: [$text(getTranslation("fnjbbcrASE+gN242r_ZjnQ#Value", "Speakers"))],
_idProps: {
service: idService,
uuid: "1"
},
...
type: /*External*/ 1,
url: ("https://pub-25da5cfeec1b4792a6dbb4d683cd363d.r2.dev/Images/Speakers/" + model.variables.getEventSpeakerMappingsByEventIdAggr.listOut.getCurrent(callContext.iterationContext).eventSpeakersAttr.imageNameAttr),
_idProps: {
service: idService,
uuid: "4"
},
_widgetRecordProvider: widgetsRecordProvider,
url_dataFetchStatus: OS.Model.calculateDataFetchStatus(model.variables.getEventSpeakerMappingsByEventIdAggr.dataFetchStatusAttr)
...
get getEventSpeakerMappingsByEventId$AggrRefresh() {if(!(this.hasOwnProperty("_getEventSpeakerMappingsByEventId$AggrRefresh"))) {
this._getEventSpeakerMappingsByEventId$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetEventSpeakerMappingsByEventId", "screenservices/PartnersHub/Events/SpeakersBlock/ScreenDataSetGetEventSpeakerMappingsByEventId", "rcCGvRkefpV3u5YxMvkFIw", maxRecords, startIndex, function (b) {
...
}set getEventSpeakerMappingsByEventId$AggrRefresh(value) {this._getEventSpeakerMappingsByEventId$AggrRefresh = value;
}
...
define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.ar-001", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "المتحدثون"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.de-DE", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Redner"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.es-ES", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Ponentes"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.fr-FR", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Intervenants"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.it-IT", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Relatori"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.pl-PL", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Mówcy"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.pt-PT", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Palestrantes"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources.ru-RU", [], function () {
return {
"fnjbbcrASE+gN242r_ZjnQ#Value": "Спикеры"
};
});

define("PartnersHub.Events.SpeakersBlock.mvc$translationsResources", ["exports", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.ar-001", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.de-DE", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.es-ES", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.fr-FR", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.it-IT", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.pl-PL", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.pt-PT", "PartnersHub.Events.SpeakersBlock.mvc$translationsResources.ru-RU"], function (exports, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_ar001, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_deDE, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_esES, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_frFR, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_itIT, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_plPL, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_ptPT, PartnersHub_Events_SpeakersBlock_mvc_translationsResources_ruRU) {
return {
"ar-001": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_ar001,
"isRTL": true
},
"de-DE": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_deDE,
"isRTL": false
},
"es-ES": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_esES,
"isRTL": false
},
"fr-FR": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_frFR,
"isRTL": false
},
"it-IT": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_itIT,
"isRTL": false
},
"pl-PL": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_plPL,
"isRTL": false
},
"pt-PT": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_ptPT,
"isRTL": false
},
"ru-RU": {
"translations": PartnersHub_Events_SpeakersBlock_mvc_translationsResources_ruRU,
"isRTL": false
}
};
});
