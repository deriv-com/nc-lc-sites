...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreationFlow.RealAccountCreation"; }
...
get _goBack$Action() {if(!(this.hasOwnProperty("__goBack$Action"))) {
...
try {controller.ensureControllerAlive("GoBack");
...
}set _goBack$Action(value) {this.__goBack$Action = value;
}

get _goNextStep$Action() {if(!(this.hasOwnProperty("__goNextStep$Action"))) {
...
try {controller.ensureControllerAlive("GoNextStep");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_controller_GoNextStep_SetCurrentStepInQueryParamsJS, "SetCurrentStepInQueryParams", "GoNextStep", {
...
}set _goNextStep$Action(value) {this.__goNextStep$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_controller_OnReady_GetAuthTokenJS, "GetAuthToken", "OnReady", {
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_controller_OnReady_CheckIfIDVIsSupportedJSJS, "CheckIfIDVIsSupportedJS", "OnReady", {
...
get _closeandGoToDashboardExitModal$Action() {if(!(this.hasOwnProperty("__closeandGoToDashboardExitModal$Action"))) {
...
try {controller.ensureControllerAlive("CloseandGoToDashboardExitModal");
callContext = controller.callContext(callContext);
...
}set _closeandGoToDashboardExitModal$Action(value) {this.__closeandGoToDashboardExitModal$Action = value;
}

get _setExitModal$Action() {if(!(this.hasOwnProperty("__setExitModal$Action"))) {
...
try {controller.ensureControllerAlive("setExitModal");
callContext = controller.callContext(callContext);
...
}set _setExitModal$Action(value) {this.__setExitModal$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._goBack$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._goNextStep$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._closeandGoToDashboardExitModal$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._setExitModal$Action, callContext, isOpenIn);
} finally {
if(span) {
span.end();
}
...
define("PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.ar-001", [], function () {
return {
...
return {
"INDkvkIe4k2YS9jNZT4rPQ#Value": "Vervollständigen Sie die Einrichtung, um Zugang zu individuellen Provisionsplänen zu erhalten.",
...
return {
"INDkvkIe4k2YS9jNZT4rPQ#Value": "Terminez la configuration pour accéder aux plans de commission personnalisés.",
...
return {
"INDkvkIe4k2YS9jNZT4rPQ#Value": "Ukończ konfigurację, aby uzyskać dostęp do niestandardowych planów prowizyjnych.",
...
return {
"INDkvkIe4k2YS9jNZT4rPQ#Value": "Conclua a configuração para aceder a planos de comissão personalizados.",
"eA6s0SHKm0+A8rlV+JQ4gw#Value": "Sair da configuração do perfil?",
"qG1AIVmW3kew2FwCyxYUew#Value": "Saltar"
};
});
...
define("PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources", ["exports", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.ar-001", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.de-DE", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.es-ES", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.fr-FR", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.it-IT", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.pl-PL", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.pt-PT", "PartnersHub.RealAccountCreationFlow.RealAccountCreation.mvc$translationsResources.ru-RU"], function (exports, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_ar001, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_deDE, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_esES, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_frFR, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_itIT, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_plPL, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_ptPT, PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_ruRU) {
return {
"ar-001": {
"translations": PartnersHub_RealAccountCreationFlow_RealAccountCreation_mvc_translationsResources_ar001,
"isRTL": true
},
"de-DE": {
