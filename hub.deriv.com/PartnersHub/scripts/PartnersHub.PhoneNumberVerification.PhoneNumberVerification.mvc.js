define("PartnersHub.PhoneNumberVerification.PhoneNumberVerification.mvc$model", ["@outsystems/runtime-core-js", "PartnersHub.model", "OutSystemsUI.model", "RESTAPIWebsocketOfficial.model", "PartnersHub.controller", "RESTAPIWebsocketOfficial.controller", "PartnersHub.Layouts.LayoutDashboard.mvc$model", "PartnersHub.Layouts.DeviceLayout.mvc$model", "PartnersHub.PhoneNumberVerification.PhoneNumberVerificationBlock.mvc$model", "PartnersHub.Common.AlertBlock.mvc$model", "PartnersHub.PhoneNumberVerification.OTPVerificationBlock.mvc$model", "PartnersHub.PhoneNumberVerification.VerifyEmailPhoneNumberVerification.mvc$model", "OutSystemsUI.model$ST_60f22bd2e9b10a22278b8afe6d7f601aStructure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$OutSystemsUI", "PartnersHub.model$RL_c0f17d75c546075264f5d075e00ba65b", "RESTAPIWebsocketOfficial.model$ST_c864353821feed79663806f3e445d40eStructure", "PartnersHub.referencesHealth$RESTAPIWebsocketOfficial", "RESTAPIWebsocketOfficial.model$ST_5fc2e4a935064c1413d6e989e87decd2Structure", "PartnersHub.model$ST_6e5c732e48bd98c4d439ed63bb1fb9c4Structure", "PartnersHub.model$ST_b04713a56316d52deeb5eab31f0fde62Structure", "PartnersHub.controller$SendPhoneNumberChallenge", "PartnersHub.model$ST_e00c986a2a7690520557f1ea58ae1d82Structure", "RESTAPIWebsocketOfficial.model$ST_f502318fbe2f943e6cfbba125766780aStructure", "PartnersHub.controller$SendAuthorize", "PartnersHub.controller$UseDevice", "RESTAPIWebsocketOfficial.controller$GetWebsiteStatus", "PartnersHub.model$ST_0be4704c381e15995202804b221a5e3aStructure", "PartnersHub.controller$SendResidenceList", "RESTAPIWebsocketOfficial.controller$GetSettings", "PartnersHub.model$ST_31dbcfc5cd9ae02da0ba12249f6ccfcdStructure", "PartnersHub.model$RL_ad0d7e810e49e61265e2d337c04416fc"], function (OSRuntimeCore, PartnersHubModel, OutSystemsUIModel, RESTAPIWebsocketOfficialModel, PartnersHubController, RESTAPIWebsocketOfficialController, PartnersHub_Layouts_LayoutDashboard_mvcModel, PartnersHub_Layouts_DeviceLayout_mvcModel, PartnersHub_PhoneNumberVerification_PhoneNumberVerificationBlock_mvcModel, PartnersHub_Common_AlertBlock_mvcModel, PartnersHub_PhoneNumberVerification_OTPVerificationBlock_mvcModel, PartnersHub_PhoneNumberVerification_VerifyEmailPhoneNumberVerification_mvcModel) {
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "PhoneNumberVerification.PhoneNumberVerification"; }
...
get _onClickCarrier$Action() {if(!(this.hasOwnProperty("__onClickCarrier$Action"))) {
...
}set _onClickCarrier$Action(value) {this.__onClickCarrier$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_PhoneNumberVerification_mvc_controller_OnReady_GetAuthTokenJS, "GetAuthToken", "OnReady", {
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_PhoneNumberVerification_mvc_controller_OnReady_CheckQueryParamJS, "CheckQueryParam", "OnReady", {
...
get _onClickSuccess$Action() {if(!(this.hasOwnProperty("__onClickSuccess$Action"))) {
...
try {controller.ensureControllerAlive("OnClickSuccess");
callContext = controller.callContext(callContext);
...
}set _onClickSuccess$Action(value) {this.__onClickSuccess$Action = value;
}

get _onClickResendCodeLink$Action() {if(!(this.hasOwnProperty("__onClickResendCodeLink$Action"))) {
...
try {controller.ensureControllerAlive("OnClickResendCodeLink");
callContext = controller.callContext(callContext);
...
}set _onClickResendCodeLink$Action(value) {this.__onClickResendCodeLink$Action = value;
}

get _onClickChangePhoneNumber$Action() {if(!(this.hasOwnProperty("__onClickChangePhoneNumber$Action"))) {
...
try {controller.ensureControllerAlive("OnClickChangePhoneNumber");
callContext = controller.callContext(callContext);
// CurrentBlock = "PhoneNumberVerificationBlock"
model.variables.currentBlockVar = "PhoneNumberVerificationBlock";
} finally {
...
}set _onClickChangePhoneNumber$Action(value) {this.__onClickChangePhoneNumber$Action = value;
}

get _onClickNextStep$Action() {if(!(this.hasOwnProperty("__onClickNextStep$Action"))) {
...
try {controller.ensureControllerAlive("OnClickNextStep");
callContext = controller.callContext(callContext);
...
}set _onClickNextStep$Action(value) {this.__onClickNextStep$Action = value;
}

get _onChallengeEmail$Action() {if(!(this.hasOwnProperty("__onChallengeEmail$Action"))) {
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_PhoneNumberVerification_mvc_controller_OnChallengeEmail_GetAuthTokenJS, "GetAuthToken", "OnChallengeEmail", {
Token: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
}set _onChallengeEmail$Action(value) {this.__onChallengeEmail$Action = value;
}
...
try {controller.ensureControllerAlive("OnClickBack");
callContext = controller.callContext(callContext);
...
get _hideResendCodePopup$Action() {if(!(this.hasOwnProperty("__hideResendCodePopup$Action"))) {
...
try {controller.ensureControllerAlive("HideResendCodePopup");
callContext = controller.callContext(callContext);
...
}set _hideResendCodePopup$Action(value) {this.__hideResendCodePopup$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onClickSuccess$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickResendCodeLink$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickChangePhoneNumber$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickNextStep$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickBack$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._hideResendCodePopup$Action, callContext);
} finally {
if(span) {
span.end();
}
...
define("PartnersHub.PhoneNumberVerification.PhoneNumberVerification.mvc$translationsResources.ar-001", [], function () {
return {
