...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.PersonalDetailsScreen"; }
...
get _personalDetailsBlockOnClickNextStep$Action() {if(!(this.hasOwnProperty("__personalDetailsBlockOnClickNextStep$Action"))) {
...
try {controller.ensureControllerAlive("PersonalDetailsBlockOnClickNextStep");
callContext = controller.callContext(callContext);
...
}set _personalDetailsBlockOnClickNextStep$Action(value) {this.__personalDetailsBlockOnClickNextStep$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._personalDetailsBlockOnClickNextStep$Action, callContext);
} finally {
if(span) {
span.end();
}
