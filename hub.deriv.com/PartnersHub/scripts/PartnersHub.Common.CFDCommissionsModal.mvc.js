    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get _eyeButtonHandler$Action() {
                if (!(this.hasOwnProperty("__eyeButtonHandler$Action"))) {
                    this.__eyeButtonHandler$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("EyeButtonHandler", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("EyeButtonHandler");
                                ...
                                OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(PartnersHub_Common_CFDCommissionsModal_mvc_controller_EyeButtonHandler_JavaScript1JS, "JavaScript1", "EyeButtonHandler", {
            ...
            set _eyeButtonHandler$Action(value) {
                this.__eyeButtonHandler$Action = value;
            }

            get _okHandler$Action() {
                if (!(this.hasOwnProperty("__okHandler$Action"))) {
                    this.__okHandler$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("OkHandler", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("OkHandler");
                                callContext = controller.callContext(callContext);
            ...
            set _okHandler$Action(value) {
                this.__okHandler$Action = value;
            }

            get _submitHandler$Action() {
                if (!(this.hasOwnProperty("__submitHandler$Action"))) {
                                            ...
                                            return OS.Flow.executeSequence(function() {
                                                if (!(((((model.variables.cfdCommissionsPasswordErrorsVar.lengthAttr === "true") || (model.variables.cfdCommissionsPasswordErrorsVar.hasAtLeastOneUppercaseAndOneLowercaseAttr === "true")) || (model.variables.cfdCommissionsPasswordErrorsVar.hasAtLeastOneNumberAttr === "true"))))) {
                                                    javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                                        ...
                                                        try {
                                                            return controller.safeExecuteJSNode(PartnersHub_Common_CFDCommissionsModal_mvc_controller_SubmitHandler_JavaScript1JS, "JavaScript1", "SubmitHandler", {
                                                    ...
                                                    return RESTAPIWebsocketOfficialController.default.postTradingPlatformPasswordChange$Action(PartnersHubClientVariables.getServer(), function() {
                                                        ...
                                                        javaScript2JSResult.value = OS.Logger.startActiveSpan("JavaScript2", function(span) {
                                                            ...
                                                            try {
                                                                return controller.safeExecuteJSNode(PartnersHub_Common_CFDCommissionsModal_mvc_controller_SubmitHandler_JavaScript2JS, "JavaScript2", "SubmitHandler", {
            ...
            set _submitHandler$Action(value) {
                this.__submitHandler$Action = value;
            }
                        ...
                        return OS.Logger.startActiveSpan("CFDPasswordInputOnChange", function(span) {
                            ...
                            try {
                                ...
                                javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(PartnersHub_Common_CFDCommissionsModal_mvc_controller_CFDPasswordInputOnChange_JavaScript1JS, "JavaScript1", "CFDPasswordInputOnChange", {
            ...
            get _tryAgainHandler$Action() {
                if (!(this.hasOwnProperty("__tryAgainHandler$Action"))) {
                    this.__tryAgainHandler$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("TryAgainHandler", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("TryAgainHandler");
                                callContext = controller.callContext(callContext);
            ...
            set _tryAgainHandler$Action(value) {
                this.__tryAgainHandler$Action = value;
            }

            get _closeButtonHandler$Action() {
                if (!(this.hasOwnProperty("__closeButtonHandler$Action"))) {
                    this.__closeButtonHandler$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("CloseButtonHandler", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("CloseButtonHandler");
                                callContext = controller.callContext(callContext);
                                // showCFDCommissionModal = False
                                PartnersHubClientVariables.setshowCFDCommissionModal(false);
            ...
            set _closeButtonHandler$Action(value) {
                this.__closeButtonHandler$Action = value;
            }
            ...
            eyeButtonHandler$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("EyeButtonHandler__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._eyeButtonHandler$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            okHandler$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("OkHandler__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._okHandler$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            tryAgainHandler$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("TryAgainHandler__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._tryAgainHandler$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
            ...
            closeButtonHandler$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("CloseButtonHandler__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._closeButtonHandler$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
