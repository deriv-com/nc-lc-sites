...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Layouts.LayoutEndpointPage"; }
...
get _onClickRedirectToDashboard$Action() {if(!(this.hasOwnProperty("__onClickRedirectToDashboard$Action"))) {
...
try {controller.ensureControllerAlive("OnClickRedirectToDashboard");
...
}set _onClickRedirectToDashboard$Action(value) {this.__onClickRedirectToDashboard$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_Layouts_LayoutEndpointPage_mvc_controller_OnRender_JavaScript1JS, "JavaScript1", "OnRender", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {controller.ensureControllerAlive("LogInOnClick");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteClientAction(controller._onClickRedirectToDashboard$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._logInOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
"RzfRPsfq0U+UE_D6UKErng#Value": "Souhaitez-vous vraiment vous déconnecter?"
};
});
...
"oiMnGVHyYUyzhvGIqB3aNQ#Value": "Terminar sessão",
"Ki5BxBoDTkOa4g55lJmHrw#Value.2011110042.1": "Cancelar",
"+by514qXEUmhswcRfSZcJA#Value.-1272307305.1": "Sim, pretendo terminar sessão",
"RzfRPsfq0U+UE_D6UKErng#Value": "Tem certeza de que deseja terminar sessão?"
};
});
...
define("PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources", ["exports", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.ar-001", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.de-DE", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.es-ES", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.fr-FR", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.it-IT", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.pl-PL", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.pt-PT", "PartnersHub.Layouts.LayoutEndpointPage.mvc$translationsResources.ru-RU"], function (exports, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_ar001, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_deDE, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_esES, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_frFR, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_itIT, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_plPL, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_ptPT, PartnersHub_Layouts_LayoutEndpointPage_mvc_translationsResources_ruRU) {
return {
"ar-001": {
