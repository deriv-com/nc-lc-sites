...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Layouts.LayoutSignup"; }
...
get _redirectToDashboard$Action() {if(!(this.hasOwnProperty("__redirectToDashboard$Action"))) {
...
try {controller.ensureControllerAlive("RedirectToDashboard");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Layouts_LayoutSignup_mvc_controller_RedirectToDashboard_JavaScript1JS, "JavaScript1", "RedirectToDashboard", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _redirectToDashboard$Action(value) {this.__redirectToDashboard$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._redirectToDashboard$Action, callContext);
} finally {
if(span) {
span.end();
}
