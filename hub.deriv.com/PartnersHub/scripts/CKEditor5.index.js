...
require(["@outsystems/runtime-core-js", "CKEditor5.appDefinition", "@outsystems/runtime-core-js/debugger"], function (OSRuntimeCore, CKEditor5AppDefinition, NullDebugger) {
var OS = OSRuntimeCore;
if(OS.Navigation.ensureRequestSecurity()) {
return;
}

Promise.all([OS.Application.default.initialize(CKEditor5AppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
if(success) {
