...
var O, F = new o.Controller.ControllerFactory(O, z);
...
var B, W = new L.Controller.ControllerFactory(B, T);
var C = y,
        ...
        internalRender() {
            ...
            return m.createElement("div", this.getRootNodeProperties(), m.createElement(_, {
                ...
                extendedEvents: {
                    onClick: a(function() {
                        var v = r.clone();
                        u.leftButtonAction$Action(u.callContext(v))
                    }, "onClick")
                },
...
<path d="M5.21875 12.5625C5.0625 12.4062 5 12.2188 5 12C5 11.8125 5.0625 11.625 5.21875 11.4688L10.7188 6.21875C11.0312 5.9375 11.5 5.9375 11.7812 6.25C12.0625 6.53125 12.0625 7.03125 11.75 7.3125L7.59375 11.25H18.25C18.6562 11.25 19 11.5938 19 12C19 12.4375 18.6562 12.75 18.25 12.75H7.59375L11.75 16.7188C12.0625 17 12.0625 17.4688 11.7812 17.7812C11.5 18.0938 11.0312 18.0938 10.7188 17.8125L5.21875 12.5625Z" fill="#101213"/>\r
</svg>`,
                ...
                align: 0,
                animate: !1,
                style: s.getCachedValue(t.getId("vP59WT0vzEi1j83cC4hZCg.Style"), function() {
                    return s.variables.isSidebarTitleIn ? "ph-sidebar-custom-title" : "title"
                }, function() {
                    return s.variables.isSidebarTitleIn
                }),
                visible: !0,
                _idProps: {
                    service: t,
                ...
                _widgetRecordProvider: e,
                style_dataFetchStatus: C.Model.calculateDataFetchStatus(s.variables._isSidebarTitleInDataFetchStatus)
            }, m.createElement(k, {
                ...
                extendedEvents: {
                    onClick: a(function() {
                        var v = r.clone();
                        u.rightButtonAction$Action(u.callContext(v))
                    }, "onClick")
                },
                extendedProperties: {
