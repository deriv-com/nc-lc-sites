define("PartnersHub.Events.EventList.mvc$model", ["@outsystems/runtime-core-js", "PartnersHub.model", "CloneAWSSignatureVersion4.model", "PartnersHub.controller", "PartnersHub.Common.SkeletonLoader.mvc$model", "PartnersHub.Events.EventBannerImage.mvc$model", "OutSystemsUI.Utilities.InlineSVG.mvc$model", "CloneAWSSignatureVersion4.model$ST_2a7ac328ca1ac01bfb70fc00237a0973Structure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$CloneAWSSignatureVersion4", "CloneAWSSignatureVersion4.model$ST_5aac4e0eb05c7f4c7f14409f9c2e3d4dStructure", "PartnersHub.model$ST_23ff1d290ec4691b1c668ad437100cd0Structure", "PartnersHub.controller$RudderstackTrackEvent", "PartnersHub.model$RC_74fba7fb18697339da88244fa3fc5435", "PartnersHub.model$RL_c442eae242b2b02d93575027f6e75422"], function (OSRuntimeCore, PartnersHubModel, CloneAWSSignatureVersion4Model, PartnersHubController, PartnersHub_Common_SkeletonLoader_mvcModel, PartnersHub_Events_EventBannerImage_mvcModel, OutSystemsUI_Utilities_InlineSVG_mvcModel) {
...
Model._hasValidationWidgetsValue = ((PartnersHub_Common_SkeletonLoader_mvcModel.hasValidationWidgets || PartnersHub_Events_EventBannerImage_mvcModel.hasValidationWidgets) || OutSystemsUI_Utilities_InlineSVG_mvcModel.hasValidationWidgets);
}
...
define("PartnersHub.Events.EventList.mvc$view", ["@outsystems/runtime-core-js", "PartnersHub.model", "PartnersHub.controller", "CloneAWSSignatureVersion4.model", "react", "@outsystems/runtime-view-js", "PartnersHub.Events.EventList.mvc$model", "PartnersHub.Events.EventList.mvc$controller", "PartnersHub.clientVariables", "PartnersHub.Common.SkeletonLoader.mvc$view", "@outsystems/runtime-widgets-js", "PartnersHub.Events.EventBannerImage.mvc$view", "OutSystemsUI.Utilities.InlineSVG.mvc$view", "CloneAWSSignatureVersion4.model$ST_2a7ac328ca1ac01bfb70fc00237a0973Structure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$CloneAWSSignatureVersion4", "CloneAWSSignatureVersion4.model$ST_5aac4e0eb05c7f4c7f14409f9c2e3d4dStructure", "PartnersHub.model$ST_23ff1d290ec4691b1c668ad437100cd0Structure", "PartnersHub.controller$RudderstackTrackEvent", "PartnersHub.model$RC_74fba7fb18697339da88244fa3fc5435", "PartnersHub.model$RL_c442eae242b2b02d93575027f6e75422"], function (OSRuntimeCore, PartnersHubModel, PartnersHubController, CloneAWSSignatureVersion4Model, React, OSView, PartnersHub_Events_EventList_mvc_model, PartnersHub_Events_EventList_mvc_controller, PartnersHubClientVariables, PartnersHub_Common_SkeletonLoader_mvc_view, OSWidgets, PartnersHub_Events_EventBannerImage_mvc_view, OutSystemsUI_Utilities_InlineSVG_mvc_view) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Events.EventList"; }
...
screen: ""
        ...
        static getBlocks() {
            return [PartnersHub_Common_SkeletonLoader_mvc_view, PartnersHub_Events_EventBannerImage_mvc_view, OutSystemsUI_Utilities_InlineSVG_mvc_view];
        }
...
inputs: {
EventDetails: model.getCachedValue(idService.getId("A8vN53M6KEWkcvMmKCq45Q.EventDetails"), function () {
return function () {
var rec = new CloneAWSSignatureVersion4Model.ST_2a7ac328ca1ac01bfb70fc00237a0973Structure();
rec.idAttr = model.variables.getEventsAggr.listOut.getCurrent(callContext.iterationContext).eventAttr.idAttr;
rec.fileNamesAttr = function () {
var rec = new CloneAWSSignatureVersion4Model.ST_5aac4e0eb05c7f4c7f14409f9c2e3d4dStructure();
rec.desktopImageNameAttr = "";
rec.mobileImageNameAttr = model.variables.getEventsAggr.listOut.getCurrent(callContext.iterationContext).eventAttr.mobileImageAttr;
return rec;
}();
return rec;
}();
}, function () {
return model.variables.getEventsAggr.listOut.getCurrent(callContext.iterationContext).eventAttr.idAttr;
}, function () {
return model.variables.getEventsAggr.listOut.getCurrent(callContext.iterationContext).eventAttr.mobileImageAttr;
}),
_eventDetailsInDataFetchStatus: OS.Model.calculateDataFetchStatus(model.variables.getEventsAggr.dataFetchStatusAttr)
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
inputs: {
EventDetails: model.getCachedValue(idService.getId("lc66TWA3tEeXkblM7AV6UQ.EventDetails"), function () {
return function () {
var rec = new CloneAWSSignatureVersion4Model.ST_2a7ac328ca1ac01bfb70fc00237a0973Structure();
rec.idAttr = model.variables.getEventsAggr.listOut.getCurrent(callContext.iterationContext).eventAttr.idAttr;
rec.fileNamesAttr = function () {
...
define("PartnersHub.Events.EventList.mvc$controller", ["@outsystems/runtime-core-js", "PartnersHub.model", "PartnersHub.controller", "CloneAWSSignatureVersion4.model", "PartnersHub.languageResources", "PartnersHub.clientVariables", "PartnersHub.Events.EventList.mvc$translationsResources", "CloneAWSSignatureVersion4.model$ST_2a7ac328ca1ac01bfb70fc00237a0973Structure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$CloneAWSSignatureVersion4", "CloneAWSSignatureVersion4.model$ST_5aac4e0eb05c7f4c7f14409f9c2e3d4dStructure", "PartnersHub.model$ST_23ff1d290ec4691b1c668ad437100cd0Structure", "PartnersHub.controller$RudderstackTrackEvent", "PartnersHub.model$RC_74fba7fb18697339da88244fa3fc5435", "PartnersHub.model$RL_c442eae242b2b02d93575027f6e75422"], function (OSRuntimeCore, PartnersHubModel, PartnersHubController, CloneAWSSignatureVersion4Model, PartnersHubLanguageResources, PartnersHubClientVariables, PartnersHub_Events_EventList_mvc_TranslationsResources) {
var OS = OSRuntimeCore;
...
get getEvents$AggrRefresh() {if(!(this.hasOwnProperty("_getEvents$AggrRefresh"))) {
this._getEvents$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetEvents", "screenservices/PartnersHub/Events/EventList/ScreenDataSetGetEvents", "BhipjVRlgfMImSn7wzourg", maxRecords, startIndex, function (b) {
...
}set getEvents$AggrRefresh(value) {this._getEvents$AggrRefresh = value;
}
...
get _getEventsOnAfterFetch$Action() {if(!(this.hasOwnProperty("__getEventsOnAfterFetch$Action"))) {
...
try {controller.ensureControllerAlive("GetEventsOnAfterFetch");
callContext = controller.callContext(callContext);
// IsLoading = False
...
}set _getEventsOnAfterFetch$Action(value) {this.__getEventsOnAfterFetch$Action = value;
}

get _onClickEvent$Action() {if(!(this.hasOwnProperty("__onClickEvent$Action"))) {
...
try {controller.ensureControllerAlive("OnClickEvent");
callContext = controller.callContext(callContext);
...
}set _onClickEvent$Action(value) {this.__onClickEvent$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._getEventsOnAfterFetch$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickEvent$Action, callContext);
} finally {
if(span) {
span.end();
}
