...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Home.CommissionBanner"; }
...
get _onClickLearnMore$Action() {if(!(this.hasOwnProperty("__onClickLearnMore$Action"))) {
...
try {controller.ensureControllerAlive("OnClickLearnMore");
...
try {return controller.safeExecuteJSNode(PartnersHub_Home_CommissionBanner_mvc_controller_OnClickLearnMore_JavaScript1JS, "JavaScript1", "OnClickLearnMore", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _onClickLearnMore$Action(value) {this.__onClickLearnMore$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onClickLearnMore$Action, callContext);
} finally {
if(span) {
span.end();
}
