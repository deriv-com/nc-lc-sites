...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Home.PartnersHubDashboard"; }
...
get getLanguagesByEnabled$AggrRefresh() {if(!(this.hasOwnProperty("_getLanguagesByEnabled$AggrRefresh"))) {
...
}set getLanguagesByEnabled$AggrRefresh(value) {this._getLanguagesByEnabled$AggrRefresh = value;
}
...
get _continueSignupOnClick$Action() {if(!(this.hasOwnProperty("__continueSignupOnClick$Action"))) {
...
try {controller.ensureControllerAlive("ContinueSignupOnClick");
callContext = controller.callContext(callContext);
...
}set _continueSignupOnClick$Action(value) {this.__continueSignupOnClick$Action = value;
}

get _onSwitchLanguage$Action() {if(!(this.hasOwnProperty("__onSwitchLanguage$Action"))) {
...
}set _onSwitchLanguage$Action(value) {this.__onSwitchLanguage$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._continueSignupOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
