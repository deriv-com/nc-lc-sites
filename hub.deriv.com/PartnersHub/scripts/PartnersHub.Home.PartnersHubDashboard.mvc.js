    ...
    class View extends OSView.BaseView.BaseWebScreen {
        ...
        internalRender() {
            ...
            return React.createElement("div", this.getRootNodeProperties(), React.createElement(PartnersHub_Layouts_LayoutWithLoaderBlock_mvc_view, {
                ...
                placeholders: {
                    placeholder: new PlaceholderContent(function() {
                        return [React.createElement(OSWidgets.Popup, {
                            ...
                            _dependencies: [asPrimitiveValue(model.variables.getLanguagesByEnabledAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getLanguagesByEnabledAggr.listOut), asPrimitiveValue(PartnersHubClientVariables.getLanguage()), asPrimitiveValue(PartnersHubClientVariables.getisLanguageSwitcherEnabledFF())]
                        }), React.createElement(OSWidgets.Container, {
                            align: /*Default*/ 0,
                            animate: false,
                            visible: PartnersHubClientVariables.getisCFDCommissionsPlanFormEnabledFF(),
                            _idProps: {
                                service: idService,
                                uuid: "17"
                            },
                ...
                _dependencies: [asPrimitiveValue(PartnersHubClientVariables.getisWhatsappBannerEnabledFF()), asPrimitiveValue(PartnersHubClientVariables.getisEventSectionEnabledFF()), asPrimitiveValue(PartnersHubClientVariables.getisCFDCommissionsPlanFormEnabledFF()), asPrimitiveValue(model.variables.getLanguagesByEnabledAggr.dataFetchStatusAttr), asPrimitiveValue(model.variables.getLanguagesByEnabledAggr.listOut), asPrimitiveValue(PartnersHubClientVariables.getLanguage()), asPrimitiveValue(PartnersHubClientVariables.getisLanguageSwitcherEnabledFF()), asPrimitiveValue(model.variables.isLoadingVar), asPrimitiveValue(PartnersHubClientVariables.getIsNotAPartner())]
            }));
        }
    }
...
define("PartnersHub.Home.PartnersHubDashboard.mvc$translationsResources.ar-001", [], function() {
    return {
        "+nOma3+jdUeiUMTnooTcnw#Value": "Partner\'s Hub",
