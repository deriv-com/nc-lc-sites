...
get _createPartnerAccountOnClick$Action() {if(!(this.hasOwnProperty("__createPartnerAccountOnClick$Action"))) {
...
try {return controller.safeExecuteJSNode(PartnersHub_Signup_Signup_mvc_controller_CreatePartnerAccountOnClick_EmailCheckJS, "EmailCheck", "CreatePartnerAccountOnClick", {
...
}set _createPartnerAccountOnClick$Action(value) {this.__createPartnerAccountOnClick$Action = value;
}

get _redirectOAuth$Action() {if(!(this.hasOwnProperty("__redirectOAuth$Action"))) {
...
try {controller.ensureControllerAlive("RedirectOAuth");
callContext = controller.callContext(callContext);
...
}set _redirectOAuth$Action(value) {this.__redirectOAuth$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._redirectOAuth$Action, callContext);
} finally {
if(span) {
span.end();
}
