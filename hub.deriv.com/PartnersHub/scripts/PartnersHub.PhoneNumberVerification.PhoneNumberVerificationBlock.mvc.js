...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "PhoneNumberVerification.PhoneNumberVerificationBlock"; }
...
get _phoneNumberOnChange$Action() {if(!(this.hasOwnProperty("__phoneNumberOnChange$Action"))) {
...
try {controller.ensureControllerAlive("PhoneNumberOnChange");
...
}set _phoneNumberOnChange$Action(value) {this.__phoneNumberOnChange$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_PhoneNumberVerificationBlock_mvc_controller_OnClickChangePhoneNumber_GetAuthTokenJS, "GetAuthToken", "OnClickChangePhoneNumber", {
...
try {return controller.safeExecuteClientAction(controller._phoneNumberOnChange$Action, callContext);
} finally {
if(span) {
span.end();
}
...
get onClickCarrier$Action() {if(!(this.hasOwnProperty("_onClickCarrier$Action"))) {
...
}set onClickCarrier$Action(value) {this._onClickCarrier$Action = value;
}
...
"FxV7q67+PESG2K+jswQeTw#Value": "Guardar número de telemóvel",
"2aFi2aZkSkiNURR5ww02yg#Value": "Número de telefone",
"W+1M6YSgM0SMwhiJ0B0niQ#Value": "Introduza o seu número de telemóvel para receber um código de verificação por WhatsApp ou SMS."
};
});
