...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.StatesListScreenMobile"; }
...
get _statesListOnClickCountry$Action() {if(!(this.hasOwnProperty("__statesListOnClickCountry$Action"))) {
...
try {controller.ensureControllerAlive("StatesListOnClickCountry");
...
}set _statesListOnClickCountry$Action(value) {this.__statesListOnClickCountry$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._statesListOnClickCountry$Action, callContext, selectedStateIn);
} finally {
if(span) {
span.end();
}
