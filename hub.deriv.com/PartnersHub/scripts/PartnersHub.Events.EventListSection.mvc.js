    ...
    class View extends OSView.BaseView.BaseWebBlock {
        ...
        internalRender() {
            ...
            return React.createElement("div", this.getRootNodeProperties(), React.createElement(OSWidgets.Container, {
                ...
                value: ((("See all" + "(") + (model.variables.numberOfEventsVar.countNumberAttr).toString()) + ")"),
                _idProps: {
                    service: idService,
                    uuid: "5"
                },
    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get countEvent$ServerAction() {
                if (!(this.hasOwnProperty("_countEvent$ServerAction"))) {
                    this._countEvent$ServerAction = function(callContext) {
                        var controller = this.controller;
                        return OS.Logger.startActiveSpan("CountEvent", function(span) {
                            ...
                            return OS.Flow.tryFinally(function() {
                                return controller.callServerAction("CountEvent", "screenservices/PartnersHub/Events/EventListSection/ActionCountEvent", "HOJWy_UKFIf59CobsAhKhg", {}, controller.callContext(callContext), undefined, undefined, true).then(function(outputs) {
            ...
            set countEvent$ServerAction(value) {
                this._countEvent$ServerAction = value;
            }
                        ...
                        return OS.Logger.startActiveSpan("OnReady", function(span) {
                            ...
                            return OS.Flow.tryFinally(function() {
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    ...
                                    model.flush();
                                    return controller.countEvent$ServerAction(callContext).then(function(value) {
            ...
            get _seeallOnClick$Action() {
                if (!(this.hasOwnProperty("__seeallOnClick$Action"))) {
                    this.__seeallOnClick$Action = function(callContext) {
                        ...
                        return OS.Logger.startActiveSpan("SeeallOnClick", function(span) {
                            ...
                            try {
                                controller.ensureControllerAlive("SeeallOnClick");
                                callContext = controller.callContext(callContext);
            ...
            set _seeallOnClick$Action(value) {
                this.__seeallOnClick$Action = value;
            }
            ...
            seeallOnClick$Action(callContext) {
                ...
                return OS.Logger.startActiveSpan("SeeallOnClick__proxy", function(span) {
                    ...
                    try {
                        return controller.safeExecuteClientAction(controller._seeallOnClick$Action, callContext);
                    } finally {
                        if (span) {
                            span.end();
                        }
