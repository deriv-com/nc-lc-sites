...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "PhoneNumberVerification.PhoneNumberEmailVerificationBlock"; }
...
get _setHasTimerStarted$Action() {if(!(this.hasOwnProperty("__setHasTimerStarted$Action"))) {
...
try {controller.ensureControllerAlive("SetHasTimerStarted");
...
}set _setHasTimerStarted$Action(value) {this.__setHasTimerStarted$Action = value;
}

get _onClickVerifyImpl$Action() {if(!(this.hasOwnProperty("__onClickVerifyImpl$Action"))) {
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_PhoneNumberEmailVerificationBlock_mvc_controller_OnClickVerifyImpl_JavaScript1JS, "JavaScript1", "OnClickVerifyImpl", {
...
}set _onClickVerifyImpl$Action(value) {this.__onClickVerifyImpl$Action = value;
}

get _onClickTimer$Action() {if(!(this.hasOwnProperty("__onClickTimer$Action"))) {
...
try {controller.ensureControllerAlive("OnClickTimer");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_PhoneNumberEmailVerificationBlock_mvc_controller_OnClickTimer_JavaScript1JS, "JavaScript1", "OnClickTimer", {
...
}set _onClickTimer$Action(value) {this.__onClickTimer$Action = value;
}

get _setTimer$Action() {if(!(this.hasOwnProperty("__setTimer$Action"))) {
...
try {controller.ensureControllerAlive("SetTimer");
callContext = controller.callContext(callContext);
...
}set _setTimer$Action(value) {this.__setTimer$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._setHasTimerStarted$Action, callContext, hasTimerStarted2In);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickTimer$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._setTimer$Action, callContext, newTimerIn);
} finally {
if(span) {
span.end();
}
...
get onClickVerify$Action() {if(!(this.hasOwnProperty("_onClickVerify$Action"))) {
...
}set onClickVerify$Action(value) {this._onClickVerify$Action = value;
}
...
"t2V+7ijrtUC1usZPy65eUg#ValueExpression.1067057.1": "Sek.",
...
"zErnXc+8rkejGu1pau+Mkw#Value": "Wir haben einen Bestätigungslink an gesendet."
};
});
...
"Q9u_dsn2akyRVs7oPoyu_Q#ValueExpression.24546143.1": "Introduce el código de 6 dígitos",
...
return {
"EZAjLJFDH06o8UEIYyToBw#Value": " • Assurez-vous que l\'adresse e-mail n\'est pas bloquée par des pare-feux ou des filtres.",
"rKpSsbFKDkuJdwtE_LVClA#Value": " • Vérifiez votre dossier de spam.",
"q9Ce0nJ7LE2y1iDV05opbw#Value": " • Assurez-vous d\'avoir saisi votre adresse e-mail correctement.",
...
"zErnXc+8rkejGu1pau+Mkw#Value": "Nous avons envoyé un code de vérification à"
};
});
...
"zErnXc+8rkejGu1pau+Mkw#Value": "Abbiamo inviato un codice di verifica a"
};
});
...
"q9Ce0nJ7LE2y1iDV05opbw#Value": "Upewnij się, że adres e-mail został wpisany poprawnie.",
"t2V+7ijrtUC1usZPy65eUg#ValueExpression.-831934195.1": "Wyślij kod ponownie za",
"t2V+7ijrtUC1usZPy65eUg#ValueExpression.1067057.1": "sek",
...
"zErnXc+8rkejGu1pau+Mkw#Value": "Wysłaliśmy kod weryfikacyjny na"
};
});

define("PartnersHub.PhoneNumberVerification.PhoneNumberEmailVerificationBlock.mvc$translationsResources.pt-PT", [], function () {
return {
"EZAjLJFDH06o8UEIYyToBw#Value": "Certifique-se de que o e-mail não está a ser bloqueado por firewalls ou filtros.",
"rKpSsbFKDkuJdwtE_LVClA#Value": "Verifique a sua pasta de spam.",
"q9Ce0nJ7LE2y1iDV05opbw#Value": "Certifique-se de que introduziu corretamente o seu endereço de e-mail.",
"t2V+7ijrtUC1usZPy65eUg#ValueExpression.-831934195.1": "Reenviar código em",
"t2V+7ijrtUC1usZPy65eUg#ValueExpression.1067057.1": "seg ",
"h0PBgujWUEC88S0ttmjwkA#Value": "Reenviar código",
...
"zErnXc+8rkejGu1pau+Mkw#Value": "Enviámos um código de verificação para"
};
});

define("PartnersHub.PhoneNumberVerification.PhoneNumberEmailVerificationBlock.mvc$translationsResources.ru-RU", [], function () {
return {
"EZAjLJFDH06o8UEIYyToBw#Value": "• Убедитесь, что письмо не блокируется брандмауэром или фильтрами.",
"rKpSsbFKDkuJdwtE_LVClA#Value": "• Проверьте папку спам.",
"q9Ce0nJ7LE2y1iDV05opbw#Value": "• Убедитесь, что вы правильно ввели email.",
