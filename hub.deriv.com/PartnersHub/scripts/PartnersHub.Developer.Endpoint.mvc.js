...
CFDCommissionToggle2: OS.Model.ValidationWidgetRecord
};
}
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Developer.Endpoint"; }
...
text: [$text(getTranslation("ziEuACfu6U+lGvqYofBi3A#Value", "Show Unpublish Event"))],
_idProps: {
service: idService,
name: "CFDCommssion2"
},
...
enabled: true,
style: "switch",
variable: model.createVariable(OS.DataTypes.DataTypes.Boolean, PartnersHubClientVariables.getshowUnpublishEventFF(), function (value) {
PartnersHubClientVariables.setshowUnpublishEventFF(value);
}),
_idProps: {
service: idService,
...
_dependencies: [asPrimitiveValue(PartnersHubClientVariables.getshowUnpublishEventFF()), asPrimitiveValue(PartnersHubClientVariables.getisCFDCommissionsPlanFormEnabledFF()), asPrimitiveValue(PartnersHubClientVariables.getisLanguageSwitcherEnabledFF()), asPrimitiveValue(model.variables.oAuthAppID2Var), asPrimitiveValue(model.variables.serverURLVar)]
}));
        }
    }
...
get _resetEndpoint$Action() {if(!(this.hasOwnProperty("__resetEndpoint$Action"))) {
...
try {controller.ensureControllerAlive("ResetEndpoint");
...
try {return controller.safeExecuteJSNode(PartnersHub_Developer_Endpoint_mvc_controller_ResetEndpoint_JavaScript1JS, "JavaScript1", "ResetEndpoint", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _resetEndpoint$Action(value) {this.__resetEndpoint$Action = value;
}
...
try {controller.ensureControllerAlive("ButtonOnClick");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Developer_Endpoint_mvc_controller_ButtonOnClick_JavaScript1JS, "JavaScript1", "ButtonOnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(PartnersHub_Developer_Endpoint_mvc_controller_OnClick_JavaScript1JS, "JavaScript1", "OnClick", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteClientAction(controller._resetEndpoint$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._buttonOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
"z4E221d1vEeR43uMRxpE+A#Value": "Auf die ursprünglichen Einstellungen zurücksetzen",
...
return {
"ziEuACfu6U+lGvqYofBi3A#Value": "Sélecteur de langue",
"SnrIUlIHwUiamFowyHw2jg#Value": "Sélecteur de langue",
"NkzbLfXeBUerQrAW2zsQfA#Value": "Sélecteur de langue",
"z4E221d1vEeR43uMRxpE+A#Value": "Rétablir les paramètres par défaut",
"KIeuFldrS0KldY+5Z10Nrw#Value": "Soumettre",
"40bWnUM0M0qjslHd09SpUw#Value": "pour vous connecter à l\'aide du serveur ci-dessus.",
"ZIpQdKMSh029jJ2Kl8HJIg#Value": "ID de l\'application",
"jso1GJeBzkmbFB0QlMBT5Q#Value": "Créez un",
...
"z4E221d1vEeR43uMRxpE+A#Value": "Restaurar para as definições de origem",
"KIeuFldrS0KldY+5Z10Nrw#Value": "Enviar",
"40bWnUM0M0qjslHd09SpUw#Value": "para utilizar o servidor acima para iniciar sessão.",
"ZIpQdKMSh029jJ2Kl8HJIg#Value": "ID da app",
"jso1GJeBzkmbFB0QlMBT5Q#Value": "Registe-se em",
"tYSnXt74LEe+5+sVcqPLpw#Value": "Identificador da aplicação OAuth.",
"DWYZMDPB40Oa+r4IbtgTyg#Value": "Servidor",
