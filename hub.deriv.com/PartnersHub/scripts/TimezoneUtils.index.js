...
require(["@outsystems/runtime-core-js", "TimezoneUtils.appDefinition", "@outsystems/runtime-core-js/debugger"], function (OSRuntimeCore, TimezoneUtilsAppDefinition, NullDebugger) {
var OS = OSRuntimeCore;
if(OS.Navigation.ensureRequestSecurity()) {
return;
}

Promise.all([OS.Application.default.initialize(TimezoneUtilsAppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
if(success) {
