...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.Addressdetails"; }
...
get _input2OnClick$Action() {if(!(this.hasOwnProperty("__input2OnClick$Action"))) {
...
try {controller.ensureControllerAlive("Input2OnClick");
...
}set _input2OnClick$Action(value) {this.__input2OnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._input2OnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
"VflU1Ll_2kKj16bUwcatLA#Value": "État/Province (facultatif)",
"oXf1D8XdYEu4kkW1oi+PEQ#Value": "État/Province (facultatif)",
...
"VflU1Ll_2kKj16bUwcatLA#Value": "Województwo (opcjonalnie)",
"oXf1D8XdYEu4kkW1oi+PEQ#Value": "Województwo (opcjonalnie)",
...
"k8QD9Tu5pEKxQ8W5PhXhZg#Value": "Código Postal (opcional)",
"VflU1Ll_2kKj16bUwcatLA#Value": "Distrito/Região (opcional)",
"oXf1D8XdYEu4kkW1oi+PEQ#Value": "Distrito/Região (opcional)",
