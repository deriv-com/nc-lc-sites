...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Home.AffiliateProgramme"; }
...
get getAffiliateLinks$AggrRefresh() {if(!(this.hasOwnProperty("_getAffiliateLinks$AggrRefresh"))) {
...
}set getAffiliateLinks$AggrRefresh(value) {this._getAffiliateLinks$AggrRefresh = value;
}
...
get _onClickSeeAllVideo$Action() {if(!(this.hasOwnProperty("__onClickSeeAllVideo$Action"))) {
...
try {controller.ensureControllerAlive("OnClickSeeAllVideo");
...
try {return controller.safeExecuteJSNode(PartnersHub_Home_AffiliateProgramme_mvc_controller_OnClickSeeAllVideo_JavaScript1JS, "JavaScript1", "OnClickSeeAllVideo", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
}set _onClickSeeAllVideo$Action(value) {this.__onClickSeeAllVideo$Action = value;
}

get _onSlideMove$Action() {if(!(this.hasOwnProperty("__onSlideMove$Action"))) {
...
try {controller.ensureControllerAlive("OnSlideMove");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Home_AffiliateProgramme_mvc_controller_OnSlideMove_AttachClickHandlersToCarouselClonesJS, "AttachClickHandlersToCarouselClones", "OnSlideMove", {
...
}set _onSlideMove$Action(value) {this.__onSlideMove$Action = value;
}

get _onClickVideo$Action() {if(!(this.hasOwnProperty("__onClickVideo$Action"))) {
...
try {controller.ensureControllerAlive("OnClickVideo");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Home_AffiliateProgramme_mvc_controller_OnClickVideo_JavaScript1JS, "JavaScript1", "OnClickVideo", {
...
}set _onClickVideo$Action(value) {this.__onClickVideo$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onClickSeeAllVideo$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onSlideMove$Action, callContext, carouselIdIn);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickVideo$Action, callContext, videoLinkIn);
} finally {
if(span) {
span.end();
}
...
"T7D85Ou3vE61yWtLCd1Qjw#Value": "Découvrez-en plus sur YouTube"
};
});
...
"T7D85Ou3vE61yWtLCd1Qjw#Value": "Scopri di più su YouTube"
};
});
