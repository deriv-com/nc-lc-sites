...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Layouts.MobileProgressBarLayout"; }
...
return {
"2iMvGgd9qEuJciPIJfkzRw#Value": "Vervollständigen Sie die Einrichtung, um Zugang zu individuellen Provisionsplänen zu erhalten.",
"PUZk8rTKV0S6uWyOIu9xxQ#Value": "Profil-Einrichtung beenden?"
};
});
...
return {
"2iMvGgd9qEuJciPIJfkzRw#Value": "Terminez la configuration pour accéder aux plans de commission personnalisés.",
"PUZk8rTKV0S6uWyOIu9xxQ#Value": "Quitter la configuration de profil ?"
};
});
...
"PUZk8rTKV0S6uWyOIu9xxQ#Value": "Uscire dalla configurazione del profilo?"
};
});

define("PartnersHub.Layouts.MobileProgressBarLayout.mvc$translationsResources.pl-PL", [], function () {
return {
"2iMvGgd9qEuJciPIJfkzRw#Value": "Ukończ konfigurację, aby uzyskać dostęp do niestandardowych planów prowizyjnych.",
"PUZk8rTKV0S6uWyOIu9xxQ#Value": "Wyjść z ustawień profilu?"
};
});

define("PartnersHub.Layouts.MobileProgressBarLayout.mvc$translationsResources.pt-PT", [], function () {
return {
"2iMvGgd9qEuJciPIJfkzRw#Value": "Conclua a configuração para aceder a planos de comissões personalizados.",
"PUZk8rTKV0S6uWyOIu9xxQ#Value": "Sair da configuração do perfil?"
};
});

define("PartnersHub.Layouts.MobileProgressBarLayout.mvc$translationsResources.ru-RU", [], function () {
return {
"2iMvGgd9qEuJciPIJfkzRw#Value": "Завершите настройку, чтобы получить доступ к индивидуальным комиссиям.",
"PUZk8rTKV0S6uWyOIu9xxQ#Value": "Выйти из настройки профиля?"
};
});
