...
var se, oe = new ie.Controller.ControllerFactory(se, B);
var x = m,
    Me = _.PlaceholderContent,
    We = _.IteratorPlaceholderContent,
...
var h = m; {
    let t = class t extends h.Controller.BaseViewController {
            ...
            return this.hasOwnProperty("_getEventSpeakerMappingsByEventId$AggrRefresh") || (this._getEventSpeakerMappingsByEventId$AggrRefresh = function() {
                var e = function(s, n, d) {
                    var g = this.model,
                        S = this.controller,
                        d = S.callContext(d);
                    return S.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetEventSpeakerMappingsByEventId", "screenservices/PartnersHub/Events/SpeakersBlock/ScreenDataSetGetEventSpeakerMappingsByEventId", "N3wE2Mqf8P1+n8E0Qh0ZCw", s, n, function(y) {
                        g.variables.getEventSpeakerMappingsByEventIdAggr.dataFetchStatusAttr = y
                    }, function(y) {
                        g.variables.getEventSpeakerMappingsByEventIdAggr.replaceWith(h.DataConversion.ServerDataConverter.from(y, g.variables.getEventSpeakerMappingsByEventIdAggr.constructor))
                    }, void 0, void 0, void 0, d, X, !0)
                }.bind(this);
                return h.Logger.startActiveSpan("GetEventSpeakerMappingsByEventId", function(s) {
                    return s && (s.setAttribute("code.function", "GetEventSpeakerMappingsByEventId"), s.setAttribute("outsystems.function.key", "7560cc89-0ac2-41fd-aa26-40842c7a091c"), s.setAttribute("outsystems.function.owner.name", "PartnersHub"), s.setAttribute("outsystems.function.owner.key", "9587f849-ee05-428a-81d2-3be0a1b1dccc"), s.setAttribute("outsystems.function.type", "SCREEN_SERVICE_AGGREGATE_CALL")), h.Flow.tryFinally(function() {
                        return e()
                    }, function() {
                        s && s.end()
                    })
        ...
        get _onParametersChanged$Action() {
            return this.hasOwnProperty("__onParametersChanged$Action") || (this.__onParametersChanged$Action = function(e) {
                var s = this.model,
                    n = this.controller,
                    o = this.idService;
                return h.Logger.startActiveSpan("OnParametersChanged", function(g) {
                    return g && (g.setAttribute("code.function", "OnParametersChanged"), g.setAttribute("outsystems.function.key", "bc24ef44-c69d-415e-a0f0-ef1a44c00ce4"), g.setAttribute("outsystems.function.owner.name", "PartnersHub"), g.setAttribute("outsystems.function.owner.key", "9587f849-ee05-428a-81d2-3be0a1b1dccc"), g.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION")), h.Flow.tryFinally(function() {
                        return n.ensureControllerAlive("OnParametersChanged"), e = n.callContext(e), h.Flow.executeAsyncFlow(function() {
                            var S = n.getEventSpeakerMappingsByEventId$AggrRefresh(50, 0, e);
                            return s.flush(), S
                        })
                    }, function() {
                        g && g.end()
        ...
        onParametersChanged$Action(e) {
            ...
            return h.Logger.startActiveSpan("OnParametersChanged__proxy", function(n) {
...
var ue, ve = new h.Controller.ControllerFactory(ue, B);
var M = m,
    tt = _.PlaceholderContent,
    ...
    R = class R extends b.BaseWebBlock {
        ...
        internalRender() {
            ...
            return f.createElement("div", this.getRootNodeProperties(), f.createElement(u, {
                ...
                text: [S(y("fnjbbcrASE+gN242r_ZjnQ#Value", "Speakers"))],
                _idProps: {
                    service: e,
                    uuid: "1"
                },
                ...
                _widgetRecordProvider: n,
                source_dataFetchStatus: M.Model.calculateDataFetchStatus(t.variables.getEventSpeakerMappingsByEventIdAggr.dataFetchStatusAttr),
                placeholders: {
                    content: new Pe(function(a, O) {
                        return [f.createElement(u, {
                            ...
                            _widgetRecordProvider: n,
                            url_dataFetchStatus: M.Model.calculateDataFetchStatus(t.variables.getEventSpeakerMappingsByEventIdAggr.dataFetchStatusAttr)
                        }), f.createElement(u, {
                            align: 0,
                            animate: !1,
                            extendedProperties: {
                            ...
                            _widgetRecordProvider: n,
                            value_dataFetchStatus: M.Model.calculateDataFetchStatus(t.variables.getEventSpeakerMappingsByEventIdAggr.dataFetchStatusAttr)
                        }), f.createElement(E, {
                            gridProperties: {
                                classes: "OSFillParent"
                            },
                                ...
                                content: new C(function() {
                                    return [c.createElement(u, {
                                        ...
                                        return [c.createElement(F, {
                                            ...
                                            _dependencies: [d(t.variables.eventImagesVar.desktopImageAttr)]
                                        }), c.createElement(u, {
                                            align: 0,
                                            animate: !1,
                                            extendedProperties: {
                                            ...
                                            value: t.getCachedValue(e.getId("9D11JWuFykiyml3jEj1sRQ.Value"), function() {
                                                return t.variables.getEventByIdAggr.listOut.getCurrent(o.iterationContext).eventAttr.titleAttr + ", " + v.BuiltinFunctions.year(v.BuiltinFunctions.textToDateTime(t.variables.getEventByIdAggr.listOut.getCurrent(o.iterationContext).eventAttr.dateTimeAttr)).toString()
                                            }, function() {
                                                return t.variables.getEventByIdAggr.listOut.getCurrent(o.iterationContext).eventAttr.titleAttr
                                            }, function() {
                                                return t.variables.getEventByIdAggr.listOut.getCurrent(o.iterationContext).eventAttr.dateTimeAttr
                                            }),
                                            _idProps: {
                                                service: e,
                                                uuid: "14"
