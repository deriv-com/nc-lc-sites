...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.IndividualAccountInformation"; }
...
get _nextAction$Action() {if(!(this.hasOwnProperty("__nextAction$Action"))) {
...
try {controller.ensureControllerAlive("NextAction");
...
}set _nextAction$Action(value) {this.__nextAction$Action = value;
}

get _onChange$Action() {if(!(this.hasOwnProperty("__onChange$Action"))) {
...
try {controller.ensureControllerAlive("OnChange");
callContext = controller.callContext(callContext);
...
}set _onChange$Action(value) {this.__onChange$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._nextAction$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onChange$Action, callContext);
} finally {
if(span) {
span.end();
}
...
"7xhuTyiejkmHiT0utntkkg#Value": "Udostępnij adres URL strony internetowej, której użyjesz do promowania naszych usług."
};
});
...
"7xhuTyiejkmHiT0utntkkg#Value": "Partilhe o URL do site que irá utilizar para promover os nossos serviços."
};
});
