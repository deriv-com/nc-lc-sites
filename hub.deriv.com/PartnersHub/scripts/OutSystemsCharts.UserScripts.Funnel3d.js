...
function(t) {
    ...
    function i(e, i, r, n) {
        e.hasOwnProperty(i) || (e[i] = n.apply(null, r), "function" == typeof CustomEvent && t.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", {
            detail: {
                path: i,
                module: e[i]
            }
    ...
    i(e, "Series/Funnel3D/SVGElement3DFunnel.js", [e["Core/Color/Color.js"], e["Core/Globals.js"], e["Core/Renderer/RendererRegistry.js"], e["Core/Utilities.js"]], function(t, e, i, r) {
        ...
        function h(t) {
            ...
            return w.backUpper = this.getCylinderBack(a, y), m = Math.min(f, t.width) / Math.max(f, t.width) != 1, w.rightUpper = this.getCylinderFront(this.getCylinderEnd(e, s(t, {
                x: t.x - t.width / 2,
                z: t.z - t.width / 2,
                alphaCorrection: m ? -i : 0
            }), !1), this.getCylinderEnd(e, s(c, {
                alphaCorrection: m ? -i : 0
            }), !l)), l && (m = Math.min(f, p) / Math.max(f, p) != 1, s(!0, w, {
        ...
        class c extends a {
            ...
            translate() {
                ...
                for (let t of (this.getWidthAt = S = function(t) {
                        return t > m || c === x ? y : y + (g - y) * (1 - (t - (a - c / 2)) / (c - x))
                    }, this.center = [d, a, c], this.centerX = d, w)) r && !1 === t.visible || (b += t.y);
                for (let n of w) D = null, U = b ? n.y / b : 0, j = (L = a - c / 2 + C * c) + U * c, F = S(L), A = j - L, k = {
                    ...
                    fraction: U,
                    width: F
                }, L >= m ? k.isCylinder = !0 : j > m && (D = j, F = S(m), j = m, k.bottom.width = F, k.middle = {
                    fraction: A ? (m - L) / A : 0,
                    width: F
