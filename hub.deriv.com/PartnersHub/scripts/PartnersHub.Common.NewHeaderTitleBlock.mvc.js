    ...
    var OS = OSRuntimeCore; {
        ...
        OS.Controller.BaseViewController {
            ...
            get onClickBackButton$Action() {
                if (!(this.hasOwnProperty("_onClickBackButton$Action"))) {
            ...
            set onClickBackButton$Action(value) {
                this._onClickBackButton$Action = value;
            }

            get onClickCloseButton$Action() {
                if (!(this.hasOwnProperty("_onClickCloseButton$Action"))) {
            ...
            set onClickCloseButton$Action(value) {
                this._onClickCloseButton$Action = value;
            }
