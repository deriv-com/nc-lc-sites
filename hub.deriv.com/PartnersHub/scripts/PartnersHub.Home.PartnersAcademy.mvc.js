...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Home.PartnersAcademy"; }
...
get _checkOS$Action() {if(!(this.hasOwnProperty("__checkOS$Action"))) {
...
try {controller.ensureControllerAlive("CheckOS");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Home_PartnersAcademy_mvc_controller_CheckOS_JavaScript1JS, "JavaScript1", "CheckOS", {
...
}set _checkOS$Action(value) {this.__checkOS$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._checkOS$Action, callContext);
} finally {
if(span) {
span.end();
}
...
"mxqBfVnviEmFswLgQBO7ug#Value": "Tout ce dont vous avez besoin pour réussir un marketing aux partenaires.",
...
"1adaFkSs6Eu8LQA1B4Z56w#Value": "Tout ce dont vous avez besoin pour réussir un marketing aux partenaires.",
...
return {
"zkMPCyO8E0aYnIYzzJSMng#Value": "Open Academy App",
"mxqBfVnviEmFswLgQBO7ug#Value": "Tutto ciò di cui hai bisogno per un partner marketing di successo.",
...
"1adaFkSs6Eu8LQA1B4Z56w#Value": "Tutto ciò di cui hai bisogno per un partner marketing di successo.",
...
return {
"zkMPCyO8E0aYnIYzzJSMng#Value": "Otwórz aplikację Academy",
...
return {
"zkMPCyO8E0aYnIYzzJSMng#Value": "Abrir a aplicação Academy",
...
"83dGwifhKk+YOiXkvULi4A#Value": "Cursos",
"kwwc0W9pKE64IAQBhqqlsg#Value": "Ouça, Aprenda, Leia.",
...
"uHFImDRVWE2MA_64Li66Ww#Value": "Cursos",
"sse4z6h_sU6gso1w6w59LA#Value": "Ouça, Aprenda, Leia."
};
});
