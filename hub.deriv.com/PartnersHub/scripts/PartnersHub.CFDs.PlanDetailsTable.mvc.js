...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "CFDs.PlanDetailsTable"; }
...
get getCFDsPlansTableDataByCFDsAllSubPlanId$AggrRefresh() {if(!(this.hasOwnProperty("_getCFDsPlansTableDataByCFDsAllSubPlanId$AggrRefresh"))) {
...
}set getCFDsPlansTableDataByCFDsAllSubPlanId$AggrRefresh(value) {this._getCFDsPlansTableDataByCFDsAllSubPlanId$AggrRefresh = value;
}

get getCFDsPlansTableDataByCFDsAllPlanId$AggrRefresh() {if(!(this.hasOwnProperty("_getCFDsPlansTableDataByCFDsAllPlanId$AggrRefresh"))) {
...
}set getCFDsPlansTableDataByCFDsAllPlanId$AggrRefresh(value) {this._getCFDsPlansTableDataByCFDsAllPlanId$AggrRefresh = value;
}
...
get _onAfterFetchSubPlan$Action() {if(!(this.hasOwnProperty("__onAfterFetchSubPlan$Action"))) {
...
try {controller.ensureControllerAlive("OnAfterFetchSubPlan");
callContext = controller.callContext(callContext);
...
}set _onAfterFetchSubPlan$Action(value) {this.__onAfterFetchSubPlan$Action = value;
}

get _onAfterFetchAllPlan$Action() {if(!(this.hasOwnProperty("__onAfterFetchAllPlan$Action"))) {
...
}set _onAfterFetchAllPlan$Action(value) {this.__onAfterFetchAllPlan$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onAfterFetchSubPlan$Action, callContext);
} finally {
if(span) {
span.end();
}
...
return {
"AiMBRsM2QEmookT5xpWXPg#Value": "Vermögenswert"
};
});
