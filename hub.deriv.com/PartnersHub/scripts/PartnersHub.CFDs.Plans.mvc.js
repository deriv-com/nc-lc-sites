...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "CFDs.Plans"; }
...
style: "to-description",
value: OS.Injector.resolve(OS.ServiceNames.TranslationsService).getMessage("bDkZC7_u4UCx5mkeEqXmZA#ValueExpression.-1076200185.1", "All commission rates are quoted in USD, per round trade."),
_idProps: {
service: idService,
uuid: "12"
},
...
get getCFDsAllSubPlansByCFDsAllPlanId$AggrRefresh() {if(!(this.hasOwnProperty("_getCFDsAllSubPlansByCFDsAllPlanId$AggrRefresh"))) {
this._getCFDsAllSubPlansByCFDsAllPlanId$AggrRefresh = function () {
var innerBody = function (maxRecords, startIndex, callContext) {
var model = this.model;
var controller = this.controller;
var callContext = controller.callContext(callContext);
return controller.callAggregateWithStartIndexAndClientVars("ScreenDataSetGetCFDsAllSubPlansByCFDsAllPlanId", "screenservices/PartnersHub/CFDs/Plans/ScreenDataSetGetCFDsAllSubPlansByCFDsAllPlanId", "qkuASiMR1A8LHhkyXR2htw", maxRecords, startIndex, function (b) {
...
}set getCFDsAllSubPlansByCFDsAllPlanId$AggrRefresh(value) {this._getCFDsAllSubPlansByCFDsAllPlanId$AggrRefresh = value;
}
...
get _onAfterFetchTable$Action() {if(!(this.hasOwnProperty("__onAfterFetchTable$Action"))) {
...
try {controller.ensureControllerAlive("OnAfterFetchTable");
...
}set _onAfterFetchTable$Action(value) {this.__onAfterFetchTable$Action = value;
}

get _onClickBackButton$Action() {if(!(this.hasOwnProperty("__onClickBackButton$Action"))) {
...
try {controller.ensureControllerAlive("OnClickBackButton");
callContext = controller.callContext(callContext);
...
}set _onClickBackButton$Action(value) {this.__onClickBackButton$Action = value;
}
...
get _onClickActionBox$Action() {if(!(this.hasOwnProperty("__onClickActionBox$Action"))) {
...
try {controller.ensureControllerAlive("OnClickActionBox");
callContext = controller.callContext(callContext);
...
}set _onClickActionBox$Action(value) {this.__onClickActionBox$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onAfterFetchTable$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickBackButton$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickActionBox$Action, callContext, subPlanIdIn, commissionTypeIn, planDetailsTitleIn);
} finally {
if(span) {
span.end();
}
...
return {
"bDkZC7_u4UCx5mkeEqXmZA#ValueExpression.-1076200185.1": "Alle Provisionssätze werden in USD pro Round-Trade angegeben",
...
return {
"bDkZC7_u4UCx5mkeEqXmZA#ValueExpression.-1076200185.1": "Todas las tasas de comisión se cotizan en USD, por operación redonda",
...
return {
"bDkZC7_u4UCx5mkeEqXmZA#ValueExpression.-1076200185.1": "Tous les taux de commission sont indiqués en USD, par transaction aller-retour",
...
define("PartnersHub.CFDs.Plans.mvc$translationsResources.pl-PL", [], function () {
return {
...
return {
"bDkZC7_u4UCx5mkeEqXmZA#ValueExpression.-1076200185.1": "Todas as taxas de comissão são cotadas em USD, por transação completa",
"y+zwjIEM6EG8K95g4EkklA#ValueExpression.-486072707.1": "Ganhe quando os seus clientes negociarem numa"
};
});

define("PartnersHub.CFDs.Plans.mvc$translationsResources.ru-RU", [], function () {
return {
...
define("PartnersHub.CFDs.Plans.mvc$translationsResources", ["exports", "PartnersHub.CFDs.Plans.mvc$translationsResources.ar-001", "PartnersHub.CFDs.Plans.mvc$translationsResources.de-DE", "PartnersHub.CFDs.Plans.mvc$translationsResources.es-ES", "PartnersHub.CFDs.Plans.mvc$translationsResources.fr-FR", "PartnersHub.CFDs.Plans.mvc$translationsResources.it-IT", "PartnersHub.CFDs.Plans.mvc$translationsResources.pl-PL", "PartnersHub.CFDs.Plans.mvc$translationsResources.pt-PT", "PartnersHub.CFDs.Plans.mvc$translationsResources.ru-RU"], function (exports, PartnersHub_CFDs_Plans_mvc_translationsResources_ar001, PartnersHub_CFDs_Plans_mvc_translationsResources_deDE, PartnersHub_CFDs_Plans_mvc_translationsResources_esES, PartnersHub_CFDs_Plans_mvc_translationsResources_frFR, PartnersHub_CFDs_Plans_mvc_translationsResources_itIT, PartnersHub_CFDs_Plans_mvc_translationsResources_plPL, PartnersHub_CFDs_Plans_mvc_translationsResources_ptPT, PartnersHub_CFDs_Plans_mvc_translationsResources_ruRU) {
return {
"ar-001": {
...
"pl-PL": {
"translations": PartnersHub_CFDs_Plans_mvc_translationsResources_plPL,
"isRTL": false
},
"pt-PT": {
...
"ru-RU": {
"translations": PartnersHub_CFDs_Plans_mvc_translationsResources_ruRU,
"isRTL": false
}
};
});
