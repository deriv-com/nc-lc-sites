                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    ...
                                    return RESTAPIWebsocketOfficialController.default.getWebsiteStatus$Action(PartnersHubClientVariables.getServer(), "1", "en", callContext).then(function(value) {
                                        ...
                                        javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                            ...
                                            try {
                                                return controller.safeExecuteJSNode(PartnersHub_RealAccountCreation_ResidenceSelector_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
                            ...
                            try {
                                ...
                                if (((OS.BuiltinFunctions.length(vars.value.searchedItemArgInLocal) > 0))) {
                                    ...
                                    javaScript1JSResult.value = OS.Logger.startActiveSpan("JavaScript1", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteJSNode(PartnersHub_RealAccountCreation_ResidenceSelector_mvc_controller_OnSearch_JavaScript1JS, "JavaScript1", "OnSearch", {
