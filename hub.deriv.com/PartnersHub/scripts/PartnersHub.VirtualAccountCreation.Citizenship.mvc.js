...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "VirtualAccountCreation.Citizenship"; }
...
screen: ""
        ...
        static getBlocks() {
            return [PartnersHub_Layouts_LayoutSignup_mvc_view, PartnersHub_Layouts_DeviceLayout_mvc_view, OutSystemsUI_Interaction_DropdownSearch_mvc_view, CustomComponentsOfficial_ButtonVariants_PrimaryButton_mvc_view, CustomComponentsOfficial_FullScreenMobileModal_FullScreenMobileModal_mvc_view, PartnersHub_Common_LoaderBlock_mvc_view, PartnersHub_VirtualAccountCreation_ResidenceSelector_mvc_view];
        }
...
try {return controller.safeExecuteClientAction(controller._dropdownSearchOnChanged$Action, callContext, selectedCitizenshipIn);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickCountry$Action, callContext, citizenshipIn);
} finally {
if(span) {
span.end();
}
...
"ErifJ+AR6Eax2K9Df+hCjQ#Value": "Wählen Sie die in Ihrem amtlichen Ausweis angegebene Staatsbürgerschaft/Nationalität.",
...
return {
"Qk41zaQoA0Ct2VwQgZt1FA#Value.-592606844.1": "Citizenship",
"ErifJ+AR6Eax2K9Df+hCjQ#Value": "Selecione a cidadania/nacionalidade indicada no seu documento de identificação oficial.",
"VOklgSMAAUC0R0Un9xFeBw#Value.-1726996070.1": "Serviços indisponíveis",
"mZWPxcZ8pUaBV52DCuAaPg#Value.-1726996070.1": "Serviços indisponíveis",
"e0ZkSI_tx0C4JE2x_02BfA#Value.-122289221.1": "Select your citizenship",
