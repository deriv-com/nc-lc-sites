...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Home.ReferralLinksReports"; }
...
get _openDashboardOnClick$Action() {if(!(this.hasOwnProperty("__openDashboardOnClick$Action"))) {
...
try {controller.ensureControllerAlive("OpenDashboardOnClick");
...
try {return controller.safeExecuteJSNode(PartnersHub_Home_ReferralLinksReports_mvc_controller_OpenDashboardOnClick_JavaScript1JS, "JavaScript1", "OpenDashboardOnClick", {
...
}set _openDashboardOnClick$Action(value) {this.__openDashboardOnClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._openDashboardOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
