...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "CommissionPlans.Turnover"; }
...
get getDigitalOptions$AggrRefresh() {if(!(this.hasOwnProperty("_getDigitalOptions$AggrRefresh"))) {
...
}set getDigitalOptions$AggrRefresh(value) {this._getDigitalOptions$AggrRefresh = value;
}

get getOptions$AggrRefresh() {if(!(this.hasOwnProperty("_getOptions$AggrRefresh"))) {
...
}set getOptions$AggrRefresh(value) {this._getOptions$AggrRefresh = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_CommissionPlans_Turnover_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
...
get _onReadyOptions$Action() {if(!(this.hasOwnProperty("__onReadyOptions$Action"))) {
...
try {controller.ensureControllerAlive("OnReadyOptions");
callContext = controller.callContext(callContext);
...
}set _onReadyOptions$Action(value) {this.__onReadyOptions$Action = value;
}

get _onReadyDigitalOptions$Action() {if(!(this.hasOwnProperty("__onReadyDigitalOptions$Action"))) {
...
try {controller.ensureControllerAlive("OnReadyDigitalOptions");
callContext = controller.callContext(callContext);
...
}set _onReadyDigitalOptions$Action(value) {this.__onReadyDigitalOptions$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onReadyOptions$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onReadyDigitalOptions$Action, callContext);
} finally {
if(span) {
span.end();
}
...
"W6zl8R+k10uKCkyPG49T9A#Value": "العمولة",
...
"SwI4jX2_F0qstT3FcV7x8w#Value": "العمولة",
