...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "CommissionPlans.ActionBox"; }
...
get getCFDsAllPlansByTabID$AggrRefresh() {if(!(this.hasOwnProperty("_getCFDsAllPlansByTabID$AggrRefresh"))) {
...
}set getCFDsAllPlansByTabID$AggrRefresh(value) {this._getCFDsAllPlansByTabID$AggrRefresh = value;
}
...
get _onAfterFetchPlans$Action() {if(!(this.hasOwnProperty("__onAfterFetchPlans$Action"))) {
...
try {controller.ensureControllerAlive("OnAfterFetchPlans");
callContext = controller.callContext(callContext);
// IsLoading = False
...
}set _onAfterFetchPlans$Action(value) {this.__onAfterFetchPlans$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._onClickActionBox$Action, callContext, plansDataIn);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onAfterFetchPlans$Action, callContext);
} finally {
if(span) {
span.end();
}
