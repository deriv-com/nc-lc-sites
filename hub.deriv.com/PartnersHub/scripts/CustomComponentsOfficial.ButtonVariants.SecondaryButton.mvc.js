define("CustomComponentsOfficial.ButtonVariants.SecondaryButton.mvc$model", ["@outsystems/runtime-core-js", "CustomComponentsOfficial.model"], function (OSRuntimeCore, CustomComponentsOfficialModel) {
...
define("CustomComponentsOfficial.ButtonVariants.SecondaryButton.mvc$view", ["@outsystems/runtime-core-js", "CustomComponentsOfficial.model", "CustomComponentsOfficial.controller", "react", "@outsystems/runtime-view-js", "CustomComponentsOfficial.ButtonVariants.SecondaryButton.mvc$model", "CustomComponentsOfficial.ButtonVariants.SecondaryButton.mvc$controller", "@outsystems/runtime-widgets-js"], function (OSRuntimeCore, CustomComponentsOfficialModel, CustomComponentsOfficialController, React, OSView, CustomComponentsOfficial_ButtonVariants_SecondaryButton_mvc_model, CustomComponentsOfficial_ButtonVariants_SecondaryButton_mvc_controller, OSWidgets) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "ButtonVariants.SecondaryButton"; }
...
screen: ""
        ...
        get modelFactory() {
            return CustomComponentsOfficial_ButtonVariants_SecondaryButton_mvc_model;
        }

        get controllerFactory() {
            return CustomComponentsOfficial_ButtonVariants_SecondaryButton_mvc_controller;
        }
...
extendedProperties: {
style: ("color: #000;" + ((((("font-weight: " + ((model.variables.isTitleBoldIn) ? ("bold") : ("normal"))) + ";") + "color: ") + model.variables.textColorIn) + ";"))
},
...
get _triggerOnClick$Action() {if(!(this.hasOwnProperty("__triggerOnClick$Action"))) {
...
}set _triggerOnClick$Action(value) {this.__triggerOnClick$Action = value;
}
