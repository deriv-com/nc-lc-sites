...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "ForgotPassword.VerificationEmailSent"; }
...
get _reSendEmailEvent$Action() {if(!(this.hasOwnProperty("__reSendEmailEvent$Action"))) {
...
}set _reSendEmailEvent$Action(value) {this.__reSendEmailEvent$Action = value;
}
