...
try {return controller.safeExecuteJSNode(DerivLogger_controller_ConsoleLog_ConsoleWarningJS, "ConsoleWarning", "ConsoleLog", {
...
try {return controller.safeExecuteJSNode(DerivLogger_controller_ConsoleLog_ConsoleErrorJS, "ConsoleError", "ConsoleLog", {
Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
} finally {
...
try {return controller.safeExecuteJSNode(DerivLogger_controller_ConsoleLog_ConsoleLogJS, "ConsoleLog", "ConsoleLog", {
Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
} finally {
...
try {return controller.safeExecuteJSNode(DerivLogger_controller_ConsoleLogWithJSON_ConsoleWarningJS, "ConsoleWarning", "ConsoleLogWithJSON", {
...
try {return controller.safeExecuteJSNode(DerivLogger_controller_ConsoleLogWithJSON_ConsoleErrorJS, "ConsoleError", "ConsoleLogWithJSON", {
JSON: OS.DataConversion.JSNodeParamConverter.to(vars.value.jSONInLocal, OS.DataTypes.DataTypes.Text),
Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
...
try {return controller.safeExecuteJSNode(DerivLogger_controller_ConsoleLogWithJSON_ConsoleLogJS, "ConsoleLog", "ConsoleLogWithJSON", {
JSON: OS.DataConversion.JSNodeParamConverter.to(vars.value.jSONInLocal, OS.DataTypes.DataTypes.Text),
Message: OS.DataConversion.JSNodeParamConverter.to(vars.value.messageInLocal, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
