                        ...
                        return OS.Logger.startActiveSpan("RegisterCallbacks", function(span) {
                            ...
                            try {
                                ...
                                getCallbackHandlersJSResult.value = OS.Logger.startActiveSpan("GetCallbackHandlers", function(span) {
                                    ...
                                    try {
                                        return controller.safeExecuteJSNode(OutSystemsUI_Utilities_InlineSVG_mvc_controller_RegisterCallbacks_GetCallbackHandlersJS, "GetCallbackHandlers", "RegisterCallbacks", {
