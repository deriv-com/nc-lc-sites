...
var y = class y extends e.DataTypes.GenericRecord {
    static attributesToDeclare() {
        ...
        }, !0, i), this.attr("GetEventTypes", "getEventTypesAggr", "GetEventTypes", !0, !0, e.DataTypes.DataTypes.Record, function() {
            return e.DataTypes.ImmutableBase.getData(new c)
        }, !0, c), this.attr("GetEvents", "getEventsAggr", "GetEvents", !0, !0, e.DataTypes.DataTypes.Record, function() {
            return e.DataTypes.ImmutableBase.getData(new d)
...
var V = new e.Model.ModelFactory(f);
export {
    V as a
};