...
try {OS.Logger.startActiveSpan("WriteToConsole", function (span) {
if(span) {
...
try {return controller.safeExecuteJSNode(CommonPlugin_controller_ConsoleLog_WriteToConsoleJS, "WriteToConsole", "ConsoleLog", {
...
try {return controller.safeExecuteJSNode(CommonPlugin_controller_GetDeviceID_GetDeviceHwIdJS, "GetDeviceHwId", "GetDeviceID", {
...
try {runCordovaJSResult.value = OS.Logger.startActiveSpan("RunCordova", function (span) {
if(span) {
...
try {return controller.safeExecuteJSNode(CommonPlugin_controller_GetPlatform_RunCordovaJS, "RunCordova", "GetPlatform", {
...
try {gettingUAJSResult.value = OS.Logger.startActiveSpan("GettingUA", function (span) {
if(span) {
...
try {return controller.safeExecuteJSNode(CommonPlugin_controller_GetUserAgent_GettingUAJS, "GettingUA", "GetUserAgent", {
...
try {return controller.safeExecuteAsyncJSNode(CommonPlugin_controller_InitPluginManager_InitScriptJS, "InitScript", "InitPluginManager", {
...
try {checkCordovaJSResult.value = OS.Logger.startActiveSpan("CheckCordova", function (span) {
if(span) {
...
try {return controller.safeExecuteJSNode(CommonPlugin_controller_IsCordovaDefined_CheckCordovaJS, "CheckCordova", "IsCordovaDefined", {
