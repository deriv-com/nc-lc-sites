...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "VirtualAccountCreation.CreatePasswordBlock"; }
...
get onSubmit$Action() {if(!(this.hasOwnProperty("_onSubmit$Action"))) {
...
}set onSubmit$Action(value) {this._onSubmit$Action = value;
}
