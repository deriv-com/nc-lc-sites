(function(global, factory) {
    ...
    const Ao = "Communication",
        ...
        xo = e => b(void 0, [e], void 0, function(_ref9) {
            let {
                url: e,
                payload: t,
                params: n,
                ...
                baseURL: l,
                responseHandler: u,
                refreshAuthTokens: h = Vr,
                httpClient: g = gn.resolve(pn.HttpClient),
                lifecycleEventsManager: p = gn.resolve(pn.LifecycleEventsManager),
            ...
            return function*() {
                ...
                try {
                    ...
                    if ((null == r ? void 0 : r.shouldRefreshToken) && (yield h()), y = (e => {
                            ...
                            return t;
                        })(r), So(r) && _o(r, (e, t) => null == p ? void 0 : p.onNewVersion(e, t)), Co(r)) throw Mo(r, f);
    ...
    Ne();
    const Km = _exports.Version = "6.20.0";
