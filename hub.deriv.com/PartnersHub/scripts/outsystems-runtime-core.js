(function(global, factory) {
    ...
    const hi = function() {
        ...
        gi = e => b(void 0, void 0, void 0, function*() {
            var t, {
                version: n,
                getCurrentScreenName: r = () => "",
                applicationName: i = B,
                applicationKey: o = V,
                clientRuntimeVersion: l = ge,
                basePath: u = fe,
                getAppVersionMethod: c = ve,
                isWebApplication: d = de,
                usePwaServiceWorkerTracer: h = _settingsJs.FeaturesManager.isEnabled(_settingsJs.FeatureKeys.ServiceWorkerTraces),
                serviceWorkerContainer: g = null === (t = navigator.serviceWorker) || void 0 === t ? void 0 : t.controller,
                settingsManager: p = gn.resolve(pn.SettingsManager),
                instrumentationFactory: f = gn.resolve(pn.InstrumentationFactory),
                httpClient: m = gn.resolve(pn.LoggerHttpClient)
            } = e;
            try {
                f || (yield hi(), f = gn.resolve(pn.InstrumentationFactory)), f.setAggregateSpansStatus(null == p ? void 0 : p.readBool("EnableSpanAggregation")), f.setLogLevel(null == p ? void 0 : p.readLogLevel());
                const e = (null == p ? void 0 : p.readString("LoggingTagID")) || (null == p ? void 0 : p.readString("LoggerApiKey"));
                f.setTagId(e), f.getTracer().addBaseSpanAttributes({
                ...
                const t = {
                    ...
                    "outsystems.app.versiontoken": n,
                    "outsystems.app.key": o(),
                    "outsystems.env.key": null == p ? void 0 : p.readString("EnvironmentKey"),
                    "outsystems.tenant.key": null == p ? void 0 : p.readString("TenantID"),
                    "outsystems.app.version": c()
                };
                f.setResourceAttributes(t), d() && (null == p ? void 0 : p.readBool("EnableOpenTelemetryTraces")) && (h && g ? f.useServiceWorkerTracerTransport({
                    resourceAttributes: t,
                    collectorBaseUrl: u(),
                    tagId: e,
                    enabled: !0,
                    aggregateSpans: null == p ? void 0 : p.readBool("EnableSpanAggregation")
                }) : f.useOpenTelemetryTracerTransport({
                    resourceAttributes: t,
                    collectorBaseUrl: u(),
                    tagId: e,
                    enabled: !0,
                ...
                const s = null == p ? void 0 : p.readNumber("LoggerSchedulerTimeInterval");
                s > 0 && Ei(s, f);
            } catch (e) {
    ...
    const Ao = "Communication",
        No = e => b(void 0, [e], void 0, function(_ref7) {
            let {
                url: e,
                params: t,
                headers: n,
        ...
        xo = t => b(void 0, [t], void 0, function(_ref8) {
            let {
                url: t,
                payload: n,
                params: r,
        ...
        Lo = e => {
            if ("function" == typeof e) return _ref9 => {
                let {
                    data: t,
                    responseHeaders: n
                } = _ref9;
    ...
    var Uo = _exports.Communication = Object.freeze({
        ...
        get: No,
        getResponseUrl: e => b(void 0, [e], void 0, function(_ref10) {
            let {
                url: e,
                params: t,
                headers: n,
    ...
    class Td {
        ...
        cacheResourcesInBackground(e) {
            return pi(cd, "Caching resources in the background..."), this.fetchApplicationManifest(!1).then(_ref13 => {
                let {
                    manifest: t,
                    isFromPrebundle: n
                } = _ref13;
        ...
        rollBackApplicationVersion(e, t) {
            return this.loadCachedManifest().then(_ref14 => {
                let {
                    manifest: n
                } = _ref14;
    ...
    class Zd extends Xd {
        ...
        handleServerDataSourceResponse(_ref16) {
            let {
                res: e,
                reject: t,
                resolve: n,
    ...
    class hh {
        ...
        static buildWithDebugger(_ref20) {
            let {
    ...
    const gh = (e, t) => b(void 0, [e, t], void 0, function(e, _ref23) {
        let {
    ...
    class Og extends wg {
        ...
        makeDeserializerForEachAttribute(_ref27) {
            let {
                data: e,
                attributes: t,
                dataType: n,
    ...
    class Fp {
        ...
        setApplicationDefinition(t) {
            P(t), J(t.applicationKey), bn() && function(t) {
                b(this, arguments, void 0, function(_ref33) {
                    let {
                        version: t,
                        ensureReady: n = Nn,
    ...
    function Xp(e) {
        ...
        if (a) {
            ...
            if (r && (n += "\n" + r), console.error(n), "undefined" != typeof document && document.querySelector) {
                ...
                if (document.querySelector(Wp).addEventListener("click", () => Zp()), null == e ? void 0 : e.showExceptionStack) {
        ...
        if ("undefined" != typeof document && document.querySelector) {
            ...
            o.innerHTML = null !== (r = null == e ? void 0 : e.reloadLabel) && void 0 !== r ? r : kp, o.addEventListener("click", () => Qp());
        }
    }
    ...
    var ef = _exports.ErrorScreen = Object.freeze({
        ...
        reloadApplication: Qp,
        setErrorPageMessages: Xp,
        toggleExceptionInfo: Zp
    });
    ...
    var rf = _exports.LanguageResources = Object.freeze({
        ...
        BaseMessagesProvider: class {
            constructor(e) {
                if (this.messages = {}, this.localeChangeHandler = e => {
                        ...
                        if (n) {
                            (null !== (t = e.localeFamily) && void 0 !== t ? t : [e.localeCode]).forEach(e => {
                                var t, i;
                                this.translationResources[e] ? (pi(tf, `Adding translations for ${e} locale.`), n.add(null !== (t = this.translationResources[e].translations) && void 0 !== t ? t : {}), r.setCurrentLocaleRTL(null !== (i = this.translationResources[e].isRTL) && void 0 !== i && i)) : pi(tf, `No translations found for ${e} locale.`);
                            });
                        }
                    }, this.translationResources = null != e ? e : this.translationResources, this.translationResources) {
                    const e = gn.resolve(pn.LocaleService);
                    if (e) {
                        ...
                        this.localeChangeHandler({
                            localeCode: t,
                            localeFamily: n
                        }), pi(tf, "Subscribing handler for locale service."), e.subscribe(this.localeChangeHandler);
                    }
                }
            }
            getMandatoryValueMessage() {
            ...
            getInvalidValueMessage(e) {
                return this.getMessage(nf.InvalidValuePrefix + Po[e], "Invalid Value!");
            }
    ...
    class cf extends Yo {
        ...
        set idAttr(e) {
            this.setBasicProperty(sf, e, Po.Text);
        }
        get nameAttr() {
        ...
        set generationNode(e) {
            this.setBasicProperty(cf.WidgetGenerationNodeAttributeName, e, Po.Object);
        }
        asReadOnly() {
            return {
                idAttr: this.idAttr,
    ...
    cf.WidgetGenerationNodeAttributeName = "widgetGenerationNode", cf.RecordClass = Yo.defineRecordClass({
        idAttr: "",
        nameAttr: "",
    ...
    hf.WidgetRecordsAttribute = "records", hf.WidgetRecordsDataCacheAttribute = "recordsCache", hf.RecordClass = Yo.defineRecordClass({
        records: null,
        recordsCache: null
    });
    class gf extends Zo {
        ...
        set dataFetchStatusAttr(e) {
            this.setBasicProperty(gf.DataFetchStatusAttributeName, e, Po.Integer);
        }
        ...
        static attributesToDeclare() {
            return [Zo.attr("DataFetchStatus", gf.DataFetchStatusAttributeName, "", !0, !1, Po.Integer, () => 0)].concat(super.attributesToDeclare());
        }
        replaceWith(e) {
    ...
    class pf extends gf {
        ...
        set listOut(e) {
            this.setComplexProperty(pf.ListOutAttributeName, e, Po.RecordList, this.getRecordListType());
        }
        get countOut() {
            return this.getBasicProperty(pf.CountOutAttributeName);
        }
        set countOut(e) {
            this.setBasicProperty(pf.CountOutAttributeName, e, Po.LongInteger);
        }
        bulkSet(e, t, n) {
            const r = [{
        ...
        static attributesToDeclare() {
            return [Zo.attr("List", pf.ListOutAttributeName, "List", !0, !1, Po.RecordList, () => !1, !0, this.RecordListType), Zo.attr("Count", pf.CountOutAttributeName, "Count", !0, !1, Po.LongInteger, () => bo.defaultValue)].concat(super.attributesToDeclare());
        }
        static init() {
    ...
    class ff extends Yo {
        ...
        flush() {
            this.pendingFlush && (clearTimeout(this.pendingFlush), this.pendingFlush = void 0), this.modified && (this.modified = !1, yf.currentGeneration++, this.innerFlush(!1), pi("BaseViewModel", "Flushing model"));
        }
        innerFlush(e) {
        ...
        set variables(e) {
            ...
            this.setComplexProperty(ff.VariablesPropertyName, e, Po.Record, t.getVariablesRecordConstructor());
        }
        ...
        set clientVariablesGeneration(e) {
            this.setBasicProperty(ff.ClientVariablesGenerationPropertyName, e, Po.Integer);
        }
        ...
        set currentLocale(e) {
            this.currentLocale !== e && this.clearCachedValues(), this.setBasicProperty(ff.CurrentLocalePropertyName, e, Po.Text);
        }
        ...
        set widgets(e) {
            this.setComplexProperty(ff.WidgetsPropertyName, e, Po.Object);
        }
        hasCachedValue(e) {
    ...
    ff.VariablesPropertyName = "variables", ff.WidgetsPropertyName = "widgets", ff.ClientVariablesGenerationPropertyName = "clientVariablesGeneration", ff.CurrentLocalePropertyName = "currentLocale", ff.InvalidValue = new Object(), ff.RecordClass = Yo.defineRecordClass({
        variables: null,
        widgets: null,
        clientVariablesGeneration: 0,
        currentLocale: null
    ...
    let Sf = class extends Zo {
        ...
        static attributesToDeclare() {
            return [this.attr("Success", "successAttr", "success", !0, !1, Po.Boolean, () => Wo(Po.Boolean)), this.attr("ChangePasswordFailureReason", "changePasswordFailureReasonAttr", "changePasswordFailureReason", !0, !1, Po.Record, () => Jo.getData(new Nf()), Nf)].concat(super.attributesToDeclare());
        }
    };
    Sf = y([e => {
        const t = e;
    ...
    let Of = class extends Zo {
        ...
        static attributesToDeclare() {
            return [this.attr("Success", "successAttr", "success", !0, !1, Po.Boolean, () => Wo(Po.Boolean)), this.attr("UpdateUserFailureReason", "updateUserFailureReasonAttr", "updateUserFailureReason", !0, !1, Po.Record, () => Jo.getData(new Lf()), Lf)].concat(super.attributesToDeclare());
        }
    };
    Of = y([e => {
        const t = e;
    ...
    let $f = class extends Zo {
        ...
        static attributesToDeclare() {
            return [this.attr("Success", "successAttr", "success", !0, !1, Po.Boolean, () => Wo(Po.Boolean)), this.attr("StartUserRegistrationFailureReason", "startUserRegistrationFailureReasonAttr", "startUserRegistrationFailureReason", !0, !1, Po.Record, () => Jo.getData(new Ff()), Ff), this.attr("TemporaryPassword", "temporaryPasswordAttr", "temporaryPassword", !0, !1, Po.Text, () => Wo(Po.Text)), this.attr("UserId", "userIdAttr", "userId", !0, !1, Po.Text, () => Wo(Po.Text)), this.attr("VerificationCode", "verificationCodeAttr", "verificationCode", !0, !1, Po.Text, () => Wo(Po.Text))].concat(super.attributesToDeclare());
        }
    };
    $f = y([e => {
        const t = e;
    ...
    let kf = class extends Zo {
        constructor(e, t) {
            super(e, t);
        }
        static attributesToDeclare() {
            return [this.attr("Success", "successAttr", "success", !0, !1, Po.Boolean, () => Wo(Po.Boolean)), this.attr("FinishResetPasswordFailureReason", "finishResetPasswordFailureReasonAttr", "finishResetPasswordFailureReason", !0, !1, Po.Record, () => Jo.getData(new Bf()), Bf)].concat(super.attributesToDeclare());
        }
    };
    kf = y([e => {
        const t = e;
    ...
    let qf = Hf = class extends Zo {
        constructor(e, t) {
            super(e, t);
        }
        static attributesToDeclare() {
            return [this.attr("Attachment", "attachmentAttr", "Attachment", !1, !1, Po.Record, () => Jo.getData(new jf()), jf)].concat(Zo.attributesToDeclare());
        }
    };
    ...
    const am = new El("DuplicatedList", "duplicatedListOut"),
        om = new El("FilteredList", "filteredListOut"),
        lm = new El("DistinctList", "distinctListOut"),
        um = new wl("ExternalLoginURL", "externalLoginURLOut"),
        cm = new El("UserLoginResult", "userLoginResultOut"),
        dm = new wl("ExternalLogoutURL", "externalLogoutURLOut"),
        hm = new El("PasswordComplexityPolicy", "passwordComplexityPolicyOut"),
        gm = new El("PasswordValidationResult", "passwordValidationResultOut");
    new El("ResetPasswordResult", "resetPasswordResultOut");
    const pm = new wl("IsExternalUser", "isExternalUserOut"),
        fm = new El("RegistrationResult", "registrationResultOut"),
        mm = new El("ChangePasswordResult", "changePasswordResultOut");
    new El("UpdateUserResult", "updateUserResultOut");
    const vm = new El("UserInfo", "userInfoOut"),
        ym = new El("FinishResetPasswordResult", "finishResetPasswordResultOut");
    class bm {
        constructor() {}
        getCurrentRowNumber(e) {
            return 0;
    ...
    var Rm = _exports.SystemActions = Object.freeze({
        ...
        isExternalUser: function(e) {
            ...
            return Dm("IsExternalUser", "5365bc0e-70f6-4e7f-90bf-6c6e12da81bb", () => {
                const e = new(pm.getType(Po.Boolean))();
        ...
        requireScript: function(e, t) {
            return Dm("RequireScript", "388d4655-dd1c-4c5c-8d46-f420d0fe02a1", t => {
                try {
                    return nm(Nr.getVersionedUrl(e), {
                        parentSpan: t
                    });
                } catch (e) {
    ...
    ! function(e) {
        ...
        e.to = function e(n, r, i) {
            ...
            if (n instanceof cf) {
                ...
                return a instanceof df && (l.Valid = e(a.validAttr, r, i, o, Po.Boolean), l.ValidationMessage = e(a.validationMessageAttr, r, i, o, Po.Text)), t(l, Po.Record);
            }
            return void 0 !== a ? i && i.length > 0 ? void km(`Cannot perform a inner evaluation to a Basic Type. Trying to evaluate '${i[0]}' for a variable of type '${Po[a]}'.`) : function(e, n) {
                switch (n) {
                    case Po.Integer:
                    case Po.Text:
                    case Po.PhoneNumber:
    ...
    Ne();
    const Ym = _exports.Version = "6.20.5";
    Me("client-runtime-core", Ym);
});