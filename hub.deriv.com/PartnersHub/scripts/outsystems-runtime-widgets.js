(function(global, factory) {
    ...
    function w(t, e, i, s) {
        ...
        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) o = Reflect.decorate(t, e, i, s);
            ...
            for (var a = t.length - 1; a >= 0; a--)(r = t[a]) && (o = (n < 3 ? r(o) : n > 3 ? r(e, i, o) : r(e, i)) || o);
    ...
    let k = D = class extends _runtimeViewJs.Widget.InputWithVariableWidget {
        ...
        getSelectedValueAndOptions() {
            ...
            if (this.isEmptyValueDefined() && (r = D.EmptyValue, n.push(m.createElement("option", {
                ...
                for (let o = 0; o < this.props.list.length; o++) {
    ...
    _exports.Icon = st;
    var rt, nt;
    _exports.Icon = st = w([_runtimeViewJs.Widget.WidgetSpec], st),
        function(t) {
    ...
    let ot = _exports.Image = rt = class extends _runtimeViewJs.Widget.Widget {
        ...
        prepareImageAttributes() {
            ...
            if (this.state.hasError) t.src = rt.getBinaryImgAbsoluteURL(this.props.defaultImage);
            else {
                ...
                s = function(t) {
                    switch (t.arrayFormat) {
                        ...
                        case "bracket-separator": {
                            ...
                            return i => (s, r) => void 0 === r || t.skipNull && null === r || t.skipEmptyString && "" === r ? s : (r = null === r ? "" : r, 0 === s.length ? [
                                [a(i, t), e, a(r, t)].join("")
                            ] : [
                                [s, a(r, t)].join(t.arrayFormatSeparator)
                            ]);
                        }
                        default:
    ...
    let Nt = _exports.Upload = Ot = class extends _runtimeViewJs.Widget.InputWithVariableWidget {
        ...
        render() {
            ...
            if (e)
                for (const i in e) this.shouldIncludeOnExtendedProperty(i) && (t[i] = e[i]);
            const i = {
                "data-upload": "",
                className: this.props.style
            };
