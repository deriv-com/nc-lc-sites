...
require(["@outsystems/runtime-core-js", "TestIMAPIOfficial.appDefinition", "@outsystems/runtime-core-js/debugger"], function (OSRuntimeCore, TestIMAPIOfficialAppDefinition, NullDebugger) {
var OS = OSRuntimeCore;
if(OS.Navigation.ensureRequestSecurity()) {
return;
}

Promise.all([OS.Application.default.initialize(TestIMAPIOfficialAppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
if(success) {
