                ...
                placeholders: {
                    onDesktop: new PlaceholderContent(function() {
                        return [React.createElement(OSWidgets.AdvancedHtml, {
                            extendedProperties: {
                                role: "banner",
                                className: OS.Injector.resolve(OS.ServiceNames.TranslationsService).getMessage("+uTrOVHr+U22dEd3ggbcYQ#Value.-1221270899.1", "header")
                            },
                            tag: "header",
                            _idProps: {
                                service: idService,
                            ...
                            return OS.Flow.tryFinally(function() {
                                ...
                                return OS.Flow.executeAsyncFlow(function() {
                                    ...
                                    return OS.Logger.startActiveSpan("HandleLogout", function(span) {
                                        ...
                                        try {
                                            return controller.safeExecuteAsyncJSNode(PartnersHub_Common_Headers_mvc_controller_OnClickLogout_HandleLogoutJS, "HandleLogout", "OnClickLogout", {
...
define("PartnersHub.Common.Headers.mvc$translationsResources.de-DE", [], function() {
    return {
        ...
        "+uTrOVHr+U22dEd3ggbcYQ#Value.-1221270899.1": "header",
...
define("PartnersHub.Common.Headers.mvc$translationsResources", ["exports", "PartnersHub.Common.Headers.mvc$translationsResources.ar-001", "PartnersHub.Common.Headers.mvc$translationsResources.de-DE", "PartnersHub.Common.Headers.mvc$translationsResources.es-ES", "PartnersHub.Common.Headers.mvc$translationsResources.fr-FR", "PartnersHub.Common.Headers.mvc$translationsResources.it-IT", "PartnersHub.Common.Headers.mvc$translationsResources.pt-PT", "PartnersHub.Common.Headers.mvc$translationsResources.ru-RU", "PartnersHub.Common.Headers.mvc$translationsResources.pl-PL"], function(exports, PartnersHub_Common_Headers_mvc_translationsResources_ar001, PartnersHub_Common_Headers_mvc_translationsResources_deDE, PartnersHub_Common_Headers_mvc_translationsResources_esES, PartnersHub_Common_Headers_mvc_translationsResources_frFR, PartnersHub_Common_Headers_mvc_translationsResources_itIT, PartnersHub_Common_Headers_mvc_translationsResources_ptPT, PartnersHub_Common_Headers_mvc_translationsResources_ruRU, PartnersHub_Common_Headers_mvc_translationsResources_plPL) {
    return {
        "ar-001": {
