    ...
    i(e, "Extensions/Breadcrumbs/BreadcrumbsDefaults.js", [], function() {
        ...
        class a extends r {
            ...
            getClassName() {
                ...
                return this.node.level <= t.nodeMap[t.rootNode].level && this.node.children.length ? i += " highcharts-above-level" : this.node.isLeaf || n(e.interactByLeaf, !e.allowTraversingTree) ? this.node.isLeaf || (i += " highcharts-internal-node") : i += " highcharts-internal-node-interactive", i
            }
            isValid() {
            ...
            getLevelOptions: function(t) {
                ...
                if (o(t))
                    for (h = r(t.from) ? t.from : 1, p = t.levels, i = {}, e = o(t.defaults) ? t.defaults : {}, s(p) && (i = p.reduce((t, i) => {
                            let s, a, d;
                            return o(i) && r(i.level) && (a = n((d = l({}, i)).levelIsConstant, e.levelIsConstant), delete d.levelIsConstant, delete d.level, o(t[s = i.level + (a ? 0 : h - 1)]) ? l(!0, t[s], d) : t[s] = d), t
                        }, {})), d = r(t.to) ? t.to : 1, a = 0; a <= d; a++) u[a] = l({}, e, o(i[a]) ? i[a] : {});
                return u
            },
        ...
        function I() {
            ...
            e && i && (this.is("treemap") ? (t = {
                ...
                title: void 0,
                tickPositions: []
            }, C(i.options, t), C(e.options, t), N = !0) : N && (i.setOptions(i.userOptions), e.setOptions(e.userOptions), N = !1))
        }
        class U extends v {
            static compose(t) {
                j(c, "TreemapSeries") && x(t, "afterBindAxes", I)
            }
            ...
            alignDataLabel(t, e, i) {
                let s = i.style;
                s && !B(s.textOverflow) && e.text && e.getBBox().width > (e.text.textWidth || 0) && e.css({
            ...
            calculateChildrenAreas(t, e) {
                let i = this.options,
                    ...
                    r = D(this[s && s.layoutAlgorithm] && s.layoutAlgorithm, i.layoutAlgorithm),
            ...
            drawDataLabels() {
                ...
                for (let s of this.points.filter(function(t) {
                    ...
                    style: {}
                }, s.node.isLeaf || (t.enabled = !1), e && e.dataLabels && (t = R(t, e.dataLabels), this.hasDataLabels = () => !0), s.shapeArgs && (t.style.width = s.shapeArgs.width, s.dataLabel && s.dataLabel.css({
                    width: s.shapeArgs.width + "px"
                })), s.dlOptions = R(t, s.options.dataLabels);
            ...
            drawPoints(t = this.points) {
                ...
                for (let e of t) {
                    let t = e.node.levelDynamic,
                        ...
                        g = n && c,
                        m = e.shapeArgs;
                    e.shouldDraw() && (e.isInside = !0, l && (d.r = l), R(!0, g ? h : d, c ? m : {}, s ? {} : this.pointAttribs(e, e.selected ? "select" : void 0)), this.colorAttribs && s && C(p, this.colorAttribs(e)), this[u] || (this[u] = i.g(u).attr({
                        zIndex: 1e3 - (t || 0)
            ...
            drillUp() {
                ...
                t && O(t.parent) && this.setRootNode(t.parent, !0, {
            ...
            init(e, i) {
                let s = this,
                    r = R(i.drillUpButton, i.breadcrumbs),
                    o = x(s, "setOptions", t => {
                        let e = t.userOptions;
                        B(e.allowDrillToNode) && !B(e.allowTraversingTree) && (e.allowTraversingTree = e.allowDrillToNode, delete e.allowDrillToNode), B(e.drillUpButton) && !B(e.traverseUpButton) && (e.traverseUpButton = e.drillUpButton, delete e.drillUpButton)
                    });
            ...
            onClickDrillToNode(t) {
                let e = t.point,
                    i = e && e.drillId;
                O(i) && (e.setState(""), this.setRootNode(i, !0, {
                    trigger: "click"
                }))
            }
            pointAttribs(t, e) {
                let i;
                let s = A(this.mapOptionsToLevel) ? this.mapOptionsToLevel : {},
                    r = t && s[t.node.level] || {},
                    o = this.options,
                    ...
                    a = {
                        ...
                        "stroke-width": D(t && t.borderWidth, r.borderWidth, l.borderWidth, o.borderWidth),
                        dashstyle: t && t.borderDashStyle || r.borderDashStyle || l.borderDashStyle || o.borderDashStyle,
                        fill: t && t.color || this.color
                    };
                return -1 !== n.indexOf("highcharts-above-level") ? (a.fill = "none", a["stroke-width"] = 0) : -1 !== n.indexOf("highcharts-internal-node-interactive") ? (i = D(l.opacity, o.opacity), a.fill = u(a.fill).setOpacity(i).get(), a.cursor = "pointer") : -1 !== n.indexOf("highcharts-internal-node") ? a.fill = "none" : e && (a.fill = u(a.fill).brighten(l.brightness).get()), a
            }
                ...
                for (let t of e) {
                    ...
                    if (e && r) {
                        let {
                            ...
                            x: n,
                            y: a
                        } = e, h = o(t), d = w(i.toPixels(n, !0), h, !0), p = w(i.toPixels(n + l, !0), h, !0), u = w(s.toPixels(a, !0), h, !0), c = w(s.toPixels(a + r, !0), h, !0), g = {
                            x: Math.min(d, p),
                            y: Math.min(u, c),
                            width: Math.abs(p - d),
                            height: Math.abs(c - u)
            ...
            setTreeValues(t) {
                ...
                let a = D(l && l.options.value, n);
                return l && (l.value = a), C(t, {
                    children: o,
                    childrenTotal: n,
                    ignore: !(D(l && l.visible, !0) && a > 0),
                    isLeaf: t.visible && !n,
                    levelDynamic: t.level - (r ? 0 : s.level),
                    name: D(l && l.name, ""),
                    sortIndex: D(l && l.sortIndex, -a),
                    val: a
                }), t
            }
            sliceAndDice(t, e) {
            ...
            translate() {
                ...
                s = t.nodeMap[i], "" === i || s || (t.setRootNode("", !1), i = t.rootNode, s = t.nodeMap[i]), t.mapOptionsToLevel = f({
                    from: s.level + 1,
                    levels: e.levels,
                    to: n.height,
                    defaults: {
        ...
        return U.defaultOptions = R(v.defaultOptions, a), C(U.prototype, {
            buildKDTree: g,
