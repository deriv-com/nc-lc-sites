define("PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$model", ["@outsystems/runtime-core-js", "PartnersHub.model", "RESTAPIWebsocketOfficial.model", "PartnersHub.controller", "RESTAPIWebsocketOfficial.controller", "PartnersHub.model$ST_9a29ef26037f71a833a7717922f3c172Structure", "PartnersHub.model$RL_d9adde0b03f648d52095292753e14389", "RESTAPIWebsocketOfficial.model$ST_63a473e932ef99f5271718b62399e682Structure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$RESTAPIWebsocketOfficial", "RESTAPIWebsocketOfficial.model$ST_5fc2e4a935064c1413d6e989e87decd2Structure", "PartnersHub.model$ST_fd472dd876adddab32395354eb83b1e8Structure", "PartnersHub.model$ST_3b8f7a9e49bbec7ed0ab55bd440bab7dStructure", "PartnersHub.controller$GetHeaderTitle", "PartnersHub.controller$RealSignupNextStep", "RESTAPIWebsocketOfficial.controller$ResidenceList", "PartnersHub.controller$GetToken", "RESTAPIWebsocketOfficial.controller$GetSettings"], function (OSRuntimeCore, PartnersHubModel, RESTAPIWebsocketOfficialModel, PartnersHubController, RESTAPIWebsocketOfficialController) {
...
define("PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$view", ["@outsystems/runtime-core-js", "PartnersHub.model", "PartnersHub.controller", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "react", "@outsystems/runtime-view-js", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$model", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$controller", "PartnersHub.clientVariables", "PartnersHub.Layouts.DeviceLayout.mvc$view", "@outsystems/runtime-widgets-js", "CustomComponentsOfficial.ButtonVariants.PrimaryButton.mvc$view", "PartnersHub.Common.SkeletonLoader.mvc$view", "PartnersHub.model$ST_9a29ef26037f71a833a7717922f3c172Structure", "PartnersHub.model$RL_d9adde0b03f648d52095292753e14389", "RESTAPIWebsocketOfficial.model$ST_63a473e932ef99f5271718b62399e682Structure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$RESTAPIWebsocketOfficial", "RESTAPIWebsocketOfficial.model$ST_5fc2e4a935064c1413d6e989e87decd2Structure", "PartnersHub.model$ST_fd472dd876adddab32395354eb83b1e8Structure", "PartnersHub.model$ST_3b8f7a9e49bbec7ed0ab55bd440bab7dStructure", "PartnersHub.controller$GetHeaderTitle", "PartnersHub.controller$RealSignupNextStep", "RESTAPIWebsocketOfficial.controller$ResidenceList", "PartnersHub.controller$GetToken", "RESTAPIWebsocketOfficial.controller$GetSettings"], function (OSRuntimeCore, PartnersHubModel, PartnersHubController, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController, React, OSView, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_model, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_controller, PartnersHubClientVariables, PartnersHub_Layouts_DeviceLayout_mvc_view, OSWidgets, CustomComponentsOfficial_ButtonVariants_PrimaryButton_mvc_view, PartnersHub_Common_SkeletonLoader_mvc_view) {
    var OS = OSRuntimeCore;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.IdentityVerificationBlock"; }
...
get _mobileOnClick$Action() {if(!(this.hasOwnProperty("__mobileOnClick$Action"))) {
...
try {return controller.safeExecuteAsyncJSNode(PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_controller_MobileOnClick_ValidateTheIDVJS, "ValidateTheIDV", "MobileOnClick", {
...
}set _mobileOnClick$Action(value) {this.__mobileOnClick$Action = value;
}
...
try {return controller.safeExecuteAsyncJSNode(PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_controller_Dropdown1OnChange_JavaScript1JS, "JavaScript1", "Dropdown1OnChange", {
SelectedDocument: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupIDVDocumentName(), OS.DataTypes.DataTypes.Text),
...
model.flush();
return RESTAPIWebsocketOfficialController.default.getSettings$Action("green.derivws.com", getTokenVar.value.tokenOut, "1", "en", callContext).then(function (value) {
getSettingsVar.value = value;
}).then(function () {
// Execute Action: ResidenceList
model.flush();
return RESTAPIWebsocketOfficialController.default.residenceList$Action("green.derivws.com", "1", "en", callContext).then(function (value) {
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_controller_OnReady_JavaScript1JS, "JavaScript1", "OnReady", {
...
try {return controller.safeExecuteAsyncJSNode(PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_controller_PrimaryButtononClick_ValidateTheIDVJS, "ValidateTheIDV", "PrimaryButtononClick", {
SelectedDocument: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupIDVDocumentName(), OS.DataTypes.DataTypes.Text),
DocumentNumber: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupIDVDocumentNumber(), OS.DataTypes.DataTypes.Text),
SupportedDocuments: OS.DataConversion.JSNodeParamConverter.to(jSONSerialize1Var.value.jSONOut, OS.DataTypes.DataTypes.Text),
AdditionalDocumentNumber: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupIDVAdditionalDocumentNumber(), OS.DataTypes.DataTypes.Text),
...
get _clickEvent$Action() {if(!(this.hasOwnProperty("__clickEvent$Action"))) {
...
}set _clickEvent$Action(value) {this.__clickEvent$Action = value;
}
...
get onClickEvent$Action() {if(!(this.hasOwnProperty("_onClickEvent$Action"))) {
...
}set onClickEvent$Action(value) {this._onClickEvent$Action = value;
}
...
define("PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.ar-001", [], function () {
return {
...
define("PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources", ["exports", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.ar-001", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.de-DE", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.es-ES", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.fr-FR", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.it-IT", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.pl-PL", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.pt-PT", "PartnersHub.RealAccountCreationFlow.IdentityVerificationBlock.mvc$translationsResources.ru-RU"], function (exports, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_ar001, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_deDE, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_esES, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_frFR, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_itIT, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_plPL, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_ptPT, PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_ruRU) {
return {
"ar-001": {
"translations": PartnersHub_RealAccountCreationFlow_IdentityVerificationBlock_mvc_translationsResources_ar001,
"isRTL": true
},
"de-DE": {
