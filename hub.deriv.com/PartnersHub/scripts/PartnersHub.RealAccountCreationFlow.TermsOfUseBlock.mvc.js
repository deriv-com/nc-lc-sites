...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.TermsOfUseBlock"; }
...
get _termsOfUseButtonAction$Action() {if(!(this.hasOwnProperty("__termsOfUseButtonAction$Action"))) {
...
}set _termsOfUseButtonAction$Action(value) {this.__termsOfUseButtonAction$Action = value;
}

get _termsOfUseOnChange$Action() {if(!(this.hasOwnProperty("__termsOfUseOnChange$Action"))) {
...
try {controller.ensureControllerAlive("TermsOfUseOnChange");
callContext = controller.callContext(callContext);
...
}set _termsOfUseOnChange$Action(value) {this.__termsOfUseOnChange$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._termsOfUseOnChange$Action, callContext);
} finally {
if(span) {
span.end();
}
