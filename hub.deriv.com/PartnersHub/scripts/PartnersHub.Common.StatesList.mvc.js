...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Common.StatesList"; }
...
try {return controller.safeExecuteJSNode(PartnersHub_Common_StatesList_mvc_controller_OnSearch_JavaScript1JS, "JavaScript1", "OnSearch", {
...
try {return controller.safeExecuteJSNode(PartnersHub_Common_StatesList_mvc_controller_OnReady_GetAuthTokenJS, "GetAuthToken", "OnReady", {
...
get onClickState$Action() {if(!(this.hasOwnProperty("_onClickState$Action"))) {
...
}set onClickState$Action(value) {this._onClickState$Action = value;
}
