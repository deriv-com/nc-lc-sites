...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "Events.EventDetails"; }
...
get getEventById$AggrRefresh() {if(!(this.hasOwnProperty("_getEventById$AggrRefresh"))) {
...
}set getEventById$AggrRefresh(value) {this._getEventById$AggrRefresh = value;
}
...
get _stickyButtonBottomOnClick$Action() {if(!(this.hasOwnProperty("__stickyButtonBottomOnClick$Action"))) {
...
try {controller.ensureControllerAlive("StickyButtonBottomOnClick");
callContext = controller.callContext(callContext);
// Execute Action: RudderstackTrackEvent
PartnersHubController.default.rudderstackTrackEvent$Action(function () {
var rec = new PartnersHubModel.ST_23ff1d290ec4691b1c668ad437100cd0Structure();
...
}set _stickyButtonBottomOnClick$Action(value) {this.__stickyButtonBottomOnClick$Action = value;
}

get _setHTMLContent$Action() {if(!(this.hasOwnProperty("__setHTMLContent$Action"))) {
...
try {controller.ensureControllerAlive("SetHTMLContent");
callContext = controller.callContext(callContext);
...
try {return controller.safeExecuteJSNode(PartnersHub_Events_EventDetails_mvc_controller_SetHTMLContent_JavaScript1JS, "JavaScript1", "SetHTMLContent", {
...
}set _setHTMLContent$Action(value) {this.__setHTMLContent$Action = value;
}

get _titleBlockCloseButtonAction$Action() {if(!(this.hasOwnProperty("__titleBlockCloseButtonAction$Action"))) {
...
try {controller.ensureControllerAlive("TitleBlockCloseButtonAction");
callContext = controller.callContext(callContext);
// Execute Action: RudderstackTrackEvent
PartnersHubController.default.rudderstackTrackEvent$Action(function () {
var rec = new PartnersHubModel.ST_23ff1d290ec4691b1c668ad437100cd0Structure();
...
}set _titleBlockCloseButtonAction$Action(value) {this.__titleBlockCloseButtonAction$Action = value;
}
...
get _getEventByIdOnAfterFetch$Action() {if(!(this.hasOwnProperty("__getEventByIdOnAfterFetch$Action"))) {
...
}set _getEventByIdOnAfterFetch$Action(value) {this.__getEventByIdOnAfterFetch$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._stickyButtonBottomOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._setHTMLContent$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._titleBlockCloseButtonAction$Action, callContext);
} finally {
if(span) {
span.end();
}
