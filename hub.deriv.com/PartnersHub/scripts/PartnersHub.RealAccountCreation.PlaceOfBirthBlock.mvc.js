...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreation.PlaceOfBirthBlock"; }
...
get getAccountPurposes$AggrRefresh() {if(!(this.hasOwnProperty("_getAccountPurposes$AggrRefresh"))) {
...
}set getAccountPurposes$AggrRefresh(value) {this._getAccountPurposes$AggrRefresh = value;
}
...
get _placeofBirthOnClick$Action() {if(!(this.hasOwnProperty("__placeofBirthOnClick$Action"))) {
...
try {controller.ensureControllerAlive("PlaceofBirthOnClick");
...
}set _placeofBirthOnClick$Action(value) {this.__placeofBirthOnClick$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreation_PlaceOfBirthBlock_mvc_controller_NextOnClick_ValidateJS, "Validate", "NextOnClick", {
...
get _nextOnDesktopClick$Action() {if(!(this.hasOwnProperty("__nextOnDesktopClick$Action"))) {
...
try {controller.ensureControllerAlive("NextOnDesktopClick");
callContext = controller.callContext(callContext);
var validateJSResult = new OS.DataTypes.VariableHolder();
var jSONDeserializePersonalDetailsValidFieldsVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(PartnersHubModel.ST_0bf22241d1cbe538c3a6a5d88308ad6cStructure))());
var jSONDeserializePersonalDetailsValidationErrorVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(PartnersHubModel.ST_0838c962fcebffa0995cc58090869a8eStructure))());
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreation_PlaceOfBirthBlock_mvc_controller_NextOnDesktopClick_ValidateJS, "Validate", "NextOnDesktopClick", {
PlaceOfBirth: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupPlaceOfBirth(), OS.DataTypes.DataTypes.Text),
PhoneNumber: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getRealSignupPhoneNumber(), OS.DataTypes.DataTypes.Text),
ValidationErrors: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text),
ValidFields: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
...
}set _nextOnDesktopClick$Action(value) {this.__nextOnDesktopClick$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._placeofBirthOnClick$Action, callContext);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._nextOnDesktopClick$Action, callContext);
} finally {
if(span) {
span.end();
}
