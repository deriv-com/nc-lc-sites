...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "PhoneNumberVerification.VerifyEmailPhoneNumberVerification"; }
...
get _onClickResendEmail$Action() {if(!(this.hasOwnProperty("__onClickResendEmail$Action"))) {
...
try {return controller.safeExecuteJSNode(PartnersHub_PhoneNumberVerification_VerifyEmailPhoneNumberVerification_mvc_controller_OnClickResendEmail_StartTimerJS, "StartTimer", "OnClickResendEmail", {
...
}set _onClickResendEmail$Action(value) {this.__onClickResendEmail$Action = value;
}
...
"Q5xGGMg4_Umu6dd_rTYEew#Value": "Wir haben einen Bestätigungslink an gesendet.",
...
return {
"v5+MWDj2dkSNxfDF9HQMGA#Value": ". Entrez le code ou cliquez sur le lien fourni dans l\'e-mail pour vérifier que le compte vous appartient.",
...
return {
"v5+MWDj2dkSNxfDF9HQMGA#Value": "Introduza o código ou clique no link no e-mail para confirmar que a conta lhe pertence.",
"Q5xGGMg4_Umu6dd_rTYEew#Value": "Enviámos um código de verificação para",
"B3lrFIwzEE6kXtLKNxbdzQ#Value": "Confirme que é realmente a pessoa a tentar aceder à conta. "
};
});
