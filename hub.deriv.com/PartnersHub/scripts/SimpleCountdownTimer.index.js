...
require(["@outsystems/runtime-core-js", "SimpleCountdownTimer.appDefinition", "@outsystems/runtime-core-js/debugger"], function (OSRuntimeCore, SimpleCountdownTimerAppDefinition, NullDebugger) {
var OS = OSRuntimeCore;
if(OS.Navigation.ensureRequestSecurity()) {
return;
}

Promise.all([OS.Application.default.initialize(SimpleCountdownTimerAppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
if(success) {
