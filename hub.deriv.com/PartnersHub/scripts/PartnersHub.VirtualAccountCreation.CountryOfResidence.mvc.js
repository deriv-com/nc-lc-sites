...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "VirtualAccountCreation.CountryOfResidence"; }
...
get _onChangeDropdownDesktop$Action() {if(!(this.hasOwnProperty("__onChangeDropdownDesktop$Action"))) {
...
try {controller.ensureControllerAlive("OnChangeDropdownDesktop");
...
}set _onChangeDropdownDesktop$Action(value) {this.__onChangeDropdownDesktop$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_VirtualAccountCreation_CountryOfResidence_mvc_controller_OnReady_CheckQueryParamsJS, "CheckQueryParams", "OnReady", {
...
try {return controller.safeExecuteClientAction(controller._onChangeDropdownDesktop$Action, callContext, selectedCountryValueIn);
} finally {
if(span) {
span.end();
}
...
try {return controller.safeExecuteClientAction(controller._onClickCountry$Action, callContext, selectedCountryIn);
} finally {
if(span) {
span.end();
}
...
return {
"pbfCjWYiFUygNJAPjiikDg#Value.-925459353.1": "Country of residence",
"sr4xc85gqU+3m+jC+yrRCw#Value.-1726996070.1": "Serviços indisponíveis",
"T3pPwyl00k64JlPCc3h4ug#Value.-1726996070.1": "Serviços indisponíveis",
"tIWqM2ADqkWSsmlZwXgmXQ#Value.830386192.1": "Select your country of residence",
