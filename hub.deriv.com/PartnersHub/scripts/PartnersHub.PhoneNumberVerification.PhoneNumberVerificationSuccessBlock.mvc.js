...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "PhoneNumberVerification.PhoneNumberVerificationSuccessBlock"; }
...
get onClickOk$Action() {if(!(this.hasOwnProperty("_onClickOk$Action"))) {
...
}set onClickOk$Action(value) {this._onClickOk$Action = value;
}
...
"HYnU0YvK1UOpA1lyGTo7Xg#Value": "Effectué"
};
});
...
"HYnU0YvK1UOpA1lyGTo7Xg#Value": "Operazione andata a buon fine"
};
});
...
return {
"nsqW7xRMnEa2udMrIDU1Bw#Value": "Número de telemóvel verificado. O seu gestor de conta irá contactá-lo em breve.",
"HYnU0YvK1UOpA1lyGTo7Xg#Value": "Concluído com sucesso"
};
});
