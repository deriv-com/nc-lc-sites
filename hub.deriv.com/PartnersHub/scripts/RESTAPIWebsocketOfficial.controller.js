...
try {return controller.safeExecuteAsyncJSNode(RESTAPIWebsocketOfficial_controller_FetchData_FetchJS, "Fetch", "FetchData", {
...
const fetchData = async () => {
    ...
    try {
        ...
        console.log("Body: ",$parameters.RequestBody)
        const options = {
            headers,
            method: $parameters.Method,
            ...(!!$parameters.RequestBody && { body: $parameters.RequestBody })
        };
...
define("RESTAPIWebsocketOfficial.controller$FetchLoginHistory", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.model$ST_609b8b40acc9750c8c3a2d077df910daStructure", "RESTAPIWebsocketOfficial.model$ST_92e8c92924c6f96b11c8b9bf865fb39cStructure", "RESTAPIWebsocketOfficial.controller$ServerAction.LoginHistory", "RESTAPIWebsocketOfficial.controller$FetchData", "RESTAPIWebsocketOfficial.controller$CheckHost"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.fetchLoginHistory$Action = function (hostIn, authTokenIn, appIdIn, languageIn, requestIn, callContext) {
return OS.Logger.startActiveSpan("FetchLoginHistory", function (span) {
if(span) {
span.setAttribute("code.function", "FetchLoginHistory");
span.setAttribute("outsystems.function.key", "3a68a6be-e574-4706-8e9a-c79c06909260");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "CLIENT_ACTION");
}
...
return OS.Flow.tryFinally(function () {
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.FetchLoginHistory$vars"))());
vars.value.hostInLocal = hostIn;
vars.value.authTokenInLocal = authTokenIn;
vars.value.appIdInLocal = appIdIn;
vars.value.languageInLocal = languageIn;
vars.value.requestInLocal = requestIn.clone();
var allExceptionsVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.ErrorHandlerOutputType());
var fetchLoginHistoryVar = new OS.DataTypes.VariableHolder();
var fetchDataVar = new OS.DataTypes.VariableHolder();
var checkHostVar = new OS.DataTypes.VariableHolder();
var generatePayloadVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.JSONSerializeOutputType());
var responseDeserializeVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(RESTAPIWebsocketOfficialModel.ST_92e8c92924c6f96b11c8b9bf865fb39cStructure))());
var outVars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.FetchLoginHistory$outVars"))());
return OS.Flow.executeAsyncFlow(function () {
// Execute Action: CheckHost
checkHostVar.value = RESTAPIWebsocketOfficialController.default.checkHost$Action(vars.value.hostInLocal, callContext);
...
return OS.Flow.executeSequence(function () {
if((checkHostVar.value.isGreenOut)) {
// Execute Action: FetchLoginHistory
return controller.loginHistory$ServerAction(vars.value.appIdInLocal, vars.value.languageInLocal, vars.value.requestInLocal, vars.value.authTokenInLocal, callContext).then(function (value) {
fetchLoginHistoryVar.value = value;
}).then(function () {
// Response = FetchLoginHistory.Response
outVars.value.responseOut = fetchLoginHistoryVar.value.responseOut;
});
} else {
...
// Execute Action: FetchData
return RESTAPIWebsocketOfficialController.default.fetchData$Action(vars.value.appIdInLocal, vars.value.languageInLocal, generatePayloadVar.value.jSONOut, vars.value.hostInLocal, "POST", "login_history", vars.value.authTokenInLocal, callContext).then(function (value) {
fetchDataVar.value = value;
}).then(function () {
// JSON Deserialize: ResponseDeserialize
responseDeserializeVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(fetchDataVar.value.responseOut, RESTAPIWebsocketOfficialModel.ST_92e8c92924c6f96b11c8b9bf865fb39cStructure, true);
// Response = ResponseDeserialize.Data
outVars.value.responseOut = responseDeserializeVar.value.dataOut;
});
}
...
OS.Logger.debug("FetchLoginHistory.FetchLoginHistory", OS.Exceptions.getMessage(ex));
// Handle Error: AllExceptions
if(!(OS.Exceptions.isSystem(ex))) {
OS.Logger.error(null, ex, null, null, 1);
allExceptionsVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
if(span) {
span.setAttribute("code.function", "AllExceptions");
span.setAttribute("outsystems.function.key", "8c5f8524-7915-4034-8489-6a04dc35f762");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "CLIENT_EXCEPTION_HANDLER");
}
...
var controller = RESTAPIWebsocketOfficialController.default;
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.FetchLoginHistory$vars", [{
name: "Host",
attrName: "hostInLocal",
mandatory: true,
dataType: OS.DataTypes.DataTypes.Text,
...
dataType: OS.DataTypes.DataTypes.Record,
defaultValue: function () {
return new RESTAPIWebsocketOfficialModel.ST_609b8b40acc9750c8c3a2d077df910daStructure();
},
complexType: RESTAPIWebsocketOfficialModel.ST_609b8b40acc9750c8c3a2d077df910daStructure
}]);
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.FetchLoginHistory$outVars", [{
name: "Response",
attrName: "responseOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Record,
defaultValue: function () {
return new RESTAPIWebsocketOfficialModel.ST_92e8c92924c6f96b11c8b9bf865fb39cStructure();
},
complexType: RESTAPIWebsocketOfficialModel.ST_92e8c92924c6f96b11c8b9bf865fb39cStructure
}, {
name: "HasNetworkError",
attrName: "hasNetworkErrorOut",
mandatory: false,
...
RESTAPIWebsocketOfficialController.default.clientActionProxies.fetchLoginHistory$Action = function (hostIn, authTokenIn, appIdIn, languageIn, requestIn) {
hostIn = (hostIn === undefined) ? "" : hostIn;
authTokenIn = (authTokenIn === undefined) ? "" : authTokenIn;
appIdIn = (appIdIn === undefined) ? 1 : appIdIn;
languageIn = (languageIn === undefined) ? "en" : languageIn;
requestIn = (requestIn === undefined) ? new RESTAPIWebsocketOfficialModel.ST_609b8b40acc9750c8c3a2d077df910daStructure() : requestIn;
return controller.executeActionInsideJSNode(RESTAPIWebsocketOfficialController.default.fetchLoginHistory$Action.bind(controller, OS.DataConversion.JSNodeParamConverter.from(hostIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(authTokenIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(appIdIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(languageIn, OS.DataTypes.DataTypes.Text), requestIn), OS.Controller.BaseViewController.activeScreen ? OS.Controller.BaseViewController.activeScreen.callContext() : undefined, function (actionResults) {
return {
Response: actionResults.responseOut,
HasNetworkError: OS.DataConversion.JSNodeParamConverter.to(actionResults.hasNetworkErrorOut, OS.DataTypes.DataTypes.Boolean)
};
...
var fetchDataVar = new OS.DataTypes.VariableHolder();
var checkHostVar = new OS.DataTypes.VariableHolder();
var responseDeserializeVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(RESTAPIWebsocketOfficialModel.ST_2f457e0a5b13526850516eea23ae0e9aStructure))());
...
// Response = GetMt5LoginList.Response
outVars.value.responseOut = getMt5LoginListVar.value.responseOut;
});
} else {
// Execute Action: FetchData
...
// JSON Deserialize: ResponseDeserialize
responseDeserializeVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(fetchDataVar.value.responseOut, RESTAPIWebsocketOfficialModel.ST_2f457e0a5b13526850516eea23ae0e9aStructure, false);
// Response = ResponseDeserialize.Data
outVars.value.responseOut = responseDeserializeVar.value.dataOut;
});
}
...
define("RESTAPIWebsocketOfficial.controller$GetPartnerAccount", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.controller$FetchData", "RESTAPIWebsocketOfficial.controller$CheckHost", "RESTAPIWebsocketOfficial.model$ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure", "RESTAPIWebsocketOfficial.controller$ServerAction.PartnerAccount"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.getPartnerAccount$Action = function (hostIn, authTokenIn, appIdIn, languageIn, callContext) {
return OS.Logger.startActiveSpan("GetPartnerAccount", function (span) {
if(span) {
span.setAttribute("code.function", "GetPartnerAccount");
span.setAttribute("outsystems.function.key", "92db5b2d-76a6-42c4-b6d0-97af9c26b448");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "CLIENT_ACTION");
}
...
return OS.Flow.tryFinally(function () {
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.GetPartnerAccount$vars"))());
vars.value.hostInLocal = hostIn;
vars.value.authTokenInLocal = authTokenIn;
vars.value.appIdInLocal = appIdIn;
vars.value.languageInLocal = languageIn;
var allExceptionsVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.ErrorHandlerOutputType());
var partnerAccountVar = new OS.DataTypes.VariableHolder();
var fetchDataVar = new OS.DataTypes.VariableHolder();
var checkHostVar = new OS.DataTypes.VariableHolder();
var fetchResponseVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(RESTAPIWebsocketOfficialModel.ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure))());
var outVars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.GetPartnerAccount$outVars"))());
return OS.Flow.executeAsyncFlow(function () {
// Execute Action: CheckHost
checkHostVar.value = RESTAPIWebsocketOfficialController.default.checkHost$Action(vars.value.hostInLocal, callContext);
...
return OS.Flow.executeSequence(function () {
if((checkHostVar.value.isGreenOut)) {
// Execute Action: PartnerAccount
return controller.partnerAccount$ServerAction(vars.value.appIdInLocal, vars.value.languageInLocal, vars.value.authTokenInLocal, callContext).then(function (value) {
partnerAccountVar.value = value;
}).then(function () {
// Response = PartnerAccount.Response
outVars.value.responseOut = partnerAccountVar.value.responseOut;
});
} else {
// Execute Action: FetchData
...
// JSON Deserialize: FetchResponse
fetchResponseVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(fetchDataVar.value.responseOut, RESTAPIWebsocketOfficialModel.ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure, false);
// Response = FetchResponse.Data
outVars.value.responseOut = fetchResponseVar.value.dataOut;
});
}
...
OS.Logger.debug("GetPartnerAccount.GetPartnerAccount", OS.Exceptions.getMessage(ex));
// Handle Error: AllExceptions
if(!(OS.Exceptions.isSystem(ex))) {
OS.Logger.error(null, ex, null, null, 1);
allExceptionsVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
if(span) {
span.setAttribute("code.function", "AllExceptions");
span.setAttribute("outsystems.function.key", "835f855d-2889-4f5d-b898-d643fab7aeba");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "CLIENT_EXCEPTION_HANDLER");
}
...
var controller = RESTAPIWebsocketOfficialController.default;
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.GetPartnerAccount$vars", [{
name: "Host",
attrName: "hostInLocal",
mandatory: true,
dataType: OS.DataTypes.DataTypes.Text,
...
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.GetPartnerAccount$outVars", [{
name: "Response",
attrName: "responseOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Record,
defaultValue: function () {
return new RESTAPIWebsocketOfficialModel.ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure();
},
complexType: RESTAPIWebsocketOfficialModel.ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure
}, {
name: "HasNetworkError",
attrName: "hasNetworkErrorOut",
mandatory: false,
...
RESTAPIWebsocketOfficialController.default.clientActionProxies.getPartnerAccount$Action = function (hostIn, authTokenIn, appIdIn, languageIn) {
hostIn = (hostIn === undefined) ? "" : hostIn;
authTokenIn = (authTokenIn === undefined) ? "" : authTokenIn;
appIdIn = (appIdIn === undefined) ? 1 : appIdIn;
languageIn = (languageIn === undefined) ? "en" : languageIn;
return controller.executeActionInsideJSNode(RESTAPIWebsocketOfficialController.default.getPartnerAccount$Action.bind(controller, OS.DataConversion.JSNodeParamConverter.from(hostIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(authTokenIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(appIdIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(languageIn, OS.DataTypes.DataTypes.Text)), OS.Controller.BaseViewController.activeScreen ? OS.Controller.BaseViewController.activeScreen.callContext() : undefined, function (actionResults) {
return {
Response: actionResults.responseOut,
HasNetworkError: OS.DataConversion.JSNodeParamConverter.to(actionResults.hasNetworkErrorOut, OS.DataTypes.DataTypes.Boolean)
};
...
define("RESTAPIWebsocketOfficial.controller$GetStatesList", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.model$ST_a67c544d9efb2ed7a818e6289b80fd02Structure", "RESTAPIWebsocketOfficial.model$ST_cab7386b3f457cedb5cb6bb7db56df4eStructure", "RESTAPIWebsocketOfficial.controller$ServerAction.FetchStatesList", "RESTAPIWebsocketOfficial.controller$CheckHost", "RESTAPIWebsocketOfficial.controller$FetchData"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.getStatesList$Action = function (hostIn, appIdIn, languageIn, requestIn, callContext) {
return OS.Logger.startActiveSpan("GetStatesList", function (span) {
if(span) {
span.setAttribute("code.function", "GetStatesList");
...
return OS.Flow.tryFinally(function () {
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.GetStatesList$vars"))());
vars.value.hostInLocal = hostIn;
vars.value.appIdInLocal = appIdIn;
vars.value.languageInLocal = languageIn;
vars.value.requestInLocal = requestIn.clone();
var allExceptionsVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.ErrorHandlerOutputType());
var getStatesListVar = new OS.DataTypes.VariableHolder();
var checkHostVar = new OS.DataTypes.VariableHolder();
var fetchDataVar = new OS.DataTypes.VariableHolder();
var stringifyPayloadVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.JSONSerializeOutputType());
var responseDeserializeVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(RESTAPIWebsocketOfficialModel.ST_cab7386b3f457cedb5cb6bb7db56df4eStructure))());
var outVars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.GetStatesList$outVars"))());
return OS.Flow.executeAsyncFlow(function () {
// Execute Action: CheckHost
checkHostVar.value = RESTAPIWebsocketOfficialController.default.checkHost$Action(vars.value.hostInLocal, callContext);
...
return OS.Flow.executeSequence(function () {
if((checkHostVar.value.isGreenOut)) {
// Execute Action: GetStatesList
return controller.fetchStatesList$ServerAction(vars.value.appIdInLocal, vars.value.languageInLocal, vars.value.requestInLocal, callContext).then(function (value) {
getStatesListVar.value = value;
}).then(function () {
// Response = GetStatesList.Response
outVars.value.responseOut = getStatesListVar.value.responseOut;
});
} else {
// JSON Serialize: StringifyPayload
stringifyPayloadVar.value.jSONOut = OS.JSONUtils.serializeToJSON(vars.value.requestInLocal, false, false);
// Execute Action: FetchData
return RESTAPIWebsocketOfficialController.default.fetchData$Action(vars.value.appIdInLocal, vars.value.languageInLocal, stringifyPayloadVar.value.jSONOut, vars.value.hostInLocal, "POST", "states_list", "", callContext).then(function (value) {
fetchDataVar.value = value;
}).then(function () {
// JSON Deserialize: ResponseDeserialize
responseDeserializeVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(fetchDataVar.value.responseOut, RESTAPIWebsocketOfficialModel.ST_cab7386b3f457cedb5cb6bb7db56df4eStructure, false);
// Response = ResponseDeserialize.Data
outVars.value.responseOut = responseDeserializeVar.value.dataOut;
});
}
...
OS.Logger.debug("GetStatesList.GetStatesList", OS.Exceptions.getMessage(ex));
// Handle Error: AllExceptions
if(!(OS.Exceptions.isSystem(ex))) {
OS.Logger.error(null, ex, null, null, 1);
allExceptionsVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
var controller = RESTAPIWebsocketOfficialController.default;
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.GetStatesList$vars", [{
name: "Host",
attrName: "hostInLocal",
mandatory: true,
dataType: OS.DataTypes.DataTypes.Text,
...
dataType: OS.DataTypes.DataTypes.Record,
defaultValue: function () {
return new RESTAPIWebsocketOfficialModel.ST_a67c544d9efb2ed7a818e6289b80fd02Structure();
},
complexType: RESTAPIWebsocketOfficialModel.ST_a67c544d9efb2ed7a818e6289b80fd02Structure
}]);
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.GetStatesList$outVars", [{
name: "Response",
attrName: "responseOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Record,
defaultValue: function () {
return new RESTAPIWebsocketOfficialModel.ST_cab7386b3f457cedb5cb6bb7db56df4eStructure();
},
complexType: RESTAPIWebsocketOfficialModel.ST_cab7386b3f457cedb5cb6bb7db56df4eStructure
}, {
name: "HasNetworkError",
attrName: "hasNetworkErrorOut",
mandatory: false,
...
RESTAPIWebsocketOfficialController.default.clientActionProxies.getStatesList$Action = function (hostIn, appIdIn, languageIn, requestIn) {
hostIn = (hostIn === undefined) ? "" : hostIn;
appIdIn = (appIdIn === undefined) ? 1 : appIdIn;
languageIn = (languageIn === undefined) ? "en" : languageIn;
requestIn = (requestIn === undefined) ? new RESTAPIWebsocketOfficialModel.ST_a67c544d9efb2ed7a818e6289b80fd02Structure() : requestIn;
return controller.executeActionInsideJSNode(RESTAPIWebsocketOfficialController.default.getStatesList$Action.bind(controller, OS.DataConversion.JSNodeParamConverter.from(hostIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(appIdIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(languageIn, OS.DataTypes.DataTypes.Text), requestIn), OS.Controller.BaseViewController.activeScreen ? OS.Controller.BaseViewController.activeScreen.callContext() : undefined, function (actionResults) {
return {
Response: actionResults.responseOut,
HasNetworkError: OS.DataConversion.JSNodeParamConverter.to(actionResults.hasNetworkErrorOut, OS.DataTypes.DataTypes.Boolean)
};
...
var checkHostVar = new OS.DataTypes.VariableHolder();
var generatePayloadVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.JSONSerializeOutputType());
var responseDeserializeVar = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getJSONDeserializeOutputType(RESTAPIWebsocketOfficialModel.ST_78c818dad6d0af8d67b898e33e5a3dfbStructure))());
...
generatePayloadVar.value.jSONOut = OS.JSONUtils.serializeToJSON(vars.value.requestInLocal, false, false);
// Execute Action: FetchData
return RESTAPIWebsocketOfficialController.default.fetchData$Action(vars.value.appIdInLocal, vars.value.languageInLocal, generatePayloadVar.value.jSONOut, vars.value.hostInLocal, "POST", "mt5_new_account", vars.value.authTokenInLocal, callContext).then(function (value) {
fetchDataVar.value = value;
}).then(function () {
// JSON Deserialize: ResponseDeserialize
responseDeserializeVar.value.dataOut = OS.JSONUtils.deserializeFromJSON(fetchDataVar.value.responseOut, RESTAPIWebsocketOfficialModel.ST_78c818dad6d0af8d67b898e33e5a3dfbStructure, false);
// Response = ResponseDeserialize.Data
outVars.value.responseOut = responseDeserializeVar.value.dataOut;
});
}
...
RESTAPIWebsocketOfficialController.default.clientActionProxies.postMT5NewAccount$Action = function (requestIn, authTokenIn, appIdIn, languageIn, hostIn) {
requestIn = (requestIn === undefined) ? new RESTAPIWebsocketOfficialModel.ST_c7e48234a44c41827c7b70f1ea8aa0b1Structure() : requestIn;
authTokenIn = (authTokenIn === undefined) ? "" : authTokenIn;
appIdIn = (appIdIn === undefined) ? 1 : appIdIn;
languageIn = (languageIn === undefined) ? "en" : languageIn;
hostIn = (hostIn === undefined) ? "" : hostIn;
return controller.executeActionInsideJSNode(RESTAPIWebsocketOfficialController.default.postMT5NewAccount$Action.bind(controller, requestIn, OS.DataConversion.JSNodeParamConverter.from(authTokenIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(appIdIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(languageIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(hostIn, OS.DataTypes.DataTypes.Text)), OS.Controller.BaseViewController.activeScreen ? OS.Controller.BaseViewController.activeScreen.callContext() : undefined, function (actionResults) {
return {
HasNetworkError: OS.DataConversion.JSNodeParamConverter.to(actionResults.hasNetworkErrorOut, OS.DataTypes.DataTypes.Boolean),
Response: actionResults.responseOut
};
...
define("RESTAPIWebsocketOfficial.controller$PostNotificationEvents", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.controller$PostNotificationEvents.JavaScript1JS", "RESTAPIWebsocketOfficial.controller$FetchData", "RESTAPIWebsocketOfficial.controller$CheckHost", "RESTAPIWebsocketOfficial.model$ST_776bbd191df189ae2b5f20c613dc695aStructure", "RESTAPIWebsocketOfficial.model$ST_dd93278b2756b05a5d284868241cc3d7Structure", "RESTAPIWebsocketOfficial.controller$ServerAction.PostNotificationEvents"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController, RESTAPIWebsocketOfficial_controller_PostNotificationEvents_JavaScript1JS) {
var OS = OSRuntimeCore;
...
span.setAttribute("outsystems.function.key", "06553b98-b281-4c15-8311-a3dd47f48742");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "JAVASCRIPT");
}

try {return controller.safeExecuteJSNode(RESTAPIWebsocketOfficial_controller_PostNotificationEvents_JavaScript1JS, "JavaScript1", "PostNotificationEvents", {
In1: OS.DataConversion.JSNodeParamConverter.to(fetchDataVar.value.responseOut, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
} finally {
if(span) {
...
define("RESTAPIWebsocketOfficial.controller$PostNotificationEvents.JavaScript1JS", [], function () {
return function ($parameters, $actions, $roles, $public) {
...
generatePayloadVar.value.jSONOut = OS.JSONUtils.serializeToJSON(vars.value.requestInLocal, false, false);
// Execute Action: FetchData
return RESTAPIWebsocketOfficialController.default.fetchData$Action(vars.value.appIdInLocal, vars.value.languageInLocal, generatePayloadVar.value.jSONOut, vars.value.hostInLocal, "POST", "trading_platform_password_change", vars.value.authTokenInLocal, callContext).then(function (value) {
fetchDataVar.value = value;
}).then(function () {
// JSON Deserialize: ResponseDeserialize
...
define("RESTAPIWebsocketOfficial.controller$PostTradingPlatformPasswordReset", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.controller$FetchData", "RESTAPIWebsocketOfficial.controller$CheckHost", "RESTAPIWebsocketOfficial.model$ST_514eb2dd1a273e9cef6da33626bbf692Structure", "RESTAPIWebsocketOfficial.model$ST_07c55c1e5241bcf8a9665901701e0dbfStructure", "RESTAPIWebsocketOfficial.controller$ServerAction.PostTradingPlatformPasswordReset"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.postTradingPlatformPasswordReset$Action = function (hostIn, appIdIn, languageIn, callContext) {
...
return OS.Flow.tryFinally(function () {
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.PostTradingPlatformPasswordReset$vars"))());
vars.value.hostInLocal = hostIn;
vars.value.appIdInLocal = appIdIn;
vars.value.languageInLocal = languageIn;
var allExceptionsVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.ErrorHandlerOutputType());
...
var outVars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial.PostTradingPlatformPasswordReset$outVars"))());
return OS.Flow.executeAsyncFlow(function () {
// Execute Action: CheckHost
checkHostVar.value = RESTAPIWebsocketOfficialController.default.checkHost$Action(vars.value.hostInLocal, callContext);
...
var rec = new RESTAPIWebsocketOfficialModel.ST_514eb2dd1a273e9cef6da33626bbf692Structure();
return rec;
}(), callContext).then(function (value) {
...
OS.Logger.debug("PostTradingPlatformPasswordReset.PostTradingPlatformPasswordReset", OS.Exceptions.getMessage(ex));
// Handle Error: AllExceptions
if(!(OS.Exceptions.isSystem(ex))) {
OS.Logger.error(null, ex, null, null, 1);
allExceptionsVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
var controller = RESTAPIWebsocketOfficialController.default;
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.PostTradingPlatformPasswordReset$vars", [{
name: "Host",
attrName: "hostInLocal",
mandatory: true,
dataType: OS.DataTypes.DataTypes.Text,
...
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial.PostTradingPlatformPasswordReset$outVars", [{
name: "HasNetworkError",
attrName: "hasNetworkErrorOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Boolean,
...
RESTAPIWebsocketOfficialController.default.clientActionProxies.postTradingPlatformPasswordReset$Action = function (hostIn, appIdIn, languageIn) {
hostIn = (hostIn === undefined) ? "" : hostIn;
appIdIn = (appIdIn === undefined) ? 1 : appIdIn;
languageIn = (languageIn === undefined) ? "en" : languageIn;
return controller.executeActionInsideJSNode(RESTAPIWebsocketOfficialController.default.postTradingPlatformPasswordReset$Action.bind(controller, OS.DataConversion.JSNodeParamConverter.from(hostIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(appIdIn, OS.DataTypes.DataTypes.Text), OS.DataConversion.JSNodeParamConverter.from(languageIn, OS.DataTypes.DataTypes.Text)), OS.Controller.BaseViewController.activeScreen ? OS.Controller.BaseViewController.activeScreen.callContext() : undefined, function (actionResults) {
return {
HasNetworkError: OS.DataConversion.JSNodeParamConverter.to(actionResults.hasNetworkErrorOut, OS.DataTypes.DataTypes.Boolean),
Response: actionResults.responseOut
};
...
try {return controller.safeExecuteJSNode(RESTAPIWebsocketOfficial_controller_TradingPlatformAvailableAccountsCtrader_JavaScript1JS, "JavaScript1", "TradingPlatformAvailableAccountsCtrader", {
...
try {return controller.safeExecuteJSNode(RESTAPIWebsocketOfficial_controller_TradingPlatformAvailableAccountsCtrader_JavaScript2JS, "JavaScript2", "TradingPlatformAvailableAccountsCtrader", {
...
return controller.callServerAction("Authorize", "screenservices/RESTAPIWebsocketOfficial/ActionAuthorize", "MWotgxVItHGppBpUzezBew", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("FetchServiceToken", "screenservices/RESTAPIWebsocketOfficial/ActionFetchServiceToken", "ncI4UxvOMyX4HiaatmAKvg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
define("RESTAPIWebsocketOfficial.controller$ServerAction.FetchStatesList", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.model$ST_cab7386b3f457cedb5cb6bb7db56df4eStructure"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.fetchStatesList$ServerAction = function (appIdIn, languageIn, requestIn, callContext) {
var controller = this.controller;
return OS.Logger.startActiveSpan("FetchStatesList", function (span) {
if(span) {
span.setAttribute("code.function", "FetchStatesList");
...
return controller.callServerAction("FetchStatesList", "screenservices/RESTAPIWebsocketOfficial/ActionFetchStatesList", "3Su8hhyHB6MrF0UJAuUd4A", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial$ActionFetchStatesList"))();
executeServerActionResult.responseOut = OS.DataConversion.ServerDataConverter.from(outputs.Response, RESTAPIWebsocketOfficialModel.ST_cab7386b3f457cedb5cb6bb7db56df4eStructure);
return executeServerActionResult;
});
}, function () {
if(span) {
...
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial$ActionFetchStatesList", [{
name: "Response",
attrName: "responseOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Record,
...
return controller.callServerAction("GetAccountStatus", "screenservices/RESTAPIWebsocketOfficial/ActionGetAccountStatus", "Eb6SNoFOsVPPch5zUoGKGw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetAssetIndex", "screenservices/RESTAPIWebsocketOfficial/ActionGetAssetIndex", "uGIiErpz1XlbGPL4YNbigw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetKYCAuthStatus", "screenservices/RESTAPIWebsocketOfficial/ActionGetKYCAuthStatus", "OPk_MSeW3K_YQh1ZRMM3Nw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetLandingCompany", "screenservices/RESTAPIWebsocketOfficial/ActionGetLandingCompany", "S0iNT2gCNOkjBLGyp_by4w", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetMT5LoginList", "screenservices/RESTAPIWebsocketOfficial/ActionGetMT5LoginList", "ykm+dpVKY4bNvv5Cr2JDrA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pAdvertInfo", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pAdvertInfo", "D9laZ0MqERIK_Ztq7Aa_fQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pAdvertiserAdverts", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pAdvertiserAdverts", "n9zB2mW7FrVxFRIgISYZ5A", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pAdvertiserInfo", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pAdvertiserInfo", "ocQQCiYfMNQCl3+y7WuVCA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pAdvertiserList", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pAdvertiserList", "P42fwBYi61VWcUObrq5kqA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pAdvertList", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pAdvertList", "KAdiGAUWCROQRPbQluMG8A", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pCountryList", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pCountryList", "MkqgnP_QBiXX_Hthc1v4+Q", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pOrderInfo", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pOrderInfo", "K5NFd1hxx+kvpUNrr_Fcwg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pOrderList", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pOrderList", "NnHpz11lfJRfBcWuS4pxug", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pPaymentMethods", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pPaymentMethods", "a+8GpFInsKL8MYEEzpMaWw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetP2pSettings", "screenservices/RESTAPIWebsocketOfficial/ActionGetP2pSettings", "h0wue8qumroY1aYRcfZGNw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetResidenceList", "screenservices/RESTAPIWebsocketOfficial/ActionGetResidenceList", "LPaU4fxAefgcGmUs8O4ZTg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetSettings", "screenservices/RESTAPIWebsocketOfficial/ActionGetSettings", "uCOCdfml_ybegDIFipnP1A", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetTradingPlatformStatus", "screenservices/RESTAPIWebsocketOfficial/ActionGetTradingPlatformStatus", "ogV_e8Es6npuRxkzpj839Q", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("GetWebsiteStatus", "screenservices/RESTAPIWebsocketOfficial/ActionGetWebsiteStatus", "edktRkYlssHSWjOZe1Bcmw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("IDVDocumentAdd", "screenservices/RESTAPIWebsocketOfficial/ActionIDVDocumentAdd", "HaPm2OdGphrxTKRcTd1YbQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
define("RESTAPIWebsocketOfficial.controller$ServerAction.LoginHistory", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.model$ST_92e8c92924c6f96b11c8b9bf865fb39cStructure"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.loginHistory$ServerAction = function (appIdIn, languageIn, requestIn, authTokenIn, callContext) {
var controller = this.controller;
return OS.Logger.startActiveSpan("LoginHistory", function (span) {
if(span) {
span.setAttribute("code.function", "LoginHistory");
span.setAttribute("outsystems.function.key", "3b07dfab-bead-4591-859a-fc9788c9c7fb");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "SCREEN_SERVICE_SERVER_ACTION_CALL");
}
...
return controller.callServerAction("LoginHistory", "screenservices/RESTAPIWebsocketOfficial/ActionLoginHistory", "EVltMBEMrBU6QiyXme3oIQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial$ActionLoginHistory"))();
executeServerActionResult.responseOut = OS.DataConversion.ServerDataConverter.from(outputs.Response, RESTAPIWebsocketOfficialModel.ST_92e8c92924c6f96b11c8b9bf865fb39cStructure);
return executeServerActionResult;
});
}, function () {
if(span) {
...
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial$ActionLoginHistory", [{
name: "Response",
attrName: "responseOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Record,
...
define("RESTAPIWebsocketOfficial.controller$ServerAction.PartnerAccount", ["exports", "@outsystems/runtime-core-js", "RESTAPIWebsocketOfficial.model", "RESTAPIWebsocketOfficial.controller", "RESTAPIWebsocketOfficial.model$ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure"], function (exports, OSRuntimeCore, RESTAPIWebsocketOfficialModel, RESTAPIWebsocketOfficialController) {
var OS = OSRuntimeCore;
RESTAPIWebsocketOfficialController.default.partnerAccount$ServerAction = function (appIdIn, languageIn, authTokenIn, callContext) {
var controller = this.controller;
return OS.Logger.startActiveSpan("PartnerAccount", function (span) {
if(span) {
span.setAttribute("code.function", "PartnerAccount");
span.setAttribute("outsystems.function.key", "4f820605-ab9f-41f9-9ac0-7be161924514");
span.setAttribute("outsystems.function.owner.name", "RESTAPIWebsocketOfficial");
span.setAttribute("outsystems.function.owner.key", "7f8cebf7-cfdc-4d8e-b4dd-0ba14627b017");
span.setAttribute("outsystems.function.type", "SCREEN_SERVICE_SERVER_ACTION_CALL");
}
...
return controller.callServerAction("PartnerAccount", "screenservices/RESTAPIWebsocketOfficial/ActionPartnerAccount", "mDjwcSQ233KUR_5yRNuTAA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("RESTAPIWebsocketOfficial$ActionPartnerAccount"))();
executeServerActionResult.responseOut = OS.DataConversion.ServerDataConverter.from(outputs.Response, RESTAPIWebsocketOfficialModel.ST_80cfad7cfd3d8af4d81e0f273be7fee9Structure);
return executeServerActionResult;
});
}, function () {
if(span) {
...
RESTAPIWebsocketOfficialController.default.constructor.registerVariableGroupType("RESTAPIWebsocketOfficial$ActionPartnerAccount", [{
name: "Response",
attrName: "responseOut",
mandatory: false,
dataType: OS.DataTypes.DataTypes.Record,
...
return controller.callServerAction("PostAccountList", "screenservices/RESTAPIWebsocketOfficial/ActionPostAccountList", "M4CZE_4CWCOJaCzaszzAVA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostCashierCrypto", "screenservices/RESTAPIWebsocketOfficial/ActionPostCashierCrypto", "1guIhmRPisiysGUCH5oq1A", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostCashierFiat", "screenservices/RESTAPIWebsocketOfficial/ActionPostCashierFiat", "Ceor+ltpRmfjmm+WIQ5RDA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostLogout", "screenservices/RESTAPIWebsocketOfficial/ActionPostLogout", "JEgQxAd+7mkCqOo_dPfzuw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostMT5NewAccount", "screenservices/RESTAPIWebsocketOfficial/ActionPostMT5NewAccount", "hON+1JPtDSeEwrO6R+9XBA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostNewAccountVirtual", "screenservices/RESTAPIWebsocketOfficial/ActionPostNewAccountVirtual", "IwWcXKHzEkPS5B6Mwk_yOg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostNotificationEvents", "screenservices/RESTAPIWebsocketOfficial/ActionPostNotificationEvents", "3TpCJbVha2zMrkghUjNrCQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pAdvertCreate", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pAdvertCreate", "bQz5sTifZqBjoGt_5VX76g", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pAdvertiserCreate", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pAdvertiserCreate", "qviCuOCL4UWEGH_yLKJwcg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pAdvertiserPaymentMethods", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pAdvertiserPaymentMethods", "gbHC181hSVCWZMEGRg57OA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pAdvertiserRelations", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pAdvertiserRelations", "_EqFavrZrec2o6U_20hCfg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pAdvertiserUpdate", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pAdvertiserUpdate", "RJI1bSSycFo9Kc7GWme2Cw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pAdvertUpdate", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pAdvertUpdate", "YBjoP+YFUqvtQNFKGp1RFg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pChatCreate", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pChatCreate", "1wzWGBb2f9q2eyKupgrzeA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pOrderCancel", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pOrderCancel", "gyfpvIYJZANbltEYD15vHw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pOrderConfirm", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pOrderConfirm", "7GlJOHdQnBFKZD_VEm0Nbw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pOrderCreate", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pOrderCreate", "TiVgXyBuvaU5xhFzBYYWTA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pOrderDispute", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pOrderDispute", "KOz4kUS6x92UGqKkbqeUQQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostP2pOrderReview", "screenservices/RESTAPIWebsocketOfficial/ActionPostP2pOrderReview", "1pha9sv4TTyoPr2TyenLlg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostResetPassword", "screenservices/RESTAPIWebsocketOfficial/ActionPostResetPassword", "ooHudkbLrengewcwcuUJIQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostSetSettings", "screenservices/RESTAPIWebsocketOfficial/ActionPostSetSettings", "_xKwJWITiKeXfs4NLX4y3w", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostTradingPlatformAccounts", "screenservices/RESTAPIWebsocketOfficial/ActionPostTradingPlatformAccounts", "dxAPYY4U5Jq4EYiZzfj3Vw", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostTradingPlatformAvailableAccountsCtrader", "screenservices/RESTAPIWebsocketOfficial/ActionPostTradingPlatformAvailableAccountsCtrader", "UUvT3S5SOU3lFgUsHHrWkg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostTradingPlatformAvailableAccountsMt5", "screenservices/RESTAPIWebsocketOfficial/ActionPostTradingPlatformAvailableAccountsMt5", "WAjVFw1c0FMOlQQTFaaVUQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostTradingPlatformPasswordChange", "screenservices/RESTAPIWebsocketOfficial/ActionPostTradingPlatformPasswordChange", "YiD5cv_ybBvR+Tlv6qF4XQ", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostTradingPlatformPasswordReset", "screenservices/RESTAPIWebsocketOfficial/ActionPostTradingPlatformPasswordReset", "OKC_1ppA+FfP46NC0wOlqA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("PostVerifyEmail", "screenservices/RESTAPIWebsocketOfficial/ActionPostVerifyEmail", "p7xvOKmHS44oJTl8+vBwQg", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
...
return controller.callServerAction("UploadDocument", "screenservices/RESTAPIWebsocketOfficial/ActionUploadDocument", "VbOZqaQbsDT5JTAJe4OODA", inputs, controller.callContext(callContext), undefined, undefined, false).then(function (outputs) {
