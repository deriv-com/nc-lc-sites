...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "PhoneNumberVerification.OTPVerificationBlock"; }
...
get onClickResendCode$Action() {if(!(this.hasOwnProperty("_onClickResendCode$Action"))) {
...
}set onClickResendCode$Action(value) {this._onClickResendCode$Action = value;
}
...
define("PartnersHub.PhoneNumberVerification.OTPVerificationBlock.mvc$translationsResources.ar-001", [], function () {
return {
