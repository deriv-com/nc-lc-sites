...
try {return controller.safeExecuteJSNode(PartnersHub_controller_AssignFeatureFlag_AssignFeaturesJS, "AssignFeatures", "AssignFeatureFlag", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_CFDCommissionModalFlow_JavaScript1JS, "JavaScript1", "CFDCommissionModalFlow", {
...
const {first_name = "", last_name = "", email} = settingsData.get_settings
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_DatadogSetUser_JavaScript1JS, "JavaScript1", "DatadogSetUser", {
...
try {return controller.safeExecuteAsyncJSNode(PartnersHub_controller_DerivApiClientSendMessage_JavaScript1JS, "JavaScript1", "DerivApiClientSendMessage", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_GetDefaultAppId_JavaScript1JS, "JavaScript1", "GetDefaultAppId", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_GetToken_JavaScript1JS, "JavaScript1", "GetToken", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_HandleRedirectOnLogin_CheckAndStoreRedirectParamsJS, "CheckAndStoreRedirectParams", "HandleRedirectOnLogin", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_HandleRedirectOnLogin_SetuseridJS, "Setuserid", "HandleRedirectOnLogin", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_HandleRedirectOnLogin_ClearParamsJS, "ClearParams", "HandleRedirectOnLogin", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteAsyncJSNode(PartnersHub_controller_IFrameLogout_IframeLogoutJSJS, "IframeLogoutJS", "IFrameLogout", {
...
try {return controller.safeExecuteAsyncJSNode(PartnersHub_controller_InitGrowthbook_InitGrowthbookJS, "InitGrowthbook", "InitGrowthbook", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_InitGrowthbook_AssignFeatureFlagsJS, "AssignFeatureFlags", "InitGrowthbook", null, function ($parameters) {
}, {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_InitialScriptNeeded_CheckScreenNoLoginNeededJS, "CheckScreenNoLoginNeeded", "InitialScriptNeeded", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_InitialScriptNeeded_GetAuthTokenJS, "GetAuthToken", "InitialScriptNeeded", {
Token: OS.DataConversion.JSNodeParamConverter.to("", OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_InitialScriptNeeded_ParsePlatformURLJS, "ParsePlatformURL", "InitialScriptNeeded", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_InitialScriptNeeded_RedirectToNonPartnerAccountScreenJS, "RedirectToNonPartnerAccountScreen", "InitialScriptNeeded", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_IsUserLoggedIn_JavaScript1JS, "JavaScript1", "IsUserLoggedIn", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_MountDatadogClient_DatadogScriptJS, "DatadogScript", "MountDatadogClient", {
PRODUCTION_HOSTNAME: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getProductionHostName(), OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_MountDerivAPIClient_JavaScript1JS, "JavaScript1", "MountDerivAPIClient", {
...
class DerivAPIClient {
    constructor(endpoint, options) {
        ...
        this.websocket.addEventListener('message', async response => {
            ...
            if (parsedData.subscription || ((_a = parsedData.echo_req) == null ? void 0 : _a.subscribe)) {
                ...
                const subscribeHash = await Ye.hashObject({ ...payload });
    ...
    async send({ name, payload }) {
        ...
        const { promise, resolve, reject } = xe.createPromise();
    ...
    async subscribe({ name, payload, onData, onError }) {
        var _a;
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_MountLiveChat_JavaScript1JS, "JavaScript1", "MountLiveChat", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_RedirectToExternalNewTab_OpenURLJS, "OpenURL", "RedirectToExternalNewTab", {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_RedirectToOauth_JavaScript1JS, "JavaScript1", "RedirectToOauth", {
...
function redirecttoOauth () {
    ...
    setTimeout(function(){window.location.href =`https://${oauthServer}/oauth2/authorize?app_id=${$parameters.CurrentAppId}&l=EN&brand=deriv`;}, 500);
}
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_RudderstackIdentifyEvent_JavaScript1JS, "JavaScript1", "RudderstackIdentifyEvent", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_RudderstackTrackEvent_TrackScriptJS, "TrackScript", "RudderstackTrackEvent", {
...
const { show_user_id: showUserId , ...rest } = payload;
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_SetAppId_JavaScript1JS, "JavaScript1", "SetAppId", {
CurrentWebsocketURL: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getWebsocketURL(), OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_SetDefaultAppId_JavaScript1JS, "JavaScript1", "SetDefaultAppId", {
ProductionHostName: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getProductionHostName(), OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_SetServer_JavaScript1JS, "JavaScript1", "SetServer", {
CurrentWebsocketURL: OS.DataConversion.JSNodeParamConverter.to(PartnersHubClientVariables.getWebsocketURL(), OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_ShowLiveChat_JavaScript1JS, "JavaScript1", "ShowLiveChat", null, function ($parameters) {
}, {}, {});
} finally {
if(span) {
span.end();
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_UseDevice_SyncIsDesktopMobileJS, "SyncIsDesktopMobile", "UseDevice", null, function ($parameters) {
}, {
...
try {return controller.safeExecuteJSNode(PartnersHub_controller_UseDevice_CheckViewportJS, "CheckViewport", "UseDevice", null, function ($parameters) {
}, {
SetIsDesktop: PartnersHubController.default.clientActionProxies.setIsDesktop$Action,
SetIsMobile: PartnersHubController.default.clientActionProxies.setIsMobile$Action
}, {});
