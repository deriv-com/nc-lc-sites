define("PartnersHub.RealAccountCreationFlow.DateOfBirthContainer.mvc$model", ["@outsystems/runtime-core-js", "PartnersHub.model", "OutSystemsUI.model", "OutSystemsUI.model$ST_bc4abb4233d9ce894e855c520a20c76fStructure", "PartnersHub.referencesHealth", "PartnersHub.referencesHealth$OutSystemsUI", "PartnersHub.model$ST_b5010cf570b4e39f4aa14db0ae11cfbfStructure", "PartnersHub.model$ST_24f25c56883af3fb98f750bd4c11bbdcStructure"], function (OSRuntimeCore, PartnersHubModel, OutSystemsUIModel) {
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.DateOfBirthContainer"; }
...
try {return controller.safeExecuteJSNode(PartnersHub_RealAccountCreationFlow_DateOfBirthContainer_mvc_controller_NextOnClick_ValidateJS, "Validate", "NextOnClick", {
...
// Trigger Event: NextStep
return controller.nextStep$Action(callContext);
}
...
get nextStep$Action() {if(!(this.hasOwnProperty("_nextStep$Action"))) {
this._nextStep$Action = function () {
return Promise.resolve();
};
}

return this._nextStep$Action;
}set nextStep$Action(value) {this._nextStep$Action = value;
}
