...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Common.AlertBlock"; }
...
get actionHandler$Action() {if(!(this.hasOwnProperty("_actionHandler$Action"))) {
...
}set actionHandler$Action(value) {this._actionHandler$Action = value;
}
