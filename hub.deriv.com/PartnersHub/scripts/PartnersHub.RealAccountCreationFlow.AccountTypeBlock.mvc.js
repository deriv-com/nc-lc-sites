...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "RealAccountCreationFlow.AccountTypeBlock"; }
...
get _companyAccountOnClick$Action() {if(!(this.hasOwnProperty("__companyAccountOnClick$Action"))) {
...
}set _companyAccountOnClick$Action(value) {this.__companyAccountOnClick$Action = value;
}

get _individualAccountOnClick$Action() {if(!(this.hasOwnProperty("__individualAccountOnClick$Action"))) {
...
}set _individualAccountOnClick$Action(value) {this.__individualAccountOnClick$Action = value;
}
