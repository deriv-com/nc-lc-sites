...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "Layouts.MobileModal"; }
...
try {return controller.safeExecuteJSNode(PartnersHub_Layouts_MobileModal_mvc_controller_OnParametersChanged_AttachHideAnimsJS, "AttachHideAnims", "OnParametersChanged", {
...
get _dispatchOnClickOutside$Action() {if(!(this.hasOwnProperty("__dispatchOnClickOutside$Action"))) {
...
}set _dispatchOnClickOutside$Action(value) {this.__dispatchOnClickOutside$Action = value;
}

get _setIsModalOpenProxy$Action() {if(!(this.hasOwnProperty("__setIsModalOpenProxy$Action"))) {
...
try {controller.ensureControllerAlive("SetIsModalOpenProxy");
callContext = controller.callContext(callContext);
...
}set _setIsModalOpenProxy$Action(value) {this.__setIsModalOpenProxy$Action = value;
}
...
try {return controller.safeExecuteJSNode(PartnersHub_Layouts_MobileModal_mvc_controller_OnReady_OnClickOutsideJS, "OnClickOutside", "OnReady", null, function ($parameters) {
}, {
...
try {return controller.safeExecuteClientAction(controller._setIsModalOpenProxy$Action, callContext, newIsModalOpenProxyIn);
} finally {
if(span) {
span.end();
}
...
get onClickOutside$Action() {if(!(this.hasOwnProperty("_onClickOutside$Action"))) {
...
}set onClickOutside$Action(value) {this._onClickOutside$Action = value;
}
