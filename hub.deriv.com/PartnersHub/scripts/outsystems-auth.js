(function(global, factory) {
            ...
            return e.prototype._padding = function(e) {
                ...
                if (e.LOG_LEVEL && (s = e.LOG_LEVEL), "undefined" != typeof window && window.LOG_LEVEL && (s = window.LOG_LEVEL), G[t] >= G[s]) {
                    ...
                    var u = "[".concat(t, "] ").concat(this._ts(), " ").concat(this.name),
                        c = "";
                    if (1 === i.length && "string" == typeof i[0]) a(c = "".concat(u, " - ").concat(i[0]));
                    else if (1 === i.length) c = "".concat(u, " ").concat(i[0]), a(u, i[0]);
        ...
        we = function() {
            if (!ge) {
                if (ge = (null === (e = ye.find(function(e) {
                    ...
                    })) || void 0 === e ? void 0 : e.platform) || H.ServerSideUnknown, me)
                    for (; ve.length;) ve.pop()();
                else ve.forEach(function(e) {
                    return e();
                });
    ...
    var Oe = function() {
            ...
            return e.prototype._remove = function(e, t) {
                ...
                if (void 0 === n && (n = "noname"), function(e) {
                    ...
                    }(t)) ke.warn("WARNING onHubCapsule is Deprecated. Please pass in a callback."), r = t.onHubCapsule.bind(t);
                else {
    ...
    if (
        ...
        function(e) {
            ...
            function c(e, t) {
                if (u(t), e = o(e, t < 0 ? 0 : 0 | h(t)), !s.TYPED_ARRAY_SUPPORT)
            ...
            e.Buffer = s, e.SlowBuffer = function(e) {
                ...
                if (t >= n) return 1;
                if (this === e) return 0;
                for (var o = (i >>>= 0) - (r >>>= 0), a = (n >>>= 0) - (t >>>= 0), u = Math.min(o, a), c = this.slice(r, i), l = e.slice(t, n), h = 0; h < u; ++h)
                    if (c[h] !== l[h]) {
                        o = c[h], a = l[h];
                        break;
                    }
    ...
    Ur.prototype.convert = function(e) {
            ...
            if (0 != l) {
                ...
                for (; --y >= 0;) {
                    ...
                    if ((n[g] += o.am(0, m, n, y, 0, c)) < m)
                        for (o.dlShiftTo(y, v), n.subTo(v, n); n[g] < --m;) n.subTo(v, n);
                }
        ...
        if (s-- > 0)
            for (a < this.DB && (n = this[s] >> a) > 0 && (i = !0, o = Ir(n)); s >= 0;) a < t ? (n = (this[s] & (1 << a) - 1) << t - a, n |= this[--s] >> (a += this.DB - t)) : (n = this[s] >> (a -= t) & r, a <= 0 && (a += this.DB, --s)), n > 0 && (i = !0), i && (o += Ir(n));
        return i ? o : "0";
        ...
        for (i = Tr(e[p]) - 1; p >= 0;) {
            ...
            if ((i -= u) < 0 && (i += this.DB, --p), g) a[f].copyTo(o), g = !1;
            else {
        ...
        Jr = function() {
            ...
            return t.setSignInUserSession = function(e) {
                ...
                if ("NEW_PASSWORD_REQUIRED" === i) {
                    ...
                    if (o && (s = JSON.parse(e.ChallengeParameters.userAttributes), a = JSON.parse(e.ChallengeParameters.requiredAttributes)), a)
        ...
        ! function(n) {
            ...
            function R(e) {
                ...
                for (r = i = E.length, i && E.push(y); r < w;) {
                    ...
                    for (a - t > S((u - n) / (b = r + 1)) && I("overflow"), n += (a - t) * b, t = a, s = 0; s < w; ++s)
                        if ((m = e[s]) < t && ++n > u && I("overflow"), m == t) {
    ...
    wi.prototype.parse = function(e, t, n) {
        ...
        if (!Pi[u] && (l || u && !Oi[u])) {
            ...
            if (!y)
                for (var v = this.hostname.split(/\./), m = (p = 0, v.length); p < m; p++) {
                    var w = v[p];
                    if (w && !w.match(Ti)) {
        ...
        if (e.protocol && e.protocol !== n.protocol) {
            ...
            if (n.protocol = e.protocol, e.host || Pi[e.protocol]) n.pathname = e.pathname;
            else {
        ...
        Li = function() {
            ...
            return e.prototype.isValidScopes = function(e) {
                ...
                if ("undefined" != typeof window && window.crypto) window.crypto.getRandomValues(t);
                    ...
                    for (var n = 0; n < e; n += 1) t[n] = 66 * Math.random() | 0;
        ...
        Ji = function() {
            ...
            return e.prototype.getModuleName = function() {
                ...
                if (n) t = n;
                    ...
                    if (r) 0 === r.length ? t = "NOMFA" : Wi.debug("invalid case for getPreferredMFA", e);
    ...
    Xi = new WeakMap(), Qi = new WeakMap(), eo = new WeakMap(), to = new WeakMap(), no = new WeakMap(),
        function(e) {
    ...
    class ba {
        ...
        getInstance(e, t) {
            ...
            if (!U(this, aa, "f") && r) U(this, ia, "m", fa).call(this, r, t);
            else if (!o && r && i) U(this, ia, "m", fa).call(this, r, t);
            else if (o && i) throw new Error("Error getting new instance of auth because a user is already authenticated using another mechanism");
            return U(this, aa, "f");
        }
        updateConfig(e, t) {
