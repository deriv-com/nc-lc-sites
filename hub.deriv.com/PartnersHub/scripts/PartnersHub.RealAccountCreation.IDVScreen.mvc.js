...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebScreen {
        static get displayName() { return "RealAccountCreation.IDVScreen"; }
...
get _realAccountCreationLayoutScreenBasedOnClickSkip$Action() {if(!(this.hasOwnProperty("__realAccountCreationLayoutScreenBasedOnClickSkip$Action"))) {
...
try {controller.ensureControllerAlive("RealAccountCreationLayoutScreenBasedOnClickSkip");
callContext = controller.callContext(callContext);
...
}set _realAccountCreationLayoutScreenBasedOnClickSkip$Action(value) {this.__realAccountCreationLayoutScreenBasedOnClickSkip$Action = value;
}
...
try {return controller.safeExecuteClientAction(controller._realAccountCreationLayoutScreenBasedOnClickSkip$Action, callContext);
} finally {
if(span) {
span.end();
}
