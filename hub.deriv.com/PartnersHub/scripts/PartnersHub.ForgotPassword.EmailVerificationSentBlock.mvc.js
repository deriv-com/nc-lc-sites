...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    class View extends OSView.BaseView.BaseWebBlock {
        static get displayName() { return "ForgotPassword.EmailVerificationSentBlock"; }
...
get resendEmailHandler$Action() {if(!(this.hasOwnProperty("_resendEmailHandler$Action"))) {
...
}set resendEmailHandler$Action(value) {this._resendEmailHandler$Action = value;
}
...
"OUP4_ngJ2U+KHS54a33Tbw#Value": "Wir haben einen Bestätigungslink an gesendet."
};
});
...
return {
"8kih1_ff0UeIFc+ysew9NA#Value": "Assurez-vous que l\'adresse e-mail n\'est pas bloquée par des pare-feux ou des filtres.",
...
return {
"8kih1_ff0UeIFc+ysew9NA#Value": "Certifique-se de que o e-mail não está a ser bloqueado por firewalls ou filtros.",
"7UEGGYTlwEKf1U81dhfqeQ#Value": "Consulte a sua pasta de correio não solicitado (spam).",
"zom7hmSWsUy5xgWgjn0ksg#Value": "Certifique-se de que introduziu corretamente o seu endereço de e-mail.",
"zMaPYVkUw0OD1za8TxdeeQ#Value": "Reenviar e-mail",
"z3UBGtc1W0+RfXnqw3WdlA#Value": "Não recebeu o e-mail?",
"OUP4_ngJ2U+KHS54a33Tbw#Value": "Enviámos um e-mail com o link de verificação para"
};
});
