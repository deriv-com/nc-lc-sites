...
require(["@outsystems/runtime-core-js", "CloneAWSSignatureVersion4.appDefinition", "@outsystems/runtime-core-js/debugger"], function (OSRuntimeCore, CloneAWSSignatureVersion4AppDefinition, NullDebugger) {
var OS = OSRuntimeCore;
if(OS.Navigation.ensureRequestSecurity()) {
return;
}

Promise.all([OS.Application.default.initialize(CloneAWSSignatureVersion4AppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
if(success) {
