...
try {var resizeOptionsIterator = callContext.iterationContext.getIterator(vars.value.resizeOptionsInLocal);
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_GetContent_GetContentJS, "GetContent", "GetContent", {
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_GetEditorConfiguration_GetConfigurationJS, "GetConfiguration", "GetEditorConfiguration", {
EditorName: OS.DataConversion.JSNodeParamConverter.to(vars.value.editorNameInLocal, OS.DataTypes.DataTypes.Text),
...
var pluginList = [];
window[$parameters.EditorName].config._config.plugins.forEach(function(plugin) {pluginList.push(plugin.pluginName)}); 
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_GetEditorState_GetReadOnlyJS, "GetReadOnly", "GetEditorState", {
EditorName: OS.DataConversion.JSNodeParamConverter.to(vars.value.editorNameInLocal, OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_GetToolbarOptions_GetToolbarOptionsJS, "GetToolbarOptions", "GetToolbarOptions", {
EditorName: OS.DataConversion.JSNodeParamConverter.to(vars.value.editorNameInLocal, OS.DataTypes.DataTypes.Text),
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_LoadHTMLIntoContainer_SetInnerHTMLJS, "SetInnerHTML", "LoadHTMLIntoContainer", {
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_MakeId_MakeIdJS, "MakeId", "MakeId", {
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_SetContent_SetContentJS, "SetContent", "SetContent", {
EditorName: OS.DataConversion.JSNodeParamConverter.to(vars.value.editorNameInLocal, OS.DataTypes.DataTypes.Text),
Content: OS.DataConversion.JSNodeParamConverter.to(vars.value.contentInLocal, OS.DataTypes.DataTypes.Text)
}, function ($parameters) {
}, {}, {});
...
try {return controller.safeExecuteJSNode(CKEditor5_controller_SetEditorState_SetReadOnlyJS, "SetReadOnly", "SetEditorState", {
