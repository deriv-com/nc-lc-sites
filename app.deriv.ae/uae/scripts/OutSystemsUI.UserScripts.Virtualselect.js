            ...
            return t = e, o = [{
                ...
                value: function() {
                    var e, t = this,
                        ...
                        u = this.labelRenderer,
                        c = this.disableOptionGroupCheckbox,
                        p = this.uniqueId,
                        h = this.searchGroup,
                        d = "function" == typeof u,
                        v = n.convertToBoolean,
                        f = "";
                    if (l && (e = new RegExp("(".concat(n.regexEscape(this.searchValue), ")(?!([^<]+)?>)"), "gi")), this.multiple && (r = '<span class="checkbox-icon"></span>'), this.allowNewOption) {
                        var y = this.getTooltipAttrText("New Option");
                        a = '<span class="vscomp-new-option-icon" '.concat(y, "></span>")
                    }
                    s.forEach((function(o) {
                        var s, n = o.index,
                            ...
                            k = v(o.isSelected),
                            C = "";
                        if (o.classNames && (y += " ".concat(o.classNames)), o.isFocused && (w = "0", y += " focused"), o.isDisabled && (y += " disabled", C = 'aria-disabled="true"'), o.isGroupTitle && (f = o.label, y += " group-title", c && (m = "")), k && (y += " selected"), o.isGroupOption) {
                            var E = "";
                            y += " group-option", S = 'data-group-index="'.concat(o.groupIndex, '"'), o.customData ? (f = void 0 !== o.customData.group_name ? "".concat(o.customData.group_name, ", ") : "", E = void 0 !== o.customData.description ? " ".concat(o.customData.description, ",") : "", x = 'aria-label="'.concat(f, " ").concat(o.label, ", ").concat(E, '"')) : x = 'aria-label="'.concat(f, ", ").concat(o.label, '"')
                        }
                        s = d ? u(o) : o.label, o.description && (O = '<div class="vscomp-option-description" '.concat(b, ">").concat(o.description, "</div>")), o.isCurrentNew ? (y += " current-new", g += a) : !l || o.isGroupTitle && !h || (s = s.replace(e, "<mark>$1</mark>")), i += '<div role="option" aria-selected="'.concat(k, '" id="vscomp-option-').concat(p, "-").concat(n, '"\n          class="').concat(y, '" data-value="').concat(o.value, '" data-index="').concat(n, '" data-visible-index="').concat(o.visibleIndex, '"\n          tabindex=').concat(w, " ").concat(S, " ").concat(C, " ").concat(x, "\n        >\n          ").concat(m, '\n          <span class="vscomp-option-text" ').concat(b, ">\n            ").concat(s, "\n          </span>\n          ").concat(O, "\n          ").concat(g, "\n        </div>")
                    })), f = "", this.$options.innerHTML = i, this.$visibleOptions = this.$options.querySelectorAll(".vscomp-option"), this.afterRenderOptions(o)
                }
            }, {
                key: "renderSearch",
                value: function() {
                ...
                value: function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                        t = g(this.sortedOptions),
                        o = 2 * this.optionsCount,
                        i = this.getVisibleStartIndex(),
                        s = this.getNewOption(),
                        n = i + o - 1,
                        r = 0;
                    s && (s.visibleIndex = r, r += 1), t = t.filter((function(e) {
                        var t = !1;
                        return e.isVisible && !e.isCurrentNew && (t = r >= i && r <= n, e.visibleIndex = r, r += 1), t
                    })), s && (t = [s].concat(g(t))), this.visibleOptions = t, this.visibleOptionsCount = t.length, this.renderOptions(e)
                }
            }, {
                    ...
                    if (h && this.hideValueTooltipOnSelectAll) r.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(c, ")");
                        ...
                        if ("" === f) r.innerHTML = this.placeholder;
                            ...
                            if (this.alwaysShowSelectedOptionsCount || d.hasEllipsis(r) || y || s) {
                                ...
                                if (y && (b += ' / <span class="vscomp-max-value-count">'.concat(y, "</span>")), h) r.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(c, ")");
                ...
                value: function() {
                    ...
                    this.isSilentClose = !1, d.removeClass(this.$allWrappers, "focused"), this.removeOptionFocus(), !t && this.isPopupActive && (d.removeClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !1), d.addClass(this.$allWrappers, "closed"), t || d.dispatchEvent(this.$ele, "afterClose");
                ...
                value: function() {
                    var t = this.$ele;
                    t.virtualSelect = void 0, t.value = void 0, t.innerHTML = "", e.openInstances.delete(this), this === e.lastInteractedInstance && (e.lastInteractedInstance = null), this.removeEvents(), this.hasDropboxWrapper && this.$dropboxWrapper.remove(), this.dropboxPopover && this.dropboxPopover.destroy(), d.removeClass(t, "vscomp-ele")
                }
            }, {
