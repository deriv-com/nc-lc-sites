...
function(t, e) {
        ...
        drawPoints(t = this.points) {
            ...
            for (let e of t) {
                let t = e.node.levelDynamic,
                    ...
                    g = l && c,
                    v = e.shapeArgs;
                e.shouldDraw() && (e.isInside = !0, a && (d.r = a), tN(!0, g ? h : d, c ? v : {}, s ? {} : this.pointAttribs(e, e.selected ? "select" : void 0)), this.colorAttribs && s && tS(p, this.colorAttribs(e)), this[u] || (this[u] = i.g(u).attr({
                    zIndex: 1e3 - (t || 0)
            ...
            let t = [],
                ...
                h = (t, e) => {
                    let {
                        x: o,
                        y: a
                    } = e, l = (i.getRotationOfChar(t) - 90) * t3, n = Math.cos(l), h = Math.sin(l);
                    return [
                        [o - r * n, a - r * h],
                        [o + s * n, a + s * h]
                    ]
    ...
    ({
        compose: function(t) {
            t9(t, "afterGetBBox", ei), t9(t, "beforeAddingDataLabel", es);
            let e = t.prototype;
