 ...
 */
function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(t._Highcharts, t._Highcharts.SVGElement, t._Highcharts.SeriesRegistry) : "function" == typeof define && define.amd ? define("highcharts/modules/networkgraph", ["highcharts/highcharts"], function(t) {
        return e(t, t.SVGElement, t.SeriesRegistry)
    }) : "object" == typeof exports ? exports["highcharts/modules/networkgraph"] = e(t._Highcharts, t._Highcharts.SVGElement, t._Highcharts.SeriesRegistry) : t.Highcharts = e(t.Highcharts, t.Highcharts.SVGElement, t.Highcharts.SeriesRegistry)
    ...
    function a(t) {
        ...
        return o[t](i, i.exports, a), i.exports
    }
    a.n = t => {
    ...
    function m() {
        let t, e, i, s, o = this;
        o.container && (t = u(o.container, "mousedown", t => {
            e && e(), i && i(), (s = o.hoverPoint) && s.series && s.series.hasDraggableNodes && s.series.options.draggable && (s.series.onMouseDown(s, t), e = u(o.container, "mousemove", t => s && s.series && s.series.onMouseMove(s, t)), i = u(o.container.ownerDocument, "mouseup", t => (e(), i(), s && s.series && s.series.onMouseUp(s, t))))
    ...
    function P() {
        ...
        if (this.graphLayoutsLookup && !this.pointer?.hasDragged) {
            for (y(!1, this), this.graphLayoutsLookup.forEach(t => t.start()); !t;) t = !0, this.graphLayoutsLookup.forEach(i);
    ...
    let w = {
        compose: function(t) {
            k(x, "GraphLayout") && (b(t, "afterPrint", v), b(t, "beforePrint", N), b(t, "predraw", L), b(t, "render", P))
        },
        integrations: {},
        layouts: {}
    };
    ...
    ! function(t) {
        function e() {
            return this.data = [].concat(this.points || [], this.nodes), X.destroy.apply(this, arguments)
        }

        function i() {
            this.nodes && (this.nodes.forEach(t => {
                t.destroy()
            }), this.nodes.length = 0), X.setData.apply(this, arguments)
        }
        ...
        function s(t) {
            ...
            "select" !== t && i.forEach(t => {
                t && t.series && (T.setState.apply(t, e), !t.isNode && (t.fromNode.graphic && T.setState.apply(t.fromNode, e), t.toNode && t.toNode.graphic && T.setState.apply(t.toNode, e)))
            }), T.setState.apply(this, e)
        }

        function o(t, e, i, s) {
            let o = this.series.options.nodes,
                r = this.series.options.data,
                a = r?.length || 0,
                n = r?.[this.index];
            if (T.update.call(this, t, !this.isNode && e, i, s), this.isNode) {
                let t = (o || []).reduce((t, e, i) => this.id === e.id ? i : t, -1),
                    s = F(o && o[t] || {}, r?.[this.index] || {});
                r && (n ? r[this.index] = n : r.length = a), o ? t >= 0 ? o[t] = s : o.push(s) : this.series.options.nodes = [s], C(e, !0) && this.series.chart.redraw(i)
            }
        }
        t.compose = function(t, r) {
            let a = t.prototype,
                n = r.prototype;
            return a.setNodeState = s, a.setState = s, a.update = o, n.destroy = e, n.setData = i, r
            ...
            return s.formatPrefix = "node", s.name = s.name || s.options.id || "", s.mass = C(s.options.mass, s.options.marker && s.options.marker.radius, this.options.marker && this.options.marker.radius, 4), s
        }, t.destroy = e, t.generatePoints = function() {
            let t = this.chart,
                e = {};
            X.generatePoints.call(this), this.nodes || (this.nodes = []), this.colorCounter = 0, this.nodes.forEach(t => {
                t.linksFrom.length = 0, t.linksTo.length = 0, t.level = t.options.level
            }), this.points.forEach(i => {
                Y(i.from) && (e[i.from] || (e[i.from] = this.createNode(i.from)), e[i.from].linksFrom.push(i), i.fromNode = e[i.from], t.styledMode ? i.colorIndex = C(i.options.colorIndex, e[i.from].colorIndex) : i.color = i.options.color || e[i.from].color), Y(i.to) && (e[i.to] || (e[i.to] = this.createNode(i.to)), e[i.to].linksTo.push(i), i.toNode = e[i.to]), i.name = i.name || i.id
            }, this), this.nodeLookup = e
        }, t.setNodeState = s, t.updateNode = o
    }(s || (s = {}));
    let I = s,
        {
            series: {
    ...
    class _ extends O {
        ...
        getLinkAttributes() {
            let t = this.series.options.link,
                e = this.options;
            return {
                "stroke-width": q(e.width, t.width),
                stroke: e.color || t.color,
                dashstyle: e.dashStyle || t.dashStyle,
                opacity: q(e.opacity, t.opacity, 1)
            }
        }
        getLinkPath() {
            let t = this.fromNode,
        ...
        remove(t, e) {
            ...
            if (this.isNode) {
                for (i.points = [], [].concat(this.linksFrom).concat(this.linksTo).forEach(function(t) {
                        (o = t.fromNode.linksFrom.indexOf(t)) > -1 && t.fromNode.linksFrom.splice(o, 1), (o = t.toNode.linksTo.indexOf(t)) > -1 && t.toNode.linksTo.splice(o, 1), A.removePoint.call(i, i.data.indexOf(t), !1, !1)
                    }), i.points = i.data.slice(), i.nodes.splice(i.nodes.indexOf(this), 1); r--;)
                    if (s[r].id === this.options.id) {
                        i.options.nodes.splice(r, 1);
                        break
    ...
    class U {
        ...
        insert(t, e) {
            let i;
            this.isInternal ? this.nodes[this.getBoxPosition(t)].insert(t, e - 1) : (this.isEmpty = !1, this.body ? e ? (this.isInternal = !0, this.divideBox(), !0 !== this.body && (this.nodes[this.getBoxPosition(this.body)].insert(this.body, e - 1), this.body = !0), this.nodes[this.getBoxPosition(t)].insert(t, e - 1)) : ((i = new U({
                top: t.plotX || NaN,
                left: t.plotY || NaN,
                width: .1,
                height: .1
    ...
    let j = class {
            constructor(t, e, i, s) {
                this.box = {
                    ...
                    width: i,
                    height: s
                }, this.maxDepth = 25, this.root = new U(this.box), this.root.isInternal = !0, this.root.isRoot = !0, this.root.divideBox()
            }
        ...
        z = {
            ...
            integrate: function(t, e) {
                let i = -t.options.friction,
                    ...
                    c = d * Math.min(s, Math.abs(n));
                e.prevX = e.plotX + e.dispX, e.prevY = e.plotY + e.dispY, e.plotX += p, e.plotY += c, e.temperature = t.vectorLength({
                    x: p,
                    y: c
                })
            },
    ...
    class tt {
        ...
        static compose(t) {
            w.compose(t), w.integrations.euler = K, w.integrations.verlet = z, w.layouts["reingold-fruchterman"] = tt
        }
        init(t) {
        ...
        step() {
            ...
            if (this.applyLimits(), this.temperature = this.coolDown(this.startTemperature, this.diffTemperature, this.currentStep), this.prevSystemTemperature = this.systemTemperature, this.systemTemperature = this.getSystemTemperature(), this.enableSimulation) {
                ...
                this.maxIterations-- && isFinite(this.temperature) && !this.isStable() ? (this.simulation && V.cancelAnimationFrame(this.simulation), this.simulation = V.requestAnimationFrame(() => this.step())) : (this.simulation = !1, this.series.forEach(t => {
                    J(t, "afterSimulation")
                }))
            }
        }
        stop() {
            this.simulation && V.cancelAnimationFrame(this.simulation)
        }
        setArea(t, e, i, s) {
            this.box = {
                left: t,
        ...
        setMaxIterations(t) {
            this.maxIterations = Z(t, this.options.maxIterations)
        }
        setTemperature() {
        ...
        createQuadTree() {
            this.quadTree = new j(this.box.left, this.box.top, this.box.width, this.box.height), this.quadTree.insertNodes(this.nodes)
        }
        initPositions() {
            let t = this.options.initialPositions;
            if (W(t))
                for (let e of (t.call(this), this.nodes)) Q(e.prevX) || (e.prevX = e.plotX), Q(e.prevY) || (e.prevY = e.plotY), e.dispX = 0, e.dispY = 0;
        ...
        setCircularPositions() {
            ...
            for (let i = 0, o = h.length; i < o; ++i)(t = h[i]).plotX = t.prevX = Z(t.plotX, e.width / 2 + a * Math.cos(i * s)), t.plotY = t.prevY = Z(t.plotY, e.height / 2 + a * Math.sin(i * s)), t.dispX = 0, t.dispY = 0
        }
        setRandomPositions() {
            let t, e = this.box,
                i = this.nodes,
            ...
            for (let r = 0, a = i.length; r < a; ++r)(t = i[r]).plotX = t.prevX = Z(t.plotX, e.width * o(r)), t.plotY = t.prevY = Z(t.plotY, e.height * o(s + r)), t.dispX = 0, t.dispY = 0
        }
        force(t, ...e) {
        ...
        applyLimitBox(t, e) {
            let i = t.radius;
            t.plotX = $(t.plotX, e.left + i, e.width - i), t.plotY = $(t.plotY, e.top + i, e.height - i)
        }
        coolDown(t, e, i) {
            return t - e * i
        }
        ...
        if (t = t || o && o.path, o && o.undo(), t && a) {
            let e = tr(s, "afterModifyTree", e => {
                if (t && a) {
                    ...
                    th(r.dx) && (a.dx = r.dx, delete r.dx), th(r.dy) && (a.dy = r.dy, delete r.dy), s.attr(a), this.attr({
                        transform: ""
    ...
    function tp(t) {
        ...
        if (i) {
            let t = [],
                ...
                n = i.innerHTML.replace(a, "").split(/<tspan class="highcharts-br"[^>]*>/),
                h = n.length,
                l = (t, e) => {
                    let {
                        x: o,
                        y: a
                    } = e, n = (i.getRotationOfChar(t) - 90) * to, h = Math.cos(n), l = Math.sin(n);
                    return [
                        [o - r * h, a - r * l],
                        [o + s * h, a + s * l]
                    ]
                };
            for (let e = 0, s = 0; s < h; s++) {
                let o = n[s].length;
                for (let r = 0; r < o; r += 5) try {
                    let o = e + r + s,
                        [a, n] = l(o, i.getStartPositionOfChar(o));
                    0 === r ? (t.push(n), t.push(a)) : (0 === s && t.unshift(n), s === h - 1 && t.push(a))
                } catch (t) {
                    break
                }
                e += o - 1;
    ...
    let {
        ...
        initDataLabels: function() {
            ...
            return this.dataLabelsGroup.attr(te({
                opacity: 1
            }, this.getPlotBox("data-labels"))), this.dataLabelsGroup
        },
        initDataLabelsDefer: function() {
            let t = this.options.dataLabels;
            t?.defer && this.options.layoutAlgorithm?.enableSimulation ? ti(() => {
                this.deferDataLabels = !1
            }, t ? ts(t.animation).defer : 0) : this.deferDataLabels = !1
        }
    }, {
        addEvent: tb,
        defined: tk,
    ...
    ({
        compose: function(t) {
            tr(t, "afterGetBBox", tp), tr(t, "beforeAddingDataLabel", tc);
            let e = t.prototype;
            e.setTextPath || (e.setTextPath = td)
        }
    }).compose(p());
    class tP extends tf {
        constructor() {
        ...
        static compose(t) {
            g.compose(t), tt.compose(t)
        }
        deferLayout() {
            let t = this.options.layoutAlgorithm,
                e = this.chart.options.chart,
                i, s = this.chart.graphLayoutsStorage,
                o = this.chart.graphLayoutsLookup;
            this.visible && (s || (this.chart.graphLayoutsStorage = s = {}, this.chart.graphLayoutsLookup = o = []), (i = s[t.type]) || (t.enableSimulation = tk(e.forExport) ? !e.forExport : t.enableSimulation, s[t.type] = i = new w.layouts[t.type], i.init(t), o.splice(i.index, 0, i)), this.layout = i, i.setArea(0, 0, this.chart.plotWidth, this.chart.plotHeight), i.addElementsToCollection([this], i.series), i.addElementsToCollection(this.nodes, i.nodes), i.addElementsToCollection(this.points, i.links))
        }
        destroy() {
            this.layout && this.layout.removeElementFromCollection(this, this.layout.series), I.destroy.call(this)
        }
        drawDataLabels() {
            let t;
            if (this.deferDataLabels) return;
            let e = this.options.dataLabels;
            e?.textPath && (t = e.textPath), tf.prototype.drawDataLabels.call(this, this.nodes), e?.linkTextPath && (e.textPath = e.linkTextPath), tf.prototype.drawDataLabels.call(this, this.data), e?.textPath && (e.textPath = t)
        }
        generatePoints() {
            let t, e;
            for (I.generatePoints.apply(this, arguments), this.options.nodes && this.options.nodes.forEach(function(t) {
                    this.nodeLookup[t.id] || (this.nodeLookup[t.id] = this.createNode(t.id))
                }, this), e = this.nodes.length - 1; e >= 0; e--)(t = this.nodes[e]).degree = t.getDegree(), t.radius = tL(t.marker && t.marker.radius, this.options.marker && this.options.marker.radius, 0), t.key = t.name, this.nodeLookup[t.id] || t.remove();
        ...
        init(t, e) {
            return super.init(t, e), tx.call(this), tb(this, "updatedData", () => {
                this.layout && this.layout.stop()
            }), tb(this, "afterUpdate", () => {
                this.nodes.forEach(t => {
                    t && t.series && t.resolveColor()
                })
            }), tb(this, "afterSimulation", function() {
                this.deferDataLabels = !1, this.drawDataLabels()
            }), this
        }
        markerAttribs(t, e) {
            let i = tf.prototype.markerAttribs.call(this, t, e);
            return tk(t.plotY) || (i.y = 0), i.x = (t.plotX || 0) - (i.width || 0) / 2, i
        }
        pointAttribs(t, e) {
            let i = e || t && t.state || "normal",
                s = this.options.states[i],
                o = tf.prototype.pointAttribs.call(this, t, i);
            return t && !t.isNode && (o = t.getLinkAttributes(), s && (o = {
                stroke: s.linkColor || o.stroke,
                dashstyle: s.linkDashStyle || o.dashstyle,
                opacity: tL(s.linkOpacity, o.opacity),
        ...
        render() {
            let t = this.points,
                ...
                i = [];
            this.points = this.nodes, tg.render.call(this), this.points = t, t.forEach(function(t) {
        ...
        setState(t, e) {
            e ? (this.points = this.nodes.concat(this.data), tf.prototype.setState.apply(this, arguments), this.points = this.data) : tf.prototype.setState.apply(this, arguments), this.layout.simulation || t || this.render()
        }
        translate() {
            this.generatePoints(), this.deferLayout(), this.nodes.forEach(function(t) {
    ...
    tP.defaultOptions = tN(tf.defaultOptions, {
        stickyTracking: !1,
        ...
        initDataLabels: ty,
        buildKDTree: tu,
        createNode: I.createNode,
        drawTracker: tm.drawTracker,
        onMouseDown: g.onMouseDown,
        onMouseMove: g.onMouseMove,
        onMouseUp: g.onMouseUp,
        redrawHalo: g.redrawHalo
    }), M().registerSeriesType("networkgraph", tP);
    let tw = l();
    tP.compose(tw.Chart);
    let tS = l();
    return n.default
