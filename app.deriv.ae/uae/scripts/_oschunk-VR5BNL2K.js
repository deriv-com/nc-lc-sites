...
Ae = F([S.WidgetSpec], Ae);
var ot, Te = (ot = class extends S.Widget {
    handleClick() {
    ...
    render() {
        let t = this.getId() + "-input",
            ...
            i = {
                ...
                value: nt.JSConversions.convertTo(this.props.value, O.DataTypes.Text),
...
Te = F([S.WidgetSpec], Te);
var Gt, at, Pe = Gt = (at = class extends S.Widget {
...
Pe = Gt = F([S.WidgetSpec], Pe);
var E, lt, I = E = (lt = class extends S.InputWithVariableWidget {
    constructor(t, e) {
        ...
        if (this.isEmptyValueDefined()) {
            let i = this.isValueInList(this.variable.value),
                ...
                s = {
                    ...
                    onClick: a(o => {
                        let h = nt.JSConversions.convertTo(null, this.variable.type);
...
}, a(lt, "DropdownCustom"), lt);
I.SmartphonePortraitWidth = 420;
I.PopupBoxMargin = 10;
I.DropdownList = "dropdown-list";
I.DropdownContainer = "dropdown-container";
I.DropdownDisplay = "dropdown-display";
I.DropdownDisplayContent = "dropdown-display-content";
I.DropdownDisabled = "dropdown-disabled";
I.DropdownPopUpRow = "dropdown-popup-row";
I.DropdownPopUpRowSelected = "dropdown-popup-row-selected";
I.DropdownEmptyValueRow = "drowpdown-empty-value-row";
I.DropdownBackgroundWindow = "dropdown-background-window";
I.ScrollableList = "scrollable-list";
I.ScrollableListWithScroll = "scrollable-list-with-scroll";
I.DropdownExpanded = "dropdown-expanded";
I.DropdownExpandedUp = "dropdown-expanded-up";
I.DropdownExpandedDown = "dropdown-expanded-down";
I = E = F([S.WidgetSpec], I);
var Q, ct, et = Q = (ct = class extends S.InputWithVariableWidget {
    constructor(t, e) {
    ...
    getSelectedValueAndOptions() {
        ...
        if (this.isEmptyValueDefined() && (i = Q.EmptyValue, r.push(v.jsx("option", {
            ...
            for (let s = 0; s < this.props.list.length; s++) {
                ...
                let h = nt.JSConversions.convertTo((e = (t = this.props).labels) === null || e === void 0 ? void 0 : e.call(t, o), O.DataTypes.Text);
                r.push(v.jsx("option", {
                    value: s,
                    children: h
                }, s))
    ...
    handleChange(t) {
        let e = parseInt(t.target.value, 10),
            i = e >= 0 ? this.props.values(this.props.list.getItem(e)) : nt.JSConversions.convertTo(null, this.variable.type);
...
}, a(ct, "DropdownNative"), ct);
et.DropdownContainer = "dropdown-container";
et.DropdownDisplay = "dropdown-display";
et.DropdownDisabled = "dropdown-disabled";
et.EmptyValue = -1;
et = Q = F([S.WidgetSpec], et);
var Xi = a(n => n.dropdownMode === 1 ? v.jsx(I, Object.assign({}, n)) : v.jsx(et, Object.assign({}, n)), "Dropdown"),
    vi = (0, L.forwardRef)((n, t) => {
        let {
            value: e,
            style: i
        } = n, r = {
...
var Rt = $e.exports,
    ...
    dt, xt = tt = (dt = class extends S.Widget {
        constructor(t, e) {
        ...
        function u(f, g) {
            var w = a(function(x) {
                    x && "touches" in x && x.touches.length > 1 || f(function(R, A) {
                        ...
                        var k = "touches" in x ? x.touches[0] : x,
                            $ = k.clientX,
                            K = k.clientY,
                ...
                Z = a(function(x) {
                    f(function(R, A) {
                        ...
                        if (R.swiping && R.eventData) {
                            k = o({}, R.eventData, {
                                event: x
                            }), A.onSwiped && A.onSwiped(k);
                            var $ = A["onSwiped" + k.dir];
                            $ && $(k)
                ...
                Qe = a(function(x) {
                    x !== null && f(function(R, A) {
                        if (R.el === x) return R;
                        var k = {};
                        return R.el && R.el !== x && R.cleanUpTouch && (R.cleanUpTouch(), k.cleanUpTouch = void 0), A.trackTouch && x && (k.cleanUpTouch = Dt(x, !A.preventDefaultTouchmoveEvent)), o({}, R, {
                            el: x
                        }, k)
                    })
                }, "onRef"),
...
N.Button = "button";
N.Container = "list-item-container";
N.LeftActions = "list-item-left-actions";
N.RightActions = "list-item-right-actions";
N.FloatRight = "list-item-float-right";
N.FloatLeft = "list-item-float-left";
N.FullSwipe = "list-item-full-swipe";
N.Animating = "list-item-animating";
N.ShowRightButtons = "list-item-show-right-buttons";
N.ShowLeftButtons = "list-item-show-left-buttons";
N.SwipeStartThreshold = 15;
N.SwipeLeftEdgeThresholdExtended = "list-item-swipe-left-edge-threshold";
N.SwipeRightEdgeThresholdExtended = "list-item-swipe-right-edge-threshold";
N.SwipeLeftEdgeDefaultThreshold = 15;
N.SwipeRightEdgeDefaultThreshold = 15;
var ht, De = (ht = class extends S.Widget {
    constructor() {
    ...
    render() {
        ...
        if (i && r) return v.jsx(Jt, {
            ...
            return v.jsx(N, Object.assign({}, s))
        }
    }
}, a(ht, "ListItem"), ht);
De = F([S.WidgetSpec], De);
var Ei = a(n => {
        var t, e;
    ...
    Ki = U(Ai),
    ut, Qt = (ut = class extends S.Widget {
        constructor() {
...
Zt = F([S.WidgetSpec], Zt);
var ft, Oe = (ft = class extends S.Widget {
    render() {
        let t = {
            className: this.props.style
        };
...
Oe = F([S.WidgetSpec], Oe);
var gt, We = (gt = class extends S.ValidationWidget {
...
var M, mt, Et = M = (mt = class extends S.InputWithVariableWidget {
    constructor(t, e) {
    ...
    UNSAFE_componentWillReceiveProps(t) {
        let e = this.getHTMLNode(),
            ...
            s = nt.JSConversions.convertTo(e.value, this.variable.type).valueOf().toString() === i,
...
var ie, vt, ne = ie = (vt = class extends S.Widget {
    constructor() {
...
ne = ie = F([S.WidgetSpec], ne);
var It, Fe = "reactContainer",
    bt, re = It = (bt = class extends S.Widget {
        constructor(t, e) {
...
re = It = F([S.WidgetSpec], re);
var se, wt, ke = se = (wt = class extends S.Widget {
    static toHtmlAlign(t) {
        switch (t) {
            case 2:
                return "center";
...
ke = se = F([S.WidgetSpec], ke);
var yt, Me = (yt = class extends S.Widget {
    constructor(t, e) {
...
var Mi = (0, L.forwardRef)((n, t) => {
    ...
    en = U(Bi),
    St, Be = (St = class extends S.InputWithVariableWidget {
        constructor(t, e) {
...
Be = F([S.WidgetSpec], Be);
var Ft;
(function(n) {
    n.ENTER_KEY = "Enter", n.SPACE_KEY = " "
})(Ft || (Ft = {}));
var oe, Ct, ae = oe = (Ct = class extends S.InputWithVariableWidget {
    constructor(t, e) {
...
ae.Capture = "capture";
ae = oe = F([S.WidgetSpec], ae);
var Hi = "6.13.1";
pe.registerPackage("client-runtime-widgets", Hi);
export {
    qi as a, $i as b, Yi as c, Ae as d, Te as e, Pe as f, Xi as g, Gi as h, xt as i, De as j, Ki as k, We as l, Ji as m, Qi as n, Et as o, Zi as p, ne as q, re as r, ke as s, Me as t, en as u
};
/*
object-assign
(c) Sindre Sorhus
