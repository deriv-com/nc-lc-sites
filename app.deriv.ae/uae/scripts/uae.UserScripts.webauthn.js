...
(() => {
    var e = Object.defineProperty,
        t = (e, t, n) => new Promise(((r, i) => {
            var a = e => {
                ...
                c = e => e.done ? r(e.value) : Promise.resolve(e.value).then(a, o);
    ...
    function c(e, t, n) {
        ...
        if (t instanceof Object) {
            ...
            for (const [i, a] of Object.entries(t)) {
                ...
                if (i in n) null != n[i] ? r[i] = c(e, a.schema, n[i]) : r[i] = null;
    ...
    var d = {
        ...
        g = {
            ...
            clientExtensionResults: s(f, (e => e.getClientExtensionResults()))
        },
        y = {
            mediation: u(a),
            publicKey: l({
        ...
        m = {
            credentialCreationOptions: h,
            publicKeyCredentialWithAttestation: g,
            credentialRequestOptions: y,
            publicKeyCredentialWithAssertion: v
        };

    function b(e) {
        return t(this, null, (function*() {
            const t = yield navigator.credentials.create(function(e) {
                return c(r, h, e)
            }(e));
            return function(e) {
                return c(i, g, e)
    ...
    function w(e) {
        return t(this, null, (function*() {
            const t = yield navigator.credentials.get(function(e) {
                return c(r, y, e)
            }(e));
            return function(e) {
                return c(i, v, e)
