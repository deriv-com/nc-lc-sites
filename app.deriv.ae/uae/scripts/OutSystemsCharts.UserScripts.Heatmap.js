...
function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(t._Highcharts, t._Highcharts.Axis, t._Highcharts.Color, t._Highcharts.LegendSymbol, t._Highcharts.SeriesRegistry, t._Highcharts.SVGElement, t._Highcharts.SVGRenderer) : "function" == typeof define && define.amd ? define("highcharts/modules/heatmap", ["highcharts/highcharts"], function(t) {
        return e(t, t.Axis, t.Color, t.LegendSymbol, t.SeriesRegistry, t.SVGElement, t.SVGRenderer)
...
}("undefined" == typeof window ? this : window, (t, e, s, i, o, r, l) => (() => {
    "use strict";
    var a, n, h, d = {
            28: t => {
                t.exports = r
        ...
        t.compose = function(t, c, u, g, m) {
            ...
            f.collectionsWithUpdate.includes("colorAxis") || (e = t, f.collectionsWithUpdate.push("colorAxis"), f.collectionsWithInit.colorAxis = [f.addColorAxis], C(c, "afterCreateAxes", s), function(t) {
                ...
                t.prototype.createAxis = function(t, i) {
                    ...
                    }), w(i.redraw, !0) && this.redraw(i.animation), o
                }
    ...
    ! function(t) {
        t.initDataClasses = function(t) {
            let e = this.chart,
                ...
                i = this.options,
                o = t.dataClasses || [],
                r, l, a = e.options.chart.colorCount,
                n = 0,
                h;
            ...
            let s, i, o, r, l, a, n = this.dataClasses,
                h = this.stops;
            if (n) {
                for (a = n.length; a--;)
    ...
    class j extends x() {
        ...
        init(t, e) {
            ...
            this.side = e.side || i ? 2 : 1, this.reversed = e.reversed || !i, this.opposite = !i, super.init(t, e, "colorAxis"), this.userOptions = e, _(t.userOptions.colorAxis) && (t.userOptions.colorAxis[this.index] = e), e.dataClasses && this.initDataClasses(e), this.initStops(), this.horiz = i, this.zoomEnabled = !1
        }
        hasData() {
        ...
        getSeriesExtremes() {
            ...
            for (this.dataMin = 1 / 0, this.dataMax = -1 / 0; r--;) {
                for (let l of (s = (o = t[r]).colorKey = K(o.options.colorKey, o.colorKey, o.pointValKey, o.zoneAxis, "y"), i = o[s + "Min"] && o[s + "Max"], [s, "value", "y"]))
                    if ((e = o.getColumn(l)).length) break;
                if (i) o.minColorValue = o[s + "Min"], o.maxColorValue = o[s + "Max"];
                else {
        ...
        update(t, e) {
            ...
            this.series.forEach(t => {
                t.isDirtyData = !0
            }), (t.dataClasses && s.allItems || this.dataClasses) && this.destroyItems(), super.update(t, e), this.legendItem?.label && (this.setLegendColor(), s.colorizeItem(this, !0))
        }
        destroyItems() {
            let t = this.chart,
                e = this.legendItem || {};
    ...
    class ti extends J {
        ...
        getCellAttributes() {
            let t = this.series,
                ...
                h = {
                    x1: Q(Math.round(o.len - o.translate(this.x - s, !1, !0, !1, !0, -a)), -o.len, 2 * o.len),
                    x2: Q(Math.round(o.len - o.translate(this.x + s, !1, !0, !1, !0, -a)), -o.len, 2 * o.len),
                    y1: Q(Math.round(r.translate(this.y - i, !1, !0, !1, !0)), -r.len, 2 * r.len),
                    y2: Q(Math.round(r.translate(this.y + i, !1, !0, !1, !0)), -r.len, 2 * r.len)
                };
            for (let t of [
                    ["width", "x"],
                    ["height", "y"]
    ...
    class tA extends tc {
                ...
                if (!e || t.isDirtyData || t.isDirtyCanvas) {
                    ...
                    if (n && l && g) {
                        let {
                            ...
                            min: f,
                            max: x
                        } = o.getExtremes(), y = m - g, b = x - f, v = Math.round(y / d / 8 * 8), C = Math.round(b / p / 8 * 8), [A, M] = [
                            [v, v / y, r, "ceil"],
                            [C, C / b, !a, "floor"]
                        ].map(([t, e, s, i]) => s ? s => Math[i](t - e * s) : t => Math[i](e * t)), w = n.width = v + 1, L = w * (n.height = C + 1), k = (u - 1) / L, I = new Uint8ClampedArray(4 * L), S = (t, e) => 4 * Math.ceil(w * M(e - f) + A(t - g));
                        t.buildKDTree();
                        for (let t = 0; t < L; t++) {
        ...
        getValidPoints(t, e) {
            return td.prototype.getValidPoints.call(this, t, e, !0)
        }
        hasData() {
        ...
        translate() {
            let {
                borderRadius: t,
                marker: e
            } = this.options, s = e?.symbol || "rect", i = tu[s] ? s : "rect", o = -1 !== ["circle", "square"].indexOf(i);
            for (let e of (this.generatePoints(), this.points)) {
                ...
                e.hasImage && (e.marker = {
                    width: n,
                    height: h
                }), e.plotX = e.clientX = (r.x1 + r.x2) / 2, e.plotY = (r.y1 + r.y2) / 2, e.shapeType = "path", e.shapeArgs = ty(!0, {
                    x: l,
                    y: a,
                    width: n,
                    height: h
