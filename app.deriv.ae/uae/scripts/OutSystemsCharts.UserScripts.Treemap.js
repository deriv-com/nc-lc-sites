        ...
        $ = {
            draw: function(t, e) {
                ...
                if (e.attribs = {
                    ...
                    }, t.shouldDraw()) a || (t.graphic = a = "text" === e.shapeType ? r.text() : "image" === e.shapeType ? r.image(e.imageUrl || "").attr(e.shapeArgs || {}) : r[e.shapeType](e.shapeArgs || {}), a.add(e.group)), o && a.css(o), a.attr(e.attribs).animate(i, !e.isNew && l, s);
                else if (a) {
                    let e = () => {
    ...
    let te = a,
        ...
        } = G().seriesTypes,
        {
            ...
            getLevelOptions: function(t) {
                let e, i, s, o, r, l, a = {};
                if (tr(t))
                    for (o = to(t.from) ? t.from : 1, l = t.levels, i = {}, e = tr(t.defaults) ? t.defaults : {}, ts(l) && (i = l.reduce((t, i) => {
                            let s, r, l;
        ...
        drawPoints(t = this.points) {
            ...
            for (let e of t) {
                let t = e.node.levelDynamic,
                    ...
                    g = a && c,
                    v = e.shapeArgs;
                e.shouldDraw() && (e.isInside = !0, l && (d.r = l), tN(!0, g ? h : d, c ? v : {}, s ? {} : this.pointAttribs(e, e.selected ? "select" : void 0)), this.colorAttribs && s && tB(p, this.colorAttribs(e)), this[u] || (this[u] = i.g(u).attr({
                    zIndex: 1e3 - (t || 0)
            ...
            for (let t of e) {
                ...
                if (e && o) {
                    let {
                        ...
                        x: a,
                        y: n
                    } = e, h = r(t), d = i.toPixels(a, !0), p = i.toPixels(a + l, !0), u = s.toPixels(n, !0), c = s.toPixels(n + o, !0), g = 0 === d ? h / 2 : tw(i.toPixels(a, !0), h, !0), v = p === i.len ? i.len - h / 2 : tw(i.toPixels(a + l, !0), h, !0), m = u === s.len ? s.len - h / 2 : tw(s.toPixels(n, !0), h, !0), b = 0 === c ? h / 2 : tw(s.toPixels(n + o, !0), h, !0), f = {
                        x: Math.min(g, v),
                        y: Math.min(m, b),
                        width: Math.abs(v - g),
                        height: Math.abs(b - m)
