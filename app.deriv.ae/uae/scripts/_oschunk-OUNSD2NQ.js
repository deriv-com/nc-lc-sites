...
var s = S; {
    let f = class f extends s.Controller.BaseViewController {
        ...
        get _onReady$Action() {
            return this.hasOwnProperty("__onReady$Action") || (this.__onReady$Action = function(e) {
                ...
                return s.Logger.startActiveSpan("OnReady", function(i) {
                    i && (i.setAttribute("code.function", "OnReady"), i.setAttribute("outsystems.function.key", "3f00b243-253b-4340-bae7-f1404edb376b"), i.setAttribute("outsystems.function.owner.name", "uae"), i.setAttribute("outsystems.function.owner.key", "20b302d1-c31f-4d5e-b3c5-77cbc01783f7"), i.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION"));
                    try {
        ...
        get _stopOnboardingOnContinue$Action() {
            return this.hasOwnProperty("__stopOnboardingOnContinue$Action") || (this.__stopOnboardingOnContinue$Action = function(e) {
                ...
                return s.Logger.startActiveSpan("StopOnboardingOnContinue", function(i) {
                    i && (i.setAttribute("code.function", "StopOnboardingOnContinue"), i.setAttribute("outsystems.function.key", "721c2029-3f5d-46e4-aa92-853250958369"), i.setAttribute("outsystems.function.owner.name", "uae"), i.setAttribute("outsystems.function.owner.key", "20b302d1-c31f-4d5e-b3c5-77cbc01783f7"), i.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION"));
                    try {
        ...
        get _onSelectTradingFrequency$Action() {
            return this.hasOwnProperty("__onSelectTradingFrequency$Action") || (this.__onSelectTradingFrequency$Action = function(e, t) {
                ...
                return s.Logger.startActiveSpan("OnSelectTradingFrequency", function(u) {
                    u && (u.setAttribute("code.function", "OnSelectTradingFrequency"), u.setAttribute("outsystems.function.key", "9baaf369-c2a3-46fb-bbe1-9fe4055bfc86"), u.setAttribute("outsystems.function.owner.name", "uae"), u.setAttribute("outsystems.function.owner.key", "20b302d1-c31f-4d5e-b3c5-77cbc01783f7"), u.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION"));
                    try {
                        r.ensureControllerAlive("OnSelectTradingFrequency"), t = r.callContext(t);
                        var C = new s.DataTypes.VariableHolder(new(r.constructor.getVariableGroupType("uae.OnboardingFlow.TradingFrequency.OnSelectTradingFrequency$vars")));
                        return C.value.selected_trading_frequencyInLocal = e, _.settrading_experience(C.value.selected_trading_frequencyInLocal), s.Navigation.navigateTo(s.Navigation.generateScreenURL("uae", "cfd-trading-experience", {}), s.Transitions.createTransition(s.Transitions.TransitionAnimation.None), t, !0)
                    } finally {
                        u && u.end()
                    }
                }, 1)
        ...
        onReady$Action(e) {
            ...
            return s.Logger.startActiveSpan("OnReady__proxy", function(n) {
                n && (n.setAttribute("code.function", "OnReady"), n.setAttribute("outsystems.function.key", "3f00b243-253b-4340-bae7-f1404edb376b"), n.setAttribute("outsystems.function.owner.name", "uae"), n.setAttribute("outsystems.function.owner.key", "20b302d1-c31f-4d5e-b3c5-77cbc01783f7"), n.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION"));
                try {
        ...
        stopOnboardingOnContinue$Action(e) {
            ...
            return s.Logger.startActiveSpan("StopOnboardingOnContinue__proxy", function(n) {
                n && (n.setAttribute("code.function", "StopOnboardingOnContinue"), n.setAttribute("outsystems.function.key", "721c2029-3f5d-46e4-aa92-853250958369"), n.setAttribute("outsystems.function.owner.name", "uae"), n.setAttribute("outsystems.function.owner.key", "20b302d1-c31f-4d5e-b3c5-77cbc01783f7"), n.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION"));
                try {
        ...
        onSelectTradingFrequency$Action(e, t) {
            ...
            return s.Logger.startActiveSpan("OnSelectTradingFrequency__proxy", function(r) {
                r && (r.setAttribute("code.function", "OnSelectTradingFrequency"), r.setAttribute("outsystems.function.key", "9baaf369-c2a3-46fb-bbe1-9fe4055bfc86"), r.setAttribute("outsystems.function.owner.name", "uae"), r.setAttribute("outsystems.function.owner.key", "20b302d1-c31f-4d5e-b3c5-77cbc01783f7"), r.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION"));
                try {
    ...
    o(f, "ControllerInner");
    let v = f;
    H = v, H.registerVariableGroupType("uae.OnboardingFlow.TradingFrequency.OnSelectTradingFrequency$vars", [{
...
var H, V = new s.Controller.ControllerFactory(H, D);
var a = Y(j());
var g = S,
...
var b = A.PlaceholderContent,
    ...
    ee = o(function() {
        var v = N(function(f) {
                ...
                placeholders: {
                    content: new b(function() {
                        return [a.createElement(y, {
                            ...
                            style: "mb-12 heading2 font-extra-bold",
                            ...
                            _widgetRecordProvider: c
                        }, J(l.variables.trading_frequencyVar.length < 1, !1, this, function() {
                            return [a.createElement(y, {
                                align: 0,
                                animate: !1,
                                extendedProperties: {
                            ...
                            return [a.createElement(z, {
                                ...
                                _widgetRecordProvider: c,
                                placeholders: {
                                    content: new Z(function(d, m) {
                                        return [a.createElement(G, {
                                            extendedProperties: {
                                                style: "border: 1px solid rgba(0, 0, 0, 0.04);"
                                            },
                                            onClick: o(function() {
                                                var X = typeof m != "undefined" && m !== null ? m.clone() : e.callContext().clone();
                                                e.onSelectTradingFrequency$Action(l.variables.trading_frequencyVar.getCurrent(m.iterationContext), e.callContext(X))
                                            }, "onClick"),
                                            style: l.getCachedValue(d.getId("ListItem1.Style"), function() {
            ...
            getAttributes: o(function() {
                return {
                    codeFunction: "TradingFrequency",
                    functionKey: "fd950156-1066-455d-96f9-c3c5f0910aaf",
                    functionOwnerName: "uae",
                    functionOwnerKey: "20b302d1-c31f-4d5e-b3c5-77cbc01783f7",
                    screen: ""
                }
            }, "getAttributes"),
            displayName: "OnboardingFlow.TradingFrequency",
            modelFactory: I,
            controllerFactory: V,
            getTitle: o(function() {
                return P("VgGV_WYQXUWW+cPF8JEKrw#Title", "TradingFrequency")
            }, "getTitle")
        });
        return v.getCssDependencies = function() {
            return ["css/OutSystemsUI.OutSystemsUI.css", "css/uae.ChampionApp.css", "css/uae.OnboardingFlow.TradingFrequency.css", "css/uae.ChampionApp.extra.css", "css/OutSystemsReactWidgets.css"]
    ...
    te = ee();
export {
    V as controllerModule, I as modelModule, te as viewModule, F as webFlowControllerModule
};