 ...
 */
function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(t._Highcharts, t._Highcharts.Templating) : "function" == typeof define && define.amd ? define("highcharts/modules/drilldown", ["highcharts/highcharts"], function(t) {
        return e(t, t.Templating)
    }) : "object" == typeof exports ? exports["highcharts/modules/drilldown"] = e(t._Highcharts, t._Highcharts.Templating) : t.Highcharts = e(t.Highcharts, t.Highcharts.Templating)
    ...
    class A {
        static compose(t, e) {
            x(u, "Breadcrumbs") && (c(t, "destroy", S), c(t, "afterShowResetZoom", D), c(t, "getMargins", B), c(t, "redraw", L), c(t, "selection", O), w(e.lang, d.lang))
        }
        constructor(t, e) {
            this.elementList = {}, this.isDirty = !0, this.level = 0, this.list = [];
            let i = b(t.options.drilldown && t.options.drilldown.drillUpButton, A.defaultOptions, t.options.navigation && t.options.navigation.breadcrumbs, e);
        ...
        getButtonText(t) {
            let e = this.chart,
                i = this.options,
                o = e.options.lang,
                l = y(i.format, i.showFullPath ? "{level.name}" : "← {level.name}"),
                r = o && y(o.drillUpText, o.mainBreadcrumb),
                s = i.formatter && i.formatter(t) || h(l, {
                    level: t.levelOptions
                }, e) || "";
            return (f(s) && !s.length || "← " === s) && m(r) && (s = i.showFullPath ? r : "← " + r), s
        }
        redraw() {
        ...
        alignBreadcrumbsGroup(t) {
            if (this.group) {
                let e = this.options,
                    ...
                    s = 2 * (i.padding || 0) + e.buttonSpacing;
                o.width = r.width + s, o.height = r.height + s;
                let n = b(o);
                t && (n.x += t), this.options.rtl && (n.x += o.width), n.y = y(n.y, this.yOffset, 0), this.group.align(n, !0, l)
            }
        }
        renderButton(t, e, i) {
            let o = this,
                ...
                n = l.renderer.button(o.getButtonText(t), e, i, function(e) {
                    let i, l = r.events && r.events.click;
                    l && (i = l.call(o, e, t)), !1 !== i && (r.showFullPath ? e.newLevel = t.level : e.newLevel = o.level - 1, g(o, "up", e))
        ...
        update(t) {
            b(!0, this.options, t), this.destroy(), this.isDirty = !0
        }
        updateSingleButton() {
            let t = this.chart,
    ...
    function _(t) {
        let e = this,
            i = e.chart,
            o = i.drilldownLevels,
            l = E((i.options.drilldown || {}).animation),
            r = this.xAxis,
            s = i.styledMode;
        if (!t) {
            let t;
            ...
            }), t.x += V(r.oldPos, r.pos) - r.pos, e.points.forEach(i => {
                let o = i.shapeArgs;
                s || (o.fill = i.color), i.graphic && i.graphic.attr(t).animate(C(i.shapeArgs, {
    ...
    function G(t) {
        let e = this,
            i = E((e.chart.options.drilldown || {}).animation);
        (e.trackerGroups || []).forEach(t => {
            e[t] && e[t].on("mouseover")
        });
        let o = e.group,
            l = o !== e.chart.columnGroup;
        l && delete e.group, (this.points || this.data).forEach(r => {
            let s = r.graphic,
                n = t.shapeArgs;
            if (s && n) {
                let a = () => {
                ...
                delete r.graphic, e.chart.styledMode || (n.fill = t.color), i.duration ? s.animate(n, I(i, {
                    complete: a
                })) : (s.attr(n), a())
            }
        })
    ...
    function U(t) {
        ...
        i && o && e.options && i.options.drilldown && i.options.drilldown.animation && (t && i.mapView ? (o.attr({
            ...
            e.options && (e.options.inactiveOtherPoints = !1, e.options.enableMouseTracking = V(e.userOptions && e.userOptions.enableMouseTracking, !0))
    ...
    function H() {
        return this.drilldown && !this.unbindDrilldownClick && (this.unbindDrilldownClick = P(this, "click", R)), this
    }

    function z() {
        let t = this.series,
            e = t.chart.styledMode;
        this.drilldown && t.halo && "hover" === this.state ? Z(t.halo, "pointer", !0, e) : t.halo && Z(t.halo, "auto", !1, e)
    }
    ...
    function W(t) {
        let e = t.options || {};
        e.drilldown && !this.unbindDrilldownClick ? this.unbindDrilldownClick = P(this, "click", R) : !e.drilldown && void 0 !== e.drilldown && this.unbindDrilldownClick && (this.unbindDrilldownClick = this.unbindDrilldownClick())
    }
    ...
    function J() {
        ...
        for (let e of this.points) e.drilldown && e.graphic && Z(e.graphic, "pointer", !0, t)
    }
    ...
    function K(t) {
        ...
        if (this.is("item") && (l.duration = 0), this.center) {
            let r = o.shapeArgs,
                s = r.start,
                n = (r.end - s) / this.points.length,
                a = e.styledMode;
            if (!t) {
                let t, d;
                for (let e = 0, p = i.length; e < p; ++e) t = (d = i[e]).shapeArgs, a || (r.fill = o.color, t.fill = d.color), d.graphic && d.graphic.attr(I(r, {
                    start: s + e * n,
                    end: s + (e + 1) * n
                }))[l ? "animate" : "attr"](t, l);
    ...
    let Y = {
            compose: function(t, e) {
                ...
                if (!o.doDrilldown) {
                    ...
                    if (P(i, "afterInit", H), P(i, "afterSetState", z), P(i, "update", W), o.doDrilldown = Q, o.runDrilldown = X, P(t, "afterDrawDataLabels", q), P(t, "afterDrawTracker", J), l) {
                        let t = l.prototype;
                        t.animateDrilldown = _, t.animateDrillupFrom = G, t.animateDrillupTo = N
                    }
                    if (r) {
                        let t = r.prototype;
                    ...
                    if (s) {
                        let t = s.prototype;
                        t.animateDrilldown = K, t.animateDrillupFrom = G, t.animateDrillupTo = N
                    }
                }
            }
        },
    ...
    class tw {
        ...
        addSeriesAsDrilldown(t, e) {
            ...
            if (tr(this, "addSeriesAsDrilldown", {
                    seriesOptions: e
                }), i.mapView)
                if (t.series.isDrilling = !0, i.series.forEach(t => {
                    ...
                    }), i.options.drilldown && !i.mapView.projection.hasGeoProjection && T && (ti(to(i.options.drilldown, T).mapZooming) || (i.options.drilldown.mapZooming = !1)), i.options.drilldown && i.options.drilldown.animation && i.options.drilldown.mapZooming) {
                    i.mapView.allowTransformAnimation = !0;
                    let o = $(i.options.drilldown.animation);
                    if ("boolean" != typeof o) {
                        let l = o.complete,
                            r = function(o) {
        ...
        addSingleSeriesAsDrilldown(t, e) {
            let i = this.chart || this,
                ...
                r = o.yAxis,
                s = i.styledMode ? {
                    colorIndex: ta(t.colorIndex, o.colorIndex)
                } : {
                    color: t.color || o.color
                },
                n = o.options._levelNumber || 0;
            i.drilldownLevels || (i.drilldownLevels = []), e = tl(tl({
                _ddSeriesId: th++
            }, s), e);
            let a = [],
                d = [],
            ...
            (p = i.drilldownLevels[i.drilldownLevels.length - 1]) && p.levelNumber !== n && (p = void 0), o.chart.series.forEach(t => {
                t.xAxis === l && (t.options._ddSeriesId = t.options._ddSeriesId || th++, t.options.colorIndex = t.colorIndex, t.options._levelNumber = t.options._levelNumber || n, p ? (a = p.levelSeries, d = p.levelSeriesOptions) : (a.push(t), t.purgedOptions = ts({
            ...
            let h = tl({
                ...
                color: t.isNull ? "rgba(0,0,0,0)" : s.color,
            ...
            u.options._levelNumber = n + 1, l && (l.oldPos = l.pos, l.userMin = l.userMax = null, r.userMin = r.userMax = null), u.isDrilling = !0, o.type === u.type && (u.animate = u.animateDrilldown || tt, u.options.animation = !0)
        }
        applyDrilldown() {
            let t, e = this.chart || this,
                i = e.drilldownLevels;
                    ...
                    if (e.mapView) {
                        if (o.options && o.options._levelNumber === t && o.group) {
                            ...
                            e.options.drilldown && (t = e.options.drilldown.animation), o.group.animate({
                                ...
                                o.remove(!1), i.levelSeries.filter(t => Object.keys(t).length).length || (e.resetZoomButton && (e.resetZoomButton.hide(), delete e.resetZoomButton), e.pointer?.reset(), tr(e, "afterDrilldown"), e.mapView && (e.series.forEach(t => {
                                    t.isDirtyData = !0, t.isDrilling = !1
                                }), e.mapView.fitToBounds(void 0, void 0), e.mapView.allowTransformAnimation = !0), tr(e, "afterApplyDrilldown"))
                            })
                        }
                    } else o.options && o.options._levelNumber === t && o.remove(!1)
                })
            })), e.mapView || (e.resetZoomButton && (e.resetZoomButton.hide(), delete e.resetZoomButton), e.pointer?.reset(), tr(e, "afterDrilldown"), e.hasCartesianSeries || e.axes.forEach(t => {
                t.destroy(!0), t.init(e, ts(t.userOptions, t.options))
            }), e.redraw(), tr(e, "afterApplyDrilldown"))
        }
        drillUp(t) {
            ...
            for (e.symbolCounter = e.colorCounter = 0; a--;) {
                ...
                if ((p = i[a]).levelNumber === o) {
                    ...
                    if (e.mapView || m.remove(!1), c && c.xAxis && (h = p.oldExtremes, c.xAxis.setExtremes(h.xMin, h.xMax, !1), c.yAxis.setExtremes(h.yMin, h.yMax, !1)), p.resetZoomButton && (e.resetZoomButton = p.resetZoomButton), e.mapView) {
                        ...
                        i ? u.remove(!1) : (u.dataLabelsGroup && (u.dataLabelsGroup.destroy(), delete u.dataLabelsGroup), e.mapView && c && (l && (u.isDrilling = !0, c.isDrilling = !0, e.redraw(!1), e.mapView.fitToBounds(u.bounds, void 0, !0, !1)), e.mapView.allowTransformAnimation = !0, tr(e, "afterDrillUp", {
                            seriesOptions: c ? c.userOptions : void 0
                        }), l ? (e.mapView.setView(void 0, ta(e.mapView.minZoom, 1), !0, {
                            complete: function() {
                    ...
                    } else tr(e, "afterDrillUp")
                }
            }
            e.mapView || t || e.redraw(), e.ddDupes && (e.ddDupes.length = 0), tr(e, "drillupall")
        }
        fadeInGroup(t) {
            let e = $(this.chart.options.drilldown.animation);
            t && (t.hide(), tp(() => {
                t && t.added && t.fadeIn()
        ...
        update(t, e) {
            let i = this.chart;
            ts(!0, i.options.drilldown, t), ta(e, !0) && i.redraw()
        }
    }! function(t) {
        function e(t) {
            let e = this.chart,
        ...
        function i() {
            let t = this.options.drilldown,
                e = t && t.breadcrumbs;
            this.breadcrumbs || (this.breadcrumbs = new A(this, e)), this.breadcrumbs.updateProperties(tm(this))
        }

        function o() {
            this.breadcrumbs && this.breadcrumbs.updateProperties(tm(this))
        }

        function l() {
            this.drilldown = new tw(this)
        }
        ...
        function n() {
            (this.xAxis || []).forEach(t => {
                t.ddPoints = {}, t.series.forEach(e => {
                    let i = e.getColumn("x"),
                        o = e.points;
                    for (let l = 0, r = i.length, s; l < r; l++)
                        if ("number" != typeof(s = e.options.data[l]) && (s = e.pointClass.prototype.optionsToObject.call({
                                series: e
                            }, s)).drilldown) {
        ...
        function p() {
            ...
            o && (e && l && l.length ? (e.drillable = !0, e.basicStyles || r || (e.basicStyles = ts(e.styles)), e.addClass("highcharts-drilldown-axis-label"), e.removeOnDrillableClick && td(e.element, "click"), e.removeOnDrillableClick = te(e.element, "click", function(e) {
        ...
        t.compose = function(t, h, u, c, m, w, g) {
            ...
            let f = h.prototype;
            if (!f.drillUp) {
                let c = w.prototype.Element,
                    m = tw.prototype,
                    b = t.prototype,
                    v = c.prototype,
                    y = g.prototype;
                b.drilldownCategory = tu, b.getDDPoints = tc, A.compose(h, u), te(A, "up", e), f.addSeriesAsDrilldown = m.addSeriesAsDrilldown, f.addSingleSeriesAsDrilldown = m.addSingleSeriesAsDrilldown, f.applyDrilldown = m.applyDrilldown, f.drillUp = m.drillUp, te(h, "afterDrilldown", i), te(h, "afterDrillUp", o), te(h, "afterInit", l), te(h, "drillup", r), te(h, "drillupall", s), te(h, "render", n), te(h, "update", a), u.drilldown = T, v.fadeIn = d, y.drillable = p
            }
        }
    }(i || (i = {}));
    let tg = i,
        tf = a();
    tf.Breadcrumbs = tf.Breadcrumbs || A, tg.compose(tf.Axis, tf.Chart, tf.defaultOptions, tf.Series, tf.seriesTypes, tf.SVGRenderer, tf.Tick);
    let tb = a();
    return s.default
})());