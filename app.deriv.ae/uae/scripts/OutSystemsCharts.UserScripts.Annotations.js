...
function(t, i) {
    ...
    function E(t) {
        ...
        e && (v(e, "remove"), m(this.options.annotations, e.options), m(i, e), e.destroy())
    }

    function P() {
        let t = this.options.annotations,
            i = this.userOptions.annotations;
        this.annotations = [], x(this.options.annotations) || (this.options.annotations = []), y(i, !0) && y(t, !0) && this.options.annotations.push(t)
    }
    ...
    function tQ(t, i, e, s) {
        ...
        }, void 0, s).appendChild(tH.createTextNode(t3(i, e).indicatorFullName)), tq("input", {
            type: "hidden",
            name: "highcharts-type-" + e,
            value: e
        }, void 0, s), t7.call(this, e, "series", t, s, i, i.linkedParent && i.linkedParent.options.id), o.volumeSeriesID && t7.call(this, e, "volume", t, s, i, i.linkedParent && o.volumeSeriesID), t1.call(this, t, "params", o, e, s)
    }
    ...
    function ik(t) {
        this.popup || (this.popup = new im(this.chart.container, this.chart.options.navigation.iconsURL || this.chart.options.stockTools && this.chart.options.stockTools.gui.iconsURL || "https://code.highcharts.com/12.3.0/gfx/stock-icons/", this.chart)), this.popup.showForm(t.formType, this.chart, t.options, t.onSubmit)
    }
    ...
    let iC = {
            compose: function(t, i) {
                iy(iv, "Popup") && (ix(t, "closePopup", iA), ix(t, "showPopup", ik), ib(i.prototype, "onContainerMouseDown", iw))
            }
        },
        {
    ...
    class er {
        static compose(t, i) {
            i8(i_, "NavigationBindings") && (iJ(t, "remove", et), ea(t), i3(t.types, t => {
                ea(t)
        ...
        initEvents() {
            let t = this,
                ...
                e = t.container,
                s = t.options;
            t.boundClassNames = {}, i3(s.bindings || {}, i => {
        ...
        annotationToFields(t) {
            let i = t.options,
                ...
                s = e.nestedOptions,
                o = i7(i.type, i.shapes && i.shapes[0] && i.shapes[0].type, i.labels && i.labels[0] && i.labels[0].type, "label"),
