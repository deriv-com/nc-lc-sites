! function(t, i) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : (t = "undefined" != typeof globalThis ? globalThis : t || self).snsWebSdk = i()
}(this, (function() {
    "use strict";
    var t = function() {
        return t = Object.assign || function(t) {
            for (var i, e = 1, o = arguments.length; e < o; e++)
                for (var n in i = arguments[e]) Object.prototype.hasOwnProperty.call(i, n) && (t[n] = i[n]);
            return t
    ...
    var e = function() {
            function e(t, i, e, o) {
                var n = this;
                this.iframe = null, this.iframeId = null, this.sessionId = "", this.$container = null, this.initialized = !1, this.scrollPosition = -1, this.scrollElement = null, this.onMessage = function(t) {
                    n.onSdkMessage(t)
                }, this.baseUrl = t || this.getCurrentBaseUrl("https://api.sumsub.com", i.accessToken), this.config = i, this.config.packageVersion = this.getVersion(), this.callbacks = e, this.options = o
            }
            return e.prototype.getVersion = function() {
                ...
                if (e)
                    for (var o = 0, n = i.replace(e, "").replace("-v2", "").split(".").map((function(t) {
                            try {
                                return atob(t)
                            } catch (i) {
                                return t
                ...
                return 2 === this.config.version && this.config.theme && (t += "&theme=" + this.config.theme), 2 === this.config.version && this.config.customizationName && (t += "&customizationName=" + encodeURIComponent(this.config.customizationName)), 2 === this.config.version && this.config.translationName && (t += "&translationName=" + encodeURIComponent(this.config.translationName)), e + t
                ...
                if (this.baseUrl === i.origin) {
                    var o = i.data;
                    if (o.method && ~o.method.indexOf("idCheck") && (!this.sessionId || this.sessionId === o.sessionId) && (null === (e = this.iframe) || void 0 === e ? void 0 : e.contentWindow)) {
                        if ("idCheck.onReady" == o.method && o.frameId === this.iframeId) {
                        ...
                        if ("idCheck.onInitialized" == o.method && (this.initialized = !0), "idCheck.onResize" == o.method && this.options.adaptIframeHeight && (this.iframe.style.height = o.height + "px"), "idCheck.scrollTo" == o.method && this.options.adaptIframeHeight) this.scrollTo(o.top);
                        else if ("idCheck.getScrollPosition" != o.method)
                            if ("idCheck.restoreScrollPosition" != o.method) {
                                var s = o.method;
                                delete o.method, delete o.frameId, delete o.sessionId, "idCheck.onError" === s && "invalid-token" === o.code ? this.callExpirationHandler() : "idCheck.onError" === s && "function" == typeof this.callbacks.onError ? this.callbacks.onError(o) : "function" == typeof this.callbacks.onMessage && this.callbacks.onMessage(s, o)
                ...
                var e = t ? i(t) : this.config.version;
                if (t && this.iframe && !this.initialized && this.config.version != e) return this.sessionId = "", this.config.accessToken = t, this.config.version = e, this.baseUrl = this.getCurrentBaseUrl(this.baseUrl, t), this.iframeId = "id_" + this.getIframeId(), void(this.iframe.src = this.getIframeSrc());
                this.updateAccessToken(t)
            }, e.prototype.getScrolledElement = function() {
                for (var t, i = null === (t = this.iframe) || void 0 === t ? void 0 : t.parentElement; 0 === (null == i ? void 0 : i.scrollTop) && "BODY" !== (null == i ? void 0 : i.tagName);) i = null == i ? void 0 : i.parentElement;
                return i
            }, e.prototype.getScrollPosition = function() {
                var t = this.getScrolledElement();
                this.scrollPosition = (null == t ? void 0 : t.scrollTop) || -1, this.scrollElement = this.scrollPosition > 0 && t ? t : null
                ...
                if (this.options.enableScrollIntoView) {
                    ...
                    if (0 === (null == e ? void 0 : e.scrollTop) && "BODY" === (null == e ? void 0 : e.tagName)) {
                        var o = (null === (i = this.iframe) || void 0 === i ? void 0 : i.getBoundingClientRect().top) || 0;
                        window.scrollTo({
                            top: o + t,
                            behavior: "smooth"
                        })
                    } else null == e || e.scrollTo({
                        top: t,
                        behavior: "smooth"
                    })
                }
                ...
                var e, o;
                null === (o = null === (e = this.iframe) || void 0 === e ? void 0 : e.contentWindow) || void 0 === o || o.postMessage({
            ...
            }, e.prototype.singleStepNext = function(t) {
                var i, e;
                null === (e = null === (i = this.iframe) || void 0 === i ? void 0 : i.contentWindow) || void 0 === e || e.postMessage({
        ...
        o = function() {
            ...
            return t.prototype.onTestEnv = function() {
                ...
                var i;
                return t.hasOwnProperty("adaptIframeHeight") && (this.options.adaptIframeHeight = t.adaptIframeHeight), t.hasOwnProperty("addViewportTag") && (this.options.addViewportTag = t.addViewportTag), this.options.enableScrollIntoView = null === (i = t.enableScrollIntoView) || void 0 === i || i, this
                ...
                var t, o, n, s, r, a, l, c, h, d, u, f, p, g, v = this,
                    m = i(this.accessToken);
                return new e(this.baseUrl, {
                    version: m,
                    theme: null === (t = this.config) || void 0 === t ? void 0 : t.theme,
                    customizationName: null === (o = this.config) || void 0 === o ? void 0 : o.customizationName,
                    translationName: null === (n = this.config) || void 0 === n ? void 0 : n.translationName,
                    accessToken: this.accessToken,
                    lang: null === (s = this.config) || void 0 === s ? void 0 : s.lang,
                    email: null === (r = this.config) || void 0 === r ? void 0 : r.email,
                    phone: null === (a = this.config) || void 0 === a ? void 0 : a.phone,
                    country: null === (l = this.config) || void 0 === l ? void 0 : l.country,
                    uiConf: null === (c = this.config) || void 0 === c ? void 0 : c.uiConf,
                    i18n: null === (h = this.config) || void 0 === h ? void 0 : h.i18n,
                    documentsByCountries: null === (d = this.config) || void 0 === d ? void 0 : d.documentsByCountries,
                    documentDefinitions: null === (u = this.config) || void 0 === u ? void 0 : u.documentDefinitions,
                    autoSelectDocumentDefinitions: null === (f = this.config) || void 0 === f ? void 0 : f.autoSelectDocumentDefinitions,
                    controlledNavigationBack: null === (p = this.config) || void 0 === p ? void 0 : p.controlledNavigationBack,
                    singleStep: null === (g = this.config) || void 0 === g ? void 0 : g.singleStep,
                    ...
                    onMessage: function(t, i) {
                        var e, o = v.eventHandlers[t];
                        o ? o(i) : null === (e = v.anyEventHandler) || void 0 === e || e.call(v, t, i)
                    }
                }, this.options)
            }, t
        }(),
        n = function() {
            ...
            return t.prototype.withAccessToken = function(t, i) {
                ...
                return new e(this.baseUrl, {
                    ...
                    documentDefinitions: null === (u = this.config) || void 0 === u ? void 0 : u.documentDefinitions,
                    autoSelectDocumentDefinitions: null === (f = this.config) || void 0 === f ? void 0 : f.autoSelectDocumentDefinitions,
                    singleStep: null === (p = this.config) || void 0 === p ? void 0 : p.singleStep,
                    reusableConfig: this.reusableConfig
                }, {
                    expirationHandler: {
                        legacy: !0,
                    ...
                    onMessage: null === (g = this.config) || void 0 === g ? void 0 : g.onMessage,
                    onError: null === (v = this.config) || void 0 === v ? void 0 : v.onError
                }, {
                    adaptIframeHeight: this.options.adaptIframeHeight,
