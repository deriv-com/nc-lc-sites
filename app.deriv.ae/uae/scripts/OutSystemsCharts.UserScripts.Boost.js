...
function(e, t) {
    ...
    class B {
        ...
        setOptions(e) {
            "pixelRatio" in e || (e.pixelRatio = 1), _(!0, this.settings, e)
        }
        allocateBuffer(e) {
            let t = this.vbuffer,
                i = 0;
        ...
        pushSeriesData(e, t) {
            ...
            a.gapSize && (en = "value" !== a.gapUnit ? a.gapSize * e.closestPointRange : a.gapSize), _ && (er = [], _.forEach((e, t) => {
                if (e.color) {
                    let i = S(e.color).rgba;
                    i[0] /= 255, i[1] /= 255, i[2] /= 255, er[t] = i, eo || void 0 !== e.value || (eo = i)
                }
            }), eo || (eo = S(e.pointAttribs && e.pointAttribs().fill || e.color).rgba, eo[0] /= 255, eo[1] /= 255, eo[2] /= 255)), n.inverted && (I = e.chart.plotHeight), e.closestPointRangePx = Number.MAX_VALUE;
            let el = e => {
                    e && (t.colorData.push(e[0]), t.colorData.push(e[1]), t.colorData.push(e[2]), t.colorData.push(e[3]))
                },
                eh = (e, o, n, a = 1, l) => {
                    el(l), 1 !== D && (!s.useGPUTranslations || t.skipTranslation) && (e *= D, o *= D, a *= D), s.usePreallocated && r ? (r.push(e, o, +!!n, a), ea += 4) : (i.push(e), i.push(o), i.push(n ? D : 0), i.push(a))
                },
                ed = () => {
            ...
            if (ef(), C && C.length > 0) {
                t.skipTranslation = !0, t.drawMode = "TRIANGLES", C[0].node && C[0].node.levelDynamic && C.sort((e, t) => {
                    ...
                    if (void 0 !== r && !isNaN(r) && null !== t.y && t.shapeArgs) {
                        ...
                        i = (s = n.styledMode ? t.series.colorAttribs(t) : s = t.series.pointAttribs(t))["stroke-width"] || 0, ee = S(s.fill).rgba, ee[0] /= 255, ee[1] /= 255, ee[2] /= 255, e.is("treemap") && (i = i || 1, V = S(s.stroke).rgba, V[0] /= 255, V[1] /= 255, V[2] /= 255, eu(r, o, a, l, V), i /= 2), e.is("heatmap") && n.inverted && (r = h.len - r, o = d.len - o, a = -a, l = -l), eu(r + i, o + i, a - 2 * i, l - 2 * i, ee)
                    }
                }), ed();
                return
            }
            for (; Y < k.length - 1;) {
                if (void 0 === (j = k[++Y])) continue;
                if (w) break;
                let i = u && u[Y];
                if (!P && L(i, !0) && i.color && (ee = S(i.color).rgba, ee[0] /= 255, ee[1] /= 255, ee[2] /= 255), P ? (H = j[0], W = j[1], k[Y + 1] && (K = k[Y + 1][0]), k[Y - 1] && (Z = k[Y - 1][0]), j.length >= 3 && (q = j[2], j[2] > t.zMax && (t.zMax = j[2]), j[2] < t.zMin && (t.zMin = j[2]))) : (H = j, W = y?.[Y], k[Y + 1] && (K = k[Y + 1]), k[Y - 1] && (Z = k[Y - 1]), v && v.length && (q = v[Y], v[Y] > t.zMax && (t.zMax = v[Y]), v[Y] < t.zMin && (t.zMin = v[Y]))), !T && (null === H || null === W)) {
                    ef();
                    continue
                }
                if (K && K >= m && K <= c && (J = !0), Z && Z >= m && Z <= c && ($ = !0), o ? (P && (W = j.slice(1, 3)), Q = e.getColumn("low", !0)?.[Y], W = e.getColumn("high", !0)?.[Y] || 0) : f && (H = j.x, Q = (W = j.stackY) - j.y), null != b && null != x && (ei = W >= b && W <= x), !l && !ei || (H > c && M.x < c && (M.x = H, M.y = W), H < m && E.x > m && (E.x = H, E.y = W), null === W && T)) continue;
                if (null === W || !ei && k.length > 1 && !J && !$) {
                    ef();
                    continue
                }
                if ((l && (K >= m || H >= m) && (Z <= c || H <= c) || !l && H >= m && H <= c) && (et = !0), et || J || $) {
                    if (en && H - Z > en && ef(), _) {
                        let e;
                        _.some((t, i) => {
                            let s = _[i - 1];
                            return "x" === R ? void 0 !== t.value && H <= t.value && (er[i] && (!s || H >= s.value) && (e = er[i]), !0) : void 0 !== t.value && W <= t.value && (er[i] && (!s || W >= s.value) && (e = er[i]), !0)
                        }), ee = e || eo || ee
                    }
                    if (s.useGPUTranslations || (t.skipTranslation = !0, H = h.toPixels(H, !0), W = d.toPixels(W, !0), !(H > I) || "POINTS" !== t.drawMode)) {
                        if (t.hasMarkers && et && !1 !== G && (e.closestPointRangePx = Math.min(e.closestPointRangePx, Math.abs(H - G))), !s.useGPUTranslations && !s.usePreallocated && G && 1 > Math.abs(H - G) && B && 1 > Math.abs(W - B)) {
                            s.debug.showSkipSummary && ++X;
                            continue
                        }
                        U && (O = Q || 0, (!1 === Q || void 0 === Q) && (O = W < 0 ? W : 0), (o || f) && !d.logarithmic || (O = Math.max(null === z ? b : z, b)), s.useGPUTranslations || (O = d.toPixels(O, !0)), eh(H, O, 0, 0, ee)), a.step && !es && eh(H, B, 0, 2, ee), eh(H, W, 0, "bubble" === e.type ? q || 1 : 2, ee), G = H, B = W, F = !0, es = !1
                    }
                }
            }
    ...
    let {
        ...
        constructor(e = {}) {
            this.autoId = !e.id, this.columns = {}, this.id = e.id || H(), this.modified = this, this.rowCount = 0, this.versionTag = H();
            let t = 0;
            F(e.columns || {}, (e, i) => {
        ...
        applyRowCount(e) {
            this.rowCount = e, F(this.columns, (t, i) => {
        ...
        deleteRows(e, t = 1) {
            if (t > 0 && e < this.rowCount) {
                let i = 0;
                F(this.columns, (s, r) => {
                    this.columns[r] = V(s, e, t).array, i = s.length
                }), this.rowCount = i
            }
        ...
        setColumns(e, t, i) {
            ...
            }), this.applyRowCount(s), i?.silent || (X(this, "afterSetColumns"), this.versionTag = H())
        }
        setRow(e, t = this.rowCount, i, s) {
            ...
            F(e, (e, n) => {
                ...
                a && (i ? a = V(a, t, 0, !0, [e]).array : a[t] = e, r[n] = a)
            }), o > this.rowCount && this.applyRowCount(o), s?.silent || (X(this, "afterSetRows"), this.versionTag = H())
        }
    }, {
        getBoostClipRect: j,
        isChartSeriesBoosting: q
    } = A, {
        getOptions: Y
    } = d(), {
        composed: Z,
    ...
    function eu(e, t) {
        let i = e.constructor,
            ...
            h = !1;
        q(e) ? a = e : (a = t, h = !!(t.options.events?.click || t.options.point?.events?.click));
        let d = a.boost = a.boost || {};
        if (l = !1, s || (s = K.createElement("canvas")), !d.target && (d.canvas = s, e.renderer.forExport || !l ? (a.renderTarget = d.target = e.renderer.image("", 0, 0, o, n).addClass("highcharts-boost-canvas").add(r), d.clear = function() {
                d.target.attr({
            ...
            }) : (d.targetFo = e.renderer.createElement("foreignObject").add(r), a.renderTarget = d.target = K.createElement("canvas"), d.targetCtx = d.target.getContext("2d"), d.targetFo.element.appendChild(d.target), d.clear = function() {
        ...
        return d.resize(), d.clear(), !d.wgl && (d.wgl = new B(e => {
        ...
        }), d.wgl.init(d.canvas) || et("[highcharts boost] - unable to init WebGL renderer"), d.wgl.setOptions(e.options.boost || {}), a instanceof i && d.wgl.allocateBuffer(e)), d.wgl.setSize(o, n), d.wgl
    }
    ...
    function ey(e, t) {
        ...
        return l.category = en(s.categories ? s.categories[l.x] : l.x, l.x), l.key = l.name ?? l.category, l.dist = t.dist, l.distX = t.distX, l.plotX = t.plotX, l.plotY = t.plotY, l.index = t.i, l.percentage = t.percentage, l.isInside = e.isPointInside(l), l
    }
    ...
    function ev(e) {
        ...
        for (let e = 0, t = n.length; e < t; ++e) v = n[e], C = d?.[e], v >= h && v <= l && C >= g && C <= u ? (c.push({
            x: v,
            y: C
        }), p.push(v), b.push(C), x && (P = Math.max(P, v), T = Math.min(T, v)), A && (k = Math.max(k, C), E = Math.min(E, C))) : y = !0;
        return x && (i.dataMax = Math.max(P, i.dataMax || 0), i.dataMin = Math.min(T, i.dataMin || 0)), A && (s.dataMax = Math.max(k, s.dataMax || 0), s.dataMin = Math.min(E, s.dataMin || 0)), this.cropped = y, this.cropStart = 0, y && this.dataTable.modified === this.dataTable && (this.dataTable.modified = new W), this.dataTable.modified.setColumns({
            x: p,
            y: b
        }), ep(this, p) || (this.processedData = c), !0
    }
    ...
    function eP() {
        ...
        if (!this.boosted || (this.points?.forEach(e => {
                e?.destroyElements?.()
            }), this.points = [], R && !R.isHidden ? (t.hoverPoint?.series === this || t.hoverPoints?.some(e => e.series === this)) && (t.hoverPoint = t.hoverPoints = void 0, R.hide(0)) : t.hoverPoints && (t.hoverPoints = t.hoverPoints.filter(e => e.series !== this)), o.isPanning || n.isPanning) || (L = eu(t, this), t.boosted = !0, !this.visible)) return;
        (this.points || this.graph) && eg(this), q(t) ? (this.markerGroup && this.markerGroup !== s?.markerGroup && this.markerGroup.destroy(), this.markerGroup = s?.markerGroup, r && r.target && (this.renderTarget = r.target = r.target.destroy())) : (this.markerGroup === s?.markerGroup && (this.markerGroup = void 0), this.markerGroup = this.plotGroup("markerGroup", "markers", "visible", 1, t.seriesGroup).addClass("highcharts-tracker"));
        let B = this.points = [],
            O = (e, s, r, a) => {
                let l = !!S && S[C + r],
                    h = e => {
                ...
                e = Math.ceil(e), i = M ? e : e + "," + s, y && (x[i] ? l === S[S.length - 1] && (B.length--, h(e)) : (x[i] = !0, h(e)))
            };
        this.buildKDTree = Q, es(this, "renderCanvas"), this.is("line") && w > 1 && r?.target && s && !s.lineWidthFilter && (s.lineWidthFilter = t.renderer.definition({
            tagName: "filter",
            children: [{
        ...
        })), L && (ed(L, this), L.pushSeries(this), eA(this));
        let V = L.settings;
        t.renderer.forExport || (V.debug.timeKDTree && console.time("kd tree building"), em(T ? this.data.slice(C) : a || f, function(e, i) {
            let s = void 0 === t.index,
                r, a, f, u, c, x = !1,
                y = !0;
            return !eh(e) || (!s && (E ? (r = e[0], a = e[1]) : (r = e, a = l[i] ?? U ?? null), P ? (E && (a = e.slice(1, 3)), x = h[i], a = d[i]) : T && (r = e.x, x = (a = e.stackY) - e.y, c = e.percentage), k || (y = (a || 0) >= p && a <= b), null !== a && r >= g && r <= m && y && (f = o.toPixels(r, !0), A ? ((void 0 === I || f === _) && (P || (x = a), (void 0 === G || a > N) && (N = a, G = i), (void 0 === I || x < D) && (D = x, I = i)), M && f === _ || (void 0 !== I && (u = n.toPixels(N, !0), z = n.toPixels(D, !0), O(f, u, G, c), z !== u && O(f, z, I, c)), I = G = void 0, _ = f)) : O(f, u = Math.ceil(n.toPixels(a, !0)), i, c))), !s)
        }, () => {
            es(this, "renderedCanvas"), delete this.buildKDTree, this.options && this.buildKDTree(), V.debug.timeKDTree && console.timeEnd("kd tree building")
        }))
    }
    ...
    function eT(e) {
        ...
        i && (ed(i, this), i.pushSeries(this)), eA(this)
    }
    ...
    function ek(e) {
        ...
        if (ef(this.chart) && u[this.type]) {
            ...
            if (!ep(this, t) || s || this.is("treemap") || this.options.stacking || !ec(this, !0)) {
                ...
                s && "treegrid" !== this.yAxis.type ? ev.call(this, arguments[1]) : e.apply(this, [].slice.call(arguments, 1)), t = this.getColumn("x", !0)
            }
            if (this.boosted = ep(this, t), this.boosted) {
                let e;
    ...
    let eM = {
            compose: function(e, t, i, s) {
                if (ea(Z, "Boost.Series")) {
                    let r = Y().plotOptions,
                        o = e.prototype;
                    if ($(e, "destroy", eb), $(e, "hide", ex), s && (o.renderCanvas = eP), el(o, "getExtremes", eC), el(o, "processData", ek), el(o, "searchPoint", eE), ["translate", "generatePoints", "drawTracker", "drawPoints", "render"].forEach(e => (function(e, t, i) {
                            function s(e) {
                            ...
                            if (el(e, i, s), "translate" === i)
                                for (let e of ["column", "arearange", "columnrange", "heatmap", "treemap"]) t[e] && el(t[e].prototype, i, s)
                        })(o, t, e)), el(i.prototype, "firePointEvent", function(e, t, i) {
                        ...
                        if (e && ei(e.prototype, {
                            ...
                            let e = s.prototype;
                            delete e.buildKDTree, el(e, "markerAttribs", function(e) {
    ...
    function ez() {
        ...
        if (void 0 !== eU.WebGLRenderingContext) {
            ...
            for (let t = 0; t < e_.length; ++t) try {
                if (null != e.getContext(e_[t])) return !0
            } catch (e) {}
        }
        return !1
    }
    let eD = {
            compose: function(e, t, i, s, r, o) {
                let n = ez();
                n || (void 0 !== d().initCanvasBoost ? d().initCanvasBoost() : eL(26)), o && !o.names.lightgoldenrodyellow && (o.names = {
                    ...o.names,
                    ...eS.defaultHTMLColorMap
                }), A.compose(e, n), eM.compose(i, s, r, n), eR(t, "setExtremes", function(e) {
        ...
        eN = d();
    eN.hasWebGLSupport = eD.hasWebGLSupport, eD.compose(eN.Chart, eN.Axis, eN.Series, eN.seriesTypes, eN.Point, eN.Color);
    let eI = d();
    return l.default
})());