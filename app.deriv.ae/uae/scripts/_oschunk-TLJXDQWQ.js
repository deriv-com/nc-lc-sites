...
var u = y,
    O = class O extends u.DataTypes.GenericRecord {
        static attributesToDeclare() {
            return [this.attr("Internal_Configs", "internal_ConfigsVar", "Internal_Configs", !0, !1, u.DataTypes.DataTypes.Record, function() {
                return u.DataTypes.ImmutableBase.getData(new S)
            }, !1, S), this.attr("IsLoading", "isLoadingIn", "IsLoading", !0, !1, u.DataTypes.DataTypes.Boolean, function() {
                return !1
            }, !1), this.attr("_isLoadingInDataFetchStatus", "_isLoadingInDataFetchStatus", "_isLoadingInDataFetchStatus", !0, !1, u.DataTypes.DataTypes.Integer, function() {
                return 1
            }, !1), this.attr("ShowLabelOnLoading", "showLabelOnLoadingIn", "ShowLabelOnLoading", !0, !1, u.DataTypes.DataTypes.Boolean, function() {
                return !1
            }, !1), this.attr("_showLabelOnLoadingInDataFetchStatus", "_showLabelOnLoadingInDataFetchStatus", "_showLabelOnLoadingInDataFetchStatus", !0, !1, u.DataTypes.DataTypes.Integer, function() {
                return 1
...
var U = new u.Model.ModelFactory(h);
var D = p(B());
var V = {};

function w(f, o, g, t) {
    f.Initialized = o.InitializedHandler
}
l(w, "default");
var r = y; {
            ...
            return this.hasOwnProperty("__initializedHandler$Action") || (this.__initializedHandler$Action = function(t, n) {
                ...
                return r.Logger.startActiveSpan("InitializedHandler", function(s) {
                    return s && (s.setAttribute("code.function", "InitializedHandler"), s.setAttribute("outsystems.function.key", "0edfd226-b70a-4aaf-8ff2-c0c972952aac"), s.setAttribute("outsystems.function.owner.name", "OutSystemsUI"), s.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271"), s.setAttribute("outsystems.function.type", "CLIENT_SCREEN_ACTION")), r.Flow.tryFinally(function() {
                        ...
                        var c = new r.DataTypes.VariableHolder(new(a.constructor.getVariableGroupType("OutSystemsUI.Utilities.ButtonLoading.InitializedHandler$vars")));
                        return c.value.buttonLoadingIdInLocal = t, r.Flow.executeAsyncFlow(function() {
                            return a.initialized$Action(c.value.buttonLoadingIdInLocal, n)
                        })
                    }, function() {
                        s && s.end()
                    })
                ...
                return r.Logger.startActiveSpan("RegisterCallbacks", function(i) {
                    ...
                    try {
                        ...
                        s.value = r.Logger.startActiveSpan("GetCallbackHandlers", function(c) {
                            c && (c.setAttribute("code.function", "GetCallbackHandlers"), c.setAttribute("outsystems.function.key", "3c6ce000-aef8-452c-acd4-1bdfdcfa8c7a"), c.setAttribute("outsystems.function.owner.name", "OutSystemsUI"), c.setAttribute("outsystems.function.owner.key", "8be17f2a-431c-4958-b894-c77b988a7271"), c.setAttribute("outsystems.function.type", "JAVASCRIPT"));
                            try {
                                return e.safeExecuteJSNode(w, "GetCallbackHandlers", "RegisterCallbacks", {
                                    ...
                                    var _ = new(e.constructor.getVariableGroupType("OutSystemsUI.Utilities.ButtonLoading.RegisterCallbacks$getCallbackHandlersJSResult"));
                                    return _.initializedOut = r.DataConversion.JSNodeParamConverter.from(A.Initialized, r.DataTypes.DataTypes.Object), _
                                }, {
                        ...
                        }, 1), d.buttonLoadingRegisterCallback$Action(n.variables.internal_ConfigsVar.uniqueIdAttr, b.registeredCallbackEvents.initialized, s.value.initializedOut, t)
                    } finally {
                        i && i.end()
                    }
                }, 1)
            ...
            return this.hasOwnProperty("__onInitialize$Action") || (this.__onInitialize$Action = function(t) {
                ...
                return r.Logger.startActiveSpan("OnInitialize", function(i) {
                    ...
                    try {
                        ...
                        var s = new r.DataTypes.VariableHolder;
                        d.logEvent$Action(b.logType.general, "Going to create ButtonLoading", t), s.value = d.generateUniqueId$Action(n.variables.internal_ConfigsVar.uniqueIdAttr, t), n.variables.internal_ConfigsVar.uniqueIdAttr = s.value.unique_IDOut, n.variables.internal_ConfigsVar.isLoadingAttr = n.variables.isLoadingIn, n.variables.internal_ConfigsVar.showLoadingAndLabelAttr = n.variables.showLabelOnLoadingIn, n.variables.internal_ConfigsVar.extendedClassAttr = n.variables.extendedClassIn, d.buttonLoadingCreate$Action(n.variables.internal_ConfigsVar, t), e._registerCallbacks$Action(t)
                    } finally {
                        i && i.end()
                    }
                }, 1)
        ...
        get _onReady$Action() {
            return this.hasOwnProperty("__onReady$Action") || (this.__onReady$Action = function(t) {
                ...
                return r.Logger.startActiveSpan("OnReady", function(i) {
                    ...
                    try {
                        e.ensureControllerAlive("OnReady"), t = e.callContext(t), d.buttonLoadingInitialize$Action(n.variables.internal_ConfigsVar.uniqueIdAttr, t), d.logEvent$Action(b.logType.general, "ButtonLoading created", t)
                    } finally {
                        i && i.end()
                    }
                }, 1)
    ...
    l(o, "ControllerInner");
    let f = o;
    v = f, v.registerVariableGroupType("OutSystemsUI.Utilities.ButtonLoading.InitializedHandler$vars", [{
    ...
    }]), v.registerVariableGroupType("OutSystemsUI.Utilities.ButtonLoading.RegisterCallbacks$getCallbackHandlersJSResult", [{
        name: "Initialized",
...
var v, x = new r.Controller.ControllerFactory(v, N);
var yt = C.PlaceholderContent,
    bt = C.IteratorPlaceholderContent,
    W = l(function() {
        var f = T(function(o) {
            var g = o.model,
                t = o.controller,
                ...
                G = H,
                q = $();
            return D.createElement("div", o.rootNodeProperties, D.createElement(k, {
                align: 0,
                content: c.props.placeholders.button,
                extendedProperties: {
                    name: g.variables.internal_ConfigsVar.uniqueIdAttr
                },
                gridProperties: {
                    classes: "OSInline"
                },
