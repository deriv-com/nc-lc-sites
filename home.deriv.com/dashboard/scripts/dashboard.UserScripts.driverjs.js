...
this.driver.js = function(F) {
    ...
    function xe(e, o) {
        ...
        const m = () => {
            ...
            const x = Date.now() - i,
                T = 400 - x <= 400 / 2;
            o.popover && T && !h && u && (ee(e, o), h = !0), s("animate") && x < 400 ? fe(x, 400, n, e) : (j(e), y && y(w ? void 0 : e, o, {
                config: s(),
                state: l(),
                driver: S()
    ...
    function ee(e, o) {
        ...
        u.className = `driver-popover ${m}`.trim(), U(t.wrapper, T => {
            var W, I, M;
            const L = T.target,
        ...
        }, T => !(t != null && t.description.contains(T)) && !(t != null && t.title.contains(T)) && typeof T.className == "string" && T.className.includes("driver-popover")), k("popover", t);
    ...
    function ne(e, o) {
        ...
        const {
            align: i = "start",
            side: d = "left"
        } = (o == null ? void 0 : o.popover) || {}, n = i, f = e.id === "driver-dummy-element" ? "over" : d, w = s("stagePadding") || 0, r = te(), v = t.arrow.getBoundingClientRect(), g = e.getBoundingClientRect(), y = g.top - r.height;
        let a = y >= 0;
    ...
    function Ae(e = {}) {
        ...
        function g(a = !0) {
            ...
            const m = (c == null ? void 0 : c.onDeselected) || s("onDeselected"),
                b = s("onDestroyed");
            if (document.body.classList.remove("driver-active", "driver-fade", "driver-simple"), Se(), Le(), Ce(), me(), de(), X(), p && c) {
