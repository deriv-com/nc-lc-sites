...
function(t, e) {
    ...
    class N {
        static compose(t, e) {
            S(m, "Breadcrumbs") && (x(t, "destroy", C), x(t, "afterShowResetZoom", O), x(t, "getMargins", M), x(t, "redraw", B), x(t, "selection", I), L(e.lang, v.lang))
        }
        constructor(t, e) {
        ...
        getButtonText(t) {
            ...
            return (T(a) && !a.length || "← " === a) && y(r) && (a = i.showFullPath ? r : "← " + r), a
        }
        redraw() {
        ...
        alignBreadcrumbsGroup(t) {
            if (this.group) {
                ...
                s.width = r.width + a, s.height = r.height + a;
                let l = w(s);
                t && (l.x += t), this.options.rtl && (l.x += s.width), l.y = R(l.y, this.yOffset, 0), this.group.align(l, !0, o)
            }
        }
        renderButton(t, e, i) {
            let s = this,
                ...
                l = o.renderer.button(s.getButtonText(t), e, i, function(e) {
                    ...
                    o && (i = o.call(s, e, t)), !1 !== i && (r.showFullPath ? e.newLevel = t.level : e.newLevel = s.level - 1, P(s, "up", e))
                }, a).addClass("highcharts-breadcrumbs-button").add(s.group);
            return o.styledMode || l.attr(r.style), l
        }
        renderSeparator(t, e) {
            let i = this.chart,
    ...
    ! function(t) {
        ...
        t.pointMembers = {
            ...
            colorAttribs: function(t) {
                let e = {};
                return U(t.color) && (!t.state || "normal" === t.state) && (e[this.colorProp || "fill"] = t.color), e
            },
            pointAttribs: z.pointAttribs
        }, t.compose = function(t) {
            return W(t.prototype.pointClass, "afterSetState", e), t
        }
    }(a || (a = {}));
    let F = a;
    var _ = p(820),
    ...
    let j = class {
        ...
        X = class {
            ...
            init(t, e, i, s, o, r, a) {
                return this.id = t, this.i = e, this.children = i, this.height = s, this.level = o, this.series = r, this.parent = a, this
            }
        },
        $ = {
            draw: function(t, e) {
                ...
                if (e.attribs = {
                    ...
                    }, t.shouldDraw()) l || (t.graphic = l = "text" === e.shapeType ? r.text() : "image" === e.shapeType ? r.image(e.imageUrl || "").attr(e.shapeArgs || {}) : r[e.shapeType](e.shapeArgs || {}), l.add(e.group)), o && l.css(o), l.attr(e.attribs).animate(i, !e.isNew && a, s);
                else if (l) {
                    let e = () => {
                        t.graphic = l = l && l.destroy(), "function" == typeof s && s()
                    };
    ...
    let ts = l,
        ...
        tp = {
            getColor: function(t, e) {
                ...
                return t && (i = v[t.i], s = h[t.level] || {}, i && s.colorByPoint && (r = i.index % (c ? c.length : f.colorCount), o = c && c[r]), u.chart.styledMode || (a = th(i && i.options.color, s && s.color, o, d && (t => {
                    let e = s && s.colorVariation;
                    return e && "brightness" === e.key && n && g ? E().parse(t).brighten(e.to * (n / g)).get() : t
                })(d), u.color)), l = th(i && i.options.colorIndex, s && s.colorIndex, r, p, e.colorIndex)), {
                    color: a,
                    colorIndex: l
                }
            },
            getLevelOptions: function(t) {
                let e, i, s, o, r, a, l = {};
                if (tl(t))
                    for (o = ta(t.from) ? t.from : 1, a = t.levels, i = {}, e = tl(t.defaults) ? t.defaults : {}, tr(a) && (i = a.reduce((t, i) => {
                            let s, r, a;
                            return tl(i) && ta(i.level) && (r = th((a = tn({}, i)).levelIsConstant, e.levelIsConstant), delete a.levelIsConstant, delete a.level, tl(t[s = i.level + (r ? 0 : o - 1)]) ? tn(!0, t[s], a) : t[s] = a), t
                        }, {})), r = ta(t.to) ? t.to : 1, s = 0; s <= r; s++) l[s] = tn({}, e, tl(i[s]) ? i[s] : {});
                return l
            },
            getNodeWidth: function(t, e) {
                ...
                if ("auto" === r) {
                    if ("string" == typeof o && /%$/.test(o)) return a / (e + parseFloat(o) / 100 * (e - 1));
                    let t = Number(o);
                    return (a + t) / (e || 1) - t
                }
                return td(r, a)
            ...
            setTreeValues: function t(e, i) {
                let s = i.before,
                    ...
                    h = [],
                    d = 0;
                e.levelDynamic = e.level - (a ? 0 : r.level), e.name = th(l && l.name, ""), e.visible = o === e.id || !0 === i.visible, "function" == typeof s && (e = s(e, i)), e.children.forEach((s, o) => {
                    let r = to({}, i);
                    to(r, {
                        index: o,
            ...
            updateRootId: function(t) {
                let e, i;
                return tl(t) && (i = tl(t.options) ? t.options : {}, e = th(t.rootNode, i.rootId, ""), tl(t.userOptions) && (t.userOptions.rootId = e), t.rootNode = e), e
            }
        },
        {
            parse: tu
    ...
    function tV() {
        ...
        e && i && (this.is("treemap") ? (t = {
            ...
            title: void 0,
            tickPositions: []
        }, tS(i.options, t), tS(e.options, t), tk = !0) : tk && (i.setOptions(i.userOptions), e.setOptions(e.userOptions), tk = !1))
    }
    class tz extends tf {
        constructor() {
        ...
        algorithmCalcPoints(t, e, i, s) {
            let o = i.plot,
                ...
                p = i.lH,
                u, c = 0;
            for (let t of (e ? (d = i.nW, p = i.nH) : u = i.elArr[r], i.elArr))(e || c < r) && (0 === i.direction ? (a = o.x, l = o.y, h = t / (n = d)) : (a = o.x, l = o.y, n = t / (h = p)), s.push({
                x: a,
                y: l,
                width: n,
                height: tT(h)
        ...
        algorithmFill(t, e, i) {
            let s = [],
                ...
                h = e.height,
                d, p, u, c;
            for (let g of i) o = e.width * e.height * (g.val / e.val), d = a, p = l, 0 === r ? (n -= u = o / (c = h), a += u) : (h -= c = o / (u = n), l += c), s.push({
                x: d,
                y: p,
                width: u,
                height: c,
        ...
        algorithmLowAspectRatio(t, e, i) {
            let s = [],
                ...
                r = e.direction,
                a = i.length - 1,
                l = new j(e.height, e.width, r, o),
                n, h = 0;
            for (let r of i) n = e.width * e.height * (r.val / e.val), l.addElement(n), l.lP.nR > l.lP.lR && this.algorithmCalcPoints(t, !1, l, s, o), h === a && this.algorithmCalcPoints(t, !0, l, s, o), ++h;
            return s
        }
        alignDataLabel(t, e, i) {
            tv.prototype.alignDataLabel.apply(this, arguments), t.dataLabel && t.dataLabel.attr({
                    ...
                    r = t => {
                        if (t?.point?.shapeArgs) {
                            let {
                                ...
                                pixelWidth: r = 0,
                                pixelHeight: a = 0
                            } = i, l = tA(a), n = a ? r * a : r * r;
                            (e < r || s < (l ? a : r) || e * s < n) && !t.isGroup && tA(t.parent) && (o[t.parent] || (o[t.parent] = []), o[t.parent].push(t))
                        }
                        t?.children.forEach(t => {
                            r(t)
                        })
                    };
                for (let a in r(t.tree), o) o[a] && o[a].length > s && o[a].forEach(s => {
                    ...
                    if (-1 !== o) {
                        ...
                        if (!l) {
                            ...
                            }), t.points.push(l), e[a].push(o), e[r] = []
                        }
                        let n = l.groupedPointsAmount + 1,
                            h = t.points[l.index].options.value || 0,
                            d = i.name || `+ ${n}`;
                        t.points[l.index].groupedPointsAmount = n, t.points[l.index].options.value = h + (s.point.value || 0), t.points[l.index].name = d, e[r].push(s.point.index)
                    }
                });
        ...
        calculateChildrenAreas(t, e) {
            ...
            s?.layoutStartingDirection && (e.direction = +("vertical" !== s.layoutStartingDirection)), h = this[o](e, a);
            let u = -1;
            for (let t of a) {
                let i = h[++u];
            ...
            if ("leaf" === i.nodeSizeBy && t === n && this.hasOutsideDataLabels && !c(n, void 0, !1).some(t => tM(t.options.value)) && !tM(n.point?.options.value)) {
                ...
                i.forEach((t, e) => {
                    let i = tP((s[e] ? o[e] / s[e] : 1) / a, .8, 1.4),
                        r = 1 - i;
                    t.value && (o[e] < 20 && (r *= o[e] / 20), r > h && (h = r), r < l && (l = r), t.simulatedValue = (t.simulatedValue || t.value) / i)
                }), (l < -.05 || h > .05) && this.simulation < 10 ? (this.simulation++, this.setTreeValues(t), e.val = t.val, this.calculateChildrenAreas(t, e)) : (i.forEach(t => {
        ...
        drawDataLabels() {
            ...
            for (let o of e) {
                let e = {},
                    ...
                    a = t[o.node.level];
                if ((!o.node.isLeaf && !o.node.isGroup || o.node.isGroup && o.node.level <= this.nodeMap[this.rootNode].level) && (r.enabled = !1), a?.dataLabels && (tN(!0, r, tH(a.dataLabels)[0]), this.hasDataLabels = () => !0), o.node.isLeaf ? r.inside = !0 : r.headers && (r.verticalAlign = "top"), o.shapeArgs && s) {
                    let {
                        height: t = 0,
                        width: s = 0
                    } = o.shapeArgs;
                    if (s > 32 && t > 16 && o.shouldDraw()) {
                        ...
                        e.width = `${a}px`, e.lineClamp ?? (e.lineClamp = Math.floor(t / 16)), e.visibility = "inherit", r.headers && o.dataLabel?.attr({
                            width: a
                        })
        ...
        drawPoints(t = this.points) {
            ...
            for (let e of t) {
                let t = {},
                    ...
                    c = l && u,
                    g = e.shapeArgs;
                e.shouldDraw() && (e.isInside = !0, a && (h.r = a), tN(!0, c ? t : h, u ? g : {}, s ? {} : this.pointAttribs(e, e.selected ? "select" : void 0)), this.colorAttribs && s && tS(d, this.colorAttribs(e)), this[p] || (this[p] = i.g(p).attr({
        ...
        buildTree(t, e, i, s, o) {
            let r = [],
                ...
                l = 0,
                n;
            for (let e of s[t] || []) l = Math.max((n = this.buildTree(this.points[e].id, e, i + 1, s, t)).height + 1, l), r.push(n);
            let h = new this.NodeClass().init(t, e, r, l, i, this, o);
            for (let t of r) t.parentNode = h;
            return this.nodeMap[h.id] = h, this.nodeList.push(h), a && (a.node = h, h.point = a), h
        }
        hasData() {
        ...
        init(t, e) {
            let i = this,
                ...
                o = ty(i, "setOptions", t => {
                    let e = t.userOptions;
                    tA(e.allowDrillToNode) && !tA(e.allowTraversingTree) && (e.allowTraversingTree = e.allowDrillToNode, delete e.allowDrillToNode), tA(e.drillUpButton) && !tA(e.traverseUpButton) && (e.traverseUpButton = e.drillUpButton, delete e.drillUpButton);
                    let i = tH(e.dataLabels || {});
                    e.levels?.forEach(t => {
                        i.push.apply(i, tH(t.dataLabels || {}))
                    }), this.hasOutsideDataLabels = i.some(t => t.headers)
                });
            super.init(t, e), delete i.opacity, i.eventsToUnbind.push(o), i.options.allowTraversingTree && (i.eventsToUnbind.push(ty(i, "click", i.onClickDrillToNode)), i.eventsToUnbind.push(ty(i, "setRootNode", function(t) {
                let e = i.chart;
            ...
            }))), t.breadcrumbs || (t.breadcrumbs = new N(t, s)), i.eventsToUnbind.push(ty(t.breadcrumbs, "up", function(t) {
        ...
        onClickDrillToNode(t) {
            let e = t.point,
                i = e?.drillId;
            tI(i) && (e.setState(""), this.setRootNode(i, !0, {
                trigger: "click"
            }))
        }
        pointAttribs(t, e) {
            ...
            return -1 !== a.indexOf("highcharts-above-level") ? (l.fill = "none", l["stroke-width"] = 0) : -1 !== a.indexOf("highcharts-internal-node-interactive") ? (l["fill-opacity"] = r.opacity ?? o.opacity ?? 1, l.cursor = "pointer") : -1 !== a.indexOf("highcharts-internal-node") ? l.fill = "none" : e && r.brightness && (l.fill = tu(l.fill).brighten(r.brightness).get()), l
        }
        setColorRecursive(t, e, i, s, o) {
            ...
            if (t) {
                let r = tb(t, {
                    ...
                    l = this.points[t.i];
                l && (l.color = r.color, l.colorIndex = r.colorIndex);
                let n = -1;
            ...
            for (let t of e) {
                ...
                if (e && o) {
                    let {
                        ...
                        x: l,
                        y: n
                    } = e, h = r(t), d = i.toPixels(l, !0), p = i.toPixels(l + a, !0), u = s.toPixels(n, !0), c = s.toPixels(n + o, !0), g = 0 === d ? h / 2 : tw(i.toPixels(l, !0), h, !0), v = p === i.len ? i.len - h / 2 : tw(i.toPixels(l + a, !0), h, !0), f = u === s.len ? s.len - h / 2 : tw(s.toPixels(n, !0), h, !0), b = 0 === c ? h / 2 : tw(s.toPixels(n + o, !0), h, !0), m = {
                        x: Math.min(g, v),
                        y: Math.min(f, b),
                        width: Math.abs(v - g),
                        height: Math.abs(b - f)
                    };
                    t.plotX = m.x + m.width / 2, t.plotY = m.y + m.height / 2, t.shapeArgs = m
        ...
        setTreeValues(t) {
            let e = this.options,
                ...
                a = this.points[t.i],
                l = 0;
            for (let e of t.children) e = this.setTreeValues(e), r.push(e), e.ignore || (l += e.val);
            tG(r, (t, e) => (t.sortIndex || 0) - (e.sortIndex || 0));
            let n = tD(a?.simulatedValue, a?.options.value, l);
            return a && (a.value = n), a?.isGroup && e.cluster?.reductionFactor && (n /= e.cluster.reductionFactor), t.parentNode?.point?.isGroup && this.rootNode !== t.parent && (t.visible = !1), tS(t, {
                children: r,
                childrenTotal: l,
        ...
        translate(t) {
            ...
            t || o.startsWith("highcharts-grouped-treemap-points-") || ((this.points || []).forEach(t => {
                t.isGroup && t.destroy()
            }), super.translate(), t = e.getTree()), e.tree = t = t || e.tree, r = e.nodeMap[o], "" === o || r || (e.setRootNode("", !1), o = e.rootNode, r = e.nodeMap[o]), r.point?.isGroup || (e.mapOptionsToLevel = tm({
                from: r.level + 1,
                levels: i.levels,
                to: t.height,
                defaults: {
                ...
                return e
            }), e.setTreeValues(t), e.axisRatio = e.xAxis.len / e.yAxis.len, e.nodeMap[""].pointValues = a = {
                x: 0,
                y: 0,
                width: 100,
                height: 100
    ...
    tz.defaultOptions = tN(tf.defaultOptions, ti), tS(tz.prototype, {
        buildKDTree: tg,
        ...
        utils: ts
    }), F.compose(tz), G().registerSeriesType("treemap", tz);
    let {
        deg2rad: tW
    } = g(), {
        fireEvent: tU,
    ...
    ! function(t) {
        t.getCenter = function() {
            ...
            for (!e.angular || this instanceof Y() || (c[3] = 0), p = 0; p < 4; ++p) u = c[p], n = p < 2 || 2 === p && /%$/.test(u), c[p] = tY(u, [s, o, a, c[2]][p]) + (n ? i : 0);
            return c[3] > c[2] && (c[3] = c[2]), tF(l) && 2 * l < c[2] && l > 0 && (c[3] = c[2] - 2 * l), tU(this, "afterGetCenter", {
                positions: c
            }), c
    ...
    class tJ extends t$ {
        getDataLabelPath(t) {
            let e = this.series.chart.renderer,
                ...
                s = i.r + tZ(t.options?.distance || 0),
                o = i.start,
                r = i.end,
                a = o + (r - o) / 2,
                l = a < 0 && a > -Math.PI || a > Math.PI,
                n;
            return o === -Math.PI / 2 && tK(r) === tK(1.5 * Math.PI) && (o = -Math.PI + Math.PI / 360, r = -Math.PI / 360, l = !0), r - o > Math.PI && (l = !1, n = !0, r - o > 2 * Math.PI - .01 && (o += .01, r -= .01)), this.dataLabelPath && (this.dataLabelPath = this.dataLabelPath.destroy()), this.dataLabelPath = e.arc({
                open: !0,
                longArc: +!!n
            }).attr({
                start: l ? o : r,
    ...
    let t5 = {
            calculateLevelSizes: function(t, e) {
                let i = t1(e) ? e : {},
                    ...
                    r, a, l, n;
                if (t1(t)) {
                    for (let e of (s = t2({}, t), a = t6(t0(i.from) ? i.from : 0, t0(i.to) ? i.to : 0), l = Object.keys(s).filter(t => -1 === a.indexOf(+t)), r = n = t0(i.diffRadius) ? i.diffRadius : 0, a)) {
                        let t = s[e],
                            i = t.levelSize.unit,
                            a = t.levelSize.value;
        ...
        if (t = t || o && o.path, o && o.undo(), t && a) {
            let e = t3(s, "afterModifyTree", e => {
                if (t && a) {
                    ...
                    t7(r.dx) && (a.dx = r.dx, delete r.dx), t7(r.dy) && (a.dy = r.dy, delete r.dy), s.attr(a), this.attr({
                        transform: ""
        ...
        if (i) {
            let t = [],
                ...
                h = (t, e) => {
                    let {
                        x: o,
                        y: a
                    } = e, l = (i.getRotationOfChar(t) - 90) * t9, n = Math.cos(l), h = Math.sin(l);
                    return [
                        [o - r * n, a - r * h],
                        [o + s * n, a + s * h]
                    ]
            ...
            for (let e = 0, s = 0; s < n; s++) {
                ...
                for (let r = 0; r < o; r += 5) try {
                    ...
                    0 === r ? (t.push(l), t.push(a)) : (0 === s && t.unshift(l), s === n - 1 && t.push(a))
                } catch {
                    break
                }
                e += o - 1;
    ...
    ({
        compose: function(t) {
            t3(t, "afterGetBBox", ei), t3(t, "beforeAddingDataLabel", es);
            let e = t.prototype;
    ...
    function ew(t, e) {
        ...
        return t.color = n.color, t.colorIndex = n.colorIndex, l && (l.color = t.color, l.colorIndex = t.colorIndex, t.sliced = t.id !== e.idRoot && l.sliced), t
    }
    class eA extends en {
        alignDataLabel(t, e, i) {
            if (!i.textPath || !i.textPath.enabled) return e.placed = !1, super.alignDataLabel.apply(this, arguments)
        }
        animate(t) {
            let e, i = this.chart,
        ...
        drawPoints() {
            let t = this,
                ...
                b = v[3] / 2,
                m = t.chart.renderer,
                x = !!(g && o && r !== a && t.dataLabelsGroup),
                y, L = !1,
                P = !1;
            for (let n of (x && (t.dataLabelsGroup.attr({
                    opacity: 0
                }), y = function() {
                    L = !0, t.dataLabelsGroup && t.dataLabelsGroup.animate({
                        opacity: 1,
                        visibility: "inherit"
                    })
                }), d)) {
                ...
                T.borderRadius = t.options.borderRadius, d = o && g ? function(t, e) {
                    let i = e.point,
                        s = e.radians,
                        o = e.innerR,
                        r = e.idRoot,
                    ...
                    let e = t.point,
                        i = em(t.shapeArgs) ? t.shapeArgs : {},
                        {
                            end: s = 0,
                            radius: o = 0,
                            start: r = 0
                        } = i,
                        a = em(t.optionsPoint) ? t.optionsPoint.dataLabels : {},
                        l = ey(eL(em(t.level) ? t.level.dataLabels : {})[0], a),
                        n = l.style = l.style || {},
                        {
                            innerArcLength: h = 0,
                            outerArcLength: d = 0
                        } = e,
                        p, u, c = l.rotationMode,
                        g = ec(n.width) ? parseInt(n.width || "0", 10) : void 0;
                    return eb(l.rotation) || (("auto" === c || "circular" === c) && (l.useHTML && "circular" === c && (c = "auto"), h < 1 && d > o ? (p = 0, e.dataLabelPath && "circular" === c && (l.textPath = {
                        enabled: !0
                        ...
                        enabled: !1
                    }), c = "perpendicular")), "auto" !== c && "circular" !== c && (e.dataLabel?.textPath && (l.textPath = {
                        enabled: !1
                    }), p = s - (s - r) / 2), "parallel" === c ? g = Math.min(2.5 * o, (d + h) / 2) : !ec(g) && o && (g = 1 === e.node.level ? 2 * o : o), "perpendicular" === c && (d < 16 ? g = 1 : i.radius && (n.lineClamp = Math.floor(h / 16) || 1, g = o - (h < 16 ? (16 - h) / (d - h) * o : 0))), g = Math.max((g || 0) - 2 * (l.padding || 0), 1), u = (p || 0) * eP % 180, "parallel" === c && (u -= 90), u > 90 ? u -= 180 : u < -90 && (u += 180), l.rotation = u), l.textPath && (0 === e.shapeExisting.innerR && l.textPath.enabled ? (l.rotation = 0, l.textPath.enabled = !1, g = Math.max(2 * e.shapeExisting.r - 2 * (l.padding || 0), 1)) : e.dlOptions?.textPath && !e.dlOptions.textPath.enabled && "circular" === c && (l.textPath.enabled = !0), l.textPath.enabled && (l.rotation = 0, g = Math.max((d + h) / 2 - 2 * (l.padding || 0), 1), n.whiteSpace = "nowrap")), n.width = g + "px", l
                }({
                    point: n,
                    level: x,
            ...
            x && P ? (t.hasRendered = !1, t.options.dataLabels.defer = !0, el.prototype.drawDataLabels.call(t), t.hasRendered = !0, L && y()) : el.prototype.drawDataLabels.call(t), t.idPreviousRoot = r
        }
        ...
        setShapeArgs(t, e, i) {
            ...
            for (let t of o) {
                ...
                this.points[t.i] && (this.points[t.i].innerArcLength = l * e.innerR, this.points[t.i].outerArcLength = l * e.r), t.shapeArgs = ey(e, {
                    plotX: n.x,
                    plotY: n.y
                }), t.values = ey(e, {
                    val: h
        ...
        translate() {
            let t = this.options,
                ...
                i = this.startAndEndRadians = er(t.startAngle, t.endAngle),
                s = e[3] / 2,
                o = e[2] / 2,
                r = eu(this),
                a = this.nodeMap,
                l, n = a && a[r],
                h = {};
            this.shapeRoot = n && n.shapeArgs, this.generatePoints(), ef(this, "afterTranslate");
            ...
            for (let t of (this.setShapeArgs(u, v, l), this.mapOptionsToLevel = l, this.points)) h[t.id] && eg(31, !1, this.chart), h[t.id] = !0
        }
    }
