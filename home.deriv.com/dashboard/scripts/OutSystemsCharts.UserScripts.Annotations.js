...
function(t, i) {
    ...
    c.n = t => {
        ...
        for (var e in i) c.o(i, e) && !c.o(t, e) && Object.defineProperty(t, e, {
            enumerable: !0,
            get: i[e]
        })
    ...
    function k(t, i) {
        ...
        return this.options.annotations.push(e.options), b(i, !0) && (e.redraw(), e.graphic.attr({
            opacity: 1
        })), e
    }
    ...
    function w() {
        ...
        t.plotBoxClip = this.renderer.clipRect(this.plotBox), t.controlPointsGroup = t.renderer.g("control-points").attr({
            zIndex: 99
        }).clip(t.plotBoxClip).add(), t.options.annotations.forEach((i, e) => {
    ...
    function E(t) {
        let i = this.annotations,
            e = "annotations" === t.coll ? t : f(i, function(i) {
                return i.options.id === t
            });
        e && (y(e, "remove"), m(this.options.annotations, e.options), m(i, e), e.destroy())
    }

    function P() {
        let t = this.options.annotations,
            i = this.userOptions.annotations;
        this.annotations = [], v(this.options.annotations) || (this.options.annotations = []), x(i, !0) && x(t, !0) && this.options.annotations.push(t)
    }
    ...
    function O(t) {
        ...
        if (!s.addAnnotation) {
            let o = e.prototype;
            g(i, "afterInit", P), s.addAnnotation = k, s.callbacks.push(w), s.collectionsWithInit.annotations = [k], s.collectionsWithUpdate.push("annotations"), s.drawAnnotations = C, s.removeAnnotation = E, s.initAnnotation = function(i) {
                let e = new(t.types[i.type] || t)(this, i);
                return this.annotations.push(e), e
            }, A(o, "onContainerMouseDown", O)
        }
    };
    let B = o,
        {
        ...
        N = {
            ...
            labelOptions: {
                ...
                crop: !1,
                formatter: function() {
                    return M(this.y) ? "" + this.y : "Annotation label"
                },
        ...
        R = class {
            addEvents() {
                ...
                if (i(this.graphic.element), (t.labels || []).forEach(t => {
                        t.options.useHTML && t.graphic.text && !t.graphic.text.foreignObject && i(t.graphic.text.element)
                    }), S(t.options.events, (i, e) => {
                        let s = function(s) {
                            "click" === e && t.cancelClick || i.call(t, t.chart.pointer?.normalize(s), t.target)
                        }; - 1 === (t.nonDOMEvents || []).indexOf(e) ? (D(t.graphic.element, e, s, {
                            passive: !1
                        }), t.graphic.div && D(t.graphic.div, e, s, {
                            passive: !1
                        })) : D(t, e, s, {
                            passive: !1
                        })
                    }), t.options.draggable && (D(t, "drag", t.onDrag), !t.graphic.renderer.styledMode)) {
                    let i = {
                        cursor: {
                            x: "ew-resize",
                            y: "ns-resize",
                    ...
                    t.graphic.css(i), (t.labels || []).forEach(t => {
                        t.options.useHTML && t.graphic.text && !t.graphic.text.foreignObject && t.graphic.text.css(i)
                    })
                }
                t.isUpdating || L(t, "add")
            }
            destroy() {
                this.removeDocEvents(), X(this), this.hcEvents = null
            }
            ...
            mouseMoveToTranslation(t) {
                let i = t.chartX - t.prevChartX,
                    ...
                    s;
                return this.chart.inverted && (s = e, e = i, i = s), {
                    x: i,
                    y: e
                }
            }
            ...
            onMouseDown(t) {
                ...
                let i = this,
                    ...
                    n = t.chartY;
                i.cancelClick = !1, i.chart.hasDraggedAnnotation = !0, i.removeDrag = D(T, I || s ? "touchmove" : "mousemove", function(t) {
                    i.hasDragged = !0, (t = e?.normalize(t) || t).prevChartX = o, t.prevChartY = n, L(i, "drag", t), o = t.chartX, n = t.chartY
                }, I || s ? {
                    passive: !1
                } : void 0), i.removeMouseUp = D(T, I || s ? "touchend" : "mouseup", function() {
                    let t = Y(i.target && i.target.annotation, i.target);
                    t && (t.cancelClick = i.hasDragged), i.cancelClick = i.hasDragged, i.chart.hasDraggedAnnotation = !1, i.hasDragged && L(Y(t, i), "afterUpdate"), i.hasDragged = !1, i.onMouseUp()
                }, I || s ? {
                    passive: !1
                } : void 0)
            }
        ...
        W = class extends R {
            constructor(t, i, e, s) {
                super(), this.nonDOMEvents = ["drag"], this.chart = t, this.target = i, this.options = e, this.index = F(e.index, s)
            }
            destroy() {
    ...
    class _ {
        static fromPoint(t) {
            return new _(t.series.chart, null, {
                x: t.x,
                y: t.y,
        ...
        getOptions() {
            return this.hasDynamicOptions() && "function" == typeof this.options ? this.options(this.target) : this.options
        }
        hasDynamicOptions() {
        ...
        isInsidePlot() {
            ...
            return e && (o.isInsidePlot = q(t) && t >= 0 && t <= e.len), s && (o.isInsidePlot = o.isInsidePlot && q(i) && i >= 0 && i <= s.len), z(this.series.chart, "afterIsInsidePlot", o), o.isInsidePlot
        }
        refresh() {
            let t = this.series,
                i = t.xAxis,
        ...
        setAxis(t, i) {
            let e = i + "Axis",
                s = t[e],
                o = this.series.chart;
            this.series[e] = "object" == typeof s ? s : q(s) ? o[e][s] || o.get(s) : null
        }
        toAnchor() {
        ...
        function i() {
            ...
            i.forEach((e, s) => {
                ...
                o.index || (o.index = s), i[s] = o, t.push(new W(this.chart, this, o))
            })
        }
        ...
        function e(t) {
            let i = t.series.getPlotBox(),
                e = t.series.chart,
                s = t.mock ? t.toAnchor() : e.tooltip && e.tooltip.getAnchor.call({
        ...
        function n() {
            let t, i, e = this.getPointsOptions(),
                s = this.points,
                o = e && e.length || 0;
            for (t = 0; t < o; t++) {
        ...
        function a(t, i) {
            ...
            if (!i || null === i.series) {
                if (u().isObject(t)) i = new _(this.chart, this, t);
                else if (u().isString(t)) i = this.chart.get(t) || null;
                else if ("function" == typeof t) {
                    let e = t.call(i, this);
                    i = e.series ? e : new _(this.chart, this, t)
                }
            }
            return i
        }
        ...
        function c(t, i, e, s, o, n) {
            let a = this.points[n];
            a.mock || (a = this.points[n] = _.fromPoint(a)), a[t](i, e, s, o)
        }
    ...
    class $ {
        ...
        attrsFromOptions(t) {
            let i, e, s = this.constructor.attrsMap,
                o = {},
        ...
        update(t) {
            let i = this.annotation,
                e = K(!0, this.options, t),
                s = this.graphic.parentGroup,
                o = this.constructor;
            this.destroy(), K(!0, this, new o(i, e, this.index, this.itemType)), this.render(s), this.redraw()
        }
    }
    G.compose($);
    let Z = $,
        ...
        to = tr("marker-end"),
        tn = tr("marker-start"),
        ta = "rgba(192,192,192," + (u().svg ? 1e-4 : .002) + ")";
    ...
    function th() {
        this.options.defs = te(J, this.options.defs || {})
    }
    ...
    class tc extends Z {
        static compose(t, i) {
            let e = i.prototype;
            e.addMarker || (Q(t, "afterGetContainer", th), e.addMarker = tl)
        }
        constructor(t, i, e) {
        ...
        toD() {
            ...
            let i = this.points,
                ...
                h;
            if (a)
                for (s.push(["M", a.x, a.y]); ++r < e && o;) h = (n = i[r]).command || "L", a = this.anchor(n).absolutePosition, "M" === h || "L" === h ? s.push([h, a.x, a.y]) : "Z" === h && s.push([h]), o = n.series.visible;
        ...
        render(t) {
            ...
            this.graphic = this.annotation.chart.renderer.path([
                ["M", 0, 0]
            ]).attr(e).add(t), this.tracker = this.annotation.chart.renderer.path([
                ["M", 0, 0]
            ...
            }), super.render(), ti(this.graphic, {
                markerStartSetter: tn,
                markerEndSetter: to
        ...
        setMarkers(t) {
            let i = t.options,
                ...
                s = e.options.defs,
                o = i.fill,
                n = tt(o) && "none" !== o ? o : i.stroke;
            ["markerStart", "markerEnd"].forEach(function(o) {
                let a, r, h, l, c = i[o];
                if (c) {
                    for (h in s)
                        if ((c === ((a = s[h]).attributes && a.attributes.id) || c === a.id) && "marker" === a.tagName) {
                            r = a;
                            break
                        } r && (l = t[o] = e.renderer.addMarker((i.id || ts()) + "-" + c, te(r, {
                        color: n
    ...
    class ty extends Z {
        ...
        init(t, i, e) {
            tf(i.yAxis) && i.points.forEach(t => {
                t.yAxis = i.yAxis
            }), tf(i.xAxis) && i.points.forEach(t => {
                t.xAxis = i.xAxis
            }), super.init(t, i, e)
        }
        render(t) {
        ...
        getRY() {
            let t = this.getYAxis();
            return tf(t) ? Math.abs(t.toPixels(this.options.ry) - t.toPixels(0)) : this.options.ry
        }
        getYAxis() {
    ...
    function tE(t, i, e, s, o) {
        let n = o && o.anchorX,
            a = o && o.anchorY,
            r, h, l = e / 2;
        return tw(n) && tw(a) && (r = [
            ["M", n, a]
        ], (h = i - a) < 0 && (h = -s - h), h < e && (l = n < t + e / 2 ? h : e - h), a > i + s ? r.push(["L", t + l, i + s]) : a < i ? r.push(["L", t + l, i]) : n < t ? r.push(["L", t, i + s / 2]) : n > t + e && r.push(["L", t + e, i + s / 2])), r || []
    }
    class tP extends Z {
        static alignedPosition(t, i) {
            return {
                x: Math.round((i.x || 0) + (t.x || 0) + (i.width - (t.width || 0)) * tk(t.align)),
                y: Math.round((i.y || 0) + (t.y || 0) + (i.height - (t.height || 0)) * tk(t.verticalAlign))
            }
        }
        static compose(t) {
        ...
        render(t) {
            let i = this.options,
                e = this.attrsFromOptions(i),
                s = i.style,
                o = this.annotation.chart.options.chart,
                n = o.plotBackgroundColor || o.backgroundColor;
            if (this.graphic = this.annotation.chart.renderer.label("", 0, -9999, i.shape, void 0, void 0, i.useHTML, void 0, "annotation-label").attr(e).add(t), !this.annotation.chart.styledMode) {
                if ("contrast" === s.color) {
                    let t = tP.shapesWithoutBackground.indexOf(i.shape) > -1 || "none" === i.backgroundColor ? n : i.backgroundColor;
                    s.color = this.annotation.chart.renderer.getContrast("string" == typeof t ? t : "string" == typeof n ? n : "#ffffff")
                }
        ...
        redraw(t) {
            ...
            s.attr({
                text: e ? tb(String(e), o, this.annotation.chart) : i.formatter.call(o, this)
            });
            let n = this.anchor(o),
                a = this.position(n);
        ...
        position(t) {
            let i = this.graphic,
                ...
                h, l, c, p, d = o.series.visible && _.prototype.isInsidePlot.call(o);
            if (i && d) {
                let {
                    width: t = 0,
                    height: u = 0
                ...
                n.distance && s ? h = s.getPosition.call({
                    ...
                    width: 0,
                    height: 0
                }, h = tP.alignedPosition(tA(n, {
                    width: t,
                    height: u
                }), l), "justify" === this.options.overflow && (h = tP.alignedPosition(tP.justifiedOptions(e, i, n, h), l))), n.crop && (c = h.x - e.plotLeft, p = h.y - e.plotTop, d = e.isInsidePlot(c, p) && e.isInsidePlot(c + t, p + u))
            }
            return d ? h : null
        }
    }
    tP.attrsMap = {
        ...
        borderRadius: "r",
        padding: "padding"
    }, tP.shapesWithoutBackground = ["connector"];
    class tO extends Z {
        constructor(t, i, e) {
        ...
        redraw(t) {
            if (this.graphic) {
                let i = this.anchor(this.points[0]),
                    e = tP.prototype.position.call(this, i);
    ...
    let {
        ...
        addCloseButton(t = "highcharts-popup-close") {
            ...
            return tT("span", {
                ...
                backgroundImage: "url(" + (e.match(/png|svg|jpeg|jpg|gif/ig) ? e : e + "close.svg") + ")"
            }, s), ["click", "touchstart"].forEach(t => {
                tN(s, t, i.closeButtonEvents.bind(i))
            }), tN(document, "keydown", function(t) {
        ...
        showPopup(t = "highcharts-annotation-toolbar") {
            let i = this.container,
                e = this.closeButton;
            this.type = void 0, i.innerHTML = tM().emptyHTML, i.className.indexOf(t) >= 0 && (i.classList.remove(t), i.removeAttribute("style")), i.appendChild(e), i.style.display = "block", i.style.height = ""
        }
        closePopup() {
    ...
    function tW(t, i, e, s, o, n) {
        let a, r;
        if (!i) return;
        let h = this.addInput,
            l = this.lang;
        tR(s, (s, n) => {
            a = "" !== e ? e + "." + n : n, tX(s) && (!tY(s) || tY(s) && tX(s[0]) ? ((r = l[n] || n).match(/\d/g) || o.push([!0, r, t]), tW.call(this, t, i, a, s, o, !1)) : o.push([this, a, "annotation", t, s]))
        }), n && (tF(o, t => t[1].match(/format/g) ? -1 : 1), tL && o.reverse(), o.forEach(t => {
            !0 === t[0] ? tS("span", {
                className: "highcharts-annotation-title"
            }, void 0, t[2]).appendChild(tD.createTextNode(t[1])) : (t[4] = {
                value: t[4][0],
                type: t[4][1]
    ...
    function tQ(t, i, e, s) {
        ...
        s.innerHTML = tM().emptyHTML, tq("h3", {
            className: "highcharts-indicator-title"
        }, void 0, s).appendChild(tH.createTextNode(t7(i, e).indicatorFullName)), tq("input", {
            type: "hidden",
            name: "highcharts-type-" + e,
            value: e
        }, void 0, s), t3.call(this, e, "series", t, s, i, i.linkedParent && i.linkedParent.options.id), o.volumeSeriesID && t3.call(this, e, "volume", t, s, i, i.linkedParent && o.volumeSeriesID), t1.call(this, t, "params", o, e, s)
    }

    function t0(t, i, e, s) {
        function o(i, e) {
            let s = g.parentNode.children[1];
            tQ.call(n, t, i, e, g), s && (s.style.display = "block"), l && i.options && tq("input", {
                type: "hidden",
        ...
        if (!t && c) return;
        let p, d = [];
        l || t_(c) ? t_(c) && (d = t6.call(this, c)) : d = t5.call(this, c, s), t$(d, (t, i) => {
        ...
        if (d.forEach(t => {
            ...
            o(t, i)
        } else l || (tM().setElementHTML(g.parentNode.children[0], a.noFilterMatch || ""), g.parentNode.children[1].style.display = "none")
    }

    function t1(t, i, e, s, o) {
        if (!t) return;
        let n = this.addInput;
        tK(e, (e, r) => {
            let h = i + "." + r;
            if (tz(e) && h)
                if (tG(e) && (n.call(this, h, s, o, {}), t1.call(this, t, h, e, s, o)), h in a) {
                    let n = t2.call(this, s, h, o);
                    t4.call(this, t, i, n, s, r, e)
                } else "params.volumeSeriesID" === h || t_(e) || n.call(this, h, s, o, {
                    value: e,
                    type: "number"
                })
        })
    ...
    function t9(t, i) {
        ...
        r.classList.add("highcharts-input-search-indicators"), h.classList.add("clear-filter-button"), tV(r, "input", function() {
    ...
    function t2(t, i, e) {
        ...
        tq("label", {
            htmlFor: n
        }, null, e).appendChild(tH.createTextNode(a[o] || i));
        let r = tq("select", {
            name: n,
    ...
    function t4(t, i, e, s, o, n, a) {
        "series" === i || "volume" === i ? t.series.forEach(t => {
            let s = t.options,
                o = s.name || s.params ? t.name : s.id || "";
            "highcharts-navigator-series" !== s.id && s.id !== (a && a.options && a.options.id) && (tz(n) || "volume" !== i || "column" !== t.type || (n = s.id), tq("option", {
                value: s.id
            }, void 0, e).appendChild(tH.createTextNode(o)))
        }) : s && o && tZ[o + "-" + s].forEach(t => {
            tq("option", {
                value: t
            }, void 0, e).appendChild(tH.createTextNode(t))
        }), tz(n) && (e.value = n)
    }

    function t5(t, i) {
        let e, s = this.chart && this.chart.options.lang,
            o = s && s.navigation && s.navigation.popup && s.navigation.popup.indicatorAliases,
            n = [];
        return tK(t, (t, s) => {
            let a = t && t.options;
    ...
    function t7(t, i) {
        let e = t.options,
            s = tj[i] && tj[i].prototype.nameBase || i.toUpperCase(),
            o = i;
        return e && e.type && (o = t.options.type, s = t.name), {
            indicatorFullName: s,
            indicatorType: o
        }
    }

    function t3(t, i, e, s, o, n) {
        if (!e) return;
        let a = t2.call(this, t, i, s);
        t4.call(this, e, i, a, void 0, void 0, void 0, o), tz(n) && (a.value = n)
    }
    let {
        doc: t8
    } = u(), {
    ...
    function is(t, i) {
        ...
        return n.appendChild(t8.createTextNode(s[t + "Button"] || t)), n.setAttribute("highcharts-data-tab-type", t), n
    }
    ...
    class im extends tI {
        constructor(t, i, e) {
            super(t, i), this.chart = e, this.lang = (il().lang.navigation || {}).popup || {}, ic(this.container, "mousedown", () => {
        ...
        addInput(t, i, e, s) {
            let o = t.split("."),
                n = o[o.length - 1],
                a = this.lang,
                r = "highcharts-" + i + "-" + ig(s.htmlFor, n);
            n.match(/^\d+$/) || ip("label", {
                htmlFor: r,
                className: s.labelClassName
            }, void 0, e).appendChild(ih.createTextNode(a[n] || n));
            let h = ip("input", {
                name: r,
                value: s.value,
                type: s.type,
        ...
        closeButtonEvents() {
            if (this.chart) {
                ...
                iu(t, "closePopup"), t && t.selectedButtonElement && iu(t, "deselectButton", {
                    button: t.selectedButtonElement
                })
            } else super.closeButtonEvents()
        }
        addButton(t, i, e, s, o) {
            let n = ip("button", void 0, void 0, t);
            return n.appendChild(ih.createTextNode(i)), o && ["click", "touchstart"].forEach(t => {
                ic(n, t, () => (this.closePopup(), o(function(t, i) {
    ...
    id(im.prototype, {
        annotations: {
            addForm: function(t, i, e, s) {
                ...
                a.appendChild(tD.createTextNode(n[i.langKey] || i.langKey || "")), a = tS("div", {
                    className: "highcharts-popup-lhs-col highcharts-popup-lhs-full"
                }, void 0, o);
                let r = tS("div", {
                    className: "highcharts-popup-bottom-row"
                }, void 0, o);
                tW.call(this, a, t, "", i, [], !0), this.addButton(r, s ? n.addButton || "Add" : n.saveButton || "Save", s ? "add" : "save", o, e)
            },
            addToolbar: function(t, i, e) {
                let s = this.lang,
                    o = this.container,
                    n = this.showForm,
                    a = "highcharts-annotation-toolbar"; - 1 === o.className.indexOf(a) && (o.className += " " + a + " highcharts-no-mousewheel"), t && (o.style.top = t.plotTop + 10 + "px");
                let r = tS("p", {
                    className: "highcharts-annotation-label"
                }, void 0, o);
                r.setAttribute("aria-label", "Annotation type"), r.appendChild(tD.createTextNode(tU(s[i.langKey] || i.langKey, i.shapes && i.shapes[0].type, "")));
                let h = this.addButton(o, s.editButton || "Edit", "edit", o, () => {
                    n.call(this, "annotation-edit", t, i, e)
                });
                h.className += " highcharts-annotation-edit-button", tS("span", {
                    className: "highcharts-icon"
                }, {
                    backgroundImage: `url(${this.iconsURL}edit.svg)`
                }, h), h = this.addButton(o, s.removeButton || "Remove", "remove", o, e), h.className += " highcharts-annotation-remove-button", tS("span", {
                    className: "highcharts-icon"
                }, {
        ...
        indicators: {
            addForm: function(t, i, e) {
                ...
                tJ(n[0]), t9.call(this, t, n[0]), t0.call(this, t, n[0], "add"), s = n[0].querySelectorAll(".highcharts-popup-rhs-col")[0], this.addButton(s, o.addButton || "add", "add", s, e), tJ(n[1]), t0.call(this, t, n[1], "edit"), s = n[1].querySelectorAll(".highcharts-popup-rhs-col")[0], this.addButton(s, o.saveButton || "save", "edit", s, e), this.addButton(s, o.removeButton || "remove", "remove", s, e)
            },
            getAmount: function() {
                let t = 0;
        ...
        tabs: {
            init: function(t) {
                ...
                let i = this.indicators.getAmount.call(t),
                    e = is.call(this, "add");
                is.call(this, "edit", i), ie.call(this), ie.call(this), ir.call(this, i), ia.call(this, e, 0)
            }
        }
    });
    let {
    ...
    function ik(t) {
        this.popup || (this.popup = new im(this.chart.container, this.chart.options.navigation.iconsURL || this.chart.options.stockTools && this.chart.options.stockTools.gui.iconsURL || "https://code.highcharts.com/12.4.0/gfx/stock-icons/", this.chart)), this.popup.showForm(t.formType, this.chart, t.options, t.onSubmit)
    }
    ...
    let iC = {
            compose: function(t, i) {
                ix(iy, "Popup") && (iv(t, "closePopup", iA), iv(t, "showPopup", ik), ib(i.prototype, "onContainerMouseDown", iw))
            }
        },
        {
            getDeferredAnimation: iE
        } = u(),
        {
            defaultOptions: iP
        } = u(),
    ...
    function iD(t, i) {
        ...
        return ["labels", "shapes"].forEach(s => {
            let o = t[s],
                n = i[s];
            o && (n ? e[s] = iI(n).map((t, i) => iN(o[i], t)) : e[s] = t[s])
        }), e
    }
    class iL extends R {
        static compose(t, i, e, s) {
            B.compose(iL, t, e), tP.compose(s), tc.compose(t, s), i.compose(iL, t), iC.compose(i, e)
        }
        constructor(t, i) {
        ...
        destroy() {
            ...
            this.labels.forEach(i), this.shapes.forEach(i), this.clipXAxis = null, this.clipYAxis = null, iB(t.labelCollectors, this.labelCollector), super.destroy(), this.destroyControlTarget(), iO(this, t)
        }
        destroyItem(t) {
            iB(this[t.itemType + "s"], t), t.destroy()
        }
        getClipBox() {
        ...
        init(t, i, e = this.index) {
            ...
            this.index = e, this.linkPoints(), this.addControlPoints(), this.addShapes(), this.addLabels(), this.setLabelCollector(), this.animationConfig = iE(s, o)
        }
        initLabel(t, i) {
            let e = new tP(this, iN(this.options.labelOptions, {
                controlPointOptions: this.options.controlPointOptions
            }, t), i);
            return e.itemType = "label", this.labels.push(e), e
        }
        initShape(t, i) {
            let e = iN(this.options.shapeOptions, {
                    controlPointOptions: this.options.controlPointOptions
                }, t),
                s = new iL.shapesMap[e.type](this, e, i);
        ...
        redrawItem(t, i) {
            t.linkPoints(), t.shouldBeDrawn() ? (t.graphic || this.renderItem(t), t.redraw(iT(i, !0) && t.graphic.placed), t.points.length && function(t) {
                let i = t.graphic,
                    e = t.points.some(t => !1 !== t.series.visible && !1 !== t.visible);
        ...
        setOptions(t) {
            this.options = iN(this.defaultOptions, t.type && this.defaultOptions.types[t.type] || {}, t)
        }
        setVisibility(t) {
            let i = this.options,
            ...
            if (this.graphic.attr("visibility", s ? "inherit" : "hidden"), !s) {
                ...
                this.shapes.forEach(t), this.labels.forEach(t), e.activeAnnotation === this && e.popup && "annotation-toolbar" === e.popup.type && iM(e, "closePopup")
            }
            i.visible = s
        }
        update(t, i) {
            let e = this.chart,
                s = iD(this.userOptions, t),
                o = e.annotations.indexOf(this),
                n = iN(!0, this.userOptions, t);
            n.labels = s.labels, n.shapes = s.shapes, this.destroy(), this.initProperties(e, n), this.init(e, n), e.options.annotations[o] = this.options, this.isUpdating = !0, iT(i, !0) && e.drawAnnotations(), iM(this, "afterUpdate"), this.isUpdating = !1
        }
    }
    iL.ControlPoint = W, iL.MockPoint = _, iL.shapesMap = {
        rect: td,
        circle: tg,
        ellipse: ty,
        path: tc,
        image: tO
    }, iL.types = {}, iL.prototype.defaultOptions = N, iP.annotations = N, iL.prototype.nonDOMEvents = ["add", "afterUpdate", "drag", "remove"], G.compose(iL), ! function(t) {
        t.compose = function(t) {
    ...
    let iS = r,
        ...
        iF = {
            annotationsFieldsTypes: iU,
            getAssignedAxis: function(t) {
                return t.filter(t => {
                    let i = t.axis.getExtremes(),
                        e = i.min,
                        s = i.max,
                        o = iR(t.axis.minPointOffset, 0);
                    return iX(e) && iX(s) && t.value >= e - o && t.value <= s + o && !t.axis.options.isInternal
                })[0]
            },
                ...
                bindings: {
                    circleAnnotation: {
                        ...
                        start: function(t) {
                            ...
                            if (e && s) return this.chart.addAnnotation(ij({
                                langKey: "circle",
                        ...
                        steps: [function(t, i) {
                            let e, s = i.options.shapes,
                                o = s && s[0] && s[0].point || {};
                            if (iH(o.xAxis) && iH(o.yAxis)) {
                    ...
                    ellipseAnnotation: {
                        ...
                        start: function(t) {
                            ...
                            }, o.annotationsOptions, o.bindings.ellipseAnnotation.annotationsOptions))
                        },
                        steps: [function(t, i) {
                            let e = i.shapes[0],
                    ...
                    rectangleAnnotation: {
                        ...
                        start: function(t) {
                            ...
                            return this.chart.addAnnotation(ij({
                                langKey: "rectangle",
                                type: "basicAnnotation",
                                shapes: [{
                                    type: "path",
                        ...
                        steps: [function(t, i) {
                            ...
                            if (n && a) {
                                let t = n.value,
                                    e = a.value;
                                s[1].x = t, s[2].x = t, s[2].y = e, s[3].y = e, i.update({
                                    shapes: [{
                                        points: s
                                    }]
                                })
    ...
    function ee() {
        let t = this.options;
        t && t.navigation && t.navigation.bindings && (this.navigationBindings = new er(this, t.navigation), this.navigationBindings.initEvents(), this.navigationBindings.initUpdate())
    }
    ...
    function es() {
        ...
        if (this && t) {
            ...
            if (this.series.forEach(t => {
                ...
                i7(t.boundClassNames, (t, o) => {
                    let n = s.querySelectorAll("." + o);
                    if (n)
                        for (let s = 0; s < n.length; s++) {
                            let o = n[s],
                                a = o.className;
                            "normal" === t.noDataState || e ? -1 !== a.indexOf(i) && o.classList.remove(i) : -1 === a.indexOf(i) && (o.className += " " + i)
                        }
                })
            }
        }
    ...
    function ea(t) {
        let i, e, s = t.prototype.defaultOptions.events && t.prototype.defaultOptions.events.click;

        function o(t) {
            let i = this,
                e = i.chart.navigationBindings,
                o = e.activeAnnotation;
            s && s.call(i, t), o !== i ? (e.deselectAnnotation(), e.activeAnnotation = i, i.setControlPointsVisibility(!0), i1(e, "showPopup", {
                annotation: i,
            ...
            })) : i1(e, "closePopup"), t.activeAnnotation = !0
        }
        i6(!0, t.prototype.defaultOptions.events, {
            click: o,
    ...
    class er {
        static compose(t, i) {
            i8(i_, "NavigationBindings") && (iJ(t, "remove", et), ea(t), i7(t.types, t => {
                ea(t)
            }), iJ(i, "destroy", ei), iJ(i, "load", ee), iJ(i, "render", es), iJ(er, "closePopup", eo), iJ(er, "deselectButton", en), iq(iV))
        }
        constructor(t, i) {
            this.boundClassNames = void 0, this.chart = t, this.options = i, this.eventsToUnbind = [], this.container = this.chart.container.getElementsByClassName(this.options.bindingsClassName || ""), this.container.length || (this.container = iG.getElementsByClassName(this.options.bindingsClassName || ""))
        }
        getCoords(t) {
            let i = this.chart.pointer?.getCoordinates(t);
            return [i && i$(i.xAxis), i && i$(i.yAxis)]
        }
        initEvents() {
            let t = this,
                i = t.chart,
                e = t.container,
                s = t.options;
            t.boundClassNames = {}, i7(s.bindings || {}, i => {
                t.boundClassNames[i.className] = i
            }), [].forEach.call(e, i => {
                t.eventsToUnbind.push(iJ(i, "click", e => {
                ...
                i2(i) && t.eventsToUnbind.push(iJ(t, e, i, {
                    passive: !1
                }))
            }), t.eventsToUnbind.push(iJ(i.container, "click", function(e) {
                !i.cancelClick && i.isInsidePlot(e.chartX - i.plotLeft, e.chartY - i.plotTop, {
                    visiblePlotOnly: !0
                }) && t.bindingsChartClick(this, e)
            })), t.eventsToUnbind.push(iJ(i.container, u().isTouchDevice ? "touchmove" : "mousemove", function(i) {
        ...
        initUpdate() {
            let t = this;
            iS.compose(this.chart).navigation.addUpdate(i => {
                t.update(i)
            })
        }
        bindingsButtonClick(t, i, e) {
            let s = this.chart,
                ...
                n = !0;
            this.selectedButtonElement && (this.selectedButtonElement.classList === t.classList && (n = !1), i1(this, "deselectButton", {
                button: this.selectedButtonElement
            }), this.nextEvent && (this.currentUserDetails && "annotations" === this.currentUserDetails.coll && s.removeAnnotation(this.currentUserDetails), this.mouseMoveEvent = this.nextEvent = !1)), n ? (this.selectedButton = i, this.selectedButtonElement = t, i1(this, "selectButton", {
                button: t
            }), i.init && i.init.call(this, t, e), (i.start || i.steps) && s.renderer.boxWrapper.addClass("highcharts-draw-mode")) : (s.stockTools && t.classList.remove("highcharts-active"), o.removeClass("highcharts-draw-mode"), this.nextEvent = !1, this.mouseMoveEvent = !1, this.selectedButton = null)
        }
        bindingsChartClick(t, i) {
            ...
            e && (e.cancelClick || i.activeAnnotation || !i.target.parentNode || function(t, i) {
                ...
                e.cancelClick = !1
            }, 0) : i1(this, "closePopup")), s && s.start && (this.nextEvent ? (this.nextEvent(i, this.currentUserDetails), this.steps && (this.stepIndex++, s.steps[this.stepIndex] ? this.mouseMoveEvent = this.nextEvent = s.steps[this.stepIndex] : (i1(this, "deselectButton", {
                button: this.selectedButtonElement
            }), o.removeClass("highcharts-draw-mode"), s.end && s.end.call(this, i, this.currentUserDetails), this.nextEvent = !1, this.mouseMoveEvent = !1, this.selectedButton = null))) : (this.currentUserDetails = s.start.call(this, i), this.currentUserDetails && s.steps ? (this.stepIndex = 0, this.steps = !0, this.mouseMoveEvent = this.nextEvent = s.steps[this.stepIndex]) : (i1(this, "deselectButton", {
                button: this.selectedButtonElement
            }), o.removeClass("highcharts-draw-mode"), this.steps = !1, this.selectedButton = null, s.end && s.end.call(this, i, this.currentUserDetails))))
        }
        ...
        fieldsToOptions(t, i) {
            return i7(t, (t, e) => {
                let s = parseFloat(t),
                    o = e.split("."),
                    n = o.length - 1;
                if (!i4(s) || t.match(/px|em/g) || e.match(/format/g) || (t = s), "undefined" !== t) {
                    let e = i;
                    o.forEach((i, s) => {
        ...
        annotationToFields(t) {
            let i = t.options,
                e = er.annotationsEditable,
                s = e.nestedOptions,
                o = i3(i.type, i.shapes && i.shapes[0] && i.shapes[0].type, i.labels && i.labels[0] && i.labels[0].type, "label"),
                n = er.annotationsNonEditable[i.langKey] || [],
                a = {
                    langKey: i.langKey,
                    type: o
                };
            ...
            function r(i, e, o, a, h) {
                let l;
                o && i0(i) && -1 === n.indexOf(e) && ((o.indexOf && o.indexOf(e)) >= 0 || o[e] || !0 === o) && (i9(i) ? (a[e] = [], i.forEach((t, i) => {
                    i5(t) ? (a[e][i] = {}, i7(t, (t, o) => {
                        r(t, o, s[e], a[e][i], e)
                    })) : r(t, 0, s[e], a[e], e)
                })) : i5(i) ? (l = {}, i9(a) ? (a.push(l), l[e] = {}, l = l[e]) : a[e] = l, i7(i, (t, i) => {
                    r(t, i, 0 === e ? o : s[e], l, e)
                })) : "format" === e ? a[e] = [iz(i, t.labels[0].points[0]).toString(), "text"] : i9(a) ? a.push([i, iZ(h, i)]) : a[e] = [i, iZ(e, i)])
            }
            return i7(i, (t, n) => {
                "typeOptions" === n ? (a[n] = {}, i7(i[n], (t, i) => {
                    r(t, i, s, a[n], i)
                })) : r(t, n, e[o], a, n)
            }), a
        }
        getClickedClassNames(t, i) {
            let e = i.target,
                s = [],
                o;
            for (; e && e.tagName && ((o = iQ(e, "class")) && (s = s.concat(o.split(" ").map(t => [t, e]))), (e = e.parentNode) !== t););
            return s
        }
        getButtonEvents(t, i) {
            let e, s = this;
        ...
        update(t) {
            this.options = i6(!0, this.options, t), this.removeEvents(), this.initEvents()
        }
        removeEvents() {
    ...
    }, er.annotationsNonEditable = {
        rectangle: ["crosshairX", "crosshairY", "labelOptions"],
        ellipse: ["labelOptions"],
        circle: ["labelOptions"]
    };
    let eh = u();
    eh.Annotation = eh.Annotation || iL, eh.NavigationBindings = eh.NavigationBindings || er, eh.Annotation.compose(eh.Chart, eh.NavigationBindings, eh.Pointer, eh.SVGRenderer);
    let el = u();
    return p.default
})());