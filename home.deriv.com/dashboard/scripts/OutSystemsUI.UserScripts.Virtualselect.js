            ...
            if (null != o) {
                ...
                try {
                    if (n = (o = o.call(e)).next, 0 === t) {
                        ...
                        for (; !(l = (i = n.call(o)).done) && (a.push(i.value), a.length !== t); l = !0);
                } catch (e) {
                    u = !0, s = e
                } finally {
                    try {
    ...
    var k, C = {
        ...
        T = function() {
            ...
            return t = e, o = [{
                ...
                value: function() {
                    ...
                    i.forEach(function(i) {
                        var n, f = i.index,
                            ...
                            k = d(i.isSelected),
                            C = "";
                        if (i.classNames && (b += " ".concat(i.classNames)), i.isFocused && (w = "0", b += " focused"), i.isDisabled && (b += " disabled", C = 'aria-disabled="true"'), i.isGroupTitle && (v = i.label, b += " group-title", u && (m = "")), k && (b += " selected"), i.isGroupOption) {
                            var E = "";
                            b += " group-option", S = 'data-group-index="'.concat(i.groupIndex, '"'), i.customData ? (v = void 0 !== i.customData.group_name ? "".concat(i.customData.group_name, ", ") : "", E = void 0 !== i.customData.description ? " ".concat(i.customData.description, ",") : "", x = 'aria-label="'.concat(v, " ").concat(i.label, ", ").concat(E, '"')) : x = 'aria-label="'.concat(v, ", ").concat(i.label, '"')
                        }
                        n = h ? l(i) : i.label, i.description && (O = '<div class="vscomp-option-description" '.concat(y, ">").concat(i.description, "</div>")), i.isCurrentNew ? (b += " current-new", g += r) : !a || i.isGroupTitle && !p || (n = n.replace(e, "<mark>$1</mark>")), o += '<div role="option" aria-selected="'.concat(k, '" id="vscomp-option-').concat(c, "-").concat(f, '"\n          class="').concat(b, '" data-value="').concat(i.value, '" data-index="').concat(f, '" data-visible-index="').concat(i.visibleIndex, '"\n          tabindex=').concat(w, " ").concat(S, " ").concat(C, " ").concat(x, "\n        >\n          ").concat(m, '\n          <span class="vscomp-option-text" ').concat(y, ">\n            ").concat(n, "\n          </span>\n          ").concat(O, "\n          ").concat(g, "\n        </div>")
                ...
                value: function(e) {
                    document.activeElement !== this.$searchInput && (e.preventDefault(), this.isOpened() ? this.focusOption({
                        direction: "next"
                    }) : this.openDropbox())
                }
            }, {
                ...
                value: function(e) {
                    if ("keydown" === e.type) {
                        if ("Enter" !== e.code && "Space" !== e.code) return;
                        e.preventDefault()
                    }
                    var t = e.target;
                ...
                value: function() {
                    var e = this;
                    this.hasServerSearch ? (clearTimeout(this.serverSearchTimeout), this.serverSearchTimeout = setTimeout(function() {
                        e.serverSearch()
                ...
                value: function(e) {
                    ...
                    Object.keys(k).forEach(function(o) {
                        var i = t.getAttribute(o); - 1 === E.indexOf(o) || "" !== i && "true" !== i || (i = !0), i && (e[k[o]] = i)
                    })
                }
            }, {
                key: "setEleProps",
                    ...
                    var O = function(t) {
                        ...
                        if (g || "" !== S || (g = !0), i && (C.isDisabled = !0 === m[S]), t.isGroupOption && (C.isGroupOption = !0, C.groupIndex = t.groupIndex), u && (C.description = h(c(t[a]))), t.customData && (C.customData = t.customData), o.push(C), v += 1, k) {
                            ...
                            f = !0, w.forEach(function(e) {
                                e.isGroupOption = !0, e.groupIndex = E, O(e)
                            })
                        }
                    };
                ...
                value: function() {
                    ...
                    if (h && this.hideValueTooltipOnSelectAll) r.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(c, ")");
                    else {
                        ...
                        if ("" === f) r.innerHTML = this.placeholder;
                            ...
                            if (this.alwaysShowSelectedOptionsCount || d.hasEllipsis(r) || b || s) {
                                var y = '<span class="vscomp-selected-value-count">'.concat(c, "</span>");
                                if (b && (y += ' / <span class="vscomp-max-value-count">'.concat(b, "</span>")), h) r.innerHTML = "".concat(this.allOptionsSelectedText, " (").concat(c, ")");
                                else if (s) r.innerHTML = u.join(""), this.$valueTags = r.querySelectorAll(".vscomp-value-tag"), this.setValueTagAttr();
                                else if (!this.alwaysShowSelectedOptionsLabel) {
                                    var m = 1 === c ? this.optionSelectedText : this.optionsSelectedText;
                                    r.innerHTML = "".concat(y, " ").concat(m)
                                }
                            } else u = []
                        }
                    }
                ...
                value: function() {
                    ...
                    this.isSilentClose = !1, d.removeClass(this.$allWrappers, "focused"), this.removeOptionFocus(), !e && this.isPopupActive && (d.removeClass(this.$body, "vscomp-popup-active"), this.isPopupActive = !1), d.addClass(this.$allWrappers, "closed"), e || d.dispatchEvent(this.$ele, "afterClose"), this.shouldFocusWrapperOnClose = !0, d.setAttr(this.$dropboxWrapper, "tabindex", "-1"), d.setAria(this.$dropboxWrapper, "hidden", !0), d.setAttr(this.$dropboxContainerTop, "tabindex", "-1"), d.setAria(this.$dropboxContainerTop, "hidden", !0), d.setAttr(this.$dropboxContainerBottom, "tabindex", "-1"), d.setAria(this.$dropboxContainerBottom, "hidden", !0)
                }
            }, {
                ...
                value: function() {
                    ...
                    if (e) t && !this.allowNewOption ? (d.setAttr(e, "disabled", ""), this.$noOptions.focus()) : (e.removeAttribute("disabled"), e.focus());
                    else {
                ...
                value: function(e) {
                    ...
                    if (t) {
                        var o, i = this.$optionsContainer.getBoundingClientRect(),
                ...
                value: function(e) {
                    ...
                    if (e) {
                        ...
                        if (this.lastSelectedOptionIndex = null, this.toggleSelectedProp(r, o), o) {
                            if (this.multiple) i.push(s), this.toggleAllOptionsClass(), this.toggleGroupOptionsParent(e), t && t.shiftKey && (l = !0);
                            else {
                ...
                value: function() {
                    var t = this.$ele;
                    t.virtualSelect = void 0, t.value = void 0, t.innerHTML = "", e.openInstances.delete(this), this === e.lastInteractedInstance && (e.lastInteractedInstance = null), this.serverSearchTimeout && (clearTimeout(this.serverSearchTimeout), this.serverSearchTimeout = null), this.removeEvents(), this.hasDropboxWrapper && this.$dropboxWrapper.remove(), this.dropboxPopover && this.dropboxPopover.destroy(), d.removeClass(t, "vscomp-ele")
                }
            }, {
                    ...
                    var t = e.ele,
                        ...
                        s = function(e) {
                            ...
                            return Array.from(e.children).forEach(function(e) {
                                ...
                                "OPTGROUP" === e.tagName ? (r.label = e.getAttribute("label"), r.options = s(e)) : r.label = e.innerHTML, t.push(r), e.disabled && o.push(n), e.selected && i.push(n)
                            }), t
                        },
                        n = s(t),
            ...
            return t = [{
                ...
                value: function() {
                    ...
                    var B = {
                        ...
                        W = B[E];
                    if (C = W.top, k = W.left, $ && ("top" === $ ? C = x : "bottom" === $ ? C = x + y - p : "left" === $ ? k = w : "right" === $ && (k = w + b - c)), k < M ? "left" === E ? n = "right" : k = M + f > g ? g - f : M : k + c > L && ("right" === E ? n = "left" : k = L + f < S ? S - d : L - c), C < P ? "top" === E ? n = "bottom" : C = P + h > O ? O - h : P : C + p > I && ("bottom" === E ? n = "top" : C = I + h < m ? m - v : I - p), n) {
                        var H = B[n];
                    ...
                    if (o.setStyle(this.$popperEle, "transform", N), o.setData(this.$popperEle, "fromLeft", t), o.setData(this.$popperEle, "fromTop", e), o.setData(this.$popperEle, "top", C), o.setData(this.$popperEle, "left", k), o.removeClass(this.$popperEle, i.join(" ")), o.addClass(this.$popperEle, "position-".concat(E)), this.hasArrow) {
                        var G = 0,
                            ...
                            K = s[E] || "";
                        "top" === E || "bottom" === E ? (G = b / 2 + S - q) < R ? G = R : G > c - R && (G = c - R) : "left" !== E && "right" !== E || ((j = y / 2 + m - z) < R ? j = R : j > p - R && (j = p - R)), o.setStyle(this.$arrowEle, "transform", "translate3d(".concat(parseInt(G), "px, ").concat(parseInt(j), "px, 0) ").concat(K))
                    }
...
function() {
        ...
        return t = e, o = [{
            ...
            value: function(e) {
                ...
                for (var t = [window], o = e.parentElement; o;) {
                    var i = getComputedStyle(o).overflow; - 1 === i.indexOf("scroll") && -1 === i.indexOf("auto") || t.push(o), o = o.parentElement
                }
                return t
            }
        }, {
    ...
    d = b.getAttrProps(), window.PopoverComponent = b
}();