...
var O = new l.Model.ModelFactory(v);
var a = T(L());
var R = {};
var w = d; {
...
var ve = u.PlaceholderContent,
    ue = u.IteratorPlaceholderContent,
    B = r(function() {
        var i = S(function(t) {
            var D = t.model,
                e = t.controller,
            ...
            getAttributes: r(function() {
                return {
                    ...
                    functionKey: "996374ef-c9f0-498c-b934-7efb10de2fa6",
                    functionOwnerName: "dashboard",
                    functionOwnerKey: "bbed91b8-a741-4694-b61f-b0ef761ba4e2",
                    screen: ""
                }
            }, "getAttributes"),
            displayName: "Layouts.LoaderBlock",
            modelFactory: O,
            controllerFactory: W
        });
        return i.getCssDependencies = function() {
            return ["css/dashboard.Layouts.LoaderBlock.css", "css/OutSystemsReactWidgets.css"]
